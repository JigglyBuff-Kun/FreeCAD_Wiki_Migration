---
title: Kreslení Uchopit
---

## Description

Uchopování znamená "přilepení" následujících 3D bodu k existujícímu bodu. Uchopování je dostupné u většiny nástrojů v [Kreslení](/Draft_Workbench/cs "Draft Workbench/cs") a [Architektuře](/Arch_Workbench/cs "Arch Workbench/cs") a může být globálně zakázáno nebo povoleno příkazem [Kreslení Přepínač uchopování](#Options)
...
- ![](/images/Draft_Snap_Lock.svg) **Uzamknout**: globálně přepíná uchopování na zapnuto/vypnuto
...
* Další, mnohem komplexnější uchopovací místa mhou být získána použitím [vazeb](/Draft_Constrain "Draft Constrain") (stiskem kláves SHIFT nebo X nebo Y nebo Z během kreslení).
* Stisknutí klávesy L během kreslení uzamkne aktuální úhel právě kresleného segmentu přímky.
* Maximální vzdálenost, na kterou může být bod uchopovacím místem uchopen, je specifikována v [předvolbách](/Draft_Preferences "Draft Preferences"), ale také může být měněna za běhu stisknutím kláves [ nebo ].

Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Snap/cs&oldid=1565072>"
