...
Při vytváření drážky, dialogové okno 'parametry drážky' nabízí několik parametrů, které specifikují jak by se náčrt měl otáčet. Mají stejný význam jako u vlastnosti [otáčení](/PartDesign_Revolution#Options "PartDesign Revolution").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Groove/cs&oldid=1402162>"