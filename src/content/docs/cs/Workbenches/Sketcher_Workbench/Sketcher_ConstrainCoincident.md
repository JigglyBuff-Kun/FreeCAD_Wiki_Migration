...
| - |
| Viz také |
| [Constraint Lock](/Sketcher_ConstrainLock/cs "Sketcher ConstrainLock/cs"), [Vazba Bod na objekt](/Sketcher_ConstrainPointOnObject/cs "Sketcher ConstrainPointOnObject/cs") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainCoincident/cs&oldid=1404868>"