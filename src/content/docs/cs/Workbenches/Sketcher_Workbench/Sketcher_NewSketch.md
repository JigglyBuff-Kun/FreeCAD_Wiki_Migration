...
| - |
| Viz také |
| [Sketcher MapSketch](/Sketcher_MapSketch/cs "Sketcher MapSketch/cs"), [Sketcher Reorient](/Sketcher_ReorientSketch/cs "Sketcher ReorientSketch/cs") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_NewSketch/cs&oldid=1388123>"