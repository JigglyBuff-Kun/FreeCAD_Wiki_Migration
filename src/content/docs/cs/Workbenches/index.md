...
FreeCAD,stejně jako mnoho dalších moderních designových aplikací takových jako [Revit](http://en.wikipedia.org/wiki/Revit "wikipedia:Revit") nebo [CATIA](http://en.wikipedia.org/wiki/CATIA "wikipedia:CATIA"), je založen na konceptu [Pracovní plochy](http://en.wikipedia.org/wiki/Workbench "wikipedia:Workbench"). Pracovní plocha představuje skupinu nástrojů speciálně sestavených pro dané úlohy. V tradiční nábytkářské dílně byl samostatný pracovní stůl pro osobu, která pracovala se dřevem, další stůl pro osobu, která pracovala s kovovými částmi a třeba i třetí stůl, na kterém třetí pracovník montoval všechny kusy dohromady.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Workbenches/cs&oldid=1540516>"
