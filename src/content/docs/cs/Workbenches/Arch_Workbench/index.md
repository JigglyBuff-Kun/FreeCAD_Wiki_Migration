...
- [IFC](/Arch_IFC/cs "Arch IFC/cs") : Industry foundation Classes (pouze import)
- [DAE](/Arch_DAE/cs "Arch DAE/cs") : Síťový formát Collada
- [OBJ](/Arch_OBJ/cs "Arch OBJ/cs") : Síťový formát Obj (pouze export)

## API

Modul Architektura může být použit v pythonovských skriptech a [makrech](/Macros/cs "Macros/cs") použitím funkcí [Arch Python API](http://www.freecadweb.org/api/Arch.html).

## Výukový program

- [Výukový program architektura](/Arch_tutorial/cs "Arch tutorial/cs")
- [Architektonický výukový program v Yorikově blogu](http://yorik.uncreated.net/guestblog.php?2012=180)

Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Workbench/cs&oldid=1433535>"
