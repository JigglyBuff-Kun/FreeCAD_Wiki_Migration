...
* Údaje**Length** (`Length`): The length of the plane. This is the dimension in its X direction. The default is `10mm`.
* Údaje**Width** (`Length`): The width of the plane. This is the dimension in its Y direction. The default is `10mm`.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Plane/cs&oldid=1143707>"