...
* Údaje**Base**: The shape onto which the chamfer is to be applied.
* Údaje**Placement**: Specifies the orientation and position of the shape in the 3D space.
* Údaje**Label**: Label given to the object. Change to suit your needs.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Chamfer/cs&oldid=1222961>"