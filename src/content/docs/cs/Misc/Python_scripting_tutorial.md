---
title: Python scripting tutorial/cs
---
## Introduction
...
Another common feature of FreeCAD objects is their [placement](/Placement "Placement"). Each object has a Údaje**Placement** property, which contains the Údaje**Base** (position) and Údaje**Rotation** (orientation) of the object. It is easy to manipulate, for example to move our object:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Python_scripting_tutorial/cs&oldid=1296881>"