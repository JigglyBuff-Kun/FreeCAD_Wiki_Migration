...
[Std\_UnitsCalculator](/Std_UnitsCalculator "Std UnitsCalculator")
...
Jednotka je používaná hlavně k popisu typu jednotky parametru. Proto speciální typ vlastnosti ve FreeCADu může předávat jednotky pro jejich kontrolu a zaručuje správnou jednotku.
...
The precision of quantities is within FreeCAD dialogs the number of decimals specified [in the preferences](/Preferences_Editor#Units "Preferences Editor"). To use this settings for your script (for example in dialogs), you can get it with this code:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Quantity/cs&oldid=1463703>"