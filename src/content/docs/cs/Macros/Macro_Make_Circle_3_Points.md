---
title: Vytvoř kružnici ze 3 bodů
---
...
| Popis                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Vytváří kružnici ze 3 vybraných bodů nebo tvarů. Version macro : 1.0 Date last modification : 2014-08-08 FreeCAD version : All Download : [ToolBar Icon](https://www.freecadweb.org/wiki/images/c/c7/Macro_Make_Circle_3_Points.png) [Icon View-Top](https://www.freecadweb.org/wiki/images/f/fb/View-Top.png) [Icon View-Left](https://www.freecadweb.org/wiki/images/c/ca/View-Left.png) [Icon View-Front](https://www.freecadweb.org/wiki/images/6/64/View-Front.png) [Icon View-C3P](https://www.freecadweb.org/wiki/images/1/19/View-C3P.png) Autor: Mario52 |
| Autor                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
- [![Kružnice na 3 tvarech (pohled zepředu),](/images/Macro_Draft_Circle_3_Points02.png)](/File:Macro_Draft_Circle_3_Points02.png  "Kružnice na 3 tvarech (pohled zepředu),")

  Kružnice na 3 tvarech (pohled zepředu),

- [![na kolmicích na vybraném tvaru (pohled zprava)](/images/Macro_Draft_Circle_3_Points03.png)](/File:Macro_Draft_Circle_3_Points03.png  "na kolmicích na vybraném tvaru (pohled zprava)")

  na kolmicích na vybraném tvaru (pohled zprava)

* ![](/images/Macro_Draft_Circle_3_Points04.png)

- ![Tři nezávislé kolmé kružnice na vybraném tvaru.](/images/Macro_Draft_Circle_3_Points05.png)
...
Zde je 3D zobrazení, které umožňuje vidět 2 různé pozice pohledu použitím brýlí s filtry pro červenou a cyan barvu ![](/images/Anaglyph_Tango.png).  
Podívejte se střídavě pravým a levým okem abyste viděli pohledy samostatně.

![3D pohled](/images/Cercle3Points2D_anaglyphe.png)
...
[Macro_Draft_Circle_3_Points](/Macro_Draft_Circle_3_Points "Macro Draft Circle 3 Points")  
[Macro_Draft_Circle_3_Points_3D](/Macro_Draft_Circle_3_Points_3D "Macro Draft Circle 3 Points 3D")

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Make_Circle_3_Points/cs&oldid=692363>"
