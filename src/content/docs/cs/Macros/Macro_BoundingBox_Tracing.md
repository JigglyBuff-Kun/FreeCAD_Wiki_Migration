...
| Popis                                                                                                                                                                                                                                                              |
| Toto makro červené stopy (editovatelné) kolem BoundingBox se 6 obdélníky. Version macro : 0.12 Date last modification : 2021/07/10 FreeCAD version : All Download : [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/60/BoundBoxTracing.png) Autor: Mario52 |
| Autor                                                                                                                                                                                                                                                              |
...
: Result: 6 obdélníků jsou barevně červené (lze změnit)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_BoundingBox_Tracing/cs&oldid=1279428>"
