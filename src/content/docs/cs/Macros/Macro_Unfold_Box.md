...
| Popis                                                                                                                                                                                                                                                                                                                                  |
| Toto makro rozloží povrchy krabice jakéhokoliv tvaru a nakreslí je na stránku. This macro must be upgraded cause error indentation and space mixed with tabulation Version macro : 1.0 Date last modification : 2013-09-20 Download : [ToolBar Icon](https://www.freecadweb.org/wiki/images/e/e4/Macro_Unfold_Box.png) Autor: Hervé B. |
| Autor                                                                                                                                                                                                                                                                                                                                  |
...
Cf [Makro pro rozložení povrchů krabice](http://forum.freecadweb.org/viewtopic.php?f=17&t=4587)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Unfold_Box/cs&oldid=1166308>"
