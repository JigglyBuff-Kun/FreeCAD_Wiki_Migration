...
| Macro Delta xyz                                                                                                                                                                                                         |
| Popis                                                                                                                                                                                                                   |
| dává hodnotu Delta mezi 2 body. Version macro : 0.2 Date last modification : 2020-10-23 FreeCAD version : All Download : [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f4/Macro_Delta_xyz.png) Autor: Mario52 |
| Autor                                                                                                                                                                                                                   |
...
| SHIFT, Q                                                                                                                                                                                                                |
| Viz též                                                                                                                                                                                                                 |
| [Part Measure Linear](/index.php?title=Part_Measure_Linear/cs&action=edit&redlink=1 "Part Measure Linear/cs (page does not exist)")                                                                                     |
|                                                                                                                                                                                                                         |
|                                                                                                                                                                                                                         |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Delta_xyz/cs&oldid=787765>"
