...
3. Optionally change the dimensions and Veri**Placement** of the box by doing one of the following:
   ...
   * Change the Veri**Placement** with the ![](/images/Std_TransformManip.svg) [Std TransformManip](/Std_TransformManip "Std TransformManip") command.
...
* Veri**Length** (`Length`): The length of the box. This is the dimension in its X direction. The default is `10mm`.
* Veri**Width** (`Length`): The width of the box. This is the dimension in its Y direction. The default is `10mm`.
* Veri**Height** (`Length`): The height of the box. This is dimension in its Z direction. The default is `10mm`.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Box/tr&oldid=1466529>"