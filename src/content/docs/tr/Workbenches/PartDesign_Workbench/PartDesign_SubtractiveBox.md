---
title: PartDesign SubtractiveBox/tr
---
|  |
| --- |
...
1. Press the ![](/images/PartDesign_SubtractiveBox.svg) **Subtractive Box** button. **Note**: the Subtractive Box is part of an icon menu labelled *Create a subtractive primitive*. After launching FreeCAD, the Subtractive Box is the one displayed in the toolbar. If a different primitive is displayed, click on the down arrow besides the icon and select Subtractive Box in the menu.
...
* Veri**Label**: Label given to the Box object. Change to suit your needs.
* Veri**Length**: the Box's dimension in the X-direction.
* Veri**Width**: the Box's dimension in the Y-direction.
* Veri**Height**: the Box's dimension in the Z-direction.

Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_SubtractiveBox/tr&oldid=1424635>"