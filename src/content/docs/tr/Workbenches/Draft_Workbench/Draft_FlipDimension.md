...
| - |
| Ayrıca bkz |
| [Dimension](/Draft_Dimension/tr "Draft Dimension/tr") |
|  |
...
* [Draft Dimensions](/Draft_Dimension "Draft Dimension") also have a Veri**Flip Text** property. When set to `true` the text is rotated 180° around the normal direction. This can be combined with the effect of this command.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_FlipDimension/tr&oldid=1338145>"