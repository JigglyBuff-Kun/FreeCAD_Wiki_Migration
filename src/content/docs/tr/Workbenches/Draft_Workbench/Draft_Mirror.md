...
| - |
| Ayrıca bkz |
| [Draft Scale](/Draft_Scale/tr "Draft Scale/tr") |
|  |
...
* Veri**Source** (`Link`): specifies the object that is mirrored.

Plane

* Veri**Base** (`Vector`): specifies the base point of the mirror plane.
* Veri**Normal** (`Vector`): specifies the normal direction of the mirror plane.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Mirror/tr&oldid=1513546>"