---
title: Taslak Paralel
---
|  |
| --- |
| Taslak Paralel |
| Menü konumu |
| Taslak → [Yakalama](/Draft_Snap/tr "Draft Snap/tr") → Paralel |
| Tezgahlar |
...
Bu Yakalama modu, hayali bir çizgi üzerinde çizgi parçasına paralel bir nokta seçmenizi sağlar.
...
2. FreeCAD belgeside işlem yapılacak bileşeni seçin
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Snap_Parallel/tr&oldid=1513557>"