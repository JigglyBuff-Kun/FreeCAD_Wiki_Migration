...
1. Do one of the following:
   * Select a single object. The following objects are supported:
     + [Draft WorkingPlaneProxies](/Draft_WorkingPlaneProxy "Draft WorkingPlaneProxy"): the Görünüm**View Data** (the camera position) and the Görünüm**Visibility Map** (the saved visibility of objects) of the working plane proxy are also restored.
     ...
     + Solid objects or objects without a shape that have a Veri**Placement** property. ([introduced in 1.0](/Release_notes_1.0 "Release notes 1.0"))
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_SelectPlane/tr&oldid=1473292>"