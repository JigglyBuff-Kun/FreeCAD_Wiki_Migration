---
title: Eskiz Tezgahı - Eskiz Oluştur
---
|  |
| --- |
| Eskiz Oluştur |
| Menü konumu |
| Sketch → Eskiz oluştur |
| Tezgahlar |
| [Sketcher](/Sketcher_Workbench/tr "Sketcher Workbench/tr") |
| Varsayılan kısayol |
| *Hiçbiri* |
| Versiyonda tanıtıldı |
| - |
| Ayrıca bkz |
| [Eskizi Yüzeye Eşle](/Sketcher_MapSketch/tr "Sketcher MapSketch/tr"), [Eskizi yeniden yönlendir...](/Sketcher_ReorientSketch/tr "Sketcher ReorientSketch/tr") |
|  |

## Tanım

Bu komut yeni bir [Eskiz](/Sketcher_Workbench/tr "Sketcher Workbench/tr") oluşturur.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_NewSketch/tr&oldid=1388127>"