...
Mimari Tezgahı, FreeCAD'e modern, [bina bilgi modellemesi](http://en.wikipedia.org/wiki/Building_Information_Modeling) (BIM) iş akışını, duvarlar, yapısal elemanlar, çatılar,pencereler, merdivenler, borular ve mobilya gibi tamamen parametrik mimari öğelerin özelliklerini destekler.[endüstriyel temel sınıflar](http://en.wikipedia.org/wiki/Industry_Foundation_Classes) (IFC) verilerini ve [Teknik resim tezgahı](/TechDraw_Workbench/tr "TechDraw Workbench/tr") ile birlikte 2D kat planlarının üretilmesini destekler.
...
Mimari tezgah, [Taslak tezgahı](/Draft_Workbench/tr "Draft Workbench/tr") 'ndaki tüm araçları mimari nesneleri oluşturmak için 2D nesneler kullandığından içe aktarır. Bununla birlikte, Mimari, [Parça tezgahı](/Part_Workbench/tr "Part Workbench/tr") ve [Parça tasarım tezgahı](/PartDesign_Workbench/tr "PartDesign Workbench/tr") gibi diğer tezgahlarda oluşturulan katı nesneleri de kullanabilir.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Workbench/tr&oldid=1433545>"
