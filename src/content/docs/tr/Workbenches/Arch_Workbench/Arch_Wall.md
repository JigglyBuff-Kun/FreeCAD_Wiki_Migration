...
| - |
| Ayrıca bkz |
| [Mimari Yapı](/Arch_Structure/tr "Arch Structure/tr") |
|  |
...
* Walls can be made to display blocks, instead of one single solid, by turning their Veri**Make Blocks** property on. The size and offset of blocks can be configured with different properties, and the amount of blocks is automatically calculated.
...
* Veri**Block Height**: The height of each block.
* Veri**Block Length**: The length of each block.
* Veri**Count Broken**: The number of broken blocks (read-only).
* Veri**Count Entire**: The number of entire blocks (read-only).
* Veri**Joint**: The size of the joints, the empty space, between blocks.
* Veri**Make Blocks**: Enables block generation.
* Veri**Offset First**: The horizontal offset of the first and every uneven line of blocks.
* Veri**Offset Second**: The horizontal offset of the second and every even line of blocks.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Wall/tr&oldid=1548503>"