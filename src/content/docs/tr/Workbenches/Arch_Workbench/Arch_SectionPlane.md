...
* Veri**Only Solids**: If this is True, non-solid objects in the set will be disregarded
* Görünüm**Display Length**: The length of the section plane gizmo in the 3D view. Doesn't affect the resulting view
* Görünüm**Display Height**: The height of the section plane gizmo in the 3D view. Doesn't affect the resulting view
* Görünüm**Arrow Size**: The size of the arrows of the section plane gizmo in the 3D view. Doesn't affect the resulting view
* Görünüm**Cut View**: If this is `true`, the whole 3D view will be cut at the location of this section plane.
* Görünüm**Clip view**: if this is `true`, it will clip the view to the display height and length of the section plane. This effectively turns the section plane into an orthographic camera, limiting the field of view.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_SectionPlane/tr&oldid=1560773>"