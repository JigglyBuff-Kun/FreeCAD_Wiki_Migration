---
title: İçe/Dışa Aktar Seçenekleri
---
## DXF Seçeneği

DXF sekmesi  [DXF](/Draft_DXF/tr "Draft DXF/tr") dosyalarının nasıl içe aktarılacağını düzenler. Ayrıca bakınız  [FreeCAD ve DXF içe aktarma](/FreeCAD_and_DXF_Import/tr "FreeCAD and DXF Import/tr").

## Introduction

İçe aktarma ve dışa aktarma araçlarına ilişkin Seçenekler [Seçenekler](/Preferences_Editor/tr "Preferences Editor/tr") menüsünde,  **Edit → Preferences → Import-Export** menüsünde bulunur.
...
| **Import** | Select what will be imported. If **texts and dimensions** is checked, texts and [mtexts](https://www.autodesk.com/techpubs/autocad/acad2000/dxf/mtext_dxf_06.htm) will be imported too.  If **points** is checked, points will be imported too.  If **layouts** is checked, paper space objects will be imported too.  If **\*blocks** is checked, anonymous blocks (which have names beginning with a \*) will be imported too. |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Import_Export_Preferences/tr&oldid=1521243>"