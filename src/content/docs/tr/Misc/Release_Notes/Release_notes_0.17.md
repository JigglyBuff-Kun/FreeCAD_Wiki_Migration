---
title: Sürüm 0.17 notları
---
*FreeCAD'in bu sürümü, arkadaşımız Roland Frank'e [2017 yılında aramızdan ayrılmıştır(Allah rahmet eylesin)](https://forum.freecadweb.org/viewtopic.php?f=8&t=25673) adanmıştır. FreeCAD forumunun aktif ve takdir görmüş bir üyesiydi. [Learn FreeCAD](https://www.youtube.com/watch?v=_HEvhclR4-o&list=PL6fZ68Cq3L8k0JhxnIVjZQN26cn9idJrj) hazırladığı videoları ve [BPLFRE](https://www.youtube.com/watch?v=m49z0weonog&list=PLsrwVwvqYb8G4Ri0iz1JIebsOXkgoytAY) youtube kanalı ile FreeCAD'e yeni başlayanlara yardımcı oluyordu.*

FreeCAD 0.17, 6 Nisan 2018'de [İndir](/Download/tr "Download/tr") sayfasında yayınlandı. Bu, en ilginç değişikliklerin bir özetidir. Değişikliklerin tam listesini [MantisBT bugtracker FC 0.17 changelog](https://www.freecadweb.org/tracker/changelog_page.php?version_id=73) adresinde bulabilirsiniz. Daha eski FreeCAD sürüm notları  [Başlangıç](/Getting_started/tr "Getting started/tr") bölümünde bulunabilir.

![](/images/Release017_Title.jpg)

"Garden Railway Coach O&K (by FreeCAD-User "Garden Railway Coach O&K" bakınız [Users Showcase](http://forum.freecadweb.org/viewtopic.php?f=24&t=17261))"

## Önemli Noktalar

Önceki 0.16 sürümünden bu yana 2 yıl geçti, ancak FreeCAD ekibi bu süre boyunca boşta kalmadı. FreeCAD'in kaynak koduna 6.800'den fazla revizyon eklendi. Karşılaştırırsak bu, v0.16 ile 0.15 arasında yapılan işin üç katından fazla! Mevcut tezgahların çoğu iyileştirmelerden yararlanmış ve iki tamamen yeni tezgah eklenmiştir. Topluluk tarafından yeni ek modüller de geliştirilmiştir. Önemli noktalardan bazıları:

**Parça tasarım tezgahı** tamamen elden geçirildi. Yeni bir Cisim konteyneri şimdi bir özellikler zincirine sahip ve eskizlerin düzlemsel yüzlere eşlenmesi gerekliliğini kaldırdı. Noktalar, eksenler ve düzlemler gibi referans noktası (referans) geometrisi oluşturmak için yeni araçlar Parça tasarım tezgahını çok daha kullanışlı hale getirdi.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Release_notes_0.17/tr&oldid=1074027>"