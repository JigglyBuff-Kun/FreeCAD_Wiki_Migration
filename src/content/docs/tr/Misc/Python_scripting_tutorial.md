...
* Bir "komut satırı" tarzı stilde basit komutlar verebileceğiniz [FreeCAD Python yorumlayıcı](/FreeCAD_Scripting_Basics/tr "FreeCAD Scripting Basics/tr") 'dan, [makrolar](/Macros/tr "Macros/tr")' dan hızlı bir şekilde eksik bir aracı FreeCAD arayüzüne eklemek için uygun bir yoldur
* [Tezgahlar](/Workbenches/tr "Workbenches/tr") gibi çok daha karmaşık şeyleri programlamak için kullanılabilecek harici komut dosyalarından,

Bu eğitici yazıda, başlamanız için birkaç basit örnek üzerinde çalışacağız, ancak bu wiki'de çok daha fazla  [python komut dosyası hakkında belgeler](/Power_users_hub/tr "Power users hub/tr") de var. Python'da tamamen yeniyseniz ve nasıl çalıştığını anlamak istiyorsanız, aynı zamanda temel bir [Python'a giriş](/Introduction_to_Python/tr "Introduction to Python/tr") var.

**Önemli!** Python komut dosyasına devam etmeden önce,  **Edit-> Prefences-> General-> Output** penceresine gidin ve 2 kutuyu işaretleyin:

* Görünüm için rapor vermek üzere dahili Python çıkışını yönlendirin
* Dahili Python'u yönlendirin rapor görünümünde hatalar Ardından  **View-> Panels** 'e gidin ve kontrol edin:
...
Bu eğitici yazıda, her iki yöntemi de, her bir satırı python konsolunda birer birer kopyalayıp / yapıştırarak ve her satırdan sonra  Return tuşuna basarak ya da tüm kodu kopyalayarak / yapıştırarak kullanabilirsiniz. Yeni Makro penceresi.
...
Another common feature of FreeCAD objects is their [placement](/Placement "Placement"). Each object has a Veri**Placement** property, which contains the Veri**Base** (position) and Veri**Rotation** (orientation) of the object. It is easy to manipulate, for example to move our object:
...
[PySide hakkında daha fazla bilgi için tıklayın ...](/PySide/tr "PySide/tr")
...
Artık daha derinlemesine FreeCAD betikleri için hazırsınız. [Uzman kullanıcılar Merkezi](/Power_users_hub/tr "Power users hub/tr") 'ne gidin!

[Top](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Python_scripting_tutorial/tr&oldid=1296835>"