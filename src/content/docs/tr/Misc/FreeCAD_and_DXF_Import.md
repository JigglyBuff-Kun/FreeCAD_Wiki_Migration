---
title: FreeCAD ve DXF içe aktarma
---
## Background

DXF is a proprietary CAD data format for 2D drawings that originated with AutoCAD. More details can be found on the [DXF](/DXF "DXF") wiki page.
...
2. Remember that maybe now you won't have coincident endpoints. You can make them coincident with [Sketcher ValidateSketch](/Sketcher_ValidateSketch "Sketcher ValidateSketch")

You can also try:

1. Go to **Edit → Preferences → Draft → General settings** and adjust the value of **Tolerance** (default: 0,05) and try again.

For an overview of all DXF related preferences see [Import Export Preferences](/Import_Export_Preferences#DXF "Import Export Preferences").

Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD_and_DXF_Import/tr&oldid=1329436>"