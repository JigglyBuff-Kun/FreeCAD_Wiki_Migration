...
Her FreeCAD komutunun [Komut Referansı](/Category:Command_Reference/tr "Category:Command Reference/tr") sayfasında görünen benzersiz bir adı vardır. Komutlar aşağıdakileri çalıştırarak, bir araç çubuğu düğmesi, bir menü öğesi veya bir python betiğinden veya python konsolundan başlatılabilir:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Command/tr&oldid=1130190>"