...
* [Komut Referans](/Category:Command_Reference/tr "Category:Command Reference/tr") sayfası, FreeCAD  [Komutlar](/Command/tr "Command/tr") 'ın tümünü listeler ve belgeler. Birçoğu çok az veya hiçbir bilgi içermiyor. Komut dokümantasyon sayfalarının nasıl görünmesi gerektiğine dair iyi örnekler için lütfen [WikiPages](/WikiPages "WikiPages") bölümüne bakın.
* [Kılavuzlar](/Tutorials/tr "Tutorials/tr") bölümü hala çok zayıf. FreeCAD ile harika bir şey geliştirdiyseniz, herkesin faydalanması için yaptığınızı bizimle paylaşır mısınız?
* FreeCAD'de [bugtracker](/Bugtracker "Bugtracker") etiketli '[belgelendirme](https://freecadweb.org/tracker/search.php?tag_string=documentation)' de biraz özveri isteyen işler var.
...
* FreeCAD ile yaptığınız çalışmaları [Kullanıcılar Vitrin Forumu](http://forum.freecadweb.org/viewforum.php?f=24) 'nda gösterme. Ekran görüntüleri yayınlayabilir ve daha da iyisi, FreeCAD dosyalarını ekleyerek diğer kişilerin incelemesini ve nasıl yaptığınızı anlamalarını sağlayabilirsiniz.
* FreeCAD'de ilginç bir şeyi nasıl yaptığınızı gösteren [videos](http://www.youtube.com/user/FreeCADNews) kaydı. Bu videolar genellikle yeni özellikler göstermede harika bir iş çıkarır.
* İlgi çekici bir şeyi açıklayan ya da öğreten [tutorials](http://freecad-tutorial.blogspot.com/) yazın. Öğreticileri kendi blogunuzda, doğrudan wiki sayfamızda veya hatta forumda yazabilirsiniz.
* [FreeCAD Google Plus](Https://plus.google.com/communities/103183769032333474646) veya [Facebook](https://www.facebook.com/groups/416491481766626) topluluğunda yayınlayın.
...
Çeviri ile ilgili detaylar için [Localisation](/Localisation "Localisation") altındaki FreeCAD Wiki Çeviri Süreci'ne bakınız.
...
Çeviri ile ilgili detaylar için [Localisation#Translating\_the\_wiki](/Localisation#Translating_the_wiki "Localisation") altındaki FreeCAD Wiki Çeviri Süreci'ne bakınız.
...
Lütfen iyi çeviriler için kurallar içeren [WikiPages](/WikiPages "WikiPages") stil rehberine aşina olduğunuzdan emin olun.
...
* ['Oyuncular' ve 'İzliyor'](Https://help.github.com/articles/be-social/#watch-a-project) ile FreeCAD'in tanıtımına yardımcı olun [/ FreeCAD FreeCAD deposu](https://github.com/FreeCAD) github
...
* Bir hata bulduğunuzdan ne kadar emin olursanız olun, lütfen önce hataları daima [Yardım forumu](http://forum.freecadweb.org/viewforum.php?f=3) 'nda tartışın.
* Bir özellik isteği göndermeden önce, bunu ilk önce [Açık tartışma forumunda](http://forum.freecadweb.org/viewforum.php?f=8) diğer kullanıcılarla tartışın, böylece daha sağlam bir teklifle sonuçlanabilirsiniz.
...
FreeCAD için simgeler tasarlama hakkında yönergeler için [Sanat eseri](/index.php?title=Artwork/tr&action=edit&redlink=1 "Artwork/tr (page does not exist)") sayfasına bakın.
...
* Hemen hemen her şey python veya C++ ile yapılabilir. İç kısımlar neredeyse her iki dilde de aynı şekilde çalışıyor. Siz C++ 'da kod yazsanız bile, [Uzman kullanıcı merkezi](/Power_users_hub/tr "Power users hub/tr") sayfalarını okumanızı öneririz, çünkü bu size iç dünya hakkında iyi bir genel bakış sunar.
* C++ 'da çalışacaksanız, önce FreeCAD'i problemsiz derleyebildiğinizden emin olun.
* Kendinizi diğer geliştiricilere sunun. FreeCAD, her şeyden önce sosyal bir projedir, uygulamadan önce [forum](http://forum.freecadweb.org) üzerinde birçok şeyi tartışırız ve fikirlerinizi tartışmak ve insanlara daha önce ne yapmayı planladığınızı söylemek her zaman en iyisidir. Ayrıca bir [irc: //chat.freenode.net/freecad IRC kanalı] var, ancak forum tüm geliştiricilerin buluşabileceği tek yer.
* 2016'dan bu yana, FreeCAD de [Google Yaz Kodu](/index.php?title=Google_Summer_of_Code/tr&action=edit&redlink=1 "Google Summer of Code/tr (page does not exist)") 'na katılıyor. Bir sonraki basıma katılmak istiyorsanız, fikirlerimizi kontrol ettiğinizden emin olun.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Help_FreeCAD/tr&oldid=1559507>"