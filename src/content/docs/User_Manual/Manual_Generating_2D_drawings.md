...
In FreeCAD, the workbench responsible for making such drawings is the ![](/src/assets/images/Workbench_TechDraw.svg) [TechDraw Workbench](/TechDraw_Workbench "TechDraw Workbench").
...
- Switch to the ![](/src/assets/images/Workbench_TechDraw.svg) [TechDraw Workbench](/TechDraw_Workbench "TechDraw Workbench")
- Press the ![](/src/assets/images/TechDraw_PageTemplate.svg) [TechDraw PageTemplate](/TechDraw_PageTemplate "TechDraw PageTemplate") button.
...
- Press the ![](/src/assets/images/TechDraw_View.svg) [TechDraw View](/TechDraw_View "TechDraw View") button.
...
- We now have a nice top view of our chair. Hit the ![](/src/assets/images/TechDraw_ToggleFrame.svg) [TechDraw ToggleFrame](/TechDraw_ToggleFrame "TechDraw ToggleFrame") button to turn the View frames, labels, and vertices off.
...
- Note that there may be easier ways to get the views that you want. You can simply [rotate](/Manual:Navigating_in_the_3D_view "Manual:Navigating in the 3D view") the 3D view of your model, and once you have the view you want, select the model in the tree view and hit ![](/src/assets/images/TechDraw_View.svg) New View. This will automatically insert a view with the desired rotation and direction properties. You can also use the ![](/src/assets/images/TechDraw_ProjectionGroup.svg) [TechDraw ProjectionGroup](/TechDraw_ProjectionGroup "TechDraw ProjectionGroup") tool.
...
We will now place dimensions and indications on our drawing. There are two ways to add dimensions to a model: one is placing the dimensions inside the 3D model, using the ![](/src/assets/images/Draft_Dimension.svg) [Dimension](/Draft_Dimension "Draft Dimension") tool of the [Draft Workbench](/Draft_Workbench "Draft Workbench"), and then placing a view of these dimensions on our sheet with the ![](/src/assets/images/TechDraw_DraftView.svg) [TechDraw DraftView](/TechDraw_DraftView "TechDraw DraftView") tool. The other is to do things directly on the TechDraw sheet. We'll use the latter method.

- Hit the ![](/src/assets/images/TechDraw_ToggleFrame.svg) Toggle button to turn the vertices on.
- Use Ctrl + Left Mouse Click to select the two vertices you want to measure the distance between.
- Hit the ![](/src/assets/images/TechDraw_LengthDimension.svg) [TechDraw LengthDimension](/TechDraw_LengthDimension "TechDraw LengthDimension") button.

![](/src/assets/images/Exercise_TechDraw_05.png)

- Repeat the operation, until all the dimensions you wish to indicate are placed. Use the ![](/src/assets/images/TechDraw_VerticalDimension.svg) [TechDraw VerticalDimension](/TechDraw_VerticalDimension "TechDraw VerticalDimension") and ![](/src/assets/images/TechDraw_HorizontalDimension.svg) [TechDraw HorizontalDimension](/TechDraw_HorizontalDimension "TechDraw HorizontalDimension") tools as necessary.
