...
![](/src/assets/images/FreeCAD_FEMBeam.png)
...
First, we will create our simple geometry. For this, we will be using the ![](/src/assets/images/Workbench_PartDesign.svg) [PartDesign](/PartDesign_Workbench "PartDesign Workbench") workbench.

- Create a new document and go to the ![](/src/assets/images/Workbench_PartDesign.svg) [PartDesign](/PartDesign_Workbench "PartDesign Workbench") workbench.
- Press on ![](/src/assets/images/Sketcher_NewSketch.svg) [NewSketch](/Sketcher_NewSketch "Sketcher NewSketch") to create a new sketch on the YZ plane.
- Create a ![](/src/assets/images/Sketcher_CreateRectangle_Center.svg) [centered rectangle](/Sketcher_CreateRectangle_Center "Sketcher CreateRectangle Center") around the origin point.
  - Using the ![](/src/assets/images/Sketcher_Dimension.svg) [Sketcher Dimension](/Sketcher_Dimension "Sketcher Dimension") set the vertical dimension to **20 mm** and the horizontal to **10 mm**
- Exit the sketch mode.
- By having selected our newly created sketch apply a ![](/src/assets/images/PartDesign_Pad.svg) [padding](/PartDesign_Pad "PartDesign Pad") operation with a length of **1000 mm**.
...
![](/src/assets/images/FreeCAD_FEM_BeamGeometry.png)

### Creating the analysis

- We are now ready to start a FEM analysis. Let's switch to the ![](/src/assets/images/Workbench_FEM.svg) [FEM workbench](/FEM_Workbench "FEM Workbench")
- Press the ![](/src/assets/images/FEM_Analysis.svg) [New Analysis](/FEM_Analysis "FEM Analysis")
...
![](/src/assets/images/FreeCAD_FEM_Beam_FC.png)

- We will now add a distributed load on the top face, that could represent, for example, a massive weight being placed on the beam. For this, we will use a press on the![](/src/assets/images/FEM_ConstraintForce.svg) [Force load](/FEM_ConstraintForce "FEM ConstraintForce") option.
...
![](/src/assets/images/FreeCAD_FEM_Beam_force.png)

- We are now ready to start the calculation. Select the ![](/src/assets/images/FEM_SolverCalculixCxxtools.svg) [Calculix solver](/FEM_SolverCalculixCxxtools "FEM SolverCalculixCxxtools").
...
![](/src/assets/images/FreeCAD_FEM_Calculix.png)

- We can now look at the results. Click on the ![](/src/assets/images/FEM_ResultShow.svg) [show results](/FEM_ResultShow "FEM ResultShow") option.
...
![](/src/assets/images/FreeCAD_FEM_Results.png)
