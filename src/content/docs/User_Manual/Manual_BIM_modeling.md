...
- Create a new document, and switch to the ![](/src/assets/images/Workbench_BIM.svg) [BIM Workbench](/BIM_Workbench "BIM Workbench").
- Open menu **Edit → Preferences → Draft → Grid and Snapping** and set:
  ...
  - **Grid size** `100 lines`.
- On the **snapping toolbar** make sure the ![](/src/assets/images/Draft_Snap_Grid.svg) [Snap grid](/Draft_Snap_Grid "Draft Snap Grid") button is enabled, so we can use the grid as much as possible.
- If you do not see the axes then click the ![](/src/assets/images/Draft_ToggleGrid.svg) [Toggle grid](/Draft_ToggleGrid "Draft ToggleGrid") button.
- Set the [Working Plane](/Draft_SelectPlane "Draft SelectPlane") to **XY** plane
- Draw four lines with the ![](/src/assets/images/Draft_Line.svg) [Draft Line](/Draft_Line "Draft Line") tool. You can enter coordinates manually, or simply pick the points on the grid with the mouse. We will be using meters for our dimensions:
...
- Select all four lines, then press the ![](/src/assets/images/Arch_Wall.svg) [Wall](/Arch_Wall "Arch Wall") button.
...
- Press the ![](/src/assets/images/Arch_Add.svg) [Add](/Arch_Add "Arch Add") button. The four walls have now been turned into one:
...
- Let's now place a door by pressing on the ![](/src/assets/images/BIM_Door.svg) [Door](/BIM_Door "BIM Door") tool.
...
- Set the ![](/src/assets/images/View-axonometric.svg) [Working Plane](/Draft_SelectPlane "Draft SelectPlane") to **auto** so we are not restricted to the ground plane
...
- Make sure the ![](/src/assets/images/Draft_Snap_Near.svg) [Snap near](/Draft_Snap_Near "Draft Snap Near") option is turned on, so we can snap on faces
...
- Let's place a window next to our door. Select the wall, press the ![](/src/assets/images/Arch_Window.svg) [Window](/Arch_Window "Arch Window") tool, select the **Open 2-pane** preset, and place a **1m x 1m** window in the same face as the door. Set the placement of the underlying sketch to position **x = 0, y = 0, z = 1.1m**, so the upper line of the window is aligned to the top of the door.
...
- Set the [Working Plane](/Draft_SelectPlane "Draft SelectPlane") to **XY** plane
- Create a ![](/src/assets/images/Draft_Rectangle.svg) [rectangle](/Draft_Rectangle "Draft Rectangle") with a **length** of 5m, a height of **4m**, and place it at position x:-0.5m, y:-0.7m, z:0.
- Select the rectangle
- Click the ![](/src/assets/images/BIM_Slab.svg) [Slab](/BIM_Slab "BIM Slab") tool to create a slab from the rectangle
...
- Let's put a roof over our heads now. We can easily do it by using the ![](/src/assets/images/Arch_Roof.svg) [Roof](/Arch_Roof "Arch Roof") tool.
- Press the ![](/src/assets/images/Draft_Snap_WorkingPlane.svg) [Snap working plane](/Draft_Snap_WorkingPlane "Draft Snap WorkingPlane") option to enable the drafting on all planes.
- By choosing one of the top faces of our house press the ![](/src/assets/images/Draft_SelectPlane.svg) [Select plane](/Draft_SelectPlane "Draft SelectPlane") button. The working plane is now set to that face.
- Create a ![](/src/assets/images/Draft_Rectangle.svg) [rectangle](/Draft_Rectangle "Draft Rectangle"), snapping to two opposite points of the walls:
...
- Press the ![](/src/assets/images/Arch_Floor.svg) [Floor](/Arch_Floor "Arch Floor") button
- Select the floor we just created
- Press the ![](/src/assets/images/Arch_Building.svg) [Building](/Arch_Building "Arch Building") button
...
We can use the ![](/src/assets/images/Workbench_TechDraw.svg) [TechDraw Workbench](/TechDraw_Workbench "TechDraw Workbench") to create a drawing of our building. The process is similar to what was shown in the previous section, so we won't go into too much detail here. Simply create a new view by using the ![](/src/assets/images/TechDraw_PageDefault.svg) [insert Default Page](/TechDraw_PageDefault "TechDraw PageDefault") option, then select the view you want to display in the drawing and add dimensions where necessary. This will allow us to create a professional 2D representation of the 3D model for documentation or presentation purposes.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:BIM_modeling/en&oldid=1522232>"
