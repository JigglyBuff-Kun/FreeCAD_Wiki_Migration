...
[底图三圆周点绘弧](/Draft_Arc_3Points "Draft Arc 3Points")工具通过输入4个点：中点、半径、第一个点、最后一点，或拾取的切线，或上述若干组合，在当前的[工作平面](/Draft_SelectPlane "Draft SelectPlane")上创建一条圆弧。它将根据[Draft Tray](/Draft_Tray "Draft Tray")中的[Draft Linestyle](/Draft_Linestyle "Draft Linestyle")设置来创建对应圆弧。
...
1. 按下![](/images/Draft_Arc_3Points.svg) [Draft Arc 3Points](/Draft_Arc_3Points "Draft Arc 3Points")按钮，或先按A键再按T键。
...
弧对象享有[Draft Circle](/Draft_Circle "Draft Circle")中的所有属性，但是有些属性仅对圆形而言才有意义。
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Arc_3Points/zh-cn&oldid=1513301>"