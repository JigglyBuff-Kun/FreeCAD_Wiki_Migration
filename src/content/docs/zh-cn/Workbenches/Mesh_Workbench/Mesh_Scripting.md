...
所以，如果您有充足的冒险精神，就可以去看一看[单元测试模块](https://github.com/FreeCAD/FreeCAD/blob/master/src/Mod/Mesh/App/MeshTestsApp.py)。
...
参见[Mesh API](/Mesh_API "Mesh API")

[Top](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Mesh_Scripting/zh-cn&oldid=1021043>"