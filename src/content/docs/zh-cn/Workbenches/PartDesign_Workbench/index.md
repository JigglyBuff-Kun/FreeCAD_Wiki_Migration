...
零件设计工作台提供了一些高级工具，基于[属性编辑方法](#Feature_Editing_Methodology)，来建模复杂实体零件。它主要用于创建机械零件，但是也不局限于机械件。它与[草图工作台](/Sketcher_Workbench "Sketcher Workbench")复杂而紧密地联系在一起。
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Workbench/zh-cn&oldid=1529335>"
