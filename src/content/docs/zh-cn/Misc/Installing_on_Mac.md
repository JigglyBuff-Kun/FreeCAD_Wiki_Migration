...
一旦成功安装，你就能 [入门](/Getting_started "Getting started")!
...
你可以从 [下载](/Download/zh-cn "Download/zh-cn") 页面下载最新的安装器。下载完成之后，只需要加载该磁盘映像，然后拖动它到应用程序目录或者你喜欢的任意目录下。
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Installing_on_Mac/zh-cn&oldid=1297701>"