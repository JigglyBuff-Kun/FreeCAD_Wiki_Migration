---
title: FreeCAD 0.18版发布说明
---
FreeCAD 0.18发布于2019年3月12日，您可从此[下载](/Download "Download")页获得它。本文为此版本中最有趣的一些变化的总结。而完整的变更列表可从[MantisBT bug追踪程序记录的FC 0.18版变更日志](https://www.freecadweb.org/tracker/changelog_page.php?version_id=78)处找到。

旧版FreeCAD的发布说明可从[特性列表](/Feature_list#Release_notes "Feature list")处找到。

## 亮点

经过扩展的[TechDraw工作台](#TechDraw_Workbench)工具

![](/images/TechDraw_sheet_screenshot.png)

图中模型由Laurent14制作

新的[草图工作台](#Sketcher_Workbench)工具，以及更稳定、更健壮的[PartDesign工作台](#PartDesign_Workbench)

![](/images/Part_engine_screenshot.jpg)

图中模型由un1corn制作

经过增强与扩展的[建筑与BIM工作台](#Arch_Workbench)工具
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Release_notes_0.18/zh-cn&oldid=1479221>"