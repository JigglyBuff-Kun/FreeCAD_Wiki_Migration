...
**[Lesser General Public Licence, version 2 or superior (LGPL2+)](http://en.wikipedia.org/wiki/LGPL "wikipedia:LGPL")**用于所有FreeCAD的源代码。所谓源代码，即包含于[官方Git仓库](https://github.com/FreeCAD/FreeCAD)里的那些。
...
Retrieved from "<http://wiki.freecad.org/index.php?title=License/zh-cn&oldid=1392645>"