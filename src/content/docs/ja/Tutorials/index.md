...
* [![Blenderを使ったレンダリングのチュートリアル（v0.18） FreeCADのボディーをWavefront .obj形式にエクスポートし、それをBlenderに読み込んでから、簡単な太陽光を設定し、組み込みのBSDFシェーダーを使って基本的な材質の設定をし、EEVEEまたはCyclesエンジンでレンダリングするチュートリアルです。](/images/07_T03_FreeCAD_Blender_EEVEE_render.png)](/Tutorial_Render_with_Blender "Blenderを使ったレンダリングのチュートリアル（v0.18） FreeCADのボディーをWavefront .obj形式にエクスポートし、それをBlenderに読み込んでから、簡単な太陽光を設定し、組み込みのBSDFシェーダーを使って基本的な材質の設定をし、EEVEEまたはCyclesエンジンでレンダリングするチュートリアルです。 ")

  [Blenderを使ったレンダリングのチュートリアル](/Tutorial_Render_with_Blender/ja "Tutorial Render with Blender/ja")（v0.18）  
  FreeCADのボディーをWavefront .obj形式にエクスポートし、それをBlenderに読み込んでから、簡単な太陽光を設定し、組み込みのBSDFシェーダーを使って基本的な材質の設定をし、EEVEEまたはCyclesエンジンでレンダリングするチュートリアルです。
...
| [Blenderを使ったレンダリングのチュートリアル](/Tutorial_Render_with_Blender/ja "Tutorial Render with Blender/ja") | レンダリング | 中級 | 01:00 | [Vocx](/index.php?title=User:Vocx&action=edit&redlink=1 "User:Vocx (page does not exist)") | 第0.18版以降 | なし |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Tutorials/ja&oldid=1541552>"