...
以下はプロジェクトでサポートしている寄付先のリストです。ご留意いただきたいのは、FreeCAD を使ったり、それについて学んだり、配布したり、開発をするのに金銭の支払いは必要ない、ということです。しかしながら、ご寄付をいただけると FreeCAD プロジェクトとその開発者が開発に専念でき、プロジェクトの進展をより促進することができます。
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Donate/ja&oldid=1531495>"
