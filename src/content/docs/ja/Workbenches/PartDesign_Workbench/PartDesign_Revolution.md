...
* データ**Type** (`Enumeration`)
* データ**Base** (`Vector`): (read-only)
* データ**Axis** (`Vector`): (read-only)
* データ**Angle** (`Angle`)
* データ**Up To Face** (`LinkSub`)
* データ**Angle2** (`Angle`)
* データ**Reference Axis** (`LinkSub`)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Revolution/ja&oldid=1547263>"