---
title: PartDesign WizardShaft/パートシャフト設計ウィザード
---
|  |
| --- |
| PartDesign\_WizardShaft |
| メニューの場所 |
| *なし* |
| ワークベンチ |
| [パートデザイン](/PartDesign_Workbench/ja "PartDesign Workbench/ja"), Complete |
| デフォルトのショートカット |
| *なし* |
| 導入バージョン |
| - |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_WizardShaft/ja&oldid=1461406>"