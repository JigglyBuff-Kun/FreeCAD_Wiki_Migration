...
* Starting from FreeCAD version 0.18, the Building object is actually a [BuildingPart](/Arch_BuildingPart "Arch BuildingPart") with its データ**IFC Type** property set to "Building". You can convert any BuildingPart to a Building simply by changing its IFC Type.
...
* データ**Building Type**: The type of this building, to choose from a list
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Building/ja&oldid=1432798>"