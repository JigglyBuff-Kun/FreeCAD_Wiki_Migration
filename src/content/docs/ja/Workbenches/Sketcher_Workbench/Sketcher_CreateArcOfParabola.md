---
title: スケッチャー・放物線の円弧を作成
---
|  |
| --- |
| スケッチャー・放物線の円弧を作成 |
| メニューの場所 |
| スケッチ → スケッチャージオメトリ → 放物線の円弧を作成 |
| ワークベンチ |
...
| 0.17 |
| 参照 |
| [スケッチャー・双曲線の円弧を作成](/Sketcher_CreateArcOfHyperbola/ja "Sketcher CreateArcOfHyperbola/ja") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_CreateArcOfParabola/ja&oldid=1547189>"