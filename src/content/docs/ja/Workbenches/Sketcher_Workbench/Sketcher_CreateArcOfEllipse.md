...
| 0.15 |
| 参照 |
| [スケッチャー・中心点を指定して楕円を作成](/Sketcher_CreateEllipseByCenter/ja "Sketcher CreateEllipseByCenter/ja") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_CreateArcOfEllipse/ja&oldid=1547193>"