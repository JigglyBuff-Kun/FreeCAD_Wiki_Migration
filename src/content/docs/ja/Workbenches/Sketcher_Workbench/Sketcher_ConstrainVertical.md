...
| Menu location |
| Sketch → Sketcher constraints → Constrain vertical |
| Workbenches |
...
| - |
| See also |
| [Sketcher ConstrainHorVer](/Sketcher_ConstrainHorVer "Sketcher ConstrainHorVer"), [Sketcher ConstraintHorizontal](/Sketcher_ConstrainHorizontal "Sketcher ConstrainHorizontal") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainVertical/ja&oldid=1532676>"