...
使用されるFreeCADのバージョン、および必要なライブラリ（Python、Qt、Coin、およびOCC）に関する情報を提供します。
...
**Copy to clipboard**をクリックし、あなたの投稿に情報を貼り付けます。その結果、次のような結果になります：
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_About/ja&oldid=1454789>"