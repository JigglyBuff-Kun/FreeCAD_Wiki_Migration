---
title: Std ViewScreenShot/スクリーンショットを見る
---
|  |
| --- |
| Std\_ViewScreenShot |
...
このコマンドは現在の3Dビューの内容をファイルに保存するためのダイアログを開きます。
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_ViewScreenShot/ja&oldid=1463895>"