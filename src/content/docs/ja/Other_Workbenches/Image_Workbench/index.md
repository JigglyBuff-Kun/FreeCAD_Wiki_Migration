...
画像モジュールは様々なタイプのビットマップ画像[bitmap images](http://en.wikipedia.org/wiki/Raster_graphics) を扱うためのもので、FreeCAD でそれらの画像を開くことを可能にします
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Image_Workbench/ja&oldid=1295079>"
