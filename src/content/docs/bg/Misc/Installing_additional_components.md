...
|  |  |  |
| --- | --- | --- |
| ['Windows'](/Install_on_Windows/bg "Install on Windows/bg") | ['Linux'](/Install_on_Unix/bg "Install on Unix/bg") | ['Mac'](/Install_on_Mac/bg "Install on Mac/bg") |
| [Инсталация на Windows](/Install_on_Windows/bg "Install on Windows/bg") | [Инсталация на Linux/Unix](/Install_on_Unix/bg "Install on Unix/bg") | [Инсталация на Mac](/Install_on_Mac/bg "Install on Mac/bg") |
...
Освен включените по подразбиране в FreeCAD [работни плотове и модули](/Workbenches/bg "Workbenches/bg"), общността от потребители публикува постоянно растяща колекция от модули в интернет. Има няколко проекта да се обединят и организират тези модули, описани по-долу.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Installing_additional_components/bg&oldid=1476432>"