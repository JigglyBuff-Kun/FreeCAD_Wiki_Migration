...
Обектите в документа имат различни типове. Всеки работен плот може да създава обекти от своите собствени типове. Нашример [Mesh Workbench](/Mesh_Workbench "Mesh Workbench") създава mesh обекти (3D повърхности изградени от триъгълници) , [Part Workbench](/Part_Workbench "Part Workbench") създава Part обкети (елементи изградени от по-прости форми), [Draft Workbench](/Draft_Workbench "Draft Workbench") също съзадава Part обекти, и т.н.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Document_structure/bg&oldid=1536771>"