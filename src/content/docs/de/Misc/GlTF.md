...
Since FreeCAD version 0.19.23074 the [Std Export](/Std_Export "Std Export") command can export to the gITF format.
...
2. Use the `cqparts` Python library ([website](https://github.com/cqparts/cqparts)):
...
Retrieved from "<http://wiki.freecad.org/index.php?title=GlTF/de&oldid=1301310>"