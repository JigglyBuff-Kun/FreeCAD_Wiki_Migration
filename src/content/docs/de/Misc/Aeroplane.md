...
Wir werden im ![](/images/Workbench_Part.svg) [Part Arbeitsbereich](/Part_Workbench/de "Part Workbench/de") arbeiten - wähle ihn aus den Menüs über **Ansicht → Arbeitsbereich → Part** oder über den [Arbeitsbereichwähler](/Std_Workbench/de "Std Workbench/de").

* Erstelle ein neues leeres Dokument.
* Wechsle zur ![](/images/Std_ViewIsometric.svg) [isometrischen Ansicht](/Std_ViewIsometric/de "Std ViewIsometric/de").
* Schalte das Achsenkreuz ein ON (über Ansichtsmenü).
* Stelle sicher, dass du die [Combo Ansicht](/Combo_view/de "Combo view/de") hast, die (über **Ansicht → Ansichten**) anzeigt.

* Erstelle einen Zylinder, durch Klicken auf die ![](/images/Part_Cylinder.svg) [Zylinder](/Part_Cylinder/de "Part Cylinder/de") Schaltfläche.
...
Klicke auf [Platzierung](/Placement/de "Placement/de") (beachte das kleine [+]) und eine Schaltfläche mit drei Punkten erscheint .... Klicke darauf. (Du kannst auch wählen: **Menü → Bearbeiten → Platzierung**) Die Aufgabenanzeige erscheint.
...
Wir werden nun einen Quader hinzufügen und verändern, also klicke auf die Schaltfläche ![](/images/Part_Box.png)[Quader](/Part_Box/de "Part Box/de"). Wähle ihn durch anklicken des Quaders in der Projektansicht aus.
Ändere die Höhe auf 1 mm, die Länge auf 5 mm und die Breite auf 20 mm.

Klicke auf [Platzierung → ...](/Placement/de "Placement/de"), um die Aufgabenansicht zu bekommen. Gib in das Übersetzungsfeld Y: -10 und Z: -1 ein. Klicke auf OK

Wir werden diese beiden Formen nun mit einer Booleschen Operation zusammenführen. Klicke auf die ![](/images/Part_Boolean.svg) [Boolesche Operation](/Part_Boolean "Part Boolean") Schaltfläche und der Aufgabenbetrachter zeigt den Auswahlschalter für Boolesche Operationen an.
...
Wir müssen jetzt unsere Fusion (Verschmelzung) zu Box001 zusammenfügen, also werden wir es auf dem schnellen Weg machen. Klicke im Projektbetrachter auf Fusion und Strg+klicke auf Box001. Dadurch werden beide Teile zusammen ausgewählt. Klicke nun auf das ![](/images/Part_Fuse.svg) [Verschmelzen](/Part_Fuse/de "Part Fuse/de") Schaltfläche, um **Fusion001** zu erhalten.
...
Klicke auf Kasten und erhalte deren [Positionierung in Aufgaben](/Placement/de "Placement/de"). Beachte, dass es bereits Y: -10 und Z: -1 in der Übersetzung hat. Ändere die X Übersetzung in 3 und klicke auf Anwenden. So ist es besser. Klicke auf OK.

## Drehungen

Klicke auf Flugzeug und rufe dessen [Positionierung in Aufgaben](/Placement/de "Placement/de") auf. Ändere im Abschnitt Rotation den Eintrag 'Rotationsachse mit Winkel' in 'Euler Winkel', da diese wesentlich einfacher zu handhaben sind.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Aeroplane/de&oldid=1251505>"