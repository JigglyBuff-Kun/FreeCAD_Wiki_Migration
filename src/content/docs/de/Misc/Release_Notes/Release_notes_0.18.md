...
Ältere FreeCAD Versionshinweise findest du unter [Liste der Funktionen](/Feature_list#Release_notes/de "Feature list").

## Höhepunkte

Erweiterte [TechDraw](#TechDraw_Workbench/de) Werkzeuge

![](/images/TechDraw_sheet_screenshot.png)

Modell von Laurent14

Neue [Skizzierer](#Sketcher_Workbench/de) Werkzeuge, stabileres und robustes [PartDesign](#PartDesign_Workbench/de)

![](/images/Part_engine_screenshot.jpg)

Modell von un1corn

Verbesserte und erweiterte [Arch und BIM](#Arch_Workbench/de) Werkzeuge.
...
* Es ist jetzt möglich, ein benutzerdefiniertes Hintergrundbild für das Hauptfenster von FreeCAD mit der Option [**Einstelllungen → Allgemein → Aktivere gekachelter Hintergrund**](/Preferences_Editor#General/de "Preferences Editor")  festzulegen.

* ![Das neu gestaltete Startzentrum](/images/Start_center_0.18_screenshot.jpg)

  Das neu gestaltete Startzentrum
* ![Der Navigationswürfel](/images/FC018_Navigation_Cube.png)

  Der Navigationswürfel
* ![FreeCAD mit einem benutzerdefinierten Hintergrundbild](/images/FreeCAD_with_background_image.jpg)

  FreeCAD mit einem benutzerdefinierten Hintergrundbild
...
Die Materialhandhabung wurde verbessert. Es ist nun möglich, den globalen FreeCAD Materialeditor zu verwenden. Siehe auch [Materialkarten](/Release_notes_0.18#Material_Handling/de "Release notes 0.18"). Dazu wurde die FEM Materialaufgabenkonsole aufpoliert.

## Arbeitsbereich Part

* Das [Geometrie prüfen](/Part_CheckGeometry/de "Part CheckGeometry/de") Werkzeug öffnet jetzt ein kleines Fenster mit einem Fortschrittsbalken und einer Cancel Schaltfläche, um die Aufgabe zu beenden, wenn sie zu lange dauert.
* Das neue [Defeaturing](/Defeaturing_Workbench/de "Defeaturing Workbench/de") Werkzeug basiert auf dem gleichnamigen Werkzeug, das in OCCT 7.3.0 enthalten ist. Es kann ausgewählte Attribute an einem Volumenkörper wie Löcher, Vorsprünge, Lücken, Fasen, Verrundungen usw. entfernen. Weitere Informationen findest du im [3D Model Defeaturing](https://dev.opencascade.org/index.php?q=node/1211) Artikel auf der OCCT Netzseite. Bitte beachte, dass, wenn FreeCAD auf einer älteren Version als OCCT 7.3.0 aufbaut, dieses Werkzeug nicht zur Verfügung steht und ausgegraut wird.

* Das neue [AuseinanderKappen](/Part_SliceApart/de "Part SliceApart/de") Werkzeug basiert auf dem Werkzeug [Kappen aus Verbund](/Part_Slice/de "Part Slice/de") und enthält ein automatisches Sprengen des Verbunds zum einfachen Aufteilen von Objekten.

## Arbeitsbereich PartDesign

* Das neue [Lokales koordinatensystem](/PartDesign_CoordinateSystem/de "PartDesign CoordinateSystem/de") Werkzeug ermöglicht jetzt das Hinzufügen einer lokalen Koordinatensystem Visualisierung zu mehreren Bezugsobjekten.
...
* Neues **[Durchmesser beschränken](/Sketcher_ConstrainDiameter/de "Sketcher ConstrainDiameter/de")** Werkzeug hinzugefügt
...
* Neuer **[Verschieben](/Sketcher_Move/de "Sketcher Move/de")** Befehl, um die gesamte ausgewählte Geometrie vom zuletzt ausgewählten Punkt aus zu verschieben. Auf diesen Befehl kann über die Ausklappliste des Klonwerkzeugs zugegriffen werden.
...
* [Arbeitsbereich Defeaturing](/Defeaturing_Workbench/de "Defeaturing Workbench/de") ist bestimmt für die Bearbeitung importierter STEP Modelle, das Entfernen der ausgewählten Funktionen aus dem Modell

Retrieved from "<http://wiki.freecad.org/index.php?title=Release_notes_0.18/de&oldid=1225926>"