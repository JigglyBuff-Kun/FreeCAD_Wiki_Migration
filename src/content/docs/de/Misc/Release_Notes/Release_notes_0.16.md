...
* Neue Werkzeuge um Objekte mit einer Wandstärke (z.B. Rohre) zu verbinden: [Connect](/Part_JoinConnect "Part JoinConnect"), [Embed](/Part_JoinEmbed "Part JoinEmbed") und [Cutout](/Part_JoinCutout "Part JoinCutout")
* Neues Werkzeug: Erstelle Fläche von Skizze (parametrisch)

## Arbeitsbereiche "Part Design" und "Sketcher"

* Neues Werkzeug: Umschalt-Modus für [Reference/Driving constraints](/Sketcher_ToggleDrivingConstraint/de "Sketcher ToggleDrivingConstraint/de")
...
* Unterstützung für [expressions/formulas](/Expressions "Expressions") in Beschränkungen und Eigenschaften
...
* Ein neues **[Mirror tool](/Draft_Mirror "Draft Mirror")** erlaubt ein Spiegeln von Objekten "auf Draft Art".
...
* [Rectangles](/Draft_Rectangle "Draft Rectangle"),[wires and lines](/Draft_Wire "Draft Wire") können nun **unterteilt** werden und erlauben so eine Menge neuer Körper-Kombinationen.

![](/images/Draft_subdivisions.jpg)

## Arbeitsbereich "Drawing"

* Ein neues Werkzeug namens **[spreadsheet view](/index.php?title=Drawing_SpreadsheetView/de&action=edit&redlink=1 "Drawing SpreadsheetView/de (page does not exist)")** erlaubt es nun, einen Bereich von Zellen eines [Tabellenblatts](/Spreadsheet_Workbench/de "Spreadsheet Workbench/de") auf ein Zeichnungsblatt zu platzieren.

![](/images/Drawing_spreadsheetview.jpg)

## Arbeitsbereich "Arch"

* **[Materials support](/Arch_SetMaterial "Arch SetMaterial")**: Arch Objekte können nun mit [material](/Material "Material") versehen werden, welches das FreeCAD-interne Materialschema benutzt. Diese Materialien werden auch in anderen Arbeitsbereichen benutzt. Diese Materialien unterstützen komplett den IFC Im- und Export.
* Das Werkzeug **[Section plane](/Arch_SectionPlane "Arch SectionPlane")** kann nun Schnitte in 3D durchführen und den Bereich in Echtzeit anzeigen.
...
* Ein neues Werkzeug [Arch Schedule/de](/Arch_Schedule/de "Arch Schedule/de") erlaubt es verschiedene Arten von Stücklisten von einem BIM-Modell zu erstellen.
...
* **GMSH Macro** Eine interessante externe Entwicklung ist das [Macro\_GMSH](/Macro_GMSH "Macro GMSH"), welches es ermöglicht, GMSH zur Vernetzung zu benutzen. Sehr nützlich für alle, denen es nicht möglich ist, FreeCAD mit Netgen zu kompilieren, um Schalen oder Kanten vernetzen zu können.
...
Ein neuer [Path Workbench/Path-Arbeitsbereich](/index.php?title=Path_Workbench/Path-Arbeitsbereich&action=edit&redlink=1 "Path Workbench/Path-Arbeitsbereich (page does not exist)") wurde in FreeCAD hinzugefügt. Dieser Arbeitsbereich, obwohl immer noch stark in der Entwicklung, hat bereits einige CAM-Operationen implementiert und erlaubt es, komplette G-Code ([[1]](https://de.wikipedia.org/wiki/Computerized_Numerical_Control#DIN/ISO-Programmierung_bzw._G-Code)) Programme für eine große Anzahl CNC-Maschinen zu exportieren.

In seinem momentanen Zustand erlaubt es der Arbeitsbereich, Profile und Taschen mit Objekten aus dem [Part](/Part_Workbench/de "Part Workbench/de")-Arbeitsbereich zu erstellen, komplexe Pfade zu erstellen durch Aneinanderfügen mehrerer Teilpfade, den Inhalt der G-Code Programme der Pfade zu betrachten und editieren, eine Werkzeugliste zu verwalten und beim Im- und Export von G-Code zwischen verschiedenen pre-processing- und post-processing-Skripten zu wählen.
Es stellt bereits eine komplette [python API](/Path_scripting/de "Path scripting/de") zur Verfügung.

## Zusätzliche Module

Eine Reihe neuer [addons workbenches](https://github.com/FreeCAD/FreeCAD-addons) wurde von Community-Mitgliedern zur Verfügung gestellt. Diese Arbeitsbereiche sind sehr leicht in eine bestehende FreeCAD-Installation einzubinden.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Release_notes_0.16/de&oldid=1158147>"