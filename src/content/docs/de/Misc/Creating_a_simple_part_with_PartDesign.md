---
title: Erstellen eines einfachen Bauteils mit PartDesign
---
|  |
| --- |
| Tutorium |
...
|  |
| Siehe auch |
| [Erstellen eines einfachen Teils mit der Part WB](/Creating_a_simple_part_with_Part_WB/de "Creating a simple part with Part WB/de"), [Erstellen eines einfachen Teils mit der Draft and Part WB](/Creating_a_simple_part_with_Draft_and_Part_WB/de "Creating a simple part with Draft and Part WB/de") |
|  |

![](/images/GGTuto1_Vue.PNG)

Dieses Tutorial soll FreeCAD-Anfängern anhand eines Beispiels einige grundlegende Funktionen vermitteln.
Nachdem die Grundlagen im [Anwenderzentrum](/User_hub/de "User hub/de") behandelt wurden, ist man in der Lage, Schritt für Schritt ein erstes Teil zu modellieren.

**Wir werden in diesem Tutorial vor allem folgendes behandeln:**

* Verwenden des [Part Design Arbeitsbereich](/PartDesign_Workbench/de "PartDesign Workbench/de"), nachzeichnen der Skizze.
...
### Verwenden des [Part Design Arbeitsbereich](/PartDesign_Workbench/de "PartDesign Workbench/de") nachverfolgen der Skizze

Erstelle ein neues Dokument und wechsle in den ![](/images/Workbench_PartDesign.svg) **Part Design Arbeitsbereich** entweder mit dem [Arbeitsbereich Wahlschalter](/Getting_started#Exploring_the_interface/de "Getting started") (im verknüpften Bild mit 10 beschriftet) oder über das Menü *Ansicht → Arbeitsbereich*. FreeCAD startet mit den Werkzeugleisten oben, die Comboansicht links und der 3D Ansicht rechts.

**Erstelle Körper:**

Drücke ![](/images/PartDesign_Body.svg) [/de|Körper erstellen](/PartDesign_Body "PartDesign Body"). **Hinweis:** verwechsle nicht den Körper, dessen Symbol blau ist, mit dem Part Behälter, dessen Icon gelb ist. *Im Modell Reiter unter der Combo Ansicht Sidebar erscheint ein neues Objekt mit der Bezeichnung "Körper" unter der Dokumentbezeichnung, das derzeit "Unnamed" ist, da wir unser Dokument noch nicht gespeichert haben. Der Körper ist ein Behälter, in dem die PartDesign Formelemente nacheinander angeordnet werden, um einen einzelnes Festkörper zu bilden. Er enthält seine eigenen Referenzachsen und -ebenen. Er wird im Modellbaum hellblau hervorgehoben, was bedeutet, dass er aktiv ist, d.h. wir können die darin enthaltenen Elemente bearbeiten und neue Elemente hinzufügen.* 
Wenn er nicht hervorgehoben ist, doppelklicke darauf oder klicke mit der rechten Maustaste und wähle *Aktiven Körper umschalten* im Kontextmenü. Vor dem Körper Schild befindet sich ein blaues Symbol, das mit dem obigen identisch ist, sowie ein Pfeil oder ein Pluszeichen, je nach Betriebssystem. Ein Klick auf den Pfeil oder das Pluszeichen vor dem Körper erweitert den Inhalt. Er enthält an dieser Stelle nur ein Element mit der Bezeichnung *Origin*. Vor diesem *Ursprung* befindet sich ebenfalls ein Pfeil oder ein Pluszeichen. Klicke darauf, um den Inhalt zu erweitern. Es zeigt die oben genannten Bezugsachsen und -ebenen, wie im Bild unten dargestellt:

![](/images/PartDesign_Body_tree_Unnamed.png)

*Der neu geschaffene aktive Körper mit seinem Inhalt erweitert.*
...
Die schräge Linie sollte sich zu diesem Zeitpunkt frei drehen können: wir geben ihr eine Winkelbeschränkung, um sie zu fixieren.
Drücke "ALT-UMSCHALT-S", um zu speichern, oder "ALT-UMSCHALT-D", um zur nächsten Meldung zu springen, oder "ALT-UMSCHALT-B", um eine Zusammenfassung zu erhalten, oder "ALT" für andere Verknüpfungen.
Dokumentation hinzufügen

Klicke auf die schräge Linie, dann auf die untere Linie; sobald diese Linien ausgewählt sind, werden sie dunkelgrün; dann klicke auf die ![](/images/Constraint_InternalAngle.svg) [Beschränke Innenwinkel](/Sketcher_ConstrainAngle "Sketcher ConstrainAngle") Symbol.
...
Wir werden nun die untere Linie mit einer Bemaßung beschränken: Wähle diese aus und klicke auf ![](/images/Constraint_HorizontalDistance.svg) [Beschränke Horizontalen Abstand](/Sketcher_ConstrainDistanceX/de "Sketcher ConstrainDistanceX/de").
...
Lass uns die Gesamthöhe auf das Profil einstellen, indem wir den höchsten Punkt links und dann den Ursprungspunkt auswählen. Klicke auf ![](/images/Constraint_VerticalDistance.svg) [Beschränke vertikalen Abstand](/Sketcher_ConstrainDistanceY "Sketcher ConstrainDistanceY"), gib einen Wert von 50 mm ein.
...
Klicke auf ![](/images/Sketcher_Arc.svg) [Bogen](/Sketcher_CreateArc/de "Sketcher CreateArc/de"), positioniere den Mittelpunkt auf ungefähr x = 80 y = 30; klicke dann, um den ersten Startpunkt des Bogens auf dem rechten Endpunkt der oberen horizontalen Linie zu definieren; klicke dann, um das Ende des Bogens auf den oberen Endpunkt der rechten vertikalen Linie zu definieren (stelle sicher, dass die Punkte gelb markiert sind, bevor Du klickst).

Gib dem Radius eine Radiusbeschränkung: Wähle den Bogen aus und klicke dann auf ![](/images/Constraint_Radius.svg) [Beschränke Radius](/Sketcher_ConstrainRadius "Sketcher ConstrainRadius") gib dann einen Wert von 20 mm ein.

Jetzt machen wir den Bogen tangential zu den Linien, mit denen er verbunden ist: Wähle den Bogen, dann die oberste Zeile, dann klicke auf ![](/images/Constraint_Tangent.svg) [Beschränke Tangente](/Sketcher_ConstrainTangent/de "Sketcher ConstrainTangent/de"). Eine *Beschränkungsersetzung* Meldung erscheint, klicke auf OK. Machen dasselbe für die Tangentialbeschränkung auf der anderen Seite des Bogens.
...
Wenn deine Skizze noch nicht grün ist, sind ein oder mehrere Punkte nicht deckungsgleich (2 Punkte können übereinander gelegt werden, aber nicht deckungsgleich sein). Erstelle ein kleines Fenster (Fang Fenster) um einen zu selektierenden Punkt und erstelle eine ![](/images/Constraint_PointOnPoint.svg) [Deckungsgleich Bedingung](/Sketcher_ConstrainCoincident/de "Sketcher ConstrainCoincident/de"). Hinweis: Verwechsledie Deckungsgleich Bedingung nicht mit dem Skizzenpunkt; während ihre Symbole sehr ähnlich sind, hat letzterer ein größeres Symbol; es fügt einen einzelnen Punkt in der Skizze hinzu.

Gehe bei allen Punkten auf die gleiche Weise vor.

Wenn deine Skizze immer noch nicht grün ist, überprüfe, ob alle Linien (außer der schrägen) entweder ein ![](/images/Constraint_Horizontal.svg) [Horizontal](/Sketcher_ConstrainHorizontal "Sketcher ConstrainHorizontal") oder ![](/images/Constraint_Vertical.svg) [Vertikal](/Sketcher_ConstrainVertical "Sketcher ConstrainVertical") und füge, wenn nötig, eine Beschränkung hinzu.
...
Klicke auf ![](/images/Std_ViewIsometric.svg) **Isometrische Ansicht** dann ![](/images/Std_ViewFitAll.svg) [Alles einpassen](/Std_ViewFitAll/de "Std ViewFitAll/de"), was eine zentrierte isometrische 3D-Ansicht liefert.

Klicke auf ![](/images/PartDesign_Pad.svg) [Polster](/PartDesign_Pad/de "PartDesign Pad/de"), gib eine Länge von 30 mm ein. Klicke auf OK, die Form ist fertig gestellt. In der Modellstruktur wird anstelle der Skizze ein **Pad** Objekt (das wir Formelement nennen) eingeblendet. Tatsächlich hat es die Skizze übernommen, da es auf ihr basiert; wenn Du auf den Pfeil oder das Pluszeichen vor *Pad* klickst, um sie zu erweitern, wird die darunter liegende Skizze angezeigt, die automatisch ausgeblendet wurde (ihre Beschriftung ist grau).
...
Klicke auf die obere (quadratische) Seite des Teils und klicke auf das ![](/images/Sketcher_NewSketch.svg) Symbol, um eine neue Skizze zu erstellen. FreeCAD erzeugt eine neue Skizze, die an diese Fläche angefügt wird. Wir befinden uns also auf einer Ebene, die parallel zur absoluten Ebene XY, aber in der Höhe versetzt ist zur Höhe des Teils, d.h. 50 mm.

Du kannst das 3D Fenster in eine isometrische Ansicht umschalten ![](/images/Std_ViewIsometric.svg) oder in der Draufsicht bleiben ![](/images/Std_ViewTop.svg). Jederzeit kannst Du zur Skizzenansicht zurückkehren (die Ansicht ist gegenüberliegend zur Skizzierebene ausgerichtet), unter Verwendung des ![](/images/Sketcher_ViewSketch.svg) [Sketcher ViewSketch/de](/Sketcher_ViewSketch/de "Sketcher ViewSketch/de") Symbols.
...
Mit dem ![](/images/Sketcher_Circle.svg)  [Kreis](/Sketcher_CreateCircle/de "Sketcher CreateCircle/de") Werkzeug ungefähr in die Mitte der Fläche klicken und einen Kreis mit beliebigem Radius erstellen.

Wähle den Kreis aus und erstelle eine ![](/images/Constraint_Radius.svg) [Radius Beschränkung](/Sketcher_ConstrainRadius/de "Sketcher ConstrainRadius/de"), gib einen Wert von 5 mm ein.

Wähle den Mittelpunkt des Kreises aus und erstelle eine ![](/images/Sketcher_ConstrainLock.svg) [Sperr Beschränkung](/Sketcher_ConstrainLock/de "Sketcher ConstrainLock/de"); doppelklicke auf die horizontale Bemaßung und gib -65 mm ein (hier geben wir eine Position relativ zum Ursprung der Skizze an). Mache dasselbe für die vertikale Bemaßung (15 mm). Der Kreis nimmt seine korrekte Position ein und die Skizze wird grün und zeigt damit an, dass sie vollständig beschränkt ist:

![](/images/GGTuto1_6.PNG)

Schließe die Skizze; im Modellbaum ist unter Pad ein neues **Sketch001** Objekt erschienen. Klicke, während Sketch001 noch ausgewählt ist, auf ![](/images/PartDesign_Pocket.svg) [Tasche](/PartDesign_Pocket "PartDesign Pocket").
...
Im Modellbaum, wenn nötig ggf. *Körper Teil1* und dann *Polster* aufklappen, um die erste Skizze anzuzeigen. Doppelklicke darauf (oder klicke mit der rechten Maustaste und wähle *Skizze bearbeiten* im Kontextmenü) und klicke dann auf ![](/images/Sketcher_ToggleConstraint.svg) [Umschalten Beschränkung](/Sketcher_ToggleDrivingConstraint/de "Sketcher ToggleDrivingConstraint/de"). (**Hinweis:** abhängig von der Bildschirmauflösung Deines Computers ist dieses Symbol möglicherweise nicht sichtbar. Am rechten Ende der Werkzeugleiste Beschränkungen findest Du möglicherweise eine » Taste. Klicke darauf, um die Symbole aufzuklappen und auf zugeklappte Symbole zuzugreifen). Von nun an können wir Referenzbemaßungen anstelle von Abmessungsbeschränkungen erstellen: sie werden blau sein und haben keinen Einfluss auf die Formen der Skizze, aus der sie stammen, sie werden automatisch berechnet.
...
Dann klicke auf ![](/images/Sketcher_External.svg) [Externe Geometrie](/Sketcher_External/de "Sketcher External/de").
...
Oftmals kann auf das Anlegen von Konstruktionslinien verzichtet werden. Du kannst die Skizze erneut bearbeiten, die Konstruktionslinien löschen und eine ![](/images/Constraint_Symmetric.svg) [Symmetrie Beschränkung](/Sketcher_ConstrainSymmetric/de "Sketcher ConstrainSymmetric/de") zwischen den beiden gegenüberliegenden Eckpunkten der äußeren Geometrielinien und dem Mittelpunkt des Kreises verwenden (wähle die Punkte in dieser Reihenfolge aus):
...
Beginne mit dem Löschen der "Taschen" Funktion sowie der Skizze der Bohrung. Wähle die obere Fläche und klicke ![](/images/PartDesign_Point.svg) [Bezugspunkt](/PartDesign_Point/de "PartDesign Point/de"): Erzeuge einen Bezugspunkt im aktiven Körper. Der gewählte Anfügemodus muss "Massenschwerpunkt" sein.
...
Wähle die obere Fläche erneut aus und während Du die STRG Taste gedrückt hälst, wähle den soeben erstellten Punkt im Modellbaum aus, lasse die STRG Taste los und klicke ![](/images/PartDesign_Plane.svg) [Bezugsebene](/PartDesign_Plane/de "PartDesign Plane/de"). Eine Referenzebene wird mit dem Ursprung des Punktes erzeugt. Klicke auf OK.

Es ist jetzt sehr einfach, den Kreis zu zentrieren! Wähle aus dem Modellbaum oder in der 3D Ansicht die von Dir erstellte Ebene aus und klicke auf ![](/images/Sketcher_NewSketch.svg) [Skizze erstellen](/Sketcher_NewSketch/de "Sketcher NewSketch/de"), wird eine Skizze mit dem Ursprung der Ebene als Ursprung erstellt. Dann zeichne einfach den Kreis mit einem Radius von 5 mm auf diesem Ursprung ab und prüfe dann (die Skizze muss unbedingt grün sein).
...
[Erstellen eines einfachen Bauteils mit PartDesign](/Basic_Part_Design_Tutorial/de "Basic Part Design Tutorial/de")

Retrieved from "<http://wiki.freecad.org/index.php?title=Creating_a_simple_part_with_PartDesign/de&oldid=1251748>"