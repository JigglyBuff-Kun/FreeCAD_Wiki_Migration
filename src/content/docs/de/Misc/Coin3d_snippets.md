...
Anwender können diese Skripte entweder als [Makro](/Macros/de "Macros/de") oder direkt in der [Python Konsole](/Python_console/de "Python console/de") ausführen. Bitte beachte, dass viele der Funktionen "Exe" oder "Execu", kurz für "Execute", in ihrem Namen haben.

Diese Dateien werden auch in der
[Inventor Mentor Tutorium](http://www-evasion.imag.fr/Membres/Francois.Faure/doc/inventorMentor/sgi_html/pr01.html) für die C Sprache erwähnt.
