---
title: AnwendungsAbbild
---

## Was ist ein AnwendungsAbbild?

[![](/images/AppImage-logo.png)](https://appimage.org) _Einmal verpackt und dann überall laufend. Erreiche Benutzer auf allen Haupt Linux Desktop Distributionen._
...
Für andere Installationsarten siehe [Herunterladen](/Download/de "Download/de").
...
Dank der Arbeit von _realthunder_, Autor von [Anwendungsverknüpfung](/App_Link/de "App Link/de") und [Assembly3 Arbeitsbereich](/Assembly3_Workbench/de "Assembly3 Workbench/de"), ist es möglich, benutzerdefinierte AnwendungsAbbilder mit Hilfe einer Reihe von Skripten zu erstellen.
...
- [Snap](/Ubuntu_Snap/de "Ubuntu Snap/de") Pakete.
- [Flatpak](/Flatpak/de "Flatpak/de") Pakete.

Retrieved from "<http://wiki.freecad.org/index.php?title=AppImage/de&oldid=1508943>"
