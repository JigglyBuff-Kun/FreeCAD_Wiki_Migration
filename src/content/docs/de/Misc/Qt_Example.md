...
| *None* |
| Siehe auch |
| [Dialogerstellung](/Dialog_creation/de "Dialog creation/de") |
|  |
|  |

Dieses Makro ist ein Beispiel für die Verwendung von Qt Befehlen, deren Verbindungen, Extraktion und Datenzuweisung.

* ![Qt Beispiel](/images/Qt_Example_00.png)

  Qt Beispiel
* ![Qt Beispiel Details](/images/Qt_Example_01.png)
...
3. **progressBar horizontal** : Fortschrittsbalken horizontal seine Verbindung und Datenextraktion / Zuweisung
4. **verticalSlider** : vertikaler Schieberegler seine Verbindung und Datenextraktion/Zuweisung
5. **progressBar vertical** : Fortschrittsbalken vertikal seine Verbindung und Datenextraktion / Zuweisung
6. **lineEdit** : Zeilenbearbeitung seiner Verbindung und Datenextraktion / Zuweisung
7. **lineEdit** : Zeilenbearbeitung seiner Verbindung und Datenextraktion / Zuweisung
...
**2:** Bearbeite die Datei und füge diese Zeile dort ein

**@"C:\Python27\python" "C:\Python27\Lib\site-packages\PyQt4\uic\pyuic.py" -x %1.ui > %1.py**

**3:** gib dann in einer Dos Konsole **convertuitopy myproject** ein (Gib keine Erweiterung ein, die der Befehl automatisch hinzufügt)
...
Der Inhalt der Datei **Qt\_Example.FCMacro** ist hierunter angegeben:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Qt_Example/de&oldid=1247044>"