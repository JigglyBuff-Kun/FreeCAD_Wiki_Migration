---
title: Individuelles Symbol in der Baumansicht
---
## Einleitung

Dies ist ein Beispiel, wie man das Symbol eines benutzerdefinierten [viewproviders](/Viewprovider/de "Viewprovider/de") verändert, der normalerweise einem [skriptgenerierten Objekt](/Scripted_objects/de "Scripted objects/de") hinzugefügt wird.
...
Das Beispielsymbol in das Verzeichnis herunterladen, das das Makro enthält ![Beispielsymbol für das Makro](/images/FreeCADIco.png)

Drei Anwendungsfälle für die Verwendung eines Symbols: icon\_in\_file\_disk (Symbol\_in\_Festplattenverzeichnis - PNG-Format), icon\_XPM\_in\_macro (Symbol\_im\_Makro - XPM-Format) und icon\_resource\_FreeCAD (Symbol\_aus\_FreeCAD-Verzeichnis)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Custom_icon_in_tree_view/de&oldid=1536811>"