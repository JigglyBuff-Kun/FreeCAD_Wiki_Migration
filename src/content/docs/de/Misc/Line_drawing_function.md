---
title: Linienzeichnungsfunktion
---
## Einführung
...
Wenn Du in Python Funktionen aus einem anderen Modul verwenden willst, musst Du es importieren. In unserem Fall benötigen wir Funktionen aus dem [Part-Arbeitsbereich](/Part_Workbench/de "Part Workbench/de"), um die Linie zu erstellen, und aus dem Gui Modul `FreeCADGui`, um auf die [3D-Ansicht](/3D_view/de "3D view/de") zuzugreifen. Außerdem benötigen wir die kompletten Inhalte der Coin-Bibliothek, damit wir alle Coin-Objekte wie `SoMouseButtonEvent`, usw. direkt verwenden können.
...
Klicke zwei Mal in der 3D Ansicht, und Bingo, hier ist unsere Linie! Um es zu wiederholen, tippe einfach nochmal `exercise.line()`.
...
Zögere nicht, deine Fragen oder Ideen im [Forum](http://forum.freecadweb.org/) zu teilen!

[Anfang](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Line_drawing_function/de&oldid=1393645>"