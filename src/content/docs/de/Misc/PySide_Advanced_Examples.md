---
title: PySide Fortgeschrittene Beispiele
---
## Einführung

Der Zweck dieser Seite ist es, Beispiele auf fortgeschrittenem Niveau für den [PySide](/PySide/de "PySide/de")-GUI-Verwalter zu behandeln (es gibt begleitende Seiten [PySide Beispiele für Anfänger](/PySide_Beginner_Examples/de "PySide Beginner Examples/de") und [PySide Weiterführende Beispiele](/PySide_Intermediate_Examples/de "PySide Intermediate Examples/de")).
...
Der Schlüssel zum erfolgreichen Laden einer UI-Datei ist die Verwendung des vollständigen Pfads zur Datei. Der [Addon Manager](/Std_AddonMgr/de "Std AddonMgr/de") macht es beispielsweise so:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PySide_Advanced_Examples/de&oldid=1523797>"