---
title: Kompilieren unter MacOS
---
:::caution
Es gibt einen experimentellen FreeCAD Docker Container, der für die FreeCAD Entwicklung getestet wird. Lies mehr darüber unterKompilieren unter Docker
:::

## Übersicht

Diese Seite beschreibt, wie der neueste FreeCAD-Quellcode unter macOS kompiliert wird.
Für andere Plattformen, siehe [Kompilieren](/Compiling/de "Compiling/de").
...
Der Pfad zu Qt muss angegeben werden: Qt5 wird derzeit unterstützt, während die Unterstützung von Qt6 noch in Arbeit ist. FREECAD\_QT\_VERSION auf "Auto" oder "5" setzen, um Qt5 (die Voreinstellung) auszuwählen. Auf der Komandozeile gibt man etwas ein, wie:
...
Siehe auch [Kompilierung - Beschleunigen](/Compiling_(Speeding_up)/de "Compiling (Speeding up)/de").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Compile_on_MacOS/de&oldid=1503582>"