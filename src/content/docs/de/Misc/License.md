...
**[Lesser General Public License, Version 2 oder höher (LGPL2+)](http://en.wikipedia.org/wiki/LGPL "wikipedia:LGPL")** Für den gesamten FreeCAD-Quellcode im [offiziellen Git-Repository](https://github.com/FreeCAD). Das + heißt, dass man FreeCAD auch wahlweise unter den Bedingungen einer neueren Version der Lizenz, wie z.B. LGPL3, einsetzen kann.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=License/de&oldid=1393615>"