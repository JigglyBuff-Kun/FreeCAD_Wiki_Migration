---
title: Dialogerstellung mit verschiedenen Widgets
---
## Einleitung
...
Der Befehl
**UserAppData** gibt den Installationspfad an
**AppHomePath** gibt den Installationspfad von FreeCAD an
...
* ![Qt-Beispiel 1](/images/Qt_Example_00.png)
...
Die Code-Seite und die Piktogramme [Qt\_Beispiel](/Qt_Example/de "Qt Example/de")

Retrieved from "<http://wiki.freecad.org/index.php?title=Dialog_creation_with_various_widgets/de&oldid=1332547>"