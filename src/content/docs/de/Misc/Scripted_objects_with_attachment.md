---
title: Geskriptete Objekte mit Anhang
---
## Einführung

Der Zweck dieser Seite ist es, ein minimales Beispiel zu geben, das die Funktion [Part Befestigen](/Part_EditAttachment/de "Part EditAttachment/de") unter Verwendung von [skriptgenerierten Objekten](/Scripted_objects "Scripted objects") in Python zeigt.

Siehe unten, [Full and complete minimal example](#Full_and_Complete_Minimal_Example).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_objects_with_attachment/de&oldid=1508377>"