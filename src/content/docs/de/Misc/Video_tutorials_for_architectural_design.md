---
title: Video Tutorien für Architektonische Gestaltung
---
:::caution
...
Die hier aufgeführten Tutorien befassen sich mit der Gestaltung von Räumen, Häusern und anderen Gebäuden, die für Architekten und Bauingenieure interessant sind. Für weitere Themen siehe die allgemeine Seite [Videotutorien](/Video_tutorials/de "Video tutorials/de").
...
* [Yorik van Havre Wiedergabelisten](https://www.youtube.com/user/yorikvanhavre/playlists): der Hauptentwickler des Arbeitsbereichs [BIM](/index.php?title=BIM-Workbench/de&action=edit&redlink=1 "BIM-Workbench/de (page does not exist)") hat verschiedene Listen zu FreeCAD für Gebäudemodellierung sowie allgemeine Architektur.
  ...
  + [BIM mit FreeCAD](https://www.youtube.com/watch?v=QhDMhYvxPO4&list=PLmKdGVtV5Vnt2cj4IZIv9FM39QHaE1ZaU): FreeCAD 0.17 bis 0.19, allgemeine Videos über die Arbeitsbereiche BIM und Arch, einschließlich Einrichtung, Bau von Wänden, Fenstern, unter Verwendung von 2D-Objekten und Ausdrücken.
...
* [Arch Arbeitsbereich Erfahrung: Neuer Arbeitsablauf](https://forum.freecadweb.org/viewtopic.php?f=36&t=44475): eine Reihe von Videos von jpg87, die auf seiner eigenen Webseite bereitgestellt werden und in denen die Benutzer lernen, Wände, Dächer sowie Fenster und Türen in verschiedenen Positionen mit Hilfe von [Skizzen](/Sketch/de "Sketch/de") zu modellieren.
...
* [Eklavya Self Learning Tutorien Wiedergabelisten](https://www.youtube.com/user/cnirbhay/playlists): verschiedene Videos von Eklavya Selbstlern Tutorien über die Verwendung von FreeCAD, mit besonderem Schwerpunkt auf der Verwendung im Architektur- und Bauwesen.
  ...
  + [FreeCAD FEM/Civil/Structural/Arch Tutorial-1-Eine Einführung](https://www.youtube.com/watch?v=wAJe1R5NDGw): FreeCAD 0.16, und eine Einführung, die eine einfache Struktur von Säulen und Balken aufbaut und diese mit der [FEM Arbeitsbereich](/FEM_Workbench/de "FEM Workbench/de") analysiert.
...
* [Peter Böttcher Playlisten](https://www.youtube.com/channel/UCJ-BL4wcOD1InrlbJsC02AQ/playlists): verschiedene hochwertige BIM-Videos in deutscher Sprache von Prof. Dr. Peter Böttcher.
  + [Grundmodell mit FreeCAD und ARCH](https://www.youtube.com/watch?v=Qe-vXRtKql4&list=PLNv9lsSmVr-iDNhHqJ1u8aZUImYIc8bB8): erster Teil einer Serie von zwei Videos mit Schritt-für-Schritt-Anleitungen zur Erstellung eines einfachen Modells. Allgemeine Einführung in FreeCAD, Achsensysteme und Teile erstellen.
  + [Fachmodell mit FreeCAD und ARCH](https://www.youtube.com/watch?v=iarSNPBKkfo&list=PLNv9lsSmVr-iDNhHqJ1u8aZUImYIc8bB8): zweiter Teil der Serie. Der Bau des eigentlichen Modells: eine Garage.

Retrieved from "<http://wiki.freecad.org/index.php?title=Video_tutorials_for_architectural_design/de&oldid=1464592>"