---
title: Common Airfoil Data Import/de
---
## Tragflächendaten importieren

FreeCAD kann Tragflächendaten importieren, wie man sie auf [UIUC Airfoil Coordinates Database](http://m-selig.ae.illinois.edu/ads/coord_database.html) finden kann oder Dateien, die mit Software für die Konstruktion und Analyse von Tragflächen wie z.B. [XFLR5](http://www.xflr5.com/xflr5.htm) erstellt wurden.
...
There is a macro available that will import the airfoil with a user defined chord length. This macro will first allow the user to select the airfoil data file to import and then take an input for the chord length. It will then properly scale the airfoil for use. The macro can be found in the [Macros recipes](/Macros_recipes "Macros recipes") section of this Wiki under [Macro Airfoil Import & Scale](/Macro_Airfoil_Import_%26_Scale "Macro Airfoil Import & Scale").

Retrieved from "<http://wiki.freecad.org/index.php?title=Common_Airfoil_Data_Import/de&oldid=1340513>"