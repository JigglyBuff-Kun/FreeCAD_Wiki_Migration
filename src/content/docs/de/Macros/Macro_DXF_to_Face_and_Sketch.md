---
title: DXF zu Fläche und Skizze
---
...
| Beschreibung                                                                                                                                                                                                                                                                           |
| Dieses makro erstellt Fläche und Skizze aus einer DXF-Datei. Versionsmakro : 02.00 Datum der letzten Änderung : 2017-10-23 FreeCAD version : All Herunterladen : [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/6d/Macro_DXF_to_Face_and_Sketch.png) Autor: shoogen, easyw-fc |
| Autor                                                                                                                                                                                                                                                                                  |
| [shoogen, easyw-fc](/index.php?title=User:Shoogen,_easyw-fc&action=edit&redlink=1 "User:Shoogen, easyw-fc (page does not exist)")                                                                                                                                                      |
| Herunterladen                                                                                                                                                                                                                                                                          |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/6d/Macro_DXF_to_Face_and_Sketch.png)                                                                                                                                                                                           |
| Links                                                                                                                                                                                                                                                                                  |
...
- Previous version [Makro Flächen aus einer DXF Datei erzeugen](/index.php?title=Macro_Creating_faces_from_a_DXF_file/de&action=edit&redlink=1 "Macro Creating faces from a DXF file/de (page does not exist)")

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_DXF_to_Face_and_Sketch/de&oldid=934238>"
