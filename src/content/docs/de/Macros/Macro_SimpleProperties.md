...
| SimpleProperties                                                                                                                                                                                                                                                                                    |
| Description                                                                                                                                                                                                                                                                                         |
| Dieses Makro liefert einfache Eigenschaften des ausgewählten Objekts (Volumen, Begrenzungsbox, ...) Macro version: 0.7 Last modified: 2019-06-10 FreeCAD version: 0.17+ Download: [Werkzeugleistensymbol](https://www.freecadweb.org/wiki/images/d/da/Macro_SimpleProperties.png) Author: OpenBrain |
| Author                                                                                                                                                                                                                                                                                              |
| [OpenBrain](/index.php?title=User:OpenBrain&action=edit&redlink=1 "User:OpenBrain (page does not exist)")                                                                                                                                                                                           |
| Download                                                                                                                                                                                                                                                                                            |
| [Werkzeugleistensymbol](https://www.freecadweb.org/wiki/images/d/da/Macro_SimpleProperties.png)                                                                                                                                                                                                     |
| Links                                                                                                                                                                                                                                                                                               |
...
| _None_                                                                                                                                                                                                                                                                                              |
| See also                                                                                                                                                                                                                                                                                            |
| [Arch Übersicht](/Arch_Survey/de "Arch Survey/de"), [Makro FCInfo](/Macro_FCInfo/de "Macro FCInfo/de")                                                                                                                                                                                              |
|                                                                                                                                                                                                                                                                                                     |
|                                                                                                                                                                                                                                                                                                     |
...
Das Makro ist über den [Addon-Manager](/Std_AddonMgr/de "Std AddonMgr/de") verfügbar.
...
Für ausführlichere Erklärungen siehe Seite [Wie man Makros installiert](/How_to_install_macros/de "How to install macros/de").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_SimpleProperties/de&oldid=1274306>"
