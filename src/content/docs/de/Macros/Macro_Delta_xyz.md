...
| Macro Delta xyz                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Beschreibung                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Gibt die Delta-Werte und den Abstand zwischen zwei Punkten an.Wählen Sie den zweiten Punkt in der 3D-Ansicht aus. Wenn die Taste "UMSCHALT" gedrückt wird, beginnt der Delta-Wert an der Koordinate 0,0,0 bis zum angeklickten Punkt (die Koordinate 0,0,0 wird rot angezeigt). Eine Option ist möglich, damit das Makro resident bleibt (fortlaufend). Drücken Sie dann die Taste "Q", um das Makro zu beenden, und die Option, die Anzahl der Dezimalstellen festzulegen, oder verwenden Sie die Dezimalstelle in der Einstellungsoption. Versionsmakro : 0.2 Datum der letzten Änderung : 2020-10-23 FreeCAD version : All Herunterladen : [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f4/Macro_Delta_xyz.png) Autor: Mario52 |
| Autor                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| SHIFT, Q                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Siehe auch                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [Part Measure Linear](/Part_Measure_Linear/de "Part Measure Linear/de")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
Um den Wert zu ändern, gehen sie zu : FreeCAD → Menu → Tools → Edit parameters... → BaseApp/Preferences/Macros/FCMmacros/Delta_XYZ.

**\_\_\_\_\_switchDecimalsPref\_\_\_\_\_**

- `true` 1: Der runde Wert nimmt den globalen Voreinstellungswert an
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Delta_xyz/de&oldid=787769>"
