...
| Beschreibung                                                                                                                                                                                                                                                          |
| Erzeugt eine Schraube, einen Bolzen ... mit oder ohne Gewinde Versionsmakro : 2.3.1 Datum der letzten Änderung : 2018-10-22 FreeCAD version : All Herunterladen : [ToolBar icon](https://wiki.freecad.org/images/0/00/Macro_screw_maker1_2.png) Autor: Ulrich Brammer |
| Autor                                                                                                                                                                                                                                                                 |
| [Ulrich Brammer](/index.php?title=User:Ulrich_Brammer&action=edit&redlink=1 "User:Ulrich Brammer (page does not exist)")                                                                                                                                              |
| Herunterladen                                                                                                                                                                                                                                                         |
| [ToolBar icon](https://wiki.freecad.org/images/0/00/Macro_screw_maker1_2.png)                                                                                                                                                                                         |
| Links                                                                                                                                                                                                                                                                 |
...
Das Forum [Screw Maker](https://forum.freecadweb.org/viewtopic.php?f=22&t=6558&start=30#p95929)

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_screw_maker1_2/de&oldid=1358736>"
