...
![](/src/assets/images/Macro_Half-Hull_ModelScreenBoatInABottle.jpg)
...
![](/src/assets/images/Macro_Half-Hull_ModelImage0.jpg)
...
![](/src/assets/images/Macro_Half-Hull_ModelImage1.jpg)
...
|               |          |                      |
| ------------- | -------- | -------------------- |
| stemline      | YZ plane | red line in sketch   |
| cross-section | XZ plane | green line in Sketch |
| transom       | XY plane | blue line in Sketch  |

Vielleicht ist es mit 7 Skizzen (eine in der YZ Ebene, eine in der XY Ebene und 5 in der XZ Ebene) einfacher zu sehen:

![](/src/assets/images/Macro_Half-Hull_ModelImage2.jpg)
...
![](/src/assets/images/Macro_Half-Hull_ModelImage3.jpg)

das zweite ist das gleiche Modell um 90 Grad gedreht, so dass der Bug im Vordergrund ist:

![](/src/assets/images/Macro_Half-Hull_ModelImage3a.jpg)
...
![](/src/assets/images/Macro_Half-Hull_ModelImage4.jpg)
...
![](/src/assets/images/Macro_Half-Hull_ModelImage7.jpg)
...
![](/src/assets/images/Macro_Half-Hull_ModelImage8.jpg)

![](/src/assets/images/Macro_Half-Hull_ModelImage9.jpg)
...
![](/src/assets/images/Macro_Half-Hull_ModelUsage1.jpg)
...
![](/src/assets/images/Macro_Half-Hull_ModelUsage2.jpg)

**Create a New Document**

The very first thing is to create a new document in FreeCAD ![](/src/assets/images/Document-new.svg). This document will hold all the Sketches that make up your hull definition.
...
1. create a new sketch ![](/src/assets/images/Sketcher_NewSketch.svg), in the YZ-Plane
2. start at origin (0,0) and draw upwards into Quadrant I  
   ![](/src/assets/images/Macro_Half-Hull_ModelUsage3.jpg)
...
5. save sketch ![](/src/assets/images/Sketcher_LeaveSketch.svg)
...
1. create a new sketch ![](/src/assets/images/Sketcher_NewSketch.svg), in the XZ-Plane
2. the following dialog will appear:  
   ![](/src/assets/images/Macro_Half-Hull_ModelScreenSnapshot1.jpg)  
...
1. create a new sketch ![](/src/assets/images/Sketcher_NewSketch.svg), in the XY-Plane
2. start on the Y axis between quadrant III and IV, and draw upwards into Quadrant IV so that the end point is coincident with the rightmost point of the lowest cross-section Sketch in the YZ-plane  
   ![](/src/assets/images/Macro_Half-Hull_ModelUsage4.jpg)
3. use the same number of line segments as in the stemline Sketch
4. save sketch ![](/src/assets/images/Sketcher_LeaveSketch.svg)
5. for ease of identification it is probably worth naming the Sketch something like "transom sketch"

**Save the New Document**

Now save the document ![](/src/assets/images/Document-save.svg) which contains the Sketches that will define the hull shape, giving it some name that is descriptive

Once the Sketches have all been created and positioned, the document should look like this from the top view ![](/src/assets/images/View-top.svg):

![](/src/assets/images/Macro_Half-Hull_ModelUsage5.jpg)
...
![](/src/assets/images/Macro_Half-Hull_ModelScreenSnapshot2.jpg)
...
- The dimensions of the top of the bulkheads will be configured as per the following diagram:  
  ![](/src/assets/images/Macro_Half-Hull_ModelUi1.jpg)
...
- [3x1 hull](https://github.com/FreeCAD/Examples/raw/master/Half_Hull_Macro_ExampleFiles/3x1.FCStd?raw=true%7C) with the minimum number of Sketches (stemline, one cross-section, transom) with 1 line segment per Sketch <<<<< NOT CURRENTLY WORKING
- [5x3 with normal bow](https://github.com/FreeCAD/Examples/raw/master/Half_Hull_Macro_ExampleFiles/5x3%20bowNormal.FCStd?raw=true%7C)
- [5x3 with trireme bow](https://github.com/FreeCAD/Examples/raw/master/Half_Hull_Macro_ExampleFiles/5x3%20bowTrireme.FCStd?raw=true%7C)
- [5x3 with canoe stern](https://github.com/FreeCAD/Examples/raw/master/Half_Hull_Macro_ExampleFiles/5x3%20sternCanoeStern.FCStd?raw=true%7C)
...
![](/src/assets/images/Macro_Half-Hull_ModelKnownProblems1.jpg)
...
ToolBar Icon ![](/src/assets/images/Macro_Half_Hull_Model.png)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Half-Hull_Model/de&oldid=1539309>"
