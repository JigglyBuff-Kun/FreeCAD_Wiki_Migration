...
The very first thing is to create a new document in FreeCAD ![](/images/Document-new.svg). This document will hold all the Sketches that make up your hull definition.
...
1. create a new sketch ![](/images/Sketcher_NewSketch.svg), in the YZ-Plane
...
5. save sketch ![](/images/Sketcher_LeaveSketch.svg)
...
1. create a new sketch ![](/images/Sketcher_NewSketch.svg), in the XZ-Plane
...
1. create a new sketch ![](/images/Sketcher_NewSketch.svg), in the XY-Plane
...
4. save sketch ![](/images/Sketcher_LeaveSketch.svg)
5. for ease of identification it is probably worth naming the Sketch something like "transom sketch"

**Save the New Document**

Now save the document ![](/images/Document-save.svg) which contains the Sketches that will define the hull shape, giving it some name that is descriptive

Once the Sketches have all been created and positioned, the document should look like this from the top view ![](/images/View-top.svg):
