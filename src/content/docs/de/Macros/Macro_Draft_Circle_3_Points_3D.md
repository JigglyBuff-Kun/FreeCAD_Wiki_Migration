...
| Beschreibung                                                                                                                                                                                                                                                                |
| Erzeugt einen Kreis aus 3 ausgewählten Punkten im Raum. Versionsmakro : 01.00 Datum der letzten Änderung : 2013-03-16 FreeCAD version : All Herunterladen : [ToolBar Icon](https://www.freecadweb.org/wiki/images/1/10/Macro_Draft_Circle_3_Points.png) Autor: galou_breizh |
| Autor                                                                                                                                                                                                                                                                       |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Draft_Circle_3_Points_3D/de&oldid=934230>"
