...
- Wenn auf Benutzerordner ('Mod', 'Makro', ...) verwiesen wird, befinden sich diese in deinem FreeCAD-Benutzerordner. Du kannst sie unter Start und Konfiguration → [Benutzerbezogene Informationen](/Start_up_and_Configuration/de#Benutzerbezogene_Informationen "Start up and Configuration/de") finden.
...
Betrachte das untenstehende Makro, das du von irgendwo heruntergeladen hast und das in deinem Ordner 'Makro' mit dem Namen 'MeinSuperMakro.FCMakro' gespeichert ist:
...
Wir haben es geschafft. Dein Makro sollte beim nächsten FreeCAD-Start automatisch ausgeführt werden.
...
- This script will be run prior to the auto loading of your desired startup workbench in the FreeCAD Preferences, [General settings](/Preferences_Editor#General_settings "Preferences Editor").
...
- [LazyLoader](/Extra_python_modules#LazyLoader "Extra python modules") ist ein Python-Modul, das verzögertes Laden erlaubt.

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_at_Startup/de&oldid=1256586>"
