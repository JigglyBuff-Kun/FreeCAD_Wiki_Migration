...
| Beschreibung                                                                                                                                                                                                                                                              |
| Diese Makro-rote Spur (editierbar) um die BoundingBox mit 6 Rechtecken. Versionsmakro : 0.12 Datum der letzten Änderung : 2021/07/10 FreeCAD version : All Herunterladen : [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/60/BoundBoxTracing.png) Autor: Mario52 |
| Autor                                                                                                                                                                                                                                                                     |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_BoundingBox_Tracing/de&oldid=1317671>"
