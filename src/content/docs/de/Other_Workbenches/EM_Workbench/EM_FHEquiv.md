...
* Daten**Node1**: the first [FHNode](/EM_FHNode "EM FHNode") to short-circuit
* Daten**Node2**: the second [FHNode](/EM_FHNode "EM FHNode") to short-circuit
...
Retrieved from "<http://wiki.freecad.org/index.php?title=EM_FHEquiv/de&oldid=1340539>"