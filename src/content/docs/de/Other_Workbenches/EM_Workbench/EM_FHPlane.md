...
Das Werkzeug FHPlane fügt ein FastHenry-Objekt einer Ebene mit gleichförmiger Leitfähigkeit ein.
...
* Daten**Base**: The base object this component is built upon (a [Draft Rectangle](/Draft_Rectangle "Draft Rectangle") or a [Part Box](/Part_Box "Part Box"))
* Daten**Thickness**: the FHPlane thickness ('thick' plane parameter in FastHenry). If the FHPlane is based on a [Part Box](/Part_Box "Part Box"), this value is inherited from the Part Box Height parameter
* Daten**seg1**: the Number of segments along the length direction ('seg1' plane parameter in FastHenry)
* Daten**seg2**: the Number of segments along the width direction ('seg2' plane parameter in FastHenry)
* Daten**nhinc**: the Number of filaments the plane thickness ('nhinc' plane parameter in FastHenry)
* Daten**rh**: the ratio of adjacent filaments along the thickness ('rh' plane parameter in FastHenry)
* Daten**Sigma**: the FHPlane conductivity ('sigma' plane parameter in FastHenry)
* Daten**segwid1**: the Width of segments along the plane length direction ('segwid1' plane parameter in FastHenry)
* Daten**segwid2**: the Width of segments along the plane width direction ('segwid2' plane parameter in FastHenry)
* Daten**Nodes**: the list of FHNode objects for connections to the plane
* Daten**Holes**: the list of FHPlaneHoles in the plane
* Daten**FineMesh**: specifies if this the plane fine mesh is shown (i.e. composing segments)
* Daten**ShowNodes**: show the internal node grid supporting the plane (i.e. internal nodes)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=EM_FHPlane/de&oldid=1340637>"