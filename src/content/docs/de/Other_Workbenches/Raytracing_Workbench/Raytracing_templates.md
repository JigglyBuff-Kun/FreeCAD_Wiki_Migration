---
title: Strahlverfolgung Vorlagen
---
## Einführung

Die [Arbeitsbereich Strahlverfolgung](/Raytracing_Workbench/de "Raytracing Workbench/de") kommt mit einigen Vorlagen für Povray und Luxrender, aber du kannst leicht deine eigenen erstellen. Alles, was du tun musst, ist, eine Szenendatei für den gegebenen Renderer zu erstellen und sie dann manuell mit einem Texteditor zu bearbeiten, um spezielle Tags einzufügen, die FreeCAD erkennt und wo der Inhalt (Kamera- und Objektdaten) eingefügt wird.

Eigene Vorlagen [introduced in 0.18](/Release_notes_0.18 "Release notes 0.18") können platziert werden unter dem Pfad
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Raytracing_templates/de&oldid=734152>"