---
title: Reinforcement ZeichnungBemaßen
---
|  |
| --- |
| Reinforcement ZeichnungBemaßen |
| Menüeintrag |
| *Keiner* |
| Arbeitsbereich |
...
Das Werkzeug [Reinforcement ZeichnungBemaßen](/Reinforcement_DrawingDimensioning "Reinforcement DrawingDimensioning") ermöglicht dem Anwender Zeichnungen mit Bemaßung von Bewehrungen zu erstellen.
...
1. Ein FreeCAD-Modell öffnen, dass Bewehrungen enthält, die mit dem [Addon Reinforcement](/Reinforcement_Addon/de "Reinforcement Addon/de") erstellt wurden.
...
* Daten**Structure**: The structure object acting as a Host for rebars to be included in the drawing.
* Daten**Rebars**: The list of rebar objects to be included in the drawing.
* Daten**View**: The reinforcement drawing view to be generated. It can be "Front", "Rear", "Left", "Right", "Top" or "Bottom".
* Daten**PositionType**: The position type of Reinforcement Drawing on Template. It can be "Automatic" to calculate drawing placement using Daten**LeftOffset**, Daten**TopOffset**, Daten**MinRightOffset** and Daten**MinBottomOffset** OR "Custom" to set placement using Daten**X** and Daten**Y**.
* Daten**RebarsStrokeWidth**: The stroke width of rebars in Reinforcement Drawing SVG.
* Daten**RebarsColorStyle**: The color style of rebars in Reinforcement Drawing SVG. Set it to "Automatic" to automatically select rebars color OR "Custom" to choose shape color value from Daten**RebarsColor**.
* Daten**RebarsColor**: The color of rebars in Reinforcement Drawing SVG.
* Daten**StructureStrokeWidth**: The stroke width of the structure in Reinforcement Drawing SVG.
* Daten**StructureColorStyle**: The color style of structure in Reinforcement Drawing SVG. Set it to "Automatic" to automatically select rebars color, "Custom" to choose shape color value from Daten**StructureColor** OR "None" to not fill structure.
* Daten**StructureColor**: The color of structure in Reinforcement Drawing SVG.
* Daten**Template**: The template for the Reinforcement Drawing view.
* Daten**Width**: The width of the Reinforcement Drawing view SVG.
* Daten**Height**: The height of Reinforcement Drawing view SVG.
* Daten**LeftOffset**: The left offset of Reinforcement Drawing view on a template.
* Daten**TopOffset**: The top offset of Reinforcement Drawing view on a template.
* Daten**MinRightOffset**: The minimum right offset of Reinforcement Drawing view on a template.
* Daten**MinBottomOffset**: The minimum bottom offset of Reinforcement Drawing view on a template.
* Daten**MaxWidth**: The maximum width of the Reinforcement Drawing view.
* Daten**MaxHeight**: The maximum height of the Reinforcement Drawing view.
* Daten**VisibleRebars**: The list of visible rebar objects in the drawing view.
* Daten**DimensionLeftOffset**: The left offset for each new ReinforcementDimensioning object.
* Daten**DimensionRightOffset**: The right offset for each new ReinforcementDimensioning object.
* Daten**DimensionTopOffset**: The top offset for each new ReinforcementDimensioning object.
* Daten**DimensionBottomOffset**: The bottom offset for each new ReinforcementDimensioning object.
...
* Daten**ParentDrawingView**: The parent ReinforcementDrawingView object containing the drawing of [Rebar](/Arch_Rebar "Arch Rebar") object.
* Daten**Rebar**: The [Rebar](/Arch_Rebar "Arch Rebar") object to perform dimensioning.
* Daten**WayPointsType**: The WayPoints type of dimension line. It can be "Automatic" (to automatically perform dimensioning of [Rebar](/Arch_Rebar "Arch Rebar") object) or "Custom" to use Daten**WayPoints** to perform dimensioning.
* Daten**WayPoints**: A list of vector points to be used to generate a dimension line.
* Daten**TextPositionType**: The position type of dimension text. It can be "StartOfLine", "MidOfLine" or "EndOfLine".
* Daten**DimensionFormat**: The dimension label format.
...
* Daten**Font**: The font family of dimension label.
* Daten**FontSize**: The font size of the dimension label.
* Daten**StrokeWidth**: The stroke width of the dimension line.
* Daten**LineStyle**: The stroke style of the dimension line. It can be "Continuous", "Dash", "Dot", "DashDot" or "DashDotDot".
* Daten**LineColor**: The color of the dimension line.
* Daten**TextColor**: The color of the dimension label.
* Daten**LineStartSymbol**: The start symbol of the dimension line. It can be "FilledArrow", "Tick", "Dot" or "None".
* Daten**LineEndSymbol**: The end symbol of the dimension line. It can be "FilledArrow", "Tick", "Dot" or "None".
* Daten**LineMidPointSymbol**: The midpoints symbol of the dimension line. It can be "Tick", "Dot" or "None".
* Daten**DimensionLeftOffset**: The left offset for automated reinforcement dimensioning.
* Daten**DimensionRightOffset**: The right offset for automated reinforcement dimensioning.
* Daten**DimensionTopOffset**: The top offset for automated reinforcement dimensioning.
* Daten**DimensionBottomOffset**: The bottom offset for automated reinforcement dimensioning.
* Daten**SingleRebar\_LineStartSymbol**: The dimension line start symbol, in case of single rebar is visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Daten**WayPointsType** is set to "Automatic".
* Daten**SingleRebar\_LineEndSymbol**: The dimension line end symbol, in case of single rebar is visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Daten**WayPointsType** is set to "Automatic".
* Daten**MultiRebar\_LineStartSymbol**: The dimension line start symbol, in case of multiple rebars are visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Daten**WayPointsType** is set to "Automatic".
* Daten**MultiRebar\_LineEndSymbol**: The dimension line end symbol, in case of multiple rebars are visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Daten**WayPointsType** is set to "Automatic".
* Daten**SingleRebar\_OuterDimension**: It specifies if dimension lines are to be outside of reinforcement drawing, in case of single rebar is visible. It is used only when Daten**WayPointsType** is set to "Automatic".
* Daten**MultiRebar\_OuterDimension**: It specifies if dimension lines are to be outside of reinforcement drawing, in case of multiple rebars are visible. It is used only when Daten**WayPointsType** is set to "Automatic".
* Daten**SingleRebar\_TextPositionType**: It specifies the dimension label position type, in case of single rebar is visible. It can be "StartOfLine", "MidOfLine" or "EndOfLine". It is used only when Daten**WayPointsType** is set to "Automatic".
* Daten**MultiRebar\_TextPositionType**: It specifies the dimension label position type, in case of multiple rebars are visible. It can be "StartOfLine", "MidOfLine" or "EndOfLine". It is used only when Daten**WayPointsType** is set to "Automatic".
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_DrawingDimensioning/de&oldid=1395584>"