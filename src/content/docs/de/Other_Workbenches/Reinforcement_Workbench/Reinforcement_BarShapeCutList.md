---
title: Reinforcement BarShapeCutList/de
---
|  |
| --- |
...
* Daten**Stirrup Extended Edge Offset**: The offset of extended end edges of the stirrup, so that end edges of the stirrup with a 90-degree bent angle do not overlap with stirrup edges.
* Daten**Rebars Stroke Width**: The stroke-width of rebars in the rebar shape cut list.
* Daten**Rebars Color Style**: The color style of rebars.
* Daten**Row Height**: The height of each row of rebar shape in the rebar shape cut list.
* Daten**Column Width**: The width of each column of rebar shape in the rebar shape cut list.
* Daten**Column Count**: The number of columns in the rebar shape cut list.
* Daten**Side Padding**: The padding on each side of the rebar shape.
* Daten**Horizontal Rebar Shape**: If True, then the rebar shape will be made horizontal by rotating the max length edge of the rebar shape.
* Daten**Include Mark**: If it is set to True, then rebar.Mark will be included for each rebar shape in the rebar shape cut list.
* Daten**SVG Output File**: The output file to write generated rebar shape cut list SVG.

**Dimension Data:**

* Daten**Include Dimensions**: If True, then each rebar edge dimensions and bent angle dimensions will be included in the rebar shape cut list.
* Daten**Include Units in Dimension Label**: If it is True, then rebar edge length units will be shown in dimension label.
* Daten**Rebar Edge Dimension Units**: The units to be used for rebar edge length dimensions.
* Daten**Rebar Edge Dimension Precision**: The number of decimals that should be shown for rebar edge length as a dimension label.
* Daten**Dimension Font Family**: The font-family of dimension text.
* Daten**Dimension Font Size**: The font-size of dimension text.
* Daten**Bent Angle Dimension Exclude List**: The list of bent angles to not include their dimensions.
* Daten**Helical Rebar Dimension Label Format**: The format of the helical rebar dimension label. e.g. "%L,r=%R,pitch=%P" where %L -> Length of helical rebar, %R -> Helix radius of helical rebar, %P -> Helix pitch of helical rebar.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_BarShapeCutList/de&oldid=1372712>"