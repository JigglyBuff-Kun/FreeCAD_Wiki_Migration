...
* Daten**Reinforcement Group By**: Reinforcement Group By specifies how reinforcement objects should be grouped in Bar Bending Schedule i.e. "Host" or "Mark".
...
* Daten**Font Family**: Font Family of text in Bar Bending Schedule SVG.
* Daten**Font Size**: Font size in mm.
* Daten**Column Width**: Width of each column in Bar Bending Schedule SVG.
* Daten**Row Height**: Height of each row in Bar Bending Schedule SVG.
...
* Daten**Column Header**: The column header for the rebar shape column.
...
* Daten**Rebars Stroke Width**: The stroke-width of rebars in the rebar shape column.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_BarBendingSchedule/de&oldid=1395645>"