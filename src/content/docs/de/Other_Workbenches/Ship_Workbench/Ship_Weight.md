---
title: Schiff Gewicht
---
|  |
| --- |
| Ship Gewicht |
| Menüeintrag |
| Weights → Neues Schiffsgewicht erstellen |
| Arbeitsbereich |
...
* [FreeCAD-Schiff s60 Tutorium](/FreeCAD-Ship_s60_tutorial/de "FreeCAD-Ship s60 tutorial/de")
* [FreeCAD-Schiff s60 Tutorium (II)](/FreeCAD-Ship_s60_tutorial_(II)/de "FreeCAD-Ship s60 tutorial (II)/de")

Retrieved from "<http://wiki.freecad.org/index.php?title=Ship_Weight/de&oldid=1249332>"