---
title: Ship SchhiffErstellen
---
|  |
| --- |
| Ship SchiffErstellen |
| Menüeintrag |
| Ship design → Erstelle ein neues Schiff |
| Arbeitsbereich |
...
Um eine **Schiffsinstanz** (in anderen Worten: ein neues Schiff) zu erstellen, die Festkörpergeometrie der Hülle auswählen und das Werkzeug **Ship design → ![](/images/Ship_CreateShip.svg) Erstelle ein neues Schiff** aufrufen.

Der Dialog zum Erstellen von Schiffsaufgaben und einige Anmerkungen unter [3D Ansicht](/3D_view/de "3D view/de") werden gezeigt. Die Anmerkungen werden entfernt, wenn du das Schiffs-Erstellungswerkzeug schließt, machen dir also keine Sorgen.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Ship_CreateShip/de&oldid=1441156>"