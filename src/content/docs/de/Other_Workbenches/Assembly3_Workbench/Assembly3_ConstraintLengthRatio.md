---
title: Assembly3 Längenverhältnis
---
:::caution
...
Der Längenwert der zuerst gewählten Linie ist gleich dem Längenwert der zweiten Linie multipliziert mit einem Verhältniswert.

:   Oder der Längenwert der zweiten gewählten Linie ist gleich dem Längenwert der ersten Linie geteilt durch einen Verhältniswert.

## Anwendung

1. Zwei Linien auswählen, von denen wenigsten eine eine 2D-Linie sein sollte.
2. Schaltfläche ![](/images/Assembly_ConstraintLengthRatio.svg) Längenverhältnis drücken.
3. **Ratio**-Parameter im Eigenschaftenfenster auf den gewünschten Wert setzen.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Assembly3_ConstraintLengthRatio/de&oldid=1536628>"