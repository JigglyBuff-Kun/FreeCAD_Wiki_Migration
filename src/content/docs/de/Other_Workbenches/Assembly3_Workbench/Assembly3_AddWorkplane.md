---
title: Assembly3 ArbeitsebeneHinzufügen
---
:::caution
...
|  |
| --- |
| Assembly3 ArbeitsebeneHinzufügen |
| Menüeintrag |
...
Der Befehl ![](/images/Assembly_Add_Workplane.svg) Arbeitsebene hinzufügen fügt einer aktiven Baugruppe eine Arbeitsebene hinzu.
...
1. Den Befehl ![](/images/Assembly_Add_Workplane.svg) **Arbeitsebene hinzufügen** aktivieren durch:
   * Die Schaltfläche ![](/images/Assembly_Add_Workplane.svg) Arbeitsebene hinzufügen.
   * Den Menüeintrag **Assembly3 → Workplane and origin → ![](/images/Assembly_Add_Workplane.svg) Arbeitsebene hinzufügen**.

Retrieved from "<http://wiki.freecad.org/index.php?title=Assembly3_AddWorkplane/de&oldid=1536571>"