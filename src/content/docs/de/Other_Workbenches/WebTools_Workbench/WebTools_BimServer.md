---
title: WebWerkzeuge BimServer
---
|  |
| --- |
| WebWerkzeuge BimServer‏‎ |
| Menüeintrag |
| Web Werkzeuge → Bim Server‏‎ |
| Arbeitsbereich |
...
* Alle Dateiübertragungen mit dem BIMServer werden mit IFC Dateien durchgeführt. Daher musst du wissen, wie man mit [IFC Dateien](/Arch_IFC/de "Arch IFC/de") arbeitet.
...
2. Wähle das Menü **Web Werkzeuge → ![](/images/WebTools_BimServer.svg) BIM Server**
...
* Wähle das **Wurzelobjekt**, das du hochladen möchtest. Es muss entweder ein [Arch Site](/Arch_Site/de "Arch Site/de") oder ein [Arch Building](/Arch_Building/de "Arch Building/de") sein. Nur Objekte, die zu diesem Stammobjekt gehören, werden hochgeladen.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=WebTools_BimServer/de&oldid=1104504>"