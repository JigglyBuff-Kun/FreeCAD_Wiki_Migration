---
title: WebWerkzeuge Sketchfab
---
|  |
| --- |
| WebWerkzeuge Sketchfab |
| Menüeintrag |
| WebWerkzeuge → Sketchfab |
| Arbeitsbereich |
...
Dieses Werkzeug erlaubt dir Objekte zu exportieren und auf dein [SketchFab](http://www.sketchfab.com) Konto hochzuladen. [eingeführt in 0.17](/Release_notes_0.17/de "Release notes 0.17/de")
...
3. Klicke auf ![](/images/WebTools_Sketchfab.svg) in der Hauptwerkzeugleiste der [Arbeitsbereich WebWerkzeuge](/WebTools_Workbench/de "WebTools Workbench/de")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=WebTools_Sketchfab/de&oldid=1024818>"