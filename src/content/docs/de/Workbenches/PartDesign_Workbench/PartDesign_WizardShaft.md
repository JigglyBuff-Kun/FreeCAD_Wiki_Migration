---
title: PartDesign EntwurfsassistentWellen
---
|  |
| --- |
| PartDesign EntwurfsassistentWellen |
| Menüeintrag |
| Part Design → Entwurfsassistent für Wellen... |
| Arbeitsbereich |
...
Der Entwurfsassistent kann aus dem PartDesign-Menü **Part Design → ![](/images/PartDesign_WizardShaft.svg) Entwurfsassistent für Wellen...** gestartet werden.
...
Der Entwurfsassistent für Wellen hängt von der Bibliothek [matplotlib](http://matplotlib.org/) ab, um die Diagramme der Scherkraft und des Biegemoments zu erstellen und anzuzeigen.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_WizardShaft/de&oldid=1462812>"