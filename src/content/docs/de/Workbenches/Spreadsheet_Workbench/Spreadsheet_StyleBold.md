...
Das Werkzeug ![](/src/assets/images/Spreadsheet_StyleBold.svg) **Spreadsheet StilFett** aktiviert bzw. deaktiviert die Darstellung des Inhalts der ausgewählten Zellen in fetter Schrift.
...
3. Es gibt mehrere Möglichkeiten, den Befehl aufzurufen:
   - Die Schaltfläche ![](/src/assets/images/Spreadsheet_StyleBold.svg) Text in Fettschrift drücken.
   - Den Menüeintrag **Kalkulationstabelle → Stile → ![](/src/assets/images/Spreadsheet_StyleBold.svg) Text in Fettschrift** auswählen.
