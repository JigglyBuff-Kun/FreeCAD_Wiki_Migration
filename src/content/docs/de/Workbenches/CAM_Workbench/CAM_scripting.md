...
Der Arbeitsbereichen CAM bietet Werkzeuge zum Importieren, Erstellen, Ändern und Exportieren von [Bearbeitungs-Werkzeugbahnen](https://en.wikipedia.org/wiki/G-code) in FreeCAD. Mit ihnen kann der Anwender bestehende G-code-Programme importieren, visualisieren und modifizieren, Werkzeugbahnen aus 3D-Formen erstellen und diese Werkzeugbahnen in G-code exportieren.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=CAM_scripting/de&oldid=1483640>"