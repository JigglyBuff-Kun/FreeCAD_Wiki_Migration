---
title: CAM Häufig gestellte Fragen
---
## Mit wievielen Achsen kann der Arbeitsbereich CAM umgehen?

Zurzeit kann der Arbeitsbereich CAM mit maximal 3-Achsen-Fräsen umgehen. Derzeit ist die 4-Achsen-Fähigkeit nicht offiziell enthalten aber es gibt eine [experimentelle Implementierung](/CAM_fourth_axis/de "CAM fourth axis/de").
...
Genauere Informationen stehen unter [Höhen und Tiefen](/CAM_Workbench/de#Höhen_und_Tiefen "CAM Workbench/de") zur Verfügung.

[Anfang](#top)

## Was ist die typische Anwendung des EinrichtungsBlatts?

Das [Einrichtungsblatt](/CAM_SetupSheet/de "CAM SetupSheet/de") ist ein spezielles Tabellenblatt, das in einem Auftrag enthalten ist, in der Eigenschaftenansicht geändert wird und nur über den Arbeitsbereich CAM zugänglich ist. Es bietet einen Mechanismus für erfahrene Benutzer, um Aspekte ihres Auftrags zu konfigurieren, indem sie Werte und Ausdrücke verwenden, die im [Einrichtungsblatt](/CAM_SetupSheet/de "CAM SetupSheet/de") enthalten sind.
...
Bearbeitungen wie [3D-Tasche](/CAM_Pocket_3D/de "CAM Pocket 3D/de"), [Taschenform](/CAM_Pocket_Shape/de "CAM Pocket Shape/de"), und [FlächeFräsen](/CAM_MillFace/de "CAM MillFace/de"), aber nicht Konturbearbeitungen, haben eine Konfigurationsoption, um das Werkzeug unten zu halten, auf dem Datenreiter in der Eigenschaftsansicht.

[Anfang](#top)

## Wie kann ich Laschen zum Spannen meiner Fräsarbeiten belassen?

CAM Arbeitsbereich bietet eine [Aufbereitungskennzeichnung](/CAM_DressupTag/de "CAM DressupTag/de") für genau diesen Zweck.

[Anfang](#top)

## Was ist ein Postprozessor?

Der [Postprozessor](/CAM_Post/de "CAM Post/de") wird verwendet, um den Ausgabecode für CNC-Steuerungen für verschiedene Maschinen in ihrem G-Code-Dialekt anzupassen.
...
Ja, in den [CAM-Einstellungen](/CAM_Preferences/de "CAM Preferences/de") gibt es einen Abschnitt für Postprozessoren, in dem du auswählen kannst, welche Postprozessoren angezeigt werden, und einen Standardpostprozessor auswählen kannst.
...
Der Arbeitsbereich CAM ermöglicht die Kontrolle über die Anzeige von Pfadlinien, indem die Sichtbarkeit des Auftrags durch Auswahl in der [Comboansicht](/Combo_view/de "Combo view/de") umgeschaltet wird. Die Sichtbarkeit einzelner Vorgänge oder Gruppen von Vorgängen wird dann in der Comboansicht umgeschaltet.
...
[CAM Skripten](/CAM_scripting/de "CAM scripting/de")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=CAM_FAQ/de&oldid=1512784>"