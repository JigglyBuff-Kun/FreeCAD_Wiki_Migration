...
Ich denke der Arbeitsbereich ![](/images/Workbench_Sketcher.svg) [Sketcher](/Sketcher_Workbench/de "Sketcher Workbench/de") kann einige Beispiele gebrauchen, die nicht so detailliert sind wie Anleitungen oder Videos...
...
Dieses Beispiel verwendet eine Art Master-Skizze, um darauf einige abhängige Skizzen aufzusetzen. Es zeigt auch, wie ein einfacher Klipp angefügt und animiert wird, der auf ![](/images/Workbench_PartDesign.svg) [PartDesign](/PartDesign_Workbench/de "PartDesign Workbench/de")-Formelementen und ![](/images/Workbench_Sketcher.svg) [Sketcher](/Sketcher_Workbench/de "Sketcher Workbench/de")-Randbedingungen basiert. Die Verwendung von ![](/images/Bound-expression.svg) [Ausdrücken](/Expressions/de "Expressions/de"), wie unten beschrieben, erfordert FreeCAD ab **Version 0.21**.
...
Der Bogen dieses Filmscharniers hat eine konstante Länge und einen variablen Radius. Eine Eingangsgröße ist NeutralerRadius der Basis-Skizze; um ihn in der Skizze zur Hand zu haben, wird er als ![](/images/Sketcher_External.svg) [externe Geometrie](/Sketcher_External/de "Sketcher External/de") eingebunden und erhält das mit ReferenzRadius benannte anzeigende Maß (reference dimension).
...
: Der ![](/images/Bound-expression.svg) [Ausdruck](/Expressions/de "Expressions/de") für den Wert von DynamischerRadius: `.Constraints.ReferenzRadius * 180 ° / .Constraints.BogenWinkel`
...
: Der ![](/images/Bound-expression.svg) [Ausdruck](/Expressions/de "Expressions/de") für den Wert von HalbBogen: `.Constraints.BogenWinkel / 2`
...
Links: Das ![](/images/PartDesign_Pad.svg) [extrudierte](/PartDesign_Pad/de "PartDesign Pad/de") halbe Scharnier mit sichtbarer Skizze. Rechts: Das halbe Scharnier mit hinzugefügter ![](/images/PartDesign_Fillet.svg) [Verrundung](/PartDesign_Fillet/de "PartDesign Fillet/de")

![](/images/Sketcher_ExampleHinge-06.png) ![](/images/Button_right.svg)
![](/images/Sketcher_ExampleHinge-07.png)

Das halbe Scharnier mit ausgewählter Spiegelebene → ![](/images/PartDesign_Mirrored.svg) [gespiegeltes](/PartDesign_Mirrored/de "PartDesign Mirrored/de") Filmscharnier

Hinweis: ![](/images/Part_Mirror.svg) [Part Spiegeln](/Part_Mirror/de "Part Mirror/de") akzeptiert nur die drei Basis-Ebenen und kann dadurch in so einem Falle nicht verwendet werden.
...
3. Das Werkuzeug ![](/images/PartDesign_Boolean.svg) [PartDesign Boolesche Operation](/PartDesign_Boolean/de "PartDesign Boolean/de") mit der (Standard-) Option Vereineigung auswählen.
...
Filmscharnier und statische Hälfte in Konstruktionslage → Filmscharnier mit versetzter und ![](/images/PartDesign_Boolean.svg) [vereinigter](/PartDesign_Boolean/de "PartDesign Boolean/de") statischer Hälfte
...
- Die Behälter ![](/images/Std_Part.svg) [Std Teil](/Std_Part/de "Std Part/de") (Part) und ![](/images/PartDesign_Body.svg) [PartDesign Körper](/PartDesign_Body/de "PartDesign Body/de") (Body) werden nicht von ![](/images/Part_EditAttachment.svg) [Part Befestigen](/Part_EditAttachment/de#Einschränkungen "Part EditAttachment/de") unterstützt.
...
- ![](/images/PartDesign_Clone.svg) [PartDesign Klon](/PartDesign_Clone/de "PartDesign Clone/de") erstellt einen Körper mit einem einzigen Formelement, der mit Befestigen verwendet werden kann.

Mit diesem Wissen im Hinterkopf könnte ein Arbeitsablauf so aussehen:

1. Den Körper (Body) der beweglichen Hälfte auswählen.
2. Den Befehl ![](/images/PartDesign_Clone.svg) [Klon erstellen](/PartDesign_Clone/de "PartDesign Clone/de") aufrufen.
3. In der Baumansicht im neuen Körper (Body-Objekt) das Clone-Objekt auswählen.
4. Das Werkzeug ![](/images/Part_EditAttachment.svg) [Part Befestigung](/Part_EditAttachment/de "Part EditAttachment/de") aufrufen, um dem Clone-Objekt die Eigenschaften von Befestigung hinzuzufügen.
...
7. MIt noch immer aktiviertem Scharnierkörper das Werkzeug ![](/images/PartDesign_Boolean.svg) [PartDesign Boolesche Operation](/PartDesign_Boolean/de "PartDesign Boolean/de") auswählen.
...
Die bewegliche Hälfte wird an einer Ecke der beweglichen Scharnierseite ![](/images/Part_EditAttachment.svg) [befestigt](/Part_EditAttachment/de "Part EditAttachment/de") (Befestigungsmodus Ausrichten OXZ: Knoten, Kante, Kante)
...
Der Klipp bis hier hin und die bewegliche Hälfte in Konstruktionslage → der fertige Klipp mit der ![](/images/Part_EditAttachment.svg) [befestigten](/Part_EditAttachment/de "Part EditAttachment/de") und ![](/images/PartDesign_Boolean.svg) [vereinigten](/PartDesign_Boolean/de "PartDesign Boolean/de") beweglichen Hälfte
