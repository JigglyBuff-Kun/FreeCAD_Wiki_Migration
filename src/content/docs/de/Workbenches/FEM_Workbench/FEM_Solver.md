...
Das [FreeCAD-Abhängigkeiten](https://github.com/luzpaz/FreeCAD-dependencies)-Repositorium verfolgt die Abhängigkeiten von FreeCAD über viele Linux-Distributionen hinweg. Die Seite [FEM.md](https://github.com/luzpaz/FreeCAD-dependencies/blob/master/FC-Workbenches/FEM.md) betrachtet verfügbare quelloffene FEA-Löser, die mit dem Arbeitsbereich [FEM](/FEM_Workbench/de "FEM Workbench/de") verwendet werden können. Die Seite zeigt die Version eines bestimmten Lösers im Repositorium einer bestimmten Linux-Distribution. Diese Information ist nützlich, um zu wissen, ob ein Löser aktuell oder veraltet ist und aktualisiert werden muss.
...
Dies ist der erste Löser, der für die Arbeit mit dem FEM Arbeitsbereich integriert wurde. CalculiX ist vor allem für statische, thermo-mechanische und modale Analysen konzipiert. Weitere Informationen über diesen Löser findet man unter [FEM CalculiX](/FEM_CalculiX/de "FEM CalculiX/de").

### Elmer

Der Elmer-Multiphysics-Löser wurde als [Google-Summer-of-Code-2017](/Google_Summer_of_Code_2017 "Google Summer of Code 2017")-Projekt in FreeCAD integriert: [Hauptwebsite](https://www.csc.fi/web/elmer), [Gemeinschaftsportal](http://www.elmerfem.org./), [Code Repositorium](https://github.com/ElmerCSC/elmerfem), [Elmer Integration (GSoC) - Aktivitätsprotokoll](https://forum.freecadweb.org/viewtopic.php?f=18&t=22576) ( Forumsthema).
...
Diese Löser sind nicht in den Arbeitsbereich [FEM](/FEM_Workbench/de "FEM Workbench/de") integriert, d.h. sie benötigen eine separate Schnittstelle, um ein Simulationsprojekt zu erstellen. Dies wird durch [Makros](/Macros/de "Macros/de") oder [externe Arbeitsbereiche](/External_workbenches/de "External workbenches/de") erreicht.
...
DesignSPHysics kann über den [Addon-Manager](/Std_AddonMgr/de "Std AddonMgr/de") installiert werden.
...
Beide Arbeitsbereiche können über den [Addon-Manager](/Std_AddonMgr/de "Std AddonMgr/de") installiert werden, und beide haben einen Platz für Diskussionen im [CfdOF / CFD-Unterforum](https://forum.freecadweb.org/viewforum.php?f=37).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_Solver/de&oldid=1351075>"