...
Dieses Tutorium soll zeigen, wie eine einfache Finite-Elemente-Analyse (**FEA**) in FreeCADs Arbeitsbereich ![](/images/Workbench_FEM.svg)
[FEM](/FEM_Workbench/de "FEM Workbench/de") mit Python erstellt wird. Das Modell aus dem [FEM CalculiX Freiträger 3D](/FEM_CalculiX_Cantilever_3D/de "FEM CalculiX Cantilever 3D/de") Tutorium wird für dieses Beispiel verwendet.
...
* **Wichtiger Hinweis:** Aufgrund der kontinuierlichen Weiterentwicklung der ![](/images/Workbench_FEM.svg) [FEM Workbench](/FEM_Workbench/de "FEM Workbench/de") wird empfohlen, den neuesten Entwicklungs-Snapshot von FreeCAD zu verwenden, insbesondere für FEM-Analysen mit Python-Skripten.
* Eine funktionierende FEM-Workbench. Führe die [FEM CalculiX Cantilever 3D](/FEM_CalculiX_Cantilever_3D "FEM CalculiX Cantilever 3D")-Analyse aus, um dies festzustellen.
...
**Hinweis:** Lese den Abschnitt [Zusätzliche Informationen](#Additional_Information) weiter unten, um zu erfahren, wie du die Mesh-Generierung mit GMSH- oder Netgen-Mesh-Objekten schreibst.
...
1. Alle Prozesse gleichzeitig ausführen (siehe Abschnitt ["Alles in einem"](#Alles_in_einem) unten)
2. Prozesse nacheinander ausführen (siehe Abschnitt ["Schritt für Schritt"](#Schritt_für_Schritt) unten)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_Tutorial_Python/de&oldid=1523715>"