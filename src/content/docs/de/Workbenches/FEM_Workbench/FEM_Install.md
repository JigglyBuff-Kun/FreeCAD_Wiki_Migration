---
title: FEM Installation
---
## Einleitung

Um die Finite Element Analyse (FEA) innerhalb des ![](/images/Workbench_FEM.svg) [FEM Arbeitsbereichs](/FEM_Workbench/de "FEM Workbench/de") durchführen zu können, verwendet FreeCAD zwei externe Programme: eines wird für die Generierung des [FEM Netz](/FEM_Mesh/de "FEM Mesh/de") verwendet, das andere für die numerische Lösung der eigentlichen Analyse. Du kannst testen, ob dein FreeCAD Installation für die FEA bereit ist, indem du das [FEM CalculiX Kragarm 3D](/FEM_CalculiX_Cantilever_3D/de "FEM CalculiX Cantilever 3D/de") Beispiel ausführen, das in jeder Installation von FreeCAD seit v0.17 enthalten ist.
...
Wenn der Netzerzeuger installiert ist, stelle sicher, dass der FEM Arbeitsbereich in der Lage ist, die Binärdatei zu finden; gehe zu **Bearbeiten → Einstellungen → FEM → Gmsh → In bekannten Binärverzeichnissen suchen**. Wenn du den Löser selbst kompiliert hast, deaktiviere die Option, und gib den korrekten Pfad zur Binärdatei an. Siehe [FEM Polygonetz](/FEM_Mesh/de "FEM Mesh/de") für verschiedene Möglichkeiten, ein gültiges Netz für die Analyse zu erhalten.
...
Der [FEM Arbeitsbereich](/FEM_Workbench/de "FEM Workbench/de") befindet sich in ständiger Entwicklung. Die aktuellsten Informationen findest du im [FreeCAD Forum](https://forum.freecad.org/viewforum.php?f=18).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_Install/de&oldid=1552834>"