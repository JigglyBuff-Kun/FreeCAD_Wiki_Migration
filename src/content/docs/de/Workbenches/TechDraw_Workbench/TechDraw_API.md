---
title: TechDraw Anwendungs­programmier­schnittstelle
---

:::caution
(November 2018) Diese Information kann unvollständig und veraltet sein. Für die neueste API siehe dieautogenerierte API-Dokumentation.
:::

Diese Funktionen sind Teil des Arbeitsbereichs [TechDraw](/TechDraw_Workbench/de "TechDraw Workbench/de") und können in [Makros](/Macros/de "Macros/de") und von der [Python](/Python/de "Python/de")-Konsole aus verwendet werden, sobald das `TechDraw`-Modul importiert wurde.
...
Siehe die [TechDrawGui API](/TechDrawGui_API/de "TechDrawGui API/de") für weitere Funktionen.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=TechDraw_API/de&oldid=1298925>"
