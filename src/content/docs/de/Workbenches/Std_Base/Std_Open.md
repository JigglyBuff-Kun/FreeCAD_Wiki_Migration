...
| -                                                                                 |
| Siehe auch                                                                        |
| [Std Import](/Std_Import/de "Std Import/de"), [Std Neu](/Std_New/de "Std New/de") |
|                                                                                   |

## Beschreibung

Der Befehl **Std Öffnen** öffnet eine Datei. Wenn die Datei keine native FreeCAD-Datei (\*.FCStd) ist, wird die enthaltene Geometrie in ein neues Dokument importiert. Siehe [Std Import](/Std_Import/de "Std Import/de") für weitere Informationen.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_Open/de&oldid=1448577>"
