...
| - |
| Siehe auch |
| [Draft Herabstufen](/Draft_Downgrade/de "Draft Downgrade/de") |
|  |

## Beschreibung

Der ![](/images/Draft_Upgrade.svg) Der Befehl **Draft Hochstufen** (Aufrüsten) aktualisiert ausgewählte Objekte. Das Ergebnis ist abhängig von der Anzahl der ausgewählten Objekte und deren Typ. Der Befehl kann zum Beispiel Elemente verschmelzen und Flächen erzeugen. Es lohnt sich, eine Auswahl mehrmals zu aktualisieren, um zu sehen, ob ein besseres Ergebnis erzielt werden kann. Siehe das Beispiel im Bild. Beachte, dass nicht alle Objekte hochgestuft werden können. Dieser Befehl ist das Gegenstück zum Befehl [Draft Herabstufen](/Draft_Downgrade/de "Draft Downgrade/de") (Zurückstufen).
...
2. Es gibt mehrere Möglichkeiten, den Befehl aufzurufen:
   * Die Schaltfläche ![](/images/Draft_Upgrade.svg) Hochstufen drücken.
   * [Draft](/Draft_Workbench "Draft Workbench"): Den Menüeintrag **Änderung → ![](/images/Draft_Upgrade.svg) Hochstufen** auswählen.
   * [BIM](/BIM_Workbench "BIM Workbench"): Den Menüeintrag **Bearbeiten → ![](/images/Draft_Upgrade.svg) Hochstufen** auswählen.
...
* [Entwurf Linien](/Draft_Line/de "Draft Line/de") und [Entwurf Drähte](/Draft_Wire/de "Draft Wire/de") können mit diesem Befehl, aber auch mit dem Befehl [Entwurf Fügen](/Draft_Join/de "Draft Join/de") oder dem Befehl [Entwurf Draht](/Draft_Wire/de "Draft Wire/de") verbunden werden.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Upgrade/de&oldid=1500008>"