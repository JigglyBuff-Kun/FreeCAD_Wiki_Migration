...
Diese Funktionen sind Teil des [Draft-Arbeitsbereichs](/Draft_Workbench/de "Draft Workbench/de") und können in [Makros](/Macros/de "Macros/de") oder mit dem [Phyton](/Python/de "Python/de")-Interpreter verwendet werden, sobald der `Draft`-Arbeitsbereich importiert wurde.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_API/de&oldid=621883>"