---
title: FEM Beschränkung hinzufügen Tutorium
---
|  |
| --- |
| Tutorium |
...
In dieser Anleitung werden wir FreeCAD die Randbedingung Strömungsgeschwindigkeit hinzufügen und die Unterstützung für den Löser Elmer implementieren. Bitte stelle sicher, dass du [FEM-Modul erweitern](/Extend_FEM_Module/de "Extend FEM Module/de") gelesen und verstanden hast, bevor du diese Anleitung liest.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Add_FEM_Constraint_Tutorial/de&oldid=1264118>"