...
Men vi har också en python modul som tillåter komplett åtkomst till allt som hanterar av Coin3D, som vår FreeCAD scengraf. Så, läs vidare på [Pivy](/Pivy/sv "Pivy/sv").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scenegraph/sv&oldid=1207341>"