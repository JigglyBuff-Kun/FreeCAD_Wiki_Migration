...
På unix system, så är det möjligt att länka Coin3D's källk0dsdokumentation med FreeCAD's.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Source_documentation/sv&oldid=1072416>"