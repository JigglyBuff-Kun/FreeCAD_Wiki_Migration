...
Det var allt. Nu kan du försöka andra saker, som till exempel sätta in din widget i FreeCAD's gränssnitt (se [kodbitar](/Code_snippets/sv "Code snippets/sv") sidan), eller göra mycket mer avancerade verktyg, genom att använda andra element på din widget.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Dialog_creation/sv&oldid=1392702>"