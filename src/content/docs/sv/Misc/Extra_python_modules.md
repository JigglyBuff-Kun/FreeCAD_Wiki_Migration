...
Med början i Debian Squeeze och Ubuntu Lucid, så kommer pivy att finnas tillgängligt direkt från de officiella förråden, vilket sparar mycket krångel. Innan dess, så kan du antingen ladda ned ett av de paket som vi har gjort (för debian och ubuntu karmic) tillgängliga på [Nedladdningssidorna](/Download/sv "Download/sv"), eller så kan du kompilera det själv.
...
så ska du kontrollera miljövariablerna DISTUTILS\_USE\_SDK och MSSDK med
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Extra_python_modules/sv&oldid=1460931>"