...
Detta exempel använder sig av [Del Modulen](/Part_Workbench/sv "Part Workbench/sv") för att skapa en oktahedron, sedan skapas dess coin representation med pivy.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_objects/sv&oldid=1499136>"