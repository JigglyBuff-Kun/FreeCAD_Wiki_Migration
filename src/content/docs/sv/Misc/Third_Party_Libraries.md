...
Överväg att använda [LibPack](#LibPack/sv) istället för att ladda ned och installera alla saker själv.
...
Windows plattformen på [Nedladdningssidan](/Download/sv "Download/sv")! Om du arbetar under Linux så behöver du inte LibPack, istället ska du använda paketförråden för din Linux distribution.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Third_Party_Libraries/sv&oldid=1457085>"