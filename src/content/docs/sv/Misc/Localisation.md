...
title: Localisation
---
**Lokalisering** är i allmänhet den process som ger användargränssnittet i ett program flera språk. I FreeCAD så kan du ställa in användargränssnittets språk under *Redigera?Alternativ?Allmänt*. FreeCAD använder [[Qt](http://sv.wikipedia.org/wiki/Qt)] för att aktivera flerspråkssupport. På Unix/Linux system så använder FreeCAD som standard de gällande locale-inställningarna för systemet.
...
* Gå till [FreeCADs projektsida för översättning på Crowdin](http://crowdin.net/project/freecad);
...
Om du är osäker på hur du ska fortsätta, tveka inte att be om hjälp på [forumet](http://forum.freecadweb.org/).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Localisation/sv&oldid=1494358>"