...
Efterföljande rader definierar Config punkterna för din FooApp Applikation. En beskrivning av Config och dess punkter hittar du i [Uppstart och Konfiguration](/Start_up_and_Configuration/sv "Start up and Configuration/sv").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Branding/sv&oldid=1091265>"