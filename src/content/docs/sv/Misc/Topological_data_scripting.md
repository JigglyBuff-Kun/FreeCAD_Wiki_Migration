...
Här kommer vi att förklara hur du kontrollerar [Del Modulen](/Part_Workbench/sv "Part Workbench/sv") direkt från FreeCADs python tolk, eller från ett externt skript. Titta igenom [Skript](/Scripting/sv "Scripting/sv") avsnittet och [FreeCAD Skript grunder](/FreeCAD_Scripting_Basics/sv "FreeCAD Scripting Basics/sv") sidorna om du behöver mer information om hur python skript fungerar i FreeCAD.
...
Det sista steget är att sätta ihop den geometriska grundelementen
...
See the [Part API](/Part_API "Part API") page for a complete list of available methods of the Part module.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Topological_data_scripting/sv&oldid=1311599>"