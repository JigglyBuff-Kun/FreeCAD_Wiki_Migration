...
* Innan du skickar något, läs [ofta ställda frågor](/index.php?title=Frequently_asked_questions/sv&action=edit&redlink=1 "Frequently asked questions/sv (page does not exist)"), gör en sökning på [forumet](http://forum.freecadweb.org/), och försäkra dig om att buggen inte har rapporterats innan , genom att söka i bug trackern.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Tracker/sv&oldid=1328545>"