...
- ![Dockad till höger,](/images/Macro_FCInfo_04.png)

  Dockad till höger,

- ![eller vänster med kombinationsvy och nås med en flik, eller inte dockad till valet.](/images/Macro_FCInfo_05.png)
...
- ![Förståelse av vinklar i FCInfo-displayen](/images/Macro_FCInfo_02.png)

  Förståelse av vinklar i FCInfo-displayen

- [![Förståelse av vinklar i poucent i FCInfo-skärm klicka två gånger för att se animationen (bilden måste vara i helskärm)](/images/Macro_FCInfo_03.gif)](/File:Macro_FCInfo_03.gif  "Förståelse av vinklar i poucent i FCInfo-skärm klicka två gånger för att se animationen (bilden måste vara i helskärm)")

  Förståelse av vinklar i poucent i FCInfo-skärm  
...
Ladda ner bildpositionering på ikonen ![](/images/FCInfo.png) ![](/images/FCInfoSpreadsheet.png) och dra sedan musen med högerklicka "spara som" (ändra inte namnet)
...
[senaste versionen Macro_FCInfo och ikonerna i slutet av sidan](https://gist.github.com/mario52a/8d40ab6c018c2bde678f)
...
- ver 1.11, 04/03/2014 Lägga till μm, nm, pm, fm, μg, ng, pg, hällande, fast av storhet karat "cd" i _'"ct" , visning av etiketten och internt namn, fast beräkning av vinklar XY YZ ZX kan ge ett fel på en sammansatt form, fönstret dockbart i FreeCAD_
...
I en Linux-distribution och i händelse av ett fel på ordinär inte inom intervallet (128) finns det en alternativ version på den här sidan [Macro_FCInfo_Alternate_Linux](/index.php?title=Macro_FCInfo_Alternate_Linux/sv&action=edit&redlink=1 "Macro FCInfo Alternate Linux/sv (page does not exist)")
...
Se även [Arch Survey](/Arch_Survey/sv "Arch Survey/sv") ![Arch Survey](/images/Arch_Survey.png)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCInfo/sv&oldid=1538276>"
