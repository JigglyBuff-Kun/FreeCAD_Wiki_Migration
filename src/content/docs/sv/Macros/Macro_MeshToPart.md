---
title: Konvertera Nät till Delar
---
|  |
| --- |
| MeshToPart |
| Beskrivning |
| Detta makro omvandlar utvalda maskor till delar. Den har en bred tolerans, så använd den bara med föremål som inte har några kurvor annars får du konstiga resultat.  Versions makro : 1.0 Datum senaste ändring : 2011-08-01 FreeCAD-versionen : All Ladda ner : [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/fa/Macro_MeshToPart.png) Författare : Wmayer |
| Författare |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_MeshToPart/sv&oldid=692385>"