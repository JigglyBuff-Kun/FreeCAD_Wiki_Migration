...
* Data**X** (`Distance`): specifies the X coordinate of the point.
* Data**Y** (`Distance`): specifies the Y coordinate of the point.
* Data**Z** (`Distance`): specifies the Z coordinate of the point.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Point/sv&oldid=1513444>"