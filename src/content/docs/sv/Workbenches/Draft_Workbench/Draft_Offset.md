...
| - |
| Se även |
| [Part 2D Offset](/index.php?title=Part_Offset2D/sv&action=edit&redlink=1 "Part Offset2D/sv (page does not exist)") |
|  |
...
* Nedtryckning av SKIFT kommer att [begränsa](/Draft_Constrain/sv "Draft Constrain/sv") dig till det nuvarande segmentet, iställed för att markera det närmaste.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Offset/sv&oldid=1473148>"