...
| - |
| Se även |
| [Draft Arc](/Draft_Arc/sv "Draft Arc/sv") |
|  |
...
* Nedtryckning av SKIFT [begränsar](/Draft_Constrain/sv "Draft Constrain/sv") din nya punkt i relation till föregående punkt.
...
* Vy**Pattern** (`Enumeration`): specifies the [Draft Pattern](/Draft_Pattern "Draft Pattern") with which to fill the face of the circle. This property only works if Data**Make Face** is `true` and if Vy**Display Mode** is `Flat Lines`.
...
Den skapade cirkeln är ett [Del](/Part_Workbench/sv "Part Workbench/sv") föremå som innehåller en kant med endast ett hörn.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Circle/sv&oldid=1472919>"