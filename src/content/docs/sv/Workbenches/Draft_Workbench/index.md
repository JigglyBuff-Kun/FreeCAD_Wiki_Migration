...
- ![](/images/Draft_ToggleDisplayMode.svg) [Toggle normal/wireframe display](/Draft_ToggleDisplayMode "Draft ToggleDisplayMode"): switches the Vy**Display Mode** property of selected objects between `Flat Lines` and `Wireframe`.
...
- [Snäpp](/Draft_Snap/sv "Draft Snap/sv"): tillåter dig att placera nya punkter på speciella platser på existerande objekt

- [Begränsning](/Draft_Constrain/sv "Draft Constrain/sv"): Tillåter att nya punkter placeras horisontellt eller vertikalt i relation till tidigare punkter

- [Konstruktionsläge](/Draft_ToggleConstructionMode/sv "Draft ToggleConstructionMode/sv"): Tillåter dig att skilja viss geometri åt från resten, för att lätt kunna stänga på/av

- [Arbetsplan](/Draft_SelectPlane/sv "Draft SelectPlane/sv"): Alla skisskommandon kan användas på valfritt plani i 3D rymden. Det gällande arbetsplanet kan konfigureras på ett lätt sätt
...
- ![](/images/Draft_SelectPlane.svg) [Write camera position](/Draft_WorkingPlaneProxy#Context_menu "Draft WorkingPlaneProxy"): updates the Vy**View Data** property of the working plane proxy with the current [3D view](/3D_view "3D view") camera settings.

- ![](/images/Draft_SelectPlane.svg) [Write objects state](/Draft_WorkingPlaneProxy#Context_menu "Draft WorkingPlaneProxy"): updates the Vy**Visibility Map** property of the working plane proxy with the current visibility state of objects in the document.
...
- [Autodesk .DXF](/Draft_DXF/sv "Draft DXF/sv"): Importerar och exporterar DXF filer som har skapats med andra CAD applikationer

- [SVG (som geometri)](/Draft_SVG/sv "Draft SVG/sv"): Importerar och exporterar SVG filer som har skapats med vektorbaserade ritapplikationer

- [Open Cad format .OCA](/Draft_OCA/sv "Draft OCA/sv"): Importerar och exporterar OCA/GCAD files, ett potentiellt nytt [öppet CAD filformat](http://groups.google.com/group/open_cad_format)

- [Airfoil Data Format .DAT](/Draft_DAT "Draft DAT") Importerar DAT filer som beskriver [Vingprofiler](http://www.ae.illinois.edu/m-selig/ads/coord_database.html)
...
Se [Skiss API](/Draft_API/sv "Draft API/sv") sidan för en komplett beskrivning av Skissfunktionerna som du kan använda i skript och makron
...
- [Draft tutorial](/Draft_tutorial/sv "Draft tutorial/sv")
- [Draft ShapeString tutorial](/Draft_ShapeString_tutorial "Draft ShapeString tutorial")

Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Workbench/sv&oldid=1547521>"
