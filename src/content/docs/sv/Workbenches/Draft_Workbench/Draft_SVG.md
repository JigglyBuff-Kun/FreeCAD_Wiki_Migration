...
Följande parametrar kan specificeras i [Skissalternativ](/Draft_Preferences/sv "Draft Preferences/sv") tabben (meny Redigera -> Alternativ -> Draft):
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_SVG/sv&oldid=1422561>"