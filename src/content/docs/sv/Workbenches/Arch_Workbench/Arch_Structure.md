...
| - |
| Se även |
| [Arch Wall](/Arch_Wall/sv "Arch Wall/sv") [Arch Rebar/sv](/Arch_Rebar/sv "Arch Rebar/sv") |
|  |
...
* Vy**Nodes Type**: The type of structural nodes of this object, linear or area.
* Vy**Show Nodes**: Shows or hides the structural nodes.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Structure/sv&oldid=1539775>"