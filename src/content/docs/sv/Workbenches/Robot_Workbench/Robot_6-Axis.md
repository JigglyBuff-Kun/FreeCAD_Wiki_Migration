...
Beskrivningen följer [Denavit-Hartenberg Parameter](http://en.wikipedia.org/wiki/Denavit-Hartenberg_Parameters) systemet, som även beskrivs i John J. Craigs bok "Introduction to Robotics".
...
Eftersom Kuka robotarna inte har alla axlar i 0 i den ritade L-Positionen, så behöver vi ändra
axel 2 & 3 med 90°.
...
FreeCAD kan generera en grov bild ur kinematiktabellen. Men om du vill komma närmare
verkligheten så kan du använda en VRML fil med robotens utseende för simuleringen.
T.ex. [Kuka](http://kuka.com) handhar VRML filer för sina modeller.
...
Detta visas återigen med exemplet Kuka KR 16.
...
Kommentera bort **TimeSensor** och de 6 rutterna. Dessa 6 rader ger dig ett tips på var robotens axlar är någonstans!
Sök först efter "AXIS\_04\_OBJ" som tar dig till den platsen:
...
Du måste precis innan definitionen av denna nod sätta in raden **"DEF FREECAD\_AXIS1 Transform { rotation 0 1 0 0 children ["** vilket är FreeCADs ankare för att förflytta axeln.

Gör nu detsamma för **FREECAD\_AXIS2**,**FREECAD\_AXIS3**,**FREECAD\_AXIS4**,**FREECAD\_AXIS5** och **FREECAD\_AXIS6**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Robot_6-Axis/sv&oldid=1251454>"