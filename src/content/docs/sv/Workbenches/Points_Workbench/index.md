...
- ![](/images/Points_Import_Point_cloud.svg) [Import Point Cloud](/index.php?title=Points_Import/sv&action=edit&redlink=1 "Points Import/sv (page does not exist)"): will import coordinates for 3D-points from a text file
- ![](/images/Points_Export_Point_cloud.svg) [Export Point Cloud](/index.php?title=Points_Export/sv&action=edit&redlink=1 "Points Export/sv (page does not exist)"): will export coordinates for 3D-points to a text file
- ![](/images/PolygonPick.svg) Polygon Pick: to do
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Points_Workbench/sv&oldid=1332297>"
