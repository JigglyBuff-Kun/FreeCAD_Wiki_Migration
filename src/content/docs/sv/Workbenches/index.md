...
FreeCAD, som många moderna design applikationer som [Revit](http://en.wikipedia.org/wiki/Revit "wikipedia:Revit"), är baserade på konceptet [Arbetsbänk](http://en.wikipedia.org/wiki/Workbench "wikipedia:Workbench"). En arbetsbänk kan anses vara ett set verktyg, grupperade för en viss uppgift. I en traditionell möbelverkstad, så skulle du ha ett arbetsbord för den person som arbetar med trä, ett annat bord för den som arbetar med metalldelar, och kanske ett tredje för den som monterar ihop allting.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Workbenches/sv&oldid=1540520>"
