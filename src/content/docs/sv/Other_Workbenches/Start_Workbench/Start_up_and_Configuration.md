...
Dessa konfigurationspunkter är relaterade till FreeCADs märkningsmekanism. Se [Branding/sv](/Branding/sv "Branding/sv") för mer detaljer.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Start_up_and_Configuration/sv&oldid=1501140>"