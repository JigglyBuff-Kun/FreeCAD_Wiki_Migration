...
This article describes the **Branding** of FreeCAD. Branding means to create your own application based on FreeCAD. That can be only your own executable or [splash screen](/Splash_screen "Splash screen") till a complete reworked program. On base of the flexible architecture of FreeCAD it's easy to use it as base for your own special purpose program.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Branding/hr&oldid=1091260>"