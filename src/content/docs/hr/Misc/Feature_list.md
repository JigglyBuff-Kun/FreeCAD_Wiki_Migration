...
Ovo je opsežan, ali ne potpun popis značajki koje FreeCAD provodi. Ako želite pogledati u budućnost, pogledajte [Razvojni plan](/Development_roadmap "Development roadmap") za brzi pregled onoga što slijedi. Također su [Screenshots](/Screenshots "Screenshots") lijepo mjesto za pogledati.
...
Napredni korisnici stvorili su razne prilagođene [vanjske radne površine](/index.php?title=External_workbenches/hr&action=edit&redlink=1 "External workbenches/hr (page does not exist)").

Retrieved from "<http://wiki.freecad.org/index.php?title=Feature_list/hr&oldid=1456941>"
