---
title: Pomozite FreeCAD-u
---
## Introduction

Ako volite FreeCAD i ako želite možete pomoći u razvoju FreeCAD-a osim [direktne donacije](/index.php?title=Donate/hr&action=edit&redlink=1 "Donate/hr (page does not exist)"), postoji i više mogućnosti kako to možete ostvariti, čak i ako niste programer.
...
Pomozi u stvaranju, ispravci i proširenju dokumentacije. Ispravi greške, proširi ili korigiraj stranice koje su nejasne, napravi nove stranice ako nedostaju. Suradnja u FreeCAD wiki je jednostavna, na [Wiki Stranice](/index.php?title=WikiPages/hr&action=edit&redlink=1 "WikiPages/hr (page does not exist)") možeš naći osnovne upute i pomoć koja je potrebna za poćetak. Za uređivanje wiki stranice potrebno je se prijavi
sa dozvolom za uređivanje. Možeš poslati upit na [on the forum](http://forum.freecadweb.org/viewtopic.php?f=21&t=6830) ili na [IRC channel](irc://irc.freenode.net/freecad). Zabilježite, IRC kanal podrška je manja nego na forumu.

Par područja koja bi pozdravila vaš rad:

* Na stranici [Category:Command Reference/hr](/Category:Command_Reference/hr "Category:Command Reference/hr") su popisane i dokumentirane sve FreeCAD [naredbes](/index.php?title=Command/hr&action=edit&redlink=1 "Command/hr (page does not exist)"). Većina ih sadrži malo ili nimalo informacija. Molimo pogledajte [Wiki stranice](/index.php?title=WikiPages/hr&action=edit&redlink=1 "WikiPages/hr (page does not exist)") za dobre primjere kako trebaju izgledati stranice naredbene dokumentacije.
* U odjeljku [Vježbe](/Tutorials/hr "Tutorials/hr") potrebni su primjeri kako koristiti radne površine. Ako ste razvili nešto super s FreeCAD-om, zašto ne dokumentirati kako ste to učinili za potomstvo?
* Na FreeCAD [bugtracker](/index.php?title=Tracker/hr&action=edit&redlink=1 "Tracker/hr (page does not exist)") postoje otvorene karte s oznakom ["dokumentacija"](https://freecadweb.org/tracker/search.php?tag_string=documentation) koje bi mogli koristiti sa ljubavlju za stvaranjem uputstava.
...
* Snimanje [videozapisa](http://www.youtube.com/user/FreeCADNews) koji prikazuje kako ste napravili nešto zanimljivo u FreeCAD-u. Ovi videozapisi obično obavljaju sjajan posao u prikazivanju novih značajki.
* Napišite [tutorials](http://freecad-tutorial.blogspot.com/) opisujući ili podučavajući nešto zanimljivo. Vježbe možete pisati na vlastitom blogu, izravno na našem wikiju, ili čak na forumu.
...
Za detalje prevođenja pogledaj [Localisation](/Localisation/hr "Localisation/hr").
...
Pojedinosti o prijevodu potražite u [Localisation/hr#Prevedite\_FreeCAD\_dokumentacija](/Localisation/hr#Prevedite_FreeCAD_dokumentacija "Localisation/hr").

Molimo vas budite sigurni da ste upoznati s osnovama wiki markiranja; pogledajte [Pomoć:Uređivanje](/Help:Editing "Help:Editing") za referencu.

Zatim idite na [WikiPages](/WikiPages "WikiPages") da se upoznate sa stilom koji se koristi u ovom wikiju, posebno kada je riječ o predlošcima.
...
Iako je mjesto za prijavljivanje potvrđenih grešaka i sugeriranje novih značajki na kraju **[FreeCAD Tracker](/Tracker "Tracker")**, uvijek najprije objavite izvještaje o pogreškama i zahtjeve za značajke na forumu za pomoć. Kako biste uštedjeli vrijeme programerima (pokretanje rješavanja problema s greškama može dugo trajati) i izbjeći frustracije jer vaš problem nije riješen onako kako biste željeli, pročitajte sljedeće:
...
* Bez obzira koliko ste sigurni da ste pronašli grešku, uvijek prvo razgovarajte o pogreškama na [forumu pomoći](http://forum.freecadweb.org/viewforum.php?f=3).
* Prije nego što pošaljete zahtjev za značajkom, uvijek prvo razgovarajte s drugim korisnicima na [Otvorenom forumu za raspravu](http://forum.freecadweb.org/viewforum.php?f=8) kako biste mogli završiti sa odlučnijim prijedlogom, s više šansi zainteresirati programera da ga implementira.
...
Pogledajte [Umetničko djelo](/Artwork "Artwork") stranicu za upute o dizajniranju ikona za FreeCAD.

### Program!

Kod za pisanje za FreeCAD nije težak i ne trebate nikakvo dopuštenje, odmah možete početi raditi na nečemu što želite, a zatim pošaljite zakrpu na [tracker](http://www.freecadweb.org/tracker) ili zatražite spajanje iz [git podružnice](https://github.com/FreeCAD). Da biste izbjegli glavobolju, prvo trebate ispuniti sljedeće preduvjete:

* FreeCAD ide svojim tempom i ima vrlo mali tim programera. Nemamo toliko vremena koliko bismo željeli posvetiti FreeCAD-u, a stvari se ne planiraju unaprijed; gotovi su kad neki programer smatra da to odgovara i kada nađe vremena za to. Stoga ne održavamo popis zadataka koje je potrebno obaviti. Na vama je samo da pronađete nešto što biste željeli učiniti, na primjer, nedostatak koji želite ispraviti ili malu značajku za koju mislite da nedostaje. [tracker](Http://www.freecadweb.org/tracker) također sadrži neke stavke koje još uvijek nisu dodijeljene nikome.
...
* Gotovo sve se može učiniti bilo u Pythonu ili C ++. Interni podaci rade gotovo isto u oba jezika. Predlažemo da pročitate stranice [Power users hub](/Power_users_hub "Power users hub"), čak i ako idete kodirati u C ++, jer će vam pružiti dobar pregled internih podataka.
* Ako ćete raditi na C ++, prvo provjerite da li možete bez problema sastaviti FreeCAD.
* Predstavite se drugim programerima. FreeCAD je prije nego što je išta društveni projekt, o njemu ćemo raspravljati o mnogim stvarima na [forumu](http://forum.freecadweb.org) prije nego što ga implementiramo i uvijek je najbolje razgovarati o svojim idejama i reći ljudima što planirate učiniti prije zapravo to radim. Imamo i [irc: //chat.freenode.net/freecad IRC kanal], ali forum je jedino mjesto na kojem možete upoznati sve programere.
* Od 2016. godine FreeCAD također sudjeluje u  [Google Summer of Code](/Google_Summer_of_Code "Google Summer of Code"). Svakako provjerite naše ideje tamo ako ste zainteresirani za sudjelovanje u sljedećem izdanju.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Help_FreeCAD/hr&oldid=1559228>"