...
| Presjek                                                                                                                                                                                                                                                                                                                              |
| Opis                                                                                                                                                                                                                                                                                                                                 |
| Makro za prikaz presjeka objekata u sceni: ravnina poprečnog presjeka može se pomicati pomoću klizne trake. Makronaredba verzije : 0.09 Datum zadnje izmjene : 2019-08-31 Verzija FreeCAD : 0.15 and above Preuzimanje datoteka : [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f5/Macro_cross_section.png) Autor : aleph0 |
| Autor                                                                                                                                                                                                                                                                                                                                |
...
Pogledajte dolje desno: "Zadrži presjek"
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_cross_section/hr&oldid=825575>"
