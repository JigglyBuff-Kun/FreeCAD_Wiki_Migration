...
| Odjeljak                                                                                                                                                                                                                                                                                                                                                         |
| Opis                                                                                                                                                                                                                                                                                                                                                             |
| Alternativna provedba [Part Section](/index.php?title=Part_Section/hr&action=edit&redlink=1 "Part Section/hr (page does not exist)") alat (parametarski) Makronaredba verzije : 1.1 Datum zadnje izmjene : 2018-04-28 Verzija FreeCAD : All Preuzimanje datoteka : [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f7/Part_Section.svg) Autor : DeepSOIC |
| Autor                                                                                                                                                                                                                                                                                                                                                            |
...
[Part Section](/index.php?title=Part_Section/hr&action=edit&redlink=1 "Part Section/hr (page does not exist)") alat proizvodi rubove s kontinuitetom C0 i velikim brojem segmenata (čvorova), što nije baš prikladno kao[Sweep](/index.php?title=Part_Sweep/hr&action=edit&redlink=1 "Part Sweep/hr (page does not exist)") staza.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Section/hr&oldid=692503>"
