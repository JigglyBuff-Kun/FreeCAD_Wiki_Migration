...
| Description                                                                                                                                                                                                                                                                                             |
| Ovaj makro prikazuje sve elemente ispod pokazivača (prikazat će se i svi elementi koje pokrivaju drugi elementi). Macro version: 01.00 Last modified: 2016-12-26 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/07/Macro_FC_element_selector.png) Author: HoWil |
| Author                                                                                                                                                                                                                                                                                                  |
...
| _None_                                                                                                                                                                                                                                                                                                  |
| See also                                                                                                                                                                                                                                                                                                |
| [Macro Mouse over cb](/Macro_Mouse_over_cb/hr "Macro Mouse over cb/hr")                                                                                                                                                                                                                                 |
|                                                                                                                                                                                                                                                                                                         |
|                                                                                                                                                                                                                                                                                                         |
...
Drugi slični makro [Macro Mouse over cb](/Macro_Mouse_over_cb/hr "Macro Mouse over cb/hr")

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FC_element_selector/hr&oldid=1182405>"
