...
title: Vježbe
---
Ova stranica predstavlja izbornik napisanih vježbi visoke kvalitete koja još nije gotova, nesortirana lista vježbi se može ovdje naći [Upute](/Category:Tutorials/hr "Category:Tutorials/hr").

Vi možete pogledati na [Vanjske Upute](/index.php?title=Offsite_tutorials/hr&action=edit&redlink=1 "Offsite tutorials/hr (page does not exist)")  i [Video Upute](/Video_tutorials/hr "Video tutorials/hr") koji su linkovi na vanjske web stranice.
Koristan izvor video vježbi je na [YouTube](https://YouTube.com),upišite *FreeCAD* u tražilicu.
...
* [![Robot tutorial/hr Robot simulacija pokretanja.](/images/Robot_Tutorial_RobotSimulation.gif)](/Robot_tutorial "Robot tutorial/hr Robot simulacija pokretanja. ")

  [Robot tutorial/hr](/index.php?title=Robot_tutorial/hr&action=edit&redlink=1 "Robot tutorial/hr (page does not exist)")   
  Robot simulacija pokretanja.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Tutorials/hr&oldid=1538586>"