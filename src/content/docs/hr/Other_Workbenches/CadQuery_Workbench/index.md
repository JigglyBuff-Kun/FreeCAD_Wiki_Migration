...
:::caution
(January 2021)The active development of CadQuery has moved away from FreeCAD[1], offering now a stand-alone GUI with the CQ-editor[2].
The CadQuery workbench isno longer actively maintained, but may receive sporadic fixes by its author.
:::
...
Retrieved from "<http://wiki.freecad.org/index.php?title=CadQuery_Workbench/hr&oldid=1289732>"