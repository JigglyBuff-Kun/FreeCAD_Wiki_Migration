...
| **Fill** | Shortcut to toggle filled mode. If filled mode is on, the created object will have Podaci**Make Face** set to `true`. |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Preferences/hr&oldid=1520955>"