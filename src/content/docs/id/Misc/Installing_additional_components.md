...
## Pilih Sistem Operasi di komputermu
...
| [Install on Windows](/Install_on_Windows "Install on Windows") | [Install on Linux](/Install_on_Linux "Install on Linux") | [Install on Mac](/Install_on_Mac "Install on Mac") |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Installing_additional_components/id&oldid=1476444>"