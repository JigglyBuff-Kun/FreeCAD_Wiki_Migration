---
title: Skrypty w Środowisku Kreślenie
---
## Introduction

The graphical user interface workflow for the [Drawing Workbench](/Drawing_Workbench "Drawing Workbench") is limited, so the scripting API is more interesting.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Drawing_API_example/pl&oldid=891729>"