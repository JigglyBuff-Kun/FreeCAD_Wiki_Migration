---
title: Elektromagnetyka Port FastHenry
---
...
- DANE**NodePos**: the positive [FHNode](/EM_FHNode "EM FHNode") of the FastHenry port
- DANE**NodeNeg**: the negative [FHNode](/EM_FHNode "EM FHNode") of the FastHenry port
...
Retrieved from "<http://wiki.freecad.org/index.php?title=EM_FHPort/pl&oldid=1080009>"
