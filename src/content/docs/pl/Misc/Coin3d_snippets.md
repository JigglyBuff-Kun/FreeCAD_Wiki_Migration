...
Użytkownicy mogą uruchamiać te skrypty jako [makrodefinicje](/Macros "Macros") lub bezpośrednio w [Konsoli Python](/Python_console/pl "Python console/pl"). Zwróć uwagę, że wiele funkcji ma w nazwie "Exe" lub "Execu", skrót od "Execute".
...
3. Ogólnie rzecz biorąc, COIN3D nie zapewnia dobrych prymitywnych rysunków. System widżetów Design456 zapewnia kilka: kilka podstawowych kształtów, a także kilka złożonych kształtów. Widżet strzałki i widżet linii używane przez środowisko pracy [Design456](/index.php?title=Design456_Workbench/pl&action=edit&redlink=1 "Design456 Workbench/pl (page does not exist)") są przykładami.

Retrieved from "<http://wiki.freecad.org/index.php?title=Coin3d_snippets/pl&oldid=1330873>"