---
title: Konwerter Podręcznika FreeCAD
---
|  |
| --- |
| [Generic macro icon. Create your personal icon with the same name of the macro](/File:Text-x-python.png "Generic macro icon. Create your personal icon with the same name of the macro")  Makrodefinicja: Konwerter Podręcznika FreeCAD |
| Opis |
| Skrypt Pythona, który automatycznie generuje wersje PDF i EPUB Podręcznika FreeCAD.  Macro version: 0.1 Last modified: 2024-12-16 FreeCAD version: Wszystkie Autor: Adrianos |
| Autor |
...
* **FreeCAD\_User\_Manual.pdf**: Kompletna wersja PDF podręcznika
* **FreeCAD\_User\_Manual.epub**: Wersja EPUB odpowiednia dla czytników e-booków
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD_Manual_Converter/pl&oldid=1537732>"