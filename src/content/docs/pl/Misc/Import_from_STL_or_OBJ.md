---
title: Importowanie plików STL lub OBJ
---
|  |
| --- |
| Ćwiczenie |
...
* Dodaj torus przez  Meshes → ![](/images/Mesh_BuildRegularSolid.svg) Regular solid... wybierają opcje:
  + Radius1: 10mm
  + Radius2: 2mm
  + Sampling: 50
...
* wybranie Meshes → ![](/images/Mesh_HarmonizeNormals.svg) Harmonize normals z górnego menu.
...
* wybierz obiekt mesh w drzewie widoku
* Wybierz  Meshes → ![](/images/Mesh_FillInteractiveHole.svg) Close hole z głównego menu
...
* przejdź do ![](/images/Workbench_Part.svg) [Środowiska roboczego Part](/Part_Workbench/pl "Part Workbench/pl"),
* upewnij się, że obiekt siatki jest zaznaczony w widoku drzewa, w przeciwnym razie zaznacz go,
* wybierz opcję Part → ![](/images/Part_ShapeFromMesh.svg) Utwórz kształt siatki ... z menu u góry,
...
* wybierz opcję  Part → Create a copy → ![](/images/Part_RefineShape.svg) Refine shape z menu u góry.
...
* [Eksport do formatu STL or OBJ](/Export_to_STL_or_OBJ "Export to STL or OBJ")
* [Import i eksport](/Import_Export/pl "Import Export/pl")

Retrieved from "<http://wiki.freecad.org/index.php?title=Import_from_STL_or_OBJ/pl&oldid=819771>"