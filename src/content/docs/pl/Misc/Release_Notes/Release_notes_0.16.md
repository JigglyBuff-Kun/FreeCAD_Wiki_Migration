...
- New tools for joining walled objects (e.g., pipes): [Connect](/Part_JoinConnect "Part JoinConnect"), [Embed](/Part_JoinEmbed "Part JoinEmbed") and [Cutout](/Part_JoinCutout "Part JoinCutout")
- New feature: make face from a sketch (parametric)

## Part Design & Sketcher Workbench

- New Feature: Toggle Mode for [Toggle reference/driving constraints](/Sketcher_ToggleDrivingConstraint "Sketcher ToggleDrivingConstraint")
...
- Support for [expressions/formulas](/Expressions "Expressions") in constraints and properties
...
- **GMSH Macro** An interesting external developing is the [Macro_GMSH](/Macro_GMSH "Macro GMSH") which makes it possible to use GMSH for meshing. Very useful for all not able to compile FreeCAD with Netgen or for meshing shell- or edge meshes.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Release_notes_0.16/pl&oldid=1121992>"
