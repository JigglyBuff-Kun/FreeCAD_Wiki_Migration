---
title: Instalacja w systemie Mac OS
---
FreeCAD można zainstalować na systemie MacOS jako pakiet .dmg, który może zostać przeciągnięty do folderu Aplikacje, zobacz stronę [Pobieranie](/Download/pl "Download/pl").
...
Po zainstalowaniu, możesz przejść do podręcznika [Jak zacząć](/Getting_started/pl "Getting started/pl")!

## Łatwa instalacja

Instalator FreeCAD jest dostarczany jako pakiet aplikacji (.app), umieszczony w pliku obrazu dysku.

Najnowszy instalator można pobrać ze strony [Download](/Download/pl "Download/pl"). Po pobraniu pliku wystarczy zamontować obraz dysku, a następnie przeciągnąć go do wybranego folderu dla tej aplikacji.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Installing_on_Mac/pl&oldid=1484389>"