...
**Polecenie** to czynność wykonywana po naciśnięciu przycisku na pasku narzędzi lub wpisaniu skrótu klawiaturowego. Może to być bardzo prosta czynność, jak zmiana stopnia powiększenia [widoku 3D](/3D_view/pl "3D view/pl") lub obrót punktu widzenia, albo złożony system, który będzie otwierał okna dialogowe i czekał na wykonanie przez użytkownika określonych zadań.

Każde polecenie FreeCAD ma unikalną nazwę, która pojawia się na stronie [:Category:Command Reference](/Category:Command_Reference "Category:Command Reference"). Polecenia mogą być uruchamiane za pomocą przycisku paska narzędzi, pozycji menu lub ze skryptu [Python](/Python/pl "Python/pl") lub [konsoli Python](/Python_console/pl "Python console/pl"), poprzez uruchomienie:
...
Zobacz stronę [Funkcja rysowania linii](/Line_drawing_function/pl "Line drawing function/pl").

Retrieved from "<http://wiki.freecad.org/index.php?title=Command/pl&oldid=1325880>"