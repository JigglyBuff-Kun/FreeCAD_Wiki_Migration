---
title: Zawijanie klasy C++ w środowisku Python
---
:::caution
...
Plik XML `[YourClass]Py.xml` zawiera informacje o funkcjach i atrybutach, które implementuje klasa Python, a także dokumentację użytkownika dla tych elementów, która wyświetla się w [konsoli FreeCAD](/Python_console/pl "Python console/pl").
...
* [Udostępnianie Cplusplus w środowisku Python](/Exposing_Cplusplus_to_Python "Exposing Cplusplus to Python")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Wrapping_a_Cplusplus_class_in_Python/pl&oldid=1319957>"