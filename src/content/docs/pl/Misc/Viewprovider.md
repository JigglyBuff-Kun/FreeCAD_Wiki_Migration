---
title: Dostawca widoku
---
## Wprowadzenie

Dostawcy widoku to klasy, które definiują sposób, w jaki obiekty będą wyglądać w oknie [widoku drzewa](/Tree_view/pl "Tree view/pl") i [widoku 3D](/3D_view/pl "3D view/pl"), oraz jak będą współdziałać z niektórymi akcjami graficznymi, takimi jak [zaznaczanie](/Selection_methods/pl "Selection methods/pl") obiektów.

Uzupełniają one [obiekty tworzone skryptami](/Scripted_objects/pl "Scripted objects/pl"). Podczas gdy klasa bazowa obiektu skryptowego definiuje jego [właściwości](/Property/pl "Property/pl") *dane*, viewprovider definiuje jego [właściwości](/Property/pl "Property/pl") *widok*. Te właściwości widoku nie są istotnymi informacjami o obiekcie, ponieważ wskazują tylko powierzchowne informacje, takie jak szerokość linii, kolor linii, kolor powierzchni itp. W sesji terminalowej dostawca widoku nie jest ładowany, ponieważ nie będzie interfejsu do manipulowania tymi widocznymi właściwościami.

Podobnie jak w przypadku właściwości danych, właściwości widoku są dostępne z poziomu [edytora własciwości](/Property_editor/pl "Property editor/pl").
...
Implementując metodę `getIcon`, można zdefiniować ikonkę, która będzie wyświetlana w [widok drzewa](/Tree_view/pl "Tree view/pl") w górnej części [widoku połączonego](/Combo_view/pl "Combo view/pl").
...
Zobacz różne przykłady na stronie [Własna ikona w widoku drzewa](/Custom_icon_in_tree_view/pl "Custom icon in tree view/pl").

Retrieved from "<http://wiki.freecad.org/index.php?title=Viewprovider/pl&oldid=1358604>"