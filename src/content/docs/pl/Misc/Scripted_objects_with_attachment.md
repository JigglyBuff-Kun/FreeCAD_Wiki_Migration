---
title: Obiekty tworzone skryptami, z dołączeniem
---
## Wprowadzenie

Celem tej strony jest pokazanie podstawowego przykładu zastosowania funkcji [Dołączenie](/Part_EditAttachment/pl "Part EditAttachment/pl") środowiska Część, przy wykorzystaniu [obiektów tworzonych skryptami](/Scripted_objects/pl "Scripted objects/pl") w środowisku Python.

Zobacz [pełny i kompletny minimalny przykład](#Full_and_Complete_Minimal_Example) poniżej.
...
* [Część: Edycja dołączenia](/Part_EditAttachment/pl "Part EditAttachment/pl")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_objects_with_attachment/pl&oldid=1491237>"