---
title: Skrypty części Łożysko kulkowe - część 1
---
...
Aby wykonać zeszkolony fragment z przekręconymi szkicami, przejrzyj samouczek [Skrypty części: Łożysko kulkowe - część 2](/Scripted_Parts:_Ball_Bearing_-_Part_2/pl "Scripted Parts: Ball Bearing - Part 2/pl").
...
[Skrypty danych topologicznych](/Topological_data_scripting/pl "Topological data scripting/pl"): Samouczek odsłaniający podstawy tworzenia skryptów  
[Skrypty części: Łożysko kulkowe - część 2](/Scripted_Parts:_Ball_Bearing_-_Part_2/pl "Scripted Parts: Ball Bearing - Part 2/pl"): Wykonanie za pomocą szkiców  
[Bearing Script 1](http://linuxforanengineer.blogspot.de/2013/08/free-cad-bearing-script.html): Baza dla tego poradnika, podziękowania dla JMG ...
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_Parts:_Ball_Bearing_-_Part_1/pl&oldid=1384975>"
