...
* ![Przykład Qt](/images/Qt_Example_00.png)

  Przykład Qt
* ![Szczegóły przykładu Qt](/images/Qt_Example_01.png)

  Szczegóły przykładu Qt
...
Zawartość pliku **Qt\_Example.FCMacro** jest podana poniżej:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Qt_Example/pl&oldid=1323017>"