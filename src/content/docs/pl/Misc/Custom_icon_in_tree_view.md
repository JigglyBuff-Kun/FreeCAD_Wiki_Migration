---
title: Własna ikona w widoku drzewa
---
## Wprowadzenie

Oto przykład modyfikacji ikony niestandardowego [Dostawcy widoku](/Viewprovider/pl "Viewprovider/pl"), które są zwykle dodawane do [obiektów tworzonych skryptami](/Scripted_objects/pl "Scripted objects/pl").
...
Pobierz przykładową ikonę do tego samego katalogu co makrodefinicję.![icon Example for the macro](/images/FreeCADIco.png)

Użycie ikony dla trzech różnych przypadków użycia: icon\_in\_file\_disk *(format .png)*, icon\_XPM\_in\_macro (format .XPM) i icon\_resource\_FreeCAD
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Custom_icon_in_tree_view/pl&oldid=1355466>"