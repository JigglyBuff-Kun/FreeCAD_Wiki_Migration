...
**[Lesser General Public Licence, wersja 2 lub wyższa *(LGPL2+)*](http://en.wikipedia.org/wiki/LGPL "wikipedia:LGPL")**. Dla całego kodu źródłowego FreeCAD znajdującego się w [oficjalnym repozytorium Git](https://github.com/FreeCAD/FreeCAD). + oznacza, że można również, według własnego uznania, korzystać z FreeCAD na warunkach późniejszej wersji licencji, takiej jak LGPL3

**[Creative Commons Attribution 3.0 License *(CC-BY-3.0)*](http://creativecommons.org/licenses/by/3.0/)**. Dla [dokumentacji](https://wiki.freecad.org) i [strony internetowej](https://www.freecad.org).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=License/pl&oldid=1394097>"