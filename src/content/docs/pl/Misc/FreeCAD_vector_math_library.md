---
title: Biblioteka matematyczna FreeCAD dla wektorów
---
## Wprowadzenie

Jest to moduł [Python](/Python/pl "Python/pl") zawierający kilka użytecznych funkcji do manipulowania wektorami. Biblioteka ta jest zawarta w środowisku pracy [Rysunek Roboczy](/Draft_Workbench/pl "Draft Workbench/pl") i może być dostępna w ten sposób z interpretera Python:
...
Chociaż moduł `DraftVecUtils` nadal istnieje i nadal jest używany w Środowisku pracy [Rysunek Roboczy](/Draft_Workbench/pl "Draft Workbench/pl"), prawdopodobnie bezpośrednio do nowych rozwiązań lepiej jest używać metod `Vector`.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD_vector_math_library/pl&oldid=986195>"