...
FreeCAD nie byłby tym, czym jest bez hojnego wkładu wielu ludzi. Oto przegląd osób i firm, które przyczyniły się do powstania FreeCAD na przestrzeni czasu. Informacje na temat zasobów dla bibliotek zewnętrznych znajdują się na stronie [Biblioteki zewnętrzne](/Third_Party_Libraries/pl "Third Party Libraries/pl").
...
Firmy, które przekazały kod, zasoby lub udostępniły czas pracy developera:
...
Osoby odpowiedzialne za [forum FreeCAD](https://forum.freecadweb.org) *(otrzymano z <https://forum.freecadweb.org/memberlist.php?mode=team>)*:
...
Ludzie pochodzący ze społeczności, którzy włożyli wiele wysiłku w pomoc projektowi FreeCAD albo poprzez aktywność na forum, prowadzenie bloga o FreeCAD, tworzenie samouczków wideo, pakowanie FreeCAD dla Linux / MacOS / Windows, pisanie książki o FreeCAD... *(w kolejności alfabetycznej) (dostępne na stronie <http://forum.freecadweb.org/memberlist.php?mode=&sk=d&sd=d#memberlist>)*.
...
Ludzie, którzy napisali dokumentację na tej [Wiki](/Main_Page/pl "Main Page/pl"):
...
Osoby, które pomogły w tłumaczeniu aplikacji FreeCAD *(otrzymano z <https://crowdin.com/project/freecad>)*:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Contributors/pl&oldid=1550633>"