...
Zanim przejdziesz przez ból debugowania użyj [środowiska pracy Test](/Testing/pl "Testing/pl") aby sprawdzić czy standardowe testy działają poprawnie. Jeśli testy nie są kompletne, prawdopodobnie instalacja jest uszkodzona.
...
* debug build FreeCAD *(w tym momencie dostępny tylko przez [kompilację ze źródeł](/Compile_on_Linux/pl#Dla_kompilacji_Debug "Compile on Linux/pl"))*
...
4. Przełącz się do GUI Windpdb i kliknij na "Dołącz". Po kilku sekundach pojawi się element "<Input>", na którym należy dwukrotnie kliknąć,
...
Zapoznaj się z treścią strony [artykuł o Pyzo](/index.php?title=Pyzo/pl&action=edit&redlink=1 "Pyzo/pl (page does not exist)").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Debugging/pl&oldid=1328876>"