---
title: Biblioteka OpenCam
---
## Opis

OpenCamLib *(OCL)* to biblioteka open source, której celem jest dostarczanie algorytmów komputerowego wspomagania wytwarzania *(CAM)*. FreeCAD wykorzystuje OCL w eksperymentalnie w narzędziu ![](/images/Path_Surface.svg) [Powierzchnia 3D](/Path_Surface/pl "Path Surface/pl") i innych funkcjach.
...
4. Postępuj zgodnie z jedną z następujących czterech(4) opcji:
   * Przejdź do folderu **FreeCAD\lib** i wklej tam plik **ocl.pyd**, red,
   ...
   * Przejdź do folderu *%USERPROFILE%\AppData\Roaming\FreeCAD*. Utwórz nowy folder **Mod**. Wejdź do folderu "Mod". Utwórz nowy folder "OCL". Wejdź do folderu **OCL** i wklej plik **ocl.pyd**. *(To jest najmniej preferowana opcja)*
...
2. Następnie uruchom następujący fragment kodu w [konsoli Python](/Python_console/pl "Python console/pl") programu FreeCAD.
...
Aby przetestować kompilację, wprowadź następujące polecenie w [konsoli Python](/Python_console/pl "Python console/pl"):
...
Retrieved from "<http://wiki.freecad.org/index.php?title=OpenCamLib/pl&oldid=1316362>"