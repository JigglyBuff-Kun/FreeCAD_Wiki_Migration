---
title: Makrodefinicja Blacha - rozwijanie
---
...
| Description                                                                                                                                                                                                                                                                                                                           |
| The macro can unfold simple sheet-metal-parts. The parts must have everywhere the same material thickness as typical for sheet-metal-parts. Macro version: 17.0 Last modified: 2018-08-14 FreeCAD version: 17.0 Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/1/16/Macro_Sheet_Metal_Unfolder.png) Author: ulrich1a |
| Author                                                                                                                                                                                                                                                                                                                                |
...
The macro creates a lot of text in the report-view. This is still a remains of the debugging process of this macro. The edges of the sheet-metal-part may be round or slanting. But if you "walk" from the upper side to the lower side of the sheet-metal-part you should not cross more than one face.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Sheet_Metal_Unfolder/pl&oldid=1081101>"
