...
| Zoom 1:1                                                                                                                                                                                                                         |
| Description                                                                                                                                                                                                                      |
| 1:1 Zooming so objects appear their actual size on the screen. Macro version: 1.1 Last modified: 2025-03-05 FreeCAD version: Python3+ Download: [ToolBar Icon](https://wiki.freecadweb.org/File:Zoom1_1.svg) Author: TheMarkster |
| Author                                                                                                                                                                                                                           |
| [TheMarkster](/index.php?title=User:TheMarkster&action=edit&redlink=1 "User:TheMarkster (page does not exist)")                                                                                                                  |
| Download                                                                                                                                                                                                                         |
| [ToolBar Icon](https://wiki.freecadweb.org/File:Zoom1_1.svg)                                                                                                                                                                     |
| Links                                                                                                                                                                                                                            |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Zoom1_1/pl&oldid=1556724>"
