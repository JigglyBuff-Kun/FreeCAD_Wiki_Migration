---
title: Makrodefinicja Znajdź odwołanie do aliasu
---
...
To makro przeskanuje wszystkie wyrażenia we wszystkich otwartych dokumentach, a następnie wyświetli w widoku raportu wszystkie wyrażenia zawierające alias lub, jeśli alias nie jest zdefiniowany, wartość w wybranych komórkach arkusza kalkulacyjnego. Jest to dopasowanie łańcuchowe, a nie wieloznaczne i nie jest to wyrażenie regularne.
...
Ikonka paska narzędzi ![](/images/FindAliasReferences.png)
...
Dyskusja na forum [makrodefinicja FindAlaisReferences](https://forum.freecad.org/viewtopic.php?t=84197)

## Wersja

2024.01.05 : pierwsza

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FindAliasReferences/pl&oldid=1396309>"
