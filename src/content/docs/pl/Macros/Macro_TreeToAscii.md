---
title: Makrodefinicja TreeToAscii
---

|                                                                                                                                                                                                            |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon. Create your personal icon with the same name of the macro](/File:Text-x-python.png "Generic macro icon. Create your personal icon with the same name of the macro") Macro TreeToAscii |
| Description                                                                                                                                                                                                |
| This macro generates an ASCII art representation of the tree of selected object(s) Macro version: 0.6 Last modified: 2020-03-23 FreeCAD version: 0.17+ Author: OpenBrain                                   |
| Author                                                                                                                                                                                                     |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_TreeToAscii/pl&oldid=1290083>"
