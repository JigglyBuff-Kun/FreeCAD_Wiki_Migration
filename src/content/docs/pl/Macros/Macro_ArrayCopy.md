---
title: Makrodefinicja ArrayCopy
---
|  |
| --- |
| ArrayCopy |
| Opis |
| Makro kopiuje zaznaczony obiekt kilka razy, na siatce tablicy Możesz zdefiniować liczbę wierszy i kolumn oraz odległość między nimi.  Macro version: 1.0 Last modified: 2014-05-04 FreeCAD version: Wszystkie Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/9/9d/Macro_ArrayCopy.png) Autor: Yorik |
| Autor |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_ArrayCopy/pl&oldid=897350>"