---
title: Makrodefinicja Zbiorczy eksport do siatki
---

|                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon. Create your personal icon with the same name of the macro](/File:Text-x-python.png "Generic macro icon. Create your personal icon with the same name of the macro") Batch Export To Mesh |
| Description                                                                                                                                                                                                   |
| This macro helps batch converting to mesh and exporting STL and OBJ files Macro version: 2.16 Last modified: 2024-10-11 Author: Pablo Gil Fernández                                                           |
| Author                                                                                                                                                                                                        |
...
- FreeCAD _standard_ meshing option
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Batch_Export_To_Mesh/pl&oldid=1495178>"
