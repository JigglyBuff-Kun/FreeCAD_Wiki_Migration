---
title: Makrodefinicja Half turn stairs
---
...
| Half_turn_stairs                                                                                                                                                                                                                                                                                                                                                                                                            |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                 |
| This macro creates a Stair with left or right turn in the defined high. The design of the stairs are defined in stairs.dat file (You must copy the data in the wiki page). The step-high of the stair is calculated from the high of the stair. Macro version: 1.0 Last modified: 2016-10-17 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/b/b8/Half_turn_stairs.png) Author: Berner |
| Author                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Half_turn_stairs/pl&oldid=1528894>"
