---
title: Makrodefinicja Utwórz ścianę lub szkic z pliku DXF
---
...
| Description                                                                                                                                                                                                                                             |
| This macro create face and sketch from a DXF file. Macro version: 02.00 Last modified: 2017-10-23 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/6d/Macro_DXF_to_Face_and_Sketch.png) Author: shoogen, easyw-fc |
| Author                                                                                                                                                                                                                                                  |
...
- Previous version [Macro Creating faces from a DXF file](/Macro_Creating_faces_from_a_DXF_file "Macro Creating faces from a DXF file")

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_DXF_to_Face_and_Sketch/pl&oldid=1149585>"
