---
title: Makrodefinicja Apothem Based Prism GUI
---
...
| Apothem Based Prism                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| This macro will present the user with a dialog to provide the distance between centers, the number of sides, and height and will create a prism based on the apothem, or inradius of a polygon. This can be extremely handy when one only knows the distance between flats. An example of this would be hexagonal stock of plastics or metal provided by vendors. Most vendors define such stock by the distance between flats. If one is using such stock in their projects, this Macro can be a real time saver. Macro version: 1.0 Last modified: 2014-12-31 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/4/4e/Part_Prism_Apothem.svg) Author: Quick61 |
| Author                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Apothem_Based_Prism_GUI/pl&oldid=1154203>"
