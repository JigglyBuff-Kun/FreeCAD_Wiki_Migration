---
title: Makrodefinicja Okrąg na podstawie trzech punktów
---
...
| Description                                                                                                                                                                                                                                                                                                                                                |
| This macro creates a circle on 3 selected points. The points can be objects such as cubes, cylinder, then selected coordinates will be the centre of these forms. Macro version: 01.00 Last modified: 2013-03-11 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/c/c7/Macro_Make_Circle_3_Points.png) Author: Mario52 |
| Author                                                                                                                                                                                                                                                                                                                                                     |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Draft_Circle_3_Points/pl&oldid=1149609>"
