---
title: Makrodefinicja Zamień cześć w złożeniu
---
...
| Description                                                                                                                                                                                                                                                                                          |
| Especially when doing "Assemblies" with simple copies of parts, one needs to replace one part by another from time to time. Macro version: 1.0 Last modified: 2014-09-10 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/07/Replace_Part.png) Author: ralvejd |
| Author                                                                                                                                                                                                                                                                                               |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Replace_Part_in_Assembly/pl&oldid=1081333>"
