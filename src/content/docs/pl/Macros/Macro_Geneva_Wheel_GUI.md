---
title: Makrodefinicja Geneva Wheel GUI
---
...
| Geneva Wheel GUI                                                                                                                                                                                                                                                                                                                        |
| Description                                                                                                                                                                                                                                                                                                                             |
| A GUI front end that allows the user to create a Geneva wheel mechanism from scratch. Based on drei's [Macro Geneva Wheel](/Macro_Geneva_Wheel "Macro Geneva Wheel") Macro version: 1.0 Last modified: 2014-09-21 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/8/8d/GW_Dim.png) Author: quick61 |
| Author                                                                                                                                                                                                                                                                                                                                  |
...
A GUI front end that allows the user to create a Geneva wheel mechanism from scratch. Based on drei's [Macro Geneva Wheel](/Macro_Geneva_Wheel "Macro Geneva Wheel")
...
This Macro is based on [Macro Geneva Wheel](/Macro_Geneva_Wheel "Macro Geneva Wheel")

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Geneva_Wheel_GUI/pl&oldid=1155929>"
