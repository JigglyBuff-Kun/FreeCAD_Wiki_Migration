---
title: Makrodefinicja Środek ciężkości
---
...
| Macro CenterFace                                                                                                                                                                                                                          |
| Description                                                                                                                                                                                                                               |
| This macro red trace (editable) the center face (mass) with 1 point and print the coordinates. Macro version: 0.2 Last modified: 2018-10-07 Download: [ToolBar Icon](https://wiki.freecad.org/images/1/16/CenterFace.png) Author: Mario52 |
| Author                                                                                                                                                                                                                                    |
| [Mario52](/User:Mario52 "User:Mario52")                                                                                                                                                                                                   |
| Download                                                                                                                                                                                                                                  |
| [ToolBar Icon](https://wiki.freecad.org/images/1/16/CenterFace.png)                                                                                                                                                                       |
| Links                                                                                                                                                                                                                                     |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_CenterFace/pl&oldid=1344846>"
