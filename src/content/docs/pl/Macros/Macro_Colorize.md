---
title: Makrodefinicja Kolorowanie
---
...
| Macro Colorize                                                                                                                                                                                                                                                                      |
| Description                                                                                                                                                                                                                                                                         |
| Quickly and easily set the color and transparency of individual faces, edges, and vertices. Macro version: 1.03 Last modified: 2023-10-07 FreeCAD version: Python3 builds Download: [ToolBar Icon](https://wiki.freecadweb.org/images/d/de/Workbench_Image.svg) Author: TheMarkster |
| Author                                                                                                                                                                                                                                                                              |
| [TheMarkster](/index.php?title=User:TheMarkster&action=edit&redlink=1 "User:TheMarkster (page does not exist)")                                                                                                                                                                     |
| Download                                                                                                                                                                                                                                                                            |
| [ToolBar Icon](https://wiki.freecadweb.org/images/d/de/Workbench_Image.svg)                                                                                                                                                                                                         |
| Links                                                                                                                                                                                                                                                                               |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Colorize/pl&oldid=1310034>"
