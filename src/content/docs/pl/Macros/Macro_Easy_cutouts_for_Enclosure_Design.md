---
title: Makrodefinicja Easy cutouts for Enclosure Design
---
...
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| This macro makes Cutouts for Enclosures in a very handy way. Just select a face of the object that is the base for the cutout and the macro will create a clone of the external outline with a margin of 0.5mm (set in the macro) This macro needs to be upgraded Macro version: 0.25 Last modified: 2016-11-26 FreeCAD version: 0.16 Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/7/71/Macro_Easy_cutouts_for_Enclosure_Design_icon.png) Author: maurice |
| Author                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Easy_cutouts_for_Enclosure_Design/pl&oldid=1155861>"
