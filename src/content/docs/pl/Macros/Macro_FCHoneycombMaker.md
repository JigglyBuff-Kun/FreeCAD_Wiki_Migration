---
title: Makrodefinicja Plaster miodu
---
...
| FCHoneycombMaker                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| This macro creates a parametric honeycomb grid. The parametric properties are contained in a spreadsheet. You could also change the base object for the honeycomb grid to achieve other interesting arrays, such as this egg crate by changing the base hexagon object with an egg-shaped ellipsoid. Including hexagon radius, separation between hexagons, etc., can be modified via an included spreadsheet. Macro version: 2020.10.30 Last modified: 2020-10-30 FreeCAD version: 0.17 and above Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/2/2d/FCHoneycombMakerIcon.png) Author: TheMarkster |
| Author                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCHoneycombMaker/pl&oldid=1154215>"
