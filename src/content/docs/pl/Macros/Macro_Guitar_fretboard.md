---
title: Makrodefinicja Podstrunnica gitarowa
---
...
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Create Guitar fretboard. Guitar Fretboard Maker (Macro), Python script is unbelievable to make complex form.... This macro creates a conical compound (or not) multiscale (or not) fretboard with nut and fret slot or zero fret slot to export to CAM software Macro version: 0.4 Last modified: 2020-01-09 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/b/be/Macro_Guitar_fretboard.png) Author: ryback08, jsiddall |
| Author                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| [ryback08, jsiddall](/index.php?title=User:Ryback08,_jsiddall&action=edit&redlink=1 "User:Ryback08, jsiddall (page does not exist)")                                                                                                                                                                                                                                                                                                                          |
| Download                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/b/be/Macro_Guitar_fretboard.png)                                                                                                                                                                                                                                                                                                                                                                        |
| Links                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| _None_                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| See also                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [Macro_Guitar_Nut](/Macro_Guitar_Nut "Macro Guitar Nut")                                                                                                                                                                                                                                                                                                                                                                                                      |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Guitar_fretboard/pl&oldid=1154234>"
