...
| Boolean Overlap                                                                                                                                                                                                                                                                                   |
| Description                                                                                                                                                                                                                                                                                       |
| Boolean tool in between [Part Fuse](/Part_Fuse "Part Fuse") and [Part Common](/Part_Common "Part Common"). Parametric. Macro version: 0.2 Last modified: 2018-08-31 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/a/ac/Macro_Overlap.png) Author: DeepSOIC |
| Author                                                                                                                                                                                                                                                                                            |
...
\* two shapes will do, too, but the action of tool will be equivalent to either [Part Common](/Part_Common "Part Common") or [Part Fuse](/Part_Fuse "Part Fuse"), and so it is recommended to use Part tools instead.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Overlap/pl&oldid=1154567>"
