---
title: Makrodefinicja Arkusz kalkulacyjny do html
---

|                                                                                                                                                                                                           |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon. Create your personal icon with the same name of the macro](/File:Text-x-python.png "Generic macro icon. Create your personal icon with the same name of the macro") Spreadsheet2html |
| Description                                                                                                                                                                                               |
| Exports a fc spreadsheet as html. Macro version: 0.1 Last modified: 2021-08-09 FreeCAD version: any with spreadsheet Author: heda                                                                         |
| Author                                                                                                                                                                                                    |
...
Exports the content of a FreeCAD SpreadSheet as styled html, can be used to import to LibreOffice Writer or Calc.
Further info in the docstring of the macro.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Spreadsheet2html/pl&oldid=1134416>"
