---
title: Makrodefinicja cięcie linią
---
...
| Macro Cut Line                                                                                                                                                                                                                                                                                                                                                                                                            |
| Description                                                                                                                                                                                                                                                                                                                                                                                                               |
| Cut a line giving as an argument number cut, create line, bicolor, create point. The new line is created in the real coordinate of object, not in the coordinate of the Body. (Command line, paste this complete macro in the Python console). Macro version: 2.0 Last modified: 2019/06/17 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/3/35/Macro_Cut_Line.png) Author: mario52 |
| Author                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Cut_Line/pl&oldid=1154211>"
