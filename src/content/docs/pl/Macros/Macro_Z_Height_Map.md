---
title: Makrodefinicja Z Height Map
---

|                                                                                                                                                                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon. Create your personal icon with the same name of the macro](/File:Text-x-python.png "Generic macro icon. Create your personal icon with the same name of the macro") Macro Z Height Map |
| Description                                                                                                                                                                                                 |
| Makes a grayscale height map in Z. Macro version: 0.1 Last modified: 2022-08-28 Author: heda                                                                                                                |
| Author                                                                                                                                                                                                      |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Z_Height_Map/pl&oldid=1184147>"
