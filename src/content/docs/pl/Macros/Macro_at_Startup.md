---
title: Automatyczne uruchamianie makroinstrukcji.
---
## Introduction
...
* When user folders ('Mod', 'Macro', ...) are referred to, they are located in your user FreeCAD folder. You can locate them at Start up and Configuration → [User related information](/Start_up_and_Configuration#User_related_information "Start up and Configuration")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_at_Startup/pl&oldid=1236177>"