---
title: Makrodefinicja Eksport przejściowych wyników MES
---
...
As an example, the bending of a aluminium/steel bimetal strip is used. A step-by-step guide to create the sample file is given [here](/Transient_FEM_analysis "Transient FEM analysis"), or you can download the file from the [downloads section](#Downloads) of this page. Save the FCMacro file in the FreeCAD macro folder, which can be found via Edit → Preferences → Python → Macro.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_export_transient_FEM_results/pl&oldid=1296851>"
