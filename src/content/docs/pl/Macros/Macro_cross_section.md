...
| Cross_section                                                                                                                                                                                                                                                                                                  |
| Description                                                                                                                                                                                                                                                                                                    |
| Macro to display a cross-section of the objects in the scene: the cross-section plane can be moved by a slider bar. Macro version: 0.10 Last modified: 2020-12-19 FreeCAD version: 0.15 and above Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f5/Macro_cross_section.png) Author: aleph0 |
| Author                                                                                                                                                                                                                                                                                                         |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_cross_section/pl&oldid=1124030>"
