---
title: Makrodefinicja Import 3DXML
---

|                                                                                                                                                                                                       |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon. Create your personal icon with the same name of the macro](/File:Text-x-python.png "Generic macro icon. Create your personal icon with the same name of the macro") 3DXML_import |
| Description                                                                                                                                                                                           |
| Imports a 3DXML-ascii file to FreeCAD. Macro version: 0.1 Last modified: 2021-10-03 FreeCAD version: - Author: heda                                                                                   |
| Author                                                                                                                                                                                                |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_3DXML_import/pl&oldid=1149581>"
