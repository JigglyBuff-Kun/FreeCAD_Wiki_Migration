---
title: Makrodefinicja SplitPropEditor
---
...
Code is provided on this page for convenience in case user system doesn't have git-python. Though it should be up-to-date, latest release is always available at [FreeCAD-macro repository](https://github.com/FreeCAD/FreeCAD-macros/blob/master/PureGui/SplitPropEditor.FCMacro)

For more detailed explanations, see the [How to install macros](/How_to_install_macros "How to install macros") page.
Notice that macro is ready to be set as [Macro at Startup](/Macro_at_Startup "Macro at Startup")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_SplitPropEditor/pl&oldid=1134418>"
