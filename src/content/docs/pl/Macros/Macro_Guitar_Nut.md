---
title: Makrodefinicja Nakrętka gitarowa
---
...
| Macro Guitar Nut                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Create [guitar nuts](https://wikipedia.org/wiki/Guitar#Nut). FreeCAD macro that will create complex guitar nut shapes. Specifically it can create a nut with the bottom of the string slots at the desired height above a fretboard of the desired radius. The diameter of each string is configurable and the slots can be configured to account for the width needed to prevent binding. See the [Usage](#Usage) section for more details. Macro version: 0.1 Last modified: 2020-01-27 FreeCAD version: All Download: [ToolBar Icon](https://wiki.freecad.org/images/9/94/Macro_Guitar_Nut.png) Author: jsiddall |
| Author                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [jsiddall](/index.php?title=User:Jsiddall&action=edit&redlink=1 "User:Jsiddall (page does not exist)")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Download                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [ToolBar Icon](https://wiki.freecad.org/images/9/94/Macro_Guitar_Nut.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Links                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| _None_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| See also                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [Macro_Guitar_fretboard](/Macro_Guitar_fretboard "Macro Guitar fretboard")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
1. Download macro from the [Addon Manager](/Std_AddonMgr "Std AddonMgr")
2. Execute macro
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Guitar_Nut/pl&oldid=1344608>"
