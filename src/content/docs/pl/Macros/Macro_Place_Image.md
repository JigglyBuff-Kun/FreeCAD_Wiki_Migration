---
title: Makrodefinicja Umieść obraz
---

|                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon. Create your personal icon with the same name of the macro](/File:Text-x-python.png "Generic macro icon. Create your personal icon with the same name of the macro") Macro Place Image                                  |
| Opis                                                                                                                                                                                                                                        |
| Tworzy płaszczyznę obrazu i wyrównuje ją do istniejącego prostokąta środowiska Kreślenie. Macro version: 0.1 Last modified: 2023-01-30 Autor: heda                                                                                          |
| Autor                                                                                                                                                                                                                                       |
...
Tworzy [płaszczyznę obrazu](/Image_CreateImagePlane/pl "Image CreateImagePlane/pl") i wyrównuje ją do istniejącego [prostokąta](/Draft_Rectangle/pl "Draft Rectangle/pl") środowiska Kreślenie.
...
Za pomocą [Menedżera dodatków](/Std_AddonMgr/pl "Std AddonMgr/pl").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Place_Image/pl&oldid=1226509>"
