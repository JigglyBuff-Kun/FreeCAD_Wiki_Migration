---
title: Makrodefinicje Polilinia FC na objętość
---
...
| Description                                                                                                                                                                                                                                                                                                 |
| Create the boolean operation with the selected wires. Push the 2d button for create the boolean operation to 2D wire. Macro version: 0.02c Last modified: 2020/04/11 FreeCAD version: 0.19 Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f2/Macro_FCWire_To_Volume.png) Author: Mario52 |
| Author                                                                                                                                                                                                                                                                                                      |
...
- Help : Connect to the wiki page (in FreeCAD browser)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCWire_To_Volume/pl&oldid=1087094>"
