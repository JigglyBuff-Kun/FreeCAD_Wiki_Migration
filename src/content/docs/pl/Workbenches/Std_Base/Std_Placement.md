...
| - |
| Zobacz także |
| [Wyrównanie](/Std_Alignment/pl "Std Alignment/pl"), [Umiejscowienie](/Placement/pl "Placement/pl") |
|  |

## Opis

Polecenie **Std: Umiejscowienie** wyświetla [panel zadań](/Task_panel/pl "Task panel/pl") Umiejscowienia dla wybranego obiektu.
...
1. Zaznacz pojedynczy obiekt, który ma właściwość DANE**Umiejscowienie**.
...
Okno dialogowe można również uruchomić, klikając przycisk z elipsą ..., który pojawia się w [edytorze właściwości](/Property_editor/pl "Property editor/pl") po kliknięciu właściwości DANE**Umiejscowienie**.

## Uwagi

* Więcej informacji na temat parametrów rozmieszczenia można znaleźć na stronie [Umiejscowienie](/Placement/pl "Placement/pl") oraz w poradniku [Samolot](/Aeroplane/pl "Aeroplane/pl").
...
Zobacz również stronę [Tworzenie skryptów Python](/Python_scripting_tutorial/pl#Wektory_i_umiejscowienia "Python scripting tutorial/pl").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_Placement/pl&oldid=1468524>"