...
Funkcje te są częścią środowiska pracy [Rysunek Techniczny](/TechDraw_Workbench/pl "TechDraw Workbench/pl") i mogą być używane w [makrodefinicjach](/Macros/pl "Macros/pl") oraz z konsoli środowiska [Python](/Python/pl "Python/pl") po zaimportowaniu modułu `TechDraw`.
...
Zobacz stronę [Api dla GUI](/TechDrawGui_API/pl "TechDrawGui API/pl") aby poznać więcej funkcji.
...
**Description**: Tworzy linie z krawędzi na wejściu przez planarne przechodzenie grafu. Opcjonalnie wyklucza OuterWire ustawiając opcjonalny parametr na false.

**Returns**: Lista przewodów posortowana według rozmiaru (malejąco)

![](/images/Method.png) **findOuterWire(***listOfEdges***)**

**Description**: Wyszukuje OuterWire (największy) z listy krawędzi (które tworzą graf planarny).

**Returns**: Outer wire

![](/images/Method.png) **findShapeOutline(***TopoShape, scale, direction***)**

**Description**: Odwzorowuje kształt w kierunku i znajduje zewnętrzną linię wyniku.
...
**Description**: Zwraca krawędzie DrawViewPart w formacie Dxf.
...
**Description**: Zwraca krawędzie DrawViewPart w formacie Svg.
...
**Description**: Zapisz DrawViewPart w formacie Dxf.
...
**Description**: Zapisz DrawPage w formacie Dxf.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=TechDraw_API/pl&oldid=1299230>"