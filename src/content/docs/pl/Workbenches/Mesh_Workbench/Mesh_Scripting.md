---
title: Skrytpy w środowisku Siatek
---
## Wprowadzenie
...
Zobacz również: [API dla Mesh](/Mesh_API "Mesh API")

[Przewiń na górę strony](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Mesh_Scripting/pl&oldid=1021052>"