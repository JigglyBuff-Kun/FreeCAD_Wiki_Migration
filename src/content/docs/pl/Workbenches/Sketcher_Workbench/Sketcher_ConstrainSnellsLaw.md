---
title: Szkicownik Wiązanie prawo Snell'a
---
|  |
| --- |
...
Narzędzie ![](/images/Sketcher_ConstrainSnellsLaw.svg) **Wiązanie prawo Snell'a** wiąże dwie linie tak, aby były zgodne z prawem załamania światła, gdy przenika ono przez interfejs, w którym spotykają się dwa materiały o różnych współczynnikach załamania. Zobacz [Prawo Snella](http://en.wikipedia.org/wiki/Snell%27s_law).
...
1. Przygotuj dwie linie reprezentujące wiązkę światła oraz krawędź pełniącą rolę interfejsu. Linie powinny znajdować się po różnych stronach interfejsu. Interfejsem może być [linia](/Sketcher_CreateLine/pl "Sketcher CreateLine/pl"), [łuk](/Sketcher_CreateArc/pl "Sketcher CreateArc/pl"), [okrąg](/Sketcher_CreateCircle/pl "Sketcher CreateCircle/pl"), [stożek](/Sketcher_CompCreateConic/pl "Sketcher CompCreateConic/pl").
...
3. Istnieje kilka sposobów wywołania narzędzia:
   * Wybierz z menu **Szkic → Wiązania szkicownika → ![](/images/Sketcher_ConstrainSnellsLaw.svg) Wiązanie prawo Snell'a**.
...
6. Dodawane jest wiązanie zgodne z prawem Snella. Jeśli jest to wymagane, punkty końcowe są [zbieżne](/Sketcher_ConstrainCoincident/pl "Sketcher ConstrainCoincident/pl") i związane [na interfejsie](/Sketcher_ConstrainPointOnObject/pl "Sketcher ConstrainPointOnObject/pl"). Te dodatkowe więzy są nazywane [wiązaniami pomocniczymi](/Sketcher_helper_constraint/pl "Sketcher helper constraint/pl").
...
* Procedura Pythona nie dodaje wiązań pomocniczych. Muszą one być dodane ręcznie przez skrypt *(zobacz przykład w sekcji [Tworzenie skryptów](#Tworzenie_skryptów))*.
...
Wiązanie może być utworzone przez [makropolecenie](/Macros/pl "Macros/pl") i z konsoli [Pyton](/Python "Python") za pomocą następującej funkcji:
...
Strona [Skrypty szkicownika](/Sketcher_scripting/pl "Sketcher scripting/pl") wyjaśnia wartości, których można użyć dla `line1`, `pointpos1`, `line2`, `pointpos2` and `interface` oraz zawiera dalsze przykłady tworzenia wiązań przy użyciu skryptów języka Python.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainSnellsLaw/pl&oldid=1467459>"