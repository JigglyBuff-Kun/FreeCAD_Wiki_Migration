...
| - |
| Zobacz także |
| [Zaokrąglenie](/Part_Fillet/pl "Part Fillet/pl") |
|  |
...
1. Istnieje kilka sposobów aby wywołać polecenie **Fazuj wybrane krawędzie**:
   * Naciśnij przycisk ![](/images/Part_Chamfer.svg).
...
* DANE**Podstawowe**: Kształt, na którym ma być zastosowana fazka.
* DANE**Umiejscowienie**: Określa orientację i położenie kształtu w przestrzeni 3D.
* DANE**Etykieta**: Etykieta nadana obiektowi. Zmień ją według własnych potrzeb.

## Ograniczenia

Fazowanie może się nie powieść, jeśli wynik dotknie lub przekroczy następną sąsiednią krawędź. Więc jeśli nie otrzymasz oczekiwanego rezultatu, spróbuj z mniejszą wartością. To samo dotyczy funkcji ![](/images/Part_Fillet.svg) [Zaokrąglij wybrane krawędzie ...](/Part_Fillet/pl "Part Fillet/pl") środowiska Część.

Zwróć również uwagę, że na funkcję fazowania części wpływa na [Topologiczny problem nazewnictwa](/Topological_naming_problem/pl "Topological naming problem/pl"), gdy jakakolwiek zmiana jest dokonywana na wcześniejszym etapie modelowania w łańcuchu, który wpływa na liczbę powierzchni lub wierzchołków. Może to spowodować nieprzewidywalny rezultat. Do czasu rozwiązania tego problemu zaleca się stosowanie operacji Fazowania i [Zaokrąglania](/Part_Fillet/pl "Part Fillet/pl") na ostatnich etapach łańcucha.

## Tworzenie skryptów

Narzędzie fazowania może być używane w [makrodefinicjach](/Macros/pl "Macros/pl") i z konsoli środowiska [Python](/Python/pl "Python/pl") poprzez dodanie obiektu fazowania do dokumentu.
...
* Tworzy sześcian o boku 5 mm, na który będziemy nakładać sfazowane krawędzie. Zobacz stronę [Part\_API](/Part_API/pl "Part API/pl") aby uzyskać wyjaśnienie metody **makeBox**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Chamfer/pl&oldid=1282110>"