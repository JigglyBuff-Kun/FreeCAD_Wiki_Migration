...
Wszystkie informacje dotyczące okna mają również zastosowanie do [drzwi](/Arch_Door/pl "Arch Door/pl"), ponieważ jest to ten sam obiekt.
...
* Utwórz [materiał złożony](/Arch_MultiMaterial/pl "Arch MultiMaterial/pl")
