...
**UWAGA:** Ten typ użycia narzędzia jest przestarzały od oficjalnego wydania wersji 0.19. W wersji 0.19 wdrożono nowy system narzędzi, który zastąpił starszy system. W związku z tym kodowanie zmieniło się w porównaniu do przedstawionego poniżej. Proszę odwiedzić stronę [Narzędzia](/CAM_Tools/pl "CAM Tools/pl") w celu uzyskania więcej informacji.
...
* Utwórz operację ProfileFromFaces nazwaną "Profile\_Faces" z pustym BaseGeometry.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=CAM_scripting/pl&oldid=1483663>"