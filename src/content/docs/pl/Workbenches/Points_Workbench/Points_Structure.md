---
title: Punkty Uporządkowana chmura punktów
---
|  |
| --- |
| Punkty: Uporządkowana chmura punktów |
| Lokalizacja w menu |
| Punkty → Uporządkowana chmura punktów |
| Środowisko pracy |
...
1. Polecenie zakłada, że kierunek widzenia chmury punktów jest równoległy do osi Z globalnego układu współrzędnych. Jeśli tak nie jest: dostosuj odpowiednio obiekt chmury punktów DANE**Umiejscowienie**.
2. Wybierz obiekt chmury punktów.
3. Polecenie można wywołać na kilka sposobów:
   * Naciśnij przycisk ![](/images/Points_Structure.svg) **Uporządkowana chmura punktów**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Points_Structure/pl&oldid=1332597>"