...
- [Le dépôt de macros FreeCAD](/Macros_recipes "Macros recipes")
- [Exemple d'objet paramétrique](/Scripted_objects "Scripted objects")
- [Plus d'exemples dans le code FreeCAD](https://github.com/FreeCAD/FreeCAD/blob/master/src/Mod/TemplatePyMod/FeaturePython.py)

Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Creating_parametric_objects/fr&oldid=1524972>"
