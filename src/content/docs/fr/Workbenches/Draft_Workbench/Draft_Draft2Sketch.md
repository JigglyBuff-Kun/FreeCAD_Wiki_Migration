...
La commande ![](/images/Draft_Draft2Sketch.svg) **Draft Draft <=> Esquisse** convertit les objets [Draft](/Draft_Workbench/fr "Draft Workbench/fr") en [Sketcher Esquisses](/Sketcher_NewSketch/fr "Sketcher NewSketch/fr") et inversement.
...
1. Sélectionnez un ou plusieurs objets Draft ou des [Sketcher Esquisses](/Sketcher_NewSketch/fr "Sketcher NewSketch/fr").
2. Il existe plusieurs façons de lancer la commande :
   * Appuyez sur le bouton ![](/images/Draft_Draft2Sketch.svg) Convertir un objet Draft en esquisse et inversement.
   * [Draft](/Draft_Workbench/fr "Draft Workbench/fr") : sélectionnez l'option **Modification → ![](/images/Draft_Draft2Sketch.svg) Convertir un objet Draft en esquisse et inversement** du menu.
   * [BIM](/BIM_Workbench/fr "BIM Workbench/fr") : sélectionnez l'option **Modification → ![](/images/Draft_Draft2Sketch.svg) Convertir un objet Draft en esquisse et inversement** du menu.
...
* Les [Draft Courbes de Bézier](/Draft_BezCurve/fr "Draft BezCurve/fr") seront approximées par des [Sketcher B-splines](/Sketcher_CreateBSpline/fr "Sketcher CreateBSpline/fr").
* L'[atelier KicadStepUp](/KicadStepUp_Workbench/fr "KicadStepUp Workbench/fr") externe contient une commande permettant de convertir une [Draft B-spline](/Draft_BSpline/fr "Draft BSpline/fr") en une série de [Sketcher Arcs](/Sketcher_CreateArc/fr "Sketcher CreateArc/fr"). Pour plus d'informations, voir la rubrique du forum [BSplines to Shape2DView and Sketcher](https://forum.freecadweb.org/viewtopic.php?f=9&t=25082).
...
Pour convertir des objets en esquisses, utilisez la méthode `make_sketch` ([introduit dans la version 0.19](/Release_notes_0.19/fr "Release notes 0.19/fr")) du module Draft. Cette méthode remplace la méthode dépréciée `makeSketch`.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Draft2Sketch/fr&oldid=1475195>"