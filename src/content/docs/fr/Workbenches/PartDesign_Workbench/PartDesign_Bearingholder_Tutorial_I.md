---
title: PartDesign Tutoriel pour la conception d'un support de roulement (I)
---
:::caution
...
Vous pouvez trouver ma version de la pièce créée dans ce tutoriel [[ici](http://ubuntuone.com/39PTZ3Y3LUnmZzpZQPcJT4)].  *Ce fichier n'est plus disponible, un nouveau fichier sera fourni à une date ultérieure.*
...
support de roulement avec les deux plans les plus importants de l'ossature
...
Plans de Base et tous les plans de référence
...
Géométrie principale du haut du support

La pièce doit maintenant ressembler à l'image sur la droite. Notez comment les différentes découpes se combinent pour créer une épaisseur de paroi presque uniforme, ce qui rendra la coulée plus facile et moins susceptibles d'avoir des pores.

![](/images/HolderTop1-8.jpg)

Croquis avec l'emplacement des boulons
...
géométrie finie de la partie supérieure du support (sans projet et congés)

Créer une fonction de révolution de l'esquisse, puis la symétriser sur le plan YZ . C'est toute la géométrie solide nous devons modéliser. Le reste est brouillon et congés.

## Application de dépouille sur les faces latérales

![](/images/HolderTop1-10.jpg)

Le plan neutre pour la création de dépouille
...
Application de dépouille sur les faces latérales du support
...
Congé à l'extérieur du support
...
Une fois que vous avez réaliser l'usinage, vous pouvez avoir un bon effet visuel en colorant toutes les surfaces usinées de sorte que vous pouvez voir d'un coup d'œil les parties qui sont brut de fonderie et celles qui sont usinées après la coulée.
...
[Tutoriel de Conception Support de Roulement II](/PartDesign_Bearingholder_Tutorial_II/fr "PartDesign Bearingholder Tutorial II/fr")

Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Bearingholder_Tutorial_I/fr&oldid=1471509>"