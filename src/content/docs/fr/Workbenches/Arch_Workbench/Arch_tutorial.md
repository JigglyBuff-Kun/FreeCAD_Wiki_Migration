...
Voici, par exemple, quelques caractéristiques intéressantes de l'atelier [Arch](/Arch_Workbench/fr "Arch Workbench/fr") de FreeCAD que vous trouverez difficilement dans d'autres applications de type BIM :
