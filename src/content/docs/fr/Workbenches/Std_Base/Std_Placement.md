...
| - |
| Voir aussi |
| [Std Aligner](/Std_Alignment/fr "Std Alignment/fr"), [Placement](/Placement/fr "Placement/fr") |
|  |

## Description

La commande **Std Positionner** affiche le [panneau des tâches](/Task_Panel/fr "Task Panel/fr") Positionner pour un objet sélectionné.
...
1. Sélectionnez un seul objet ayant une propriété Données**Placement**.
2. Sélectionnez l'option **Édition → ![](/images/Std_Placement.svg) Positionner...** du menu.
...
La boîte de dialogue peut également être lancée en cliquant sur le bouton de sélection ... qui apparaît dans l'[éditeur de propriétés](/Property_editor/fr "Property editor/fr") lorsque vous cliquez sur la propriété Données**Placement**.

## Remarques

* Pour plus d'informations sur les paramètres de placement, consultez la page [Placement](/Placement/fr "Placement/fr") et le tutoriel [Aéroplane](/Aeroplane/fr "Aeroplane/fr").
...
Voir le [Tutoriel pour scripter en Python](/Python_scripting_tutorial/fr#Vecteurs_et_placements "Python scripting tutorial/fr").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_Placement/fr&oldid=1449154>"