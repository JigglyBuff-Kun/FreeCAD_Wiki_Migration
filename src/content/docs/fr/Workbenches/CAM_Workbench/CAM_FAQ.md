...
Pour le moment, CAM Workbench peut gérer jusqu'à 3 axes de fraisage. Actuellement, les capacités du 4ème axe ne sont pas officiellement incluses mais il existe des [expérimentations](/CAM_fourth_axis/fr "CAM fourth axis/fr").
...
Des informations plus détaillées sont disponible ici [Hauteurs et profondeurs](/CAM_Workbench/fr#Hauteurs_et_profondeurs "CAM Workbench/fr").

[En haut](#top)

## Quelle est l'utilisation habituelle de SetupSheet?

La [feuille de configuration](/CAM_SetupSheet/fr "CAM SetupSheet/fr") est une feuille de calcul spécifique, contenue dans une tâche, modifié dans la vue Propriétés, seulement accessible depuis l'atelier CAM. Elle fournit une méthode pour configurer les éléments d'une tâche en utilisant des valeurs et des expressions de la [feuille de configuration](/CAM_SetupSheet/fr "CAM SetupSheet/fr") aux utilisateurs experts.
...
Les opérations telles que [Poche 3D](/CAM_Pocket_3D/fr "CAM Pocket 3D/fr"), [Poche](/CAM_Pocket_Shape/fr "CAM Pocket Shape/fr") et [Surfaçage](/CAM_MillFace/fr "CAM MillFace/fr") mais pas les opérations de contour, ont une option de configuration pour maintenir l'outil vers le bas, dans l'onglet Données de la vue Propriétés.

[En haut](#top)

## Comment puis-je laisser des attaches pour maintenir mes travaux de fraisage?

L'atelier CAM fournit des [Attaches](/CAM_DressupTag/fr "CAM DressupTag/fr") à cette fin.

[En haut](#top)

## Qu'est-ce qu'un post-processeur?

Le [post-processeur](/CAM_Post/fr "CAM Post/fr") est utilisé pour adapter le code de sortie aux contrôleurs CNC cibles pour diverses machines dans leur langage en G-Code.
...
Oui, les [préférences de CAM](/CAM_Preferences/fr "CAM Preferences/fr") ont une section pour les post-processeurs où vous pouvez sélectionner les post-processeurs à afficher et sélectionner un post par défaut.
...
[CAM Ecrire un script](/CAM_scripting/fr "CAM scripting/fr").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=CAM_FAQ/fr&oldid=1483317>"