---
title: TechDraw Cotes parallèles horizontales
---
|  |
| --- |
| TechDraw Cotes parallèles horizontales |
| Emplacement du menu |
| TechDraw → Extensions : cotes → Cotes parallèles horizontales |
| Ateliers |
...
| 0.20 |
| Voir aussi |
| [TechDraw Cotes parallèles verticales](/TechDraw_ExtensionCreateVertCoordDimension/fr "TechDraw ExtensionCreateVertCoordDimension/fr"), [TechDraw Cotes parallèles inclinées](/TechDraw_ExtensionCreateObliqueCoordDimension/fr "TechDraw ExtensionCreateObliqueCoordDimension/fr") |
|  |
...
4. Il existe plusieurs façons de lancer l'outil :
   ...
   * Si cette préférence a une valeur différente (et dans version 0.21 et précédentes) : appuyez sur le bouton ![](/images/TechDraw_ExtensionCreateHorizCoordDimension.svg) Cotes parallèles horizontales.
   * Sélectionnez l'option **TechDraw → Extensions : cotes → ![](/images/TechDraw_ExtensionCreateHorizCoordDimension.svg) Cotes parallèles horizontales** à partir du menu.
5. Des cotes avec des textes de cotes centrés sont créées.

Retrieved from "<http://wiki.freecad.org/index.php?title=TechDraw_ExtensionCreateHorizCoordDimension/fr&oldid=1488140>"