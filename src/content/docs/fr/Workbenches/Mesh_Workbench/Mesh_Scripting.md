...
Donc, si vous êtes assez audacieux, jetez un œil au [module de test unitaire](https://github.com/FreeCAD/FreeCAD/blob/master/src/Mod/Mesh/App/MeshTestsApp.py).

Voir aussi : [Mesh API](/Mesh_API/fr "Mesh API/fr").

[En haut](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Mesh_Scripting/fr&oldid=1311852>"