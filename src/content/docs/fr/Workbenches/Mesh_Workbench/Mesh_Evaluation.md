---
title: Mesh Évaluation
---
|  |
| --- |
| Mesh Évaluation |
| Emplacement du menu |
| Maillages → Analyser → Évaluer et réparer un maillage... |
| Ateliers |
...
2. Il existe plusieurs façons de lancer la commande :
   * Appuyez sur le bouton ![](/images/Mesh_Evaluation.svg) Évaluer et réparer un maillage...
   * Sélectionnez l'option **Maillages → Analyser → ![](/images/Mesh_Evaluation.svg) Évaluer et réparer un maillage...** du menu.
...
10. Les erreurs seront indiquées dans la fenêtre de dialogue, ainsi que, avec des marqueurs jaunes et rouges, dans la [vue 3D](/3D_view/fr "3D view/fr").
...
* La réparation d'un maillage peut signifier que les éléments problématiques sont supprimés du maillage, ce qui entraîne des trous. Les trous peuvent être fermés avec les commandes [Mesh Remplir les trous](/Mesh_FillupHoles/fr "Mesh FillupHoles/fr"), [Mesh Boucher un trou](/Mesh_FillInteractiveHole/fr "Mesh FillInteractiveHole/fr") et [Mesh Ajouter une facette](/Mesh_AddFacet/fr "Mesh AddFacet/fr").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Mesh_Evaluation/fr&oldid=1495790>"