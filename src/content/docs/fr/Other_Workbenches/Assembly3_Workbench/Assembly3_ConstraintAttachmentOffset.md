---
title: Assembly3 Contrainte décalage d'accrochage
---
:::caution
...
|  |
| --- |
| Assembly3 Contrainte décalage d'accrochage |
| Emplacement du menu |
| *Aucun* |
| Ateliers |
...
3. Appuyez sur le bouton ![](/images/Assembly_ConstraintAttachmentOffset.svg) Create "AttachmentOffset" constraint.
4. Les deux objets restent à leur position.

Retrieved from "<http://wiki.freecad.org/index.php?title=Assembly3_ConstraintAttachmentOffset/fr&oldid=1536566>"