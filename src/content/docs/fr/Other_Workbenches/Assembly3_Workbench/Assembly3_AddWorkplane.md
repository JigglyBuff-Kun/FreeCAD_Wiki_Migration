---
title: Assembly3 Ajouter un plan de travail
---
:::caution
...
La commande ![](/images/Assembly_Add_Workplane.svg) Ajouter un plan de travail ajoute un plan de travail à un assemblage actif.
...
1. Activez la commande ![](/images/Assembly_Add_Workplane.svg) **Ajouter un plan de travail** en utilisant l'une des commandes suivantes :
   * Le bouton ![](/images/Assembly_Add_Workplane.svg) Add workplane.
   * L'option de menu **Assembly3 → Workplane and origin → ![](/images/Assembly_Add_Workplane.svg) Add workplane**.

Retrieved from "<http://wiki.freecad.org/index.php?title=Assembly3_AddWorkplane/fr&oldid=1536567>"