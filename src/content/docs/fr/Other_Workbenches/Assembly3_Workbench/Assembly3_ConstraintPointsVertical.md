---
title: Assembly3 Contrainte alignement vertical
---
:::caution
...
|  |
| --- |
| Assembly3 Contrainte alignement vertical |
| Emplacement du menu |
| *Aucun* |
| Ateliers |
...
Sur la base de l'ICS d'un élément planaire, les origines des ICS des deux autres éléments sont positionnées de manière à avoir des coordonnées x identiques.
...
4. Appuyez sur le bouton ![](/images/Assembly_ConstraintPointsVertical.svg) Points vertical.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Assembly3_ConstraintPointsVertical/fr&oldid=1536666>"