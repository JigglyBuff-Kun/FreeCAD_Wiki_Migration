---
title: Assembly3 Contrainte longueur différence
---
:::caution
...
|  |
| --- |
| Assembly3 Contrainte longueur différence |
| Emplacement du menu |
| *Aucun* |
| Ateliers |
...
2. Appuyez sur le bouton ![](/images/Assembly_ConstraintLengthDifference.svg) Length difference.
3. Définissez la valeur **Différence** dans le panneau des propriétés.
4. Appuyez sur le bouton ![](/images/Assembly3_workbench_icon.svg) [Solve constraints](/Assembly3_ResolveConstraints/fr "Assembly3 ResolveConstraints/fr") ou sur le ![](/images/Assembly_QuickSolve.svg) [Quick solve](/Assembly3_QuickSolve/fr "Assembly3 QuickSolve/fr") pour recalculer
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Assembly3_ConstraintLengthDifference/fr&oldid=1536582>"