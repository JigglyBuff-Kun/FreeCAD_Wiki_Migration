---
title: Assembly3 Ajouter un plan de travail XZ
---
:::caution
...
|  |
| --- |
| Assembly3 Ajouter un plan de travail XZ |
| Emplacement du menu |
...
La commande ![](/images/Assembly_Add_WorkplaneXZ.svg) Ajouter un plan de travail XZ ajoute un plan de travail XZ à un assemblage actif.
...
1. Activez la commande ![](/images/Assembly_Add_WorkplaneXZ.svg) **Ajouter un plan de travail XZ** en utilisant l'une des commandes suivantes :
   * Le bouton ![](/images/Assembly_Add_WorkplaneXZ.svg) Add workplane XZ.
   * L'option de menu **Assembly3 → Workplane and origin → ![](/images/Assembly_Add_WorkplaneXZ.svg) Add workplane XZ**.

Retrieved from "<http://wiki.freecad.org/index.php?title=Assembly3_AddXZWorkplane/fr&oldid=1536583>"