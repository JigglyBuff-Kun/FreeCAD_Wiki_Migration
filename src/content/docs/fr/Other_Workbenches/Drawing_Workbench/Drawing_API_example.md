---
title: Exemple d'interface de programmation pour dessin
---
## Introduction

Le flux de travail de l'interface utilisateur graphique pour l' [atelier Drawing](/Drawing_Workbench/fr "Drawing Workbench/fr") est limité. Utiliser un script pour l'interface est plus intéressante.
...
*Voir aussi :* [Extension dimensionnement Drawing](/Drawing_Dimensioning_Addon/fr "Drawing Dimensioning Addon/fr")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Drawing_API_example/fr&oldid=1536787>"