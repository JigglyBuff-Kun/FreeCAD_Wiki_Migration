...
| Description                                                                                                                                                                                                                                                                                                                                                                                            |
| Affichez et modifiez rapidement les coordonnées de placement d'un objet sélectionné, directement ou par le biais d'expressions. Version macro : 1.0 Date dernière modification : 2023-08-01 Version FreeCAD : Créé et testé en 0.21 Téléchargement : [Express Placement](https://raw.githubusercontent.com/screeneroner/fc-express-placement/master/fc-express-placement.FCMacro) Auteur: screeneroner |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                                 |
...
_Si vous trouvez cette extension utile et que vous estimez qu'elle vaut la peine de m'offrir deux-trois tasses de café en reconnaissance de mon travail, vous pouvez le faire à tout moment via [☕ Buy me a coffee](https://www.buymeacoffee.com/screeneroner)_
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Express_Placement/fr&oldid=1499917>"
