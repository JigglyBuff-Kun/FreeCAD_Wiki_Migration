...
| Description                                                                                                                                                                                                                                                                                 |
| Cette macro crée une face et un sketch à partir d'un fichier DXF. Version macro : 2.0 Date dernière modification : 2017-10-23 Version FreeCAD : All Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/6d/Macro_DXF_to_Face_and_Sketch.png) Auteur: shoogen, easyw-fc |
| Auteur                                                                                                                                                                                                                                                                                      |
...
- Macro originelle [Macro Creating faces from a DXF file](/Macro_Creating_faces_from_a_DXF_file "Macro Creating faces from a DXF file")

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_DXF_to_Face_and_Sketch/fr&oldid=692136>"
