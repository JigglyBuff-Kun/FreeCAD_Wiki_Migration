...
|                                                                                                                                                                                                                                  |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon](/File:Text-x-python.png "Generic macro icon") 3DXML_import                                                                                                                                                  |
| Description                                                                                                                                                                                                                      |
...
Forum : Pas de fil de discussion dédié, mais issu du [forum post](https://forum.freecadweb.org/viewtopic.php?f=8&t=28199).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_3DXML_import/fr&oldid=1210530>"
