...
| Cross_section                                                                                                                                                                                                                                                                                                |
| Description                                                                                                                                                                                                                                                                                                  |
| Affiche de manière interactive une section transversale avec l'aide d'une barre coulissante. Version macro : 0.10 Date dernière modification : 2020-12-19 Version FreeCAD : 0.15 et plus Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f5/Macro_cross_section.png) Auteur: aleph0 |
| Auteur                                                                                                                                                                                                                                                                                                       |
| [aleph0](/index.php?title=User:Aleph0&action=edit&redlink=1 "User:Aleph0 (page does not exist)")                                                                                                                                                                                                             |
| Téléchargement                                                                                                                                                                                                                                                                                               |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f5/Macro_cross_section.png)                                                                                                                                                                                                                          |
| Liens                                                                                                                                                                                                                                                                                                        |
...
Affiche de manière interactive une section transversale d'un objet à l'aide d'une barre coulissante.
...
- Pour exécuter la macro, d'abord la télécharger à partir de cette page et installez la dans votre répertoire de macros,
- Utilisez alors le menu pour appeler la liste des macros et double-cliquez sur **Macro cross section**.
- la macro affiche une section par défaut et affiche une fenêtre pour vous permettre de définir les paramètres de coupe transversale.
- La fermeture de la fenêtre pop-up va restaurer la scène à son état original.

## LIENS

Voir le forum : [forum](http://forum.freecadweb.org/viewtopic.php?f=28&t=15084&p=120159#p120159)

![](/images/Macro_Cross_Section_01.png)

Regardez en bas à droite: "Gardez la vue en coupe"
...
La discussion sur le forum [Posting a new macro](http://forum.freecadweb.org/viewtopic.php?f=22&t=14049)

## Version

ver 00.10 19/12/2020: mise à niveau par Chris_G correctif pour exclure App.Part des objets d'entrée, voir [macro de coupe ne fonctionne pas sur les corps dans un conteneur de pièces](https://forum.freecadweb.org/viewtopic.php?f=22&t=53423)

ver 00.09 31/08/2019 : upgrade by g.becu ajout de la ligne 334 #[Sezione Dinamica](https://forum.freecadweb.org/viewtopic.php?f=28&t=15084&start=20#p330351)

ver 00.08 04/07/2019 : upgrade remplacer Tab par Space pary duke24 [Macro cross_section update](https://forum.freecadweb.org/viewtopic.php?f=13&t=37449)

ver 00.07 17/09/2017 : upgrade multiple objets avec différentes couleurs par Gift
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_cross_section/fr&oldid=831474>"
