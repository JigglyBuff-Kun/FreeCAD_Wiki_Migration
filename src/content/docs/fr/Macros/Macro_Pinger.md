...
| Macro Pinger                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Utilisez cette macro pour envoyer facilement un message aux utilisateurs du forum FreeCAD. Sélectionnez l'utilisateur dans la liste déroulante, cliquez sur Ping, collez le code dans le message du forum. Vous pouvez ajouter de nouveaux utilisateurs. Version macro : 1.81 Date dernière modification : 2022.03.28 Version FreeCAD : 0.19 Téléchargement : [Icône de la barre d'outils](https://wiki.freecadweb.org/images/6/67/Pinger_Icon.svg) Auteur: TheMarkster |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| [TheMarkster](/index.php?title=User:TheMarkster&action=edit&redlink=1 "User:TheMarkster (page does not exist)")                                                                                                                                                                                                                                                                                                                                                         |
| Téléchargement                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [Icône de la barre d'outils](https://wiki.freecadweb.org/images/6/67/Pinger_Icon.svg)                                                                                                                                                                                                                                                                                                                                                                                   |
| Liens                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| _None_                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Voir aussi                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [Macro Snip](/Macro_Snip/fr "Macro Snip/fr")                                                                                                                                                                                                                                                                                                                                                                                                                            |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

## Description

Utilisez cette macro pour envoyer un ping à un autre utilisateur du forum afin que celui-ci reçoive une notification. Pour effectuer un ping, il faut connaître le nom d'utilisateur exact et le numéro d'identification de l'utilisateur. Vous devez également connaître la syntaxe requise pour produire le ping. Le moins que l'on puisse dire, c'est qu'elle est très peu conviviale. La macro Pinger est là pour vous sauver la mise. Exécutez la macro, sélectionnez l'utilisateur que vous souhaitez pinger, cliquez sur le bouton Ping, copiez-collez le code dans le message du forum.

![](/images/Pinger_scr.png)

Capture d'écran de Pinger

## Paramètres

La macro prend en charge les paramètres utilisateur, qui sont utilisés pour la liste des utilisateurs ajoutés. Ils se trouvent dans User parameter:Plugins/Pinger sous le nom de "AddedUsers", une chaîne contenant la représentation d'un dictionnaire Python.
...
La discussion sur forum [Pinger macro](https://forum.freecadweb.org/viewtopic.php?f=22&t=48872)

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Pinger/fr&oldid=1534816>"
