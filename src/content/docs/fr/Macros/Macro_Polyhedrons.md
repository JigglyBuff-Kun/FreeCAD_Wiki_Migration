...
| Macro Polyhedrons                                                                                                                                                                                                                                                                                                                                                                                           |
| Description                                                                                                                                                                                                                                                                                                                                                                                                 |
| Cette macro crée des polyèdres paramétriques : tétraèdre, hexaèdre, octaèdre, dodécaèdre, icosaèdre, icosaèdre_tronqué Les paramètres rayon et côté peuvent être ajustés. Version macro : 01.02 Date dernière modification : 2020-01-10 Version FreeCAD : Toutes Téléchargement : [Icône de la barre d'outils](https://wiki.freecad.org/images/a/a4/Dodecahedron.svg) Auteur: Eddy Verlinden, Genk, Belgium |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Téléchargement                                                                                                                                                                                                                                                                                                                                                                                              |
| [Icône de la barre d'outils](https://wiki.freecad.org/images/a/a4/Dodecahedron.svg)                                                                                                                                                                                                                                                                                                                         |
| Liens                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| _None_                                                                                                                                                                                                                                                                                                                                                                                                      |
| Voir aussi                                                                                                                                                                                                                                                                                                                                                                                                  |
| [Macro Pyramid](/Macro_Pyramid/fr "Macro Pyramid/fr")                                                                                                                                                                                                                                                                                                                                                       |
|                                                                                                                                                                                                                                                                                                                                                                                                             |
|                                                                                                                                                                                                                                                                                                                                                                                                             |
...
- Si vous êtes également intéressé par les pyramides, vous pouvez utiliser la ![](/images/Pyramidicon.svg) [macro Pyramid](/Macro_Pyramid/fr "Macro Pyramid/fr").
...
- Utilisez le ![](/images/Std_AddonMgr.svg) [Gestionnaire des extensions](/Std_AddonMgr/fr "Std AddonMgr/fr") pour installer la macro via **Outils → Gestionnaire des extensions → onglet Macros**
...
- Cliquez sur `polyhedrons.py` puis cliquez sur le bouton Execute.
...
Icône de la barre d'outils ![](/images/Dodecahedron.svg)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Polyhedrons/fr&oldid=1345905>"
