...
| Description                                                                                                                                                                                                                                                                                                                                                    |
| La macro peut déplier de simples pièces de tôle. Les pièces doivent avoir partout la même épaisseur de matériau que celle des pièces en tôle. Version macro : 17.0 Date dernière modification : 2018-08-14 Version FreeCAD : 17.0 Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/1/16/Macro_Sheet_Metal_Unfolder.png) Auteur: ulrich1a |
| Auteur                                                                                                                                                                                                                                                                                                                                                         |
...
Cette macro permet de déplier des pièces simples de métal en feuille. Ces pièces doivent posséder une épaisseur de paroi uniforme (ce qui caractérise les pièces de métal en feuille). Voyez l'exemple :
...
Sélectionner une face plane de la pièce dans la vue 3D. Lancer la macro.
...
La discussion du forum (en anglais) [Sheet metal: add wall tool](http://forum.freecadweb.org/viewtopic.php?f=24&t=8789)

Une version mise à jour est disponible ici : <https://github.com/ulrich1a/sheet_ufo>
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Sheet_Metal_Unfolder/fr&oldid=1423030>"
