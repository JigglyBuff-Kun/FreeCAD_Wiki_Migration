...
| MatrixTransform                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Transforme unobjet en modifiant la matrice 3x3 (parametrique). Cette macro est composée de 2 macro: **MatrixTransform.FCMacro** (lanceur) et **MatrixTransform.py** (exécuteur). Le **.FCMacro** est installé avec AddonManager vous devez installer la macro **.py** manuellement. Lien des deux macros: [MatrixTransform.FCMacro](https://github.com/DeepSOIC/FreeCAD-Macros/raw/master/MatrixTransform/MatrixTransform.FCMacro) (lanceur) [MatrixTransform.py](https://github.com/DeepSOIC/FreeCAD-Macros/raw/master/MatrixTransform/MatrixTransform.py) (exécuteur) Version macro : 1.1 Date dernière modification : 2024-12-09 Version FreeCAD : All Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/d/db/Macro_MatrixTransform.png) Auteur: DeepSOIC |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_MatrixTransform/fr&oldid=1515960>"
