...
| Section                                                                                                                                                                                                                                                                                       |
| Description                                                                                                                                                                                                                                                                                   |
| Outil alternatif à l'outil [Part Section](/Part_Section/fr "Part Section/fr") (parametrique) Version macro : 1.1 Date dernière modification : 2018-04-28 Version FreeCAD : All Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f7/Part_Section.svg) Auteur: DeepSOIC |
| Auteur                                                                                                                                                                                                                                                                                        |
...
L'outil [Part Section](/Part_Section/fr "Part Section/fr") produit des bords avec de continuité et un grand nombre de segments (nœuds), ce qui n'est pas très approprié pour l'outil [Sweep](/Part_Sweep/fr "Part Sweep/fr").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Section/fr&oldid=692497>"
