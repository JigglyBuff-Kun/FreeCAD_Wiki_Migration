...
| Description                                                                                                                                                                                                                                                                          |
| La macro permet de dérouler la surface d'une forme et la placer dans une page. Version macro : 1.1 Date dernière modification : 2022-07-24 Téléchargement : [Icône de la barre d'outils](https://wiki.freecad.org/images/b/ba/Macro_Unroll_Ruled_Surface.png) Auteur: Hervé B., heda |
| Auteur                                                                                                                                                                                                                                                                               |
| [Hervé B., heda](/index.php?title=User:Herv%C3%A9_B.,_heda&action=edit&redlink=1 "User:Hervé B., heda (page does not exist)")                                                                                                                                                        |
| Téléchargement                                                                                                                                                                                                                                                                       |
| [Icône de la barre d'outils](https://wiki.freecad.org/images/b/ba/Macro_Unroll_Ruled_Surface.png)                                                                                                                                                                                    |
| Liens                                                                                                                                                                                                                                                                                |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Unroll_Ruled_Surface/fr&oldid=1346091>"
