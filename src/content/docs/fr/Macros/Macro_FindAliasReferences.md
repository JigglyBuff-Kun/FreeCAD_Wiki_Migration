...
| FindAliasReferences                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Cette macro analysera toutes les expressions de tous les documents ouverts, puis affichera, dans la vue du rapport, toutes les expressions contenant l'alias ou, si l'alias n'est pas défini, la valeur dans la ou les cellules sélectionnées de la feuille de calcul. Macro version: 2024.04.09 Last modified: 2024-04-09 FreeCAD version: 0.22 Download: [Icône de la barre d'outils](https://wiki.freecad.org/images/b/bd/FindAliasReferences.png?20240117201630) Author: RoyW |
| Author                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [RoyW](/index.php?title=User:RoyW&action=edit&redlink=1 "User:RoyW (page does not exist)")                                                                                                                                                                                                                                                                                                                                                                                        |
| Download                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [Icône de la barre d'outils](https://wiki.freecad.org/images/b/bd/FindAliasReferences.png?20240117201630)                                                                                                                                                                                                                                                                                                                                                                         |
| Links                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
Icône de la barre d'outils ![](/images/FindAliasReferences.png)
...
La discussion sur le forum [FindAlaisReferences Macro](https://forum.freecad.org/viewtopic.php?t=84197)

## Version

2024.01.05 : première

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FindAliasReferences/fr&oldid=1395963>"
