...
| Macro FCInfoGlass                                                                                                                                                                                                                                                 |
| Description                                                                                                                                                                                                                                                       |
| Donne une série d'informations sur l'objet avec affichage dans la vue 3D. Version macro : 00.05 Date dernière modification : 2016-08-28 Téléchargement : [Icône de la barre d'outils](https://wiki.freecad.org/images/6/6b/Macro_FCInfoGlass.png) Auteur: Mario52 |
| Auteur                                                                                                                                                                                                                                                            |
| [Mario52](/User:Mario52 "User:Mario52")                                                                                                                                                                                                                           |
| Téléchargement                                                                                                                                                                                                                                                    |
| [Icône de la barre d'outils](https://wiki.freecad.org/images/6/6b/Macro_FCInfoGlass.png)                                                                                                                                                                          |
| Liens                                                                                                                                                                                                                                                             |
...
- ![colorize ="black"](/images/Macro_FCInfoGlass_01.png)
...
L'icône **Macro_FCInfoGlass.FCMacro** ![FCInfoGlass](/images/Macro_FCInfoGlass.png)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCInfoGlass/fr&oldid=1345197>"
