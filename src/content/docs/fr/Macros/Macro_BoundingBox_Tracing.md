...
| Description                                                                                                                                                                                                                                                                                                                 |
| Crée un contour rouge de la BoundingBox (6 faces avec 6 rectangles) d'un objet, crée le volume du boundBox. Version macro : 0.12 Date dernière modification : 2021/07/10 Version FreeCAD : Toutes versions Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/60/BoundBoxTracing.png) Auteur: Mario52 |
| Auteur                                                                                                                                                                                                                                                                                                                      |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_BoundingBox_Tracing/fr&oldid=1279472>"
