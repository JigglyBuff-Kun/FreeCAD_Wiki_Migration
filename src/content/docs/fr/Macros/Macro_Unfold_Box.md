...
| Macro Unfold Box                                                                                                                                                                                                                                                                                             |
| Description                                                                                                                                                                                                                                                                                                  |
| La macro permet de déplier les surfaces d'un objet de n'importe quelle forme et la dessiner sur une page. Version macro : 1.1 Date dernière modification : 2022-07-28 Téléchargement : [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/e/e4/Macro_Unfold_Box.png) Auteur: Hervé B., heda |
| Auteur                                                                                                                                                                                                                                                                                                       |
| [Hervé B., heda](/index.php?title=User:Herv%C3%A9_B.,_heda&action=edit&redlink=1 "User:Hervé B., heda (page does not exist)")                                                                                                                                                                                |
| Téléchargement                                                                                                                                                                                                                                                                                               |
| [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/e/e4/Macro_Unfold_Box.png)                                                                                                                                                                                                               |
| Liens                                                                                                                                                                                                                                                                                                        |
...
1. Sélectionnez une boîte réalisée avec l'outil [Part Lissage](/Part_Loft/fr "Part Loft/fr") par exemple.
2. [Draft Désagréger](/Draft_Downgrade/fr "Draft Downgrade/fr") la divise en plusieurs faces.
...
4. Utilisez [Draft Déplacer](/Draft_Move/fr "Draft Move/fr") et [Draft Pivoter](/Draft_Rotate/fr "Draft Rotate/fr") pour repositionner les faces clonées dépliées (une poignée de clics par face lorsque le snapping est utilisé).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Unfold_Box/fr&oldid=1210102>"
