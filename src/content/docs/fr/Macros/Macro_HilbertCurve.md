...
| HilbertCurve                                                                                                                                                                                                                                                                                                               |
| Description                                                                                                                                                                                                                                                                                                                |
| Cette macro crée une courbe de Hilbert en 2 ou 3 dimensions avec de nombreuses itérations. Version macro : 1.2.0 Date dernière modification : 2021-02-13 Version FreeCAD : 0.16 to 0.19 Téléchargement : [Icône de la barre d'outils](https://wiki.freecad.org/images/6/69/Hilbert_curve_icon.png) Auteur: Simone Bignetti |
| Auteur                                                                                                                                                                                                                                                                                                                     |
| [Simone Bignetti](/index.php?title=User:Simone_Bignetti&action=edit&redlink=1 "User:Simone Bignetti (page does not exist)")                                                                                                                                                                                                |
| Téléchargement                                                                                                                                                                                                                                                                                                             |
| [Icône de la barre d'outils](https://wiki.freecad.org/images/6/69/Hilbert_curve_icon.png)                                                                                                                                                                                                                                  |
| Liens                                                                                                                                                                                                                                                                                                                      |
...
2. Dans la boîte de dialogue qui s'ouvre, choisissez les paramètres de la courbe de Hilbert:
   - Sélectionnez si la courbe doit être à 2 dimensions: ![](/images/CheckBoxTrue.svg) 2D, ou 3 dimensions: ![](/images/CheckBoxFalse.svg) 3D.
   - Spécifiez le nombre d'itérations 1 ![](/images/SpinBox.svg). _Attention!_ L'augmentation du nombre d'itérations augmentera également le temps de calcul.
   - Spécifiez la longueur du segment de fil: 10.00 ![](/images/SpinBox.svg).
...
La polyligne de Hilbert en 3D et 2 itérations.

Vous pouvez utiliser une courbe de Hilbert comme chemin pour un [Part Balayage](/Part_Sweep/fr "Part Sweep/fr"), mais il est préférable d'appliquer d'abord un rayon au fil, sinon le balayage sera mal formé.

![La courbe de Hilbert avec un rayon](/images/HilbertCurveWireRadius.png)

La courbe de Hilbert avec un rayon
...
![Un solide obtenu par le balayage d'un cercle par la courbe de Hilbert](/images/HilbertCurveSweep.png)

Un solide obtenu par le balayage d'un cercle par la courbe de Hilbert
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_HilbertCurve/fr&oldid=1345450>"
