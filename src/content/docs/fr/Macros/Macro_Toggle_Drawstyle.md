...
| Description                                                                                                                                                                                                                                                                            |
| Cette macro permet de basculer style d'affichage de l'objet sélectionné. Version macro : 2.0 Date dernière modification : 2020-02-02 Version FreeCAD : >=0.17 Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/0b/Macro_Toggle_Drawstyle.png) Auteur: Piffpoof |
| Auteur                                                                                                                                                                                                                                                                                 |
| [Piffpoof](/User:Piffpoof "User:Piffpoof")                                                                                                                                                                                                                                             |
| Téléchargement                                                                                                                                                                                                                                                                         |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/0b/Macro_Toggle_Drawstyle.png)                                                                                                                                                                                                 |
| Liens                                                                                                                                                                                                                                                                                  |
...
| _None_                                                                                                                                                                                                                                                                                 |
| Voir aussi                                                                                                                                                                                                                                                                             |
| [Macro Toggle Drawstyle Optimized](/Macro_Toggle_Drawstyle_Optimized/fr "Macro Toggle Drawstyle Optimized/fr") pour tous les langages                                                                                                                                                  |
|                                                                                                                                                                                                                                                                                        |
|                                                                                                                                                                                                                                                                                        |
...
- voir [Comment installer une macro](/How_to_install_macros/fr "How to install macros/fr")
- voir [Comment créer une barre d'outils personnalisée](/Customize_Toolbars/fr "Customize Toolbars/fr")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Toggle_Drawstyle/fr&oldid=692566>"
