---
title: Shake Sketch (Secouer l'esquisse)
---
...
| Macro Shake Sketch                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Secoue une esquisse afin de découvrir ses parties non contraintes. Mettez vous en mode édition dans une esquisse et lancez la macro. La macro ajoute un déplacement aléatoire sur tous les points de l'esquisse. Les contraintes de l'esquisse sont alors résolues, les parties contraintes conservent leur position, les parties libres se déplacent. (Utilisez les boutons Undo (Ctrl+Z) et Redo (Ctrl+Y) (étiqueté "Shake Sketch") ou travaillez sur une copie de votre fichier car la macro "démonte tout" pour afficher et vous devrez peut-être recommencer). Version macro : 1.3 Date dernière modification : 2022-06-01 Version FreeCAD : Toutes Téléchargement : [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/4/4a/Macro_Shake_Sketch.png) Auteur: Gaël Ecorchard, heda |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| Téléchargement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/4/4a/Macro_Shake_Sketch.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Liens                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Shake_Sketch/fr&oldid=1304215>"
