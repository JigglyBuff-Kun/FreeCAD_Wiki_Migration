...
| StraightenObject                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Cette macro aligne un objet avec le système de coordonnées FC en fonction des éléments de référence (face/arête) Cette macro a été écrite principalement pour réaligner les objets importés (par exemple, STEP) avec les principaux plans / axes de FreeCAD. utilisez la macro, sélectionnez le ou les éléments de référence, éventuellement d'autres objets, puis exécutez la macro. Si vous souhaitez aligner votre objet avec un autre plan/axe, utilisez la macro puis la fonction Transformer de FreeCAD. Voir le chapitre "Détails" pour la sélection multi-objets. Version macro : 0.8 Date dernière modification : 2019-06-10 Version FreeCAD : 0.17+ Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/c/c9/Macro_StraightenObject.png) Auteur: OpenBrain |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
Pour utiliser la macro, sélectionnez le ou les éléments de référence, éventuellement d'autres objets, puis exécutez la macro.
...
La macro est disponible via le [gestionnaire des extensions](/Std_AddonMgr/fr "Std AddonMgr/fr"). Le code est fourni sur cette page pour plus de commodité au cas où le système utilisateur n'aurait pas git-python. Bien qu'elle soit à jour, la dernière version est toujours disponible sur [FreeCAD-macro repository](https://github.com/FreeCAD/FreeCAD-macros/blob/master/Utility/StraightenObject.FCMacro)
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Une face de référence                                                      | Tout (facultatif)                                              | Le premier objet est tourné/déplacé de sorte que la face de référence se trouve sur le plan XY, son centre de masse étant à l'origine. Les autres objets sélectionnés subissent le même mouvement que le premier objet                                                    |
| Une arête de référence (ou 2 sommets de référence)                         | Tout (facultatif)                                              | Le premier objet est tourné autour de son centre de masse de sorte que le bord de référence soit parallèle à l'axe Y (aucun décalage n'est appliqué). Les autres objets sélectionnés subissent le même mouvement que le premier objet                                     |
| Une face de référence + une arête de référence (ou 2 sommets de référence) | Tout (facultatif)                                              | Le premier objet est tourné / déplacé de sorte que la face de référence se trouve sur le plan XY (son centre de masse étant à l'origine) et le bord de référence est parallèle à l'axe Y. Les autres objets sélectionnés subissent le même mouvement que le premier objet |
| 2+ visages + tout                                                          | Tout (facultatif)                                              | La macro échoue                                                                                                                                                                                                                                                           |
| 2+ arêtes (ou 3+ sommets) + tout                                           | Tout (facultatif)                                              | La macro échoue                                                                                                                                                                                                                                                           |
| Toute autre combinaison                                                    | Tout (facultatif)                                              | La macro échoue                                                                                                                                                                                                                                                           |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_StraightenObject/fr&oldid=1210591>"
