...
| Description                                                                                                                                                                                                                                                                                                                                   |
| Créez l'opération booléenne avec les fils sélectionnés. Appuyez sur le bouton 2d pour créer l'opération booléenne sur un fil 2D. Version macro : 0.02c Date dernière modification : 2020/04/11 Version FreeCAD : 0.19 Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f2/Macro_FCWire_To_Volume.png) Auteur: Mario52 |
| Auteur                                                                                                                                                                                                                                                                                                                                        |
...
- SpinBox ![](/images/SpinBox.svg) : Donnez l'épaisseur

### Choix

#### Booléen

![](/images/RadioButtonTrue.svg) Intersection : Opération booléenne

![](/images/RadioButtonFalse.svg) Substraction : Opération booléenne

![](/images/RadioButtonFalse.svg) Union : Opération booléenne

![](/images/RadioButtonFalse.svg) Xor : Opération booléenne

#### Axes

![](/images/RadioButtonFalse.svg) X Axis : Axe X

![](/images/RadioButtonFalse.svg) Y Axis : Axe Y

![](/images/RadioButtonTrue.svg) Z Axis : Axe Z (défaut)

![](/images/RadioButtonFalse.svg) Direction : (Non fonctionnel plus tard)

#### Option

![](/images/CheckBoxTrue.svg) Single object : Si la case à cocher est cochée, l'objet se trouve sur un seul objet sinon l'objet créé conserve la hiérarchie de la construction de l'objet

![](/images/CheckBoxTrue.svg) Hidden : Les objets originaux sont cachés

![](/images/CheckBoxFalse.svg) Color : S'il a vérifié l'objet résultant est coloré en rouge

#### Commande

- Create 2D : Créez l'objet booléen 2D (fil de contour avec `Draft.makeShape2DView()`)
...
L'icône pour votre barre d'outils ![](/images/Macro_FCWire_To_Volume.png)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCWire_To_Volume/fr&oldid=693826>"
