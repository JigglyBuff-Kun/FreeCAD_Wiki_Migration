...
| Macro Dump Objects                                                                                                                                                                                                                                                                                                                                             |
| Description                                                                                                                                                                                                                                                                                                                                                    |
| Cette macro génère une liste de tous les objets du document en cours - la liste peut se trouver dans une fenêtre ou dans la Vue rapport. Version macro : 0.3 Date dernière modification : 2023-01-14 Version FreeCAD : 0.20 Téléchargement : [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/2/2e/Macro_Dump_Objects.png) Auteur: Piffpoof |
| Auteur                                                                                                                                                                                                                                                                                                                                                         |
| [Piffpoof](/User:Piffpoof "User:Piffpoof")                                                                                                                                                                                                                                                                                                                     |
| Téléchargement                                                                                                                                                                                                                                                                                                                                                 |
| [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/2/2e/Macro_Dump_Objects.png)                                                                                                                                                                                                                                                               |
| Liens                                                                                                                                                                                                                                                                                                                                                          |
...
- Voir [Comment installer des macros](/How_to_install_macros/fr "How to install macros/fr") pour des informations sur la façon d'installer le code de cette macro.
- Voir [Personnaliser les barres d'outils](/Customize_Toolbars/fr "Customize Toolbars/fr") pour savoir comment l'installer en tant que bouton sur une barre d'outils.
...
Selon les paramètres sélectionnés dans la première fenêtre, le rapport sera affiché dans la vue Rapport ou dans une fenêtre.
Les informations afficheront tous les objets du document en cours. Certains des avantages à attendre sont la détection de:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Dump_Objects/fr&oldid=1221035>"
