---
title: Replace Part in Assembly
---
...
| Description                                                                                                                                                                                                                                          |
| Remplace une pièce dans un assemblage par une autre. Version macro : 1.0 Date dernière modification : 2014-09-10 Version FreeCAD : All Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/07/Replace_Part.png) Auteur: ralvejd |
| Auteur                                                                                                                                                                                                                                               |
...
Surtout quand on fait des "Assemblages" avec de simples pièces copiées, il faut remplacer une pièce par une autre de temps en temps.
Ensuite, vous pouvez utiliser cette macro pour ce faire.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Replace_Part_in_Assembly/fr&oldid=693143>"
