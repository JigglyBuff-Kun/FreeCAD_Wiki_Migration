---
title: Iges PyImporter
---

|                                                                                                                                                                                                                                  |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon](/File:Text-x-python.png "Generic macro icon") Iges_PyImporter                                                                                                                                               |
| Description                                                                                                                                                                                                                      |
| Importer un fichier IGES avec l'entité 128 dans FreeCAD. Version macro : 0.2 Date dernière modification : 2022-03-26 Version FreeCAD : Toutes Auteur: heda                                                                       |
| Auteur                                                                                                                                                                                                                           |
...
Importation automatique de fichiers iges ascii avec des surfaces de B-spline, entité 128, par exemple créés avec FreeShip, qui semble toujours être mal géré par [OCC](/OpenCASCADE/fr "OpenCASCADE/fr").

De plus amples informations sont disponibles dans la `docstring` de la macro.
...
Lancez la macro et sélectionnez un fichier IGES.
...
v0.2 2022-03-26 : première version
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Iges_PyImporter/fr&oldid=1474555>"
