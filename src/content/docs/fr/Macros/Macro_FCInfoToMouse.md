...
| Macro FCInfoToMouse                                                                                                                                                                                                                                                                                        |
| Description                                                                                                                                                                                                                                                                                                |
| Fournit des informations sur les coordonnées, la longueur et les angles en temps réel à côté du pointeur de la souris. Version macro : 00.04 Date dernière modification : 2018-03-27 Téléchargement : [Icône de la barre d'outils](https://wiki.freecad.org/images/1/10/FCInfoToMouse.png) Auteur: Mario52 |
| Auteur                                                                                                                                                                                                                                                                                                     |
| [Mario52](/User:Mario52 "User:Mario52")                                                                                                                                                                                                                                                                    |
| Téléchargement                                                                                                                                                                                                                                                                                             |
| [Icône de la barre d'outils](https://wiki.freecad.org/images/1/10/FCInfoToMouse.png)                                                                                                                                                                                                                       |
| Liens                                                                                                                                                                                                                                                                                                      |
...
Fournit des informations sur les coordonnées, la longueur et les angles en temps réel à côté du pointeur de la souris dans une annotation à bulles affichée dans la [Vue 3D](/3D_view/fr "3D view/fr").
...
1. Installez la macro FCInfoToMouse dans votre répertoire de macros via le [Gestionnaire des extensions](/Std_AddonMgr/fr "Std AddonMgr/fr").
2. Lancez la [Macro](/Macros/fr "Macros/fr")
...
: _ **X1, Y1, Z1** : Coordonnées initiales du 1er clic de la souris
_ **X2, Y2, Z2** : Coordonnées en cours de la souris
_ **L** : Longueur entre le premier clic de la souris et l'emplacement du pointeur en cours de la souris
_ **XY, YZ, XZ** : Angles entre le 1er point et le pointeur de la souris en mouvement dans les plans XY, YZ, et XZ
...
L'icône **FCInfoToMouse.png** ![FCInfoToMouse](/images/FCInfoToMouse.png) pour votre [barre d'outils](http://www.freecadweb.org/wiki/index.php?title=Customize_ToolsBar/fr)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCInfoToMouse/fr&oldid=1345209>"
