...
| Description                                                                                                                                                                                                                                                                    |
| Extrait les fils constituants les bords des mailles sélectionnées Version macro : 1 Date dernière modification : 2016-12-17 Version FreeCAD : All Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/2/28/Macro_Extract_Wires_from_Mesh.png) Auteur: Yorik |
| Auteur                                                                                                                                                                                                                                                                         |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Extract_Wires_from_Mesh/fr&oldid=1086153>"
