...
| Macro_PropertyMemo                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Nouvelle interface graphique modifiée pour fonctionner en HD dpi (QGridLayout), uniquement la version FC 0.19 et plus (PySide2 Qt5) Pour la version précédente, voir [Macro_FCPropertyMemo.FCMacro](https://gist.githubusercontent.com/mario52a/eafcf79703fab64b8da5/raw/51702c17fb4b205da52488bf2a239011bbbc9da5/Macro_FCPropertyMemo.FCMacro) et l'installer manuellement. Cette macro crée une propriété supplémentaire (mémo ou autre texte) pour votre objet (ne fonctionne qu'avec les objets Draft). Version macro : 2020-05-17 Version FreeCAD : 0.19 Téléchargement : [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/f/f2/PropertyMemo.png) Auteur: Mario52 |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [Mario52](/User:Mario52 "User:Mario52")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Téléchargement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/f/f2/PropertyMemo.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Liens                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
* ![](/images/CheckBoxTrue.svg) UnCheck for String : case à cocher qui détermine le type de mémo. Cochez la case pour changer le type en chaîne au lieu de la liste.

![Exemple de propriété mémo](/images/Macro_FCPropertyMemo_01.png)

Exemple de propriété mémo

- **Memo** : titre de la propriété : `Memo`.
- **Name** : nom de la propriété : `Name`.
- Le champ est vide.

- ![Exemple de propriété mémo utilisant une liste](/images/Macro_FCPropertyMemo_02.png)

  Exemple de propriété mémo utilisant une liste

- ![Modification de la liste](/images/Macro_FCPropertyMemo_03.png)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_PropertyMemo/fr&oldid=1336984>"
