...
| Half_turn_stairs                                                                                                                                                                                                                                                                                                                                                                                    |
| Description                                                                                                                                                                                                                                                                                                                                                                                         |
| Cette macro crée un escalier tournant à gauche ou à droite. La conception des escaliers est définie dans le fichier stairs.dat (vous devez copier les données qui se trouvent dans la page wiki) Version macro : 1.0 Date dernière modification : 2016-10-17 Version FreeCAD : All Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/b/b8/Half_turn_stairs.png) Auteur: Berner |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                              |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Half_turn_stairs/fr&oldid=1528895>"
