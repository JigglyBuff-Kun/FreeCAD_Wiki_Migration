...
| Image Scaling                                                                                                                                                                                                                                   |
| Description                                                                                                                                                                                                                                     |
| Met une image à une échelle voulue Version macro : 1.0 Date dernière modification : 2016-01-19 Version FreeCAD : 0.17 and below Téléchargement : [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/05/Image_Scaling.svg) Auteur: JAndersM |
| Auteur                                                                                                                                                                                                                                          |
...
- exécuter la macro - un dialogue apparaît
- cliquez sur les deux points de l'image dont vous connaissez la vraie distance entre
- Sélectionnez le plan d'image dans l'arborescence
- Entrez la vraie distance en mm entre les points dans le champ de texte de la boîte de dialogue et cliquez sur OK
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Image_Scaling/fr&oldid=693109>"
