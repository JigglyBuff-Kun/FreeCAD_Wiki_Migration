...
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Nouvelle version GUI modifiée pour la HD dpi (QGridLayout) ne fonctionne que sur FC version 0.18 et plus (PySide2 Qt5). Pour la version précédente, voir [Macro Fonts Win10 PYMP](https://gist.githubusercontent.com/mario52a/e7aa19a9dc8ea28ad4f03944ffc8f731/raw/0f5d54209d6c242b49519c83e96c548b06a8f4c6/Macro_Fonts_Win10_PYMP.FCMacro) et l'installer manuellement. Cette petite macro est dédiée aux utilisateurs de Windows 10. Les polices de l'explorateur pour utiliser la ShapeString est vide et cette petite macro peut vous aider à voir facilement la police à utiliser. Version macro : 02.00 Date dernière modification : 2020-06-06 Version FreeCAD : 0.18 and more Téléchargement : [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/f/fa/Macro_Fonts_Win10_PYMP.png) Auteur: Mario52 |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [Mario52](/User:Mario52 "User:Mario52")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Téléchargement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/f/fa/Macro_Fonts_Win10_PYMP.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Liens                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
- 10.00 ![](/images/SpinBox.svg) : dimension du texte dans la vue 3D

* ![](/images/CheckBoxFalse.svg) Text : creation de votre texte en mode text avec le texte ShapeString

- 20.00 ![](/images/SpinBox.svg) : dimension du texte affiché dans la fenêtre de la macro\* \*Exit : quit Fonts Win10 PYMP
- OK : validation
- New folder : autre dossier de fichier police
- Origin : répertoire original des polices (système)
- Help : affiche la page wiki page dans FreeCAD browser

## Configuration

Après le premier lancement, configurer :

`Menu → Tools → User parameter : BaseApp/Preferences/Macros/FCMmacros/Fonts Win10 PYMP`

- **switchModeTextList**
  - `false` mode text normal (et noir) coupe le switchFontComBox
  - `true` permet le switchFontComBox 1
- **switchFontComBox**
  - `false` (et switchModeTextList= `true`) mode texte (en couleur) dans liste ComboBox plus rapide
  - `true` (et switchModeTextList= `true`) la liste dans la ComboBox est affichée en fontFamily, plus lent mais plus beau !
- **setSystemFonts**
...
- **seTtextAlignement**
  ...
  - 2 = AlignRight
- **setFontByDefault**
  - la dernière fonte utilisée
- **setLastFontPath**
  - le dernier chemin utilisé
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Fonts_Win10_PYMP/fr&oldid=1084762>"
