...
|                                                                                                                                                                                                                                  |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon](/File:Text-x-python.png "Generic macro icon") Macro Draft Circle Tangent                                                                                                                                    |
| Description                                                                                                                                                                                                                      |
| Crée des tangentes aux Draft cercles. Version macro : 0.2 Date dernière modification : 2022-11-27 Version FreeCAD : - Auteur: heda                                                                                               |
| Auteur                                                                                                                                                                                                                           |
...
v0.2 2022-11-27 : correction de la sélection des points de repère dans la vue en arborescence.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Draft_Circle_Tangent/fr&oldid=1499556>"
