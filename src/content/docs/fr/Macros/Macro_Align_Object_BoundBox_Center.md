...
| Description                                                                                                                                                                                                                      |
| Aligne 2 objets (ou plus) par le centre de leurs boîtes englobantes. Version macro : 0.2 Date dernière modification : 2024-11-10 Auteur: heda                                                                                    |
| Auteur                                                                                                                                                                                                                           |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Align_Object_BoundBox_Center/fr&oldid=1504806>"
