...
| Cabinets32                                                                                                                                                                                                                                                                                                             |
| Description                                                                                                                                                                                                                                                                                                            |
| Cette macro crée le haut/bas et les parois latérales d'une armoire avec la spécification System32. Version macro : 1.0 Date dernière modification : 2015-01-22 Version FreeCAD : Toutes Téléchargement : [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/6/64/Macro_Cabinets32.png) Auteur: Berner |
| Auteur                                                                                                                                                                                                                                                                                                                 |
| [Berner](/index.php?title=User:Berner&action=edit&redlink=1 "User:Berner (page does not exist)")                                                                                                                                                                                                                       |
| Téléchargement                                                                                                                                                                                                                                                                                                         |
| [Icône de la barre d'outils](https://www.freecadweb.org/wiki/images/6/64/Macro_Cabinets32.png)                                                                                                                                                                                                                         |
| Liens                                                                                                                                                                                                                                                                                                                  |
...
Cette macro crée le Haut/Bas et les parois latérales d'une armoire avec la spécification System32.
Les valeurs par défaut de la macro sont les spécifications du fabricant Hettich.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Cabinets32/fr&oldid=1345360>"
