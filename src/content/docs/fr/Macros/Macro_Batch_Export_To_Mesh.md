---
title: Batch Export To Mesh
---

|                                                                                                                                                                                                                                  |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Generic macro icon](/File:Text-x-python.png "Generic macro icon") Batch Export To Mesh                                                                                                                                          |
| Description                                                                                                                                                                                                                      |
| Cette macro permet de convertir par lots en maillage et d'exporter des fichiers STL et OBJ. Version macro : 2.16 Date dernière modification : 2024-10-11 Auteur: Pablo Gil Fernández                                             |
| Auteur                                                                                                                                                                                                                           |
| [Pablo Gil Fernández](/index.php?title=User:Pablo_Gil_Fern%C3%A1ndez&action=edit&redlink=1 "User:Pablo Gil Fernández (page does not exist)")                                                                                     |
| Téléchargement                                                                                                                                                                                                                   |
| _None_                                                                                                                                                                                                                           |
| Liens                                                                                                                                                                                                                            |
...
- Option de maillage _standard_ de FreeCAD
...
Ce travail est sous licence GNU Lesser General Public License (LGPL). Pour voir une copie de cette licence, visitez :  
<https://www.gnu.org/licenses/lgpl-3.0.html>

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Batch_Export_To_Mesh/fr&oldid=1495164>"
