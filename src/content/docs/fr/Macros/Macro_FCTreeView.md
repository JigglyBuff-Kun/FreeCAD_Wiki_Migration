...
| Macro FCTreeView                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Nouvelle version de l'interface graphique modifiée pour la HD dpi (QGridLayout) fonctionnant uniquement avec FC version 0.18 et plus (PySide2 Qt5) Macro pour lister tous les objets d'un projet dans une liste sans hiérarchie, options de tri par nom, étiquette, visibilité, groupe, par longueur, option de recherche par nom, étiquette... avec ou sans distinction de la casse et sélection de tous les objets affichés dans la fenêtre de la macro. [Pack d'icônes Macro FCTreeView](https://forum.freecadweb.org/download/file.php?id=70498) décompressez le fichier .zip et copiez les icônes dans votre répertoire de macros. Pour la version précédente, voir [Macro_FCTreeView.FCMacro](https://gist.githubusercontent.com/mario52a/67517ef758ff20005d0a6adcfd8c9190/raw/0a92d7f591a0a179f84b2fc417046723b4d7b0e6/Macro_FCTreeView.FCMacro) installez la manuellement. Version macro : 00.09 Date dernière modification : 2020-09-24 Version FreeCAD : 0.18 et avant Téléchargement : [Icône de la barre d'outils](https://wiki.freecad.org/images/6/64/Macro_FCTreeView.png) Auteur: Mario52 |
| Auteur                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| [Mario52](/User:Mario52 "User:Mario52")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Téléchargement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [Icône de la barre d'outils](https://wiki.freecad.org/images/6/64/Macro_FCTreeView.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Liens                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
[![Icône utilisé pour visualiser si le statut de l'objet est Visible (cliquez avec la souris pour caché l'objet)](/images/Macro_FCTreeView_01.png)](/File:Macro_FCTreeView_01.png  "Icône utilisé pour visualiser si le statut de l'objet est Visible (cliquez avec la souris pour caché l'objet)") (la barre de défilement est colorée en vert)

[![Icon used for visualise if the object is status Hidden (cliquez avec la souris pour le rendre visible)](/images/Macro_FCTreeView_02.png)](/File:Macro_FCTreeView_02.png  "Icon used for visualise if the object is status Hidden (cliquez avec la souris pour le rendre visible)") Icône utilisé pour visualiser si le statut de l'objet est caché (cliquez avec la souris pour le rendre visible) (la barre de défilement est colorée en rouge)

[![Icône utilisée pour le nom contient des objets (ou le dossier Groupe)](/images/Macro_FCTreeView_17.png)](/File:Macro_FCTreeView_17.png  "Icône utilisée pour le nom contient des objets (ou le dossier Groupe)") Icône utilisée pour le nom contenant des objets (ou le dossier Group)
...
[![Icône utilisée pour afficher l'objet unique (pas le groupe)](/images/Macro_FCTreeView_04.png)](/File:Macro_FCTreeView_04.png  "Icône utilisée pour afficher l'objet unique (pas le groupe)") Icône utilisée pour afficher l'objet unique (pas le groupe)

### Section **Sort by :**

![](/images/Macro_FCTreeView_10.png) Name Icône utilisée pour le basculement normal/inversé de la liste des données triées par nom

![](/images/Macro_FCTreeView_11.png) Label Icône utilisée pour le basculement normal/inversé de la liste des données triées par étiquette

![](/images/Macro_FCTreeView_12.png) Visible Icône utilisée pour le basculement normal/inversé de la liste des données triées par visible/caché

![](/images/Macro_FCTreeView_13.png) Group Icône utilisée pour le basculement normal/inversé de la liste des données triées par groupe/objet unique

![](/images/Macro_FCTreeView_19.png) Length Si cette case est cochée, le tri est créé par longueur avec le bouton cliqué (Name, Label...)

### Section **Global**

![](/images/Macro_FCTreeView_21.png) Split Bascule de séparation de la liste des noms

![](/images/Macro_FCTreeView_22.png) Split Bascule de séparation de la liste des noms et des étiquettes

![](/images/Macro_FCTreeView_14.png) Expend Bascule de séparation de la liste les données plier/déployer

![](/images/Macro_FCTreeView_15.png) Expend Bascule de séparation de la liste les données déployer/plier

![](/images/Macro_FCTreeView_06.png) Visibility Bascule de normal/visible

![](/images/Macro_FCTreeView_07.png) Group Bascule de normal/groupe

![](/images/Macro_FCTreeView_16.png) Reload Recharge les données dans le projet

![](/images/Macro_FCTreeView_18.png) Original Retour dans l'organisation originale après l'opération visibilité/caché

![](/images/Macro_FCTreeView_01.png) All Visible Visualise si l'objet est de status Visible

![](/images/Macro_FCTreeView_02.png) All Hidden Visualise si l'objet a le statut caché

### Section **Search**

![](/images/Macro_FCTreeView_20.png) Clear Efface l'édition de la ligne de recherche
...
![](/images/Macro_FCTreeView_23.png) Select bascule pour sélectionner tous les objets affichés dans la fenêtre

![](/images/Macro_FCTreeView_24.png) Unselected bascule pour désélectionner tous les objets

![](/images/Macro_FCTreeView_25.png) S Sheet accès aux options du tableur (Spreadsheet)
...
![](/images/Macro_FCTreeView_28.png) Select : sélectionne toutes les cases à cocher à garder

![](/images/Macro_FCTreeView_29.png) Select : désélectionne toutes les cases à cocher à garder
...
![](/images/Macro_FCTreeView_28.png) Select sélectionne toutes les options des cases à cocher

![](/images/Macro_FCTreeView_29.png) Unselect déselectionne toutes les options des cases à cocher

![](/images/Macro_FCTreeView_27.png) Save sauvegarde les données dans la feuille de calcul affichée. Si aucune feuille de calcul n'est active, la feuille de calcul nommée **FCSpreadSheet** est créée

![](/images/Macro_FCTreeView_26.png) Quit quitte les options de la feuille de calcul
...
ver 00.09 (2020-09-24) : correction de la cause **freeze** de la macro après avoir appellé **assembly4 workbench**. J'ai essayé d'activer la "'_Classe SelObserver_" et cela a fonctionné???
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCTreeView/fr&oldid=1345867>"
