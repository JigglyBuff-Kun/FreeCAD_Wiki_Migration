...
* Données**Anchor Length** : représente la longueur du bras de la barre d'armature parallèle pliée lorsque le type de barre d'armature parallèle est BentShapeRebar.
