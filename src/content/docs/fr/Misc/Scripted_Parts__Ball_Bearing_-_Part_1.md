---
title: Part Tutoriel écrire un script - Roulement à bille
---
...
Pour faire une pièce "scriptée" avec des esquisses de révolution, consultez le didacticiel [Scripted Parts: Ball Bearing - Part 2](/Scripted_Parts:_Ball_Bearing_-_Part_2 "Scripted Parts: Ball Bearing - Part 2").

### Liens

[Objets créés par script](/Scripted_objects/fr "Scripted objects/fr") : La page wiki expliquant les bases du langage de script  
[Scripts pour création topologique](/Topological_data_scripting/fr "Topological data scripting/fr") : Un tutoriel qui couvre les bases de la création de scripts  
[Objets scriptés "Part" : Roulement à billes - Partie 2](/Scripted_Parts:_Ball_Bearing_-_Part_2/fr "Scripted Parts: Ball Bearing - Part 2/fr") : Le faire avec des esquisses  
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_Parts:_Ball_Bearing_-_Part_1/fr&oldid=1471546>"
