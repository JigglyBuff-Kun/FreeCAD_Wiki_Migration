...
OpenCamLib (OCL) est une bibliothèque open source visant à fournir des algorithmes de fabrication assistée par ordinateur (FAO). FreeCAD utilise OCL dans les opérations expérimentales de ![](/images/Path_Surface.svg) [Surface](/Path_Surface/fr "Path Surface/fr") et autres fonctionnalités expérimentales.
...
2. Exécutez ensuite le code suivant dans la [console Python](/Python_console/fr "Python console/fr") de FreeCAD
...
Pour tester la compilation, entrez ce qui suit dans la [console Python](/Python_console/fr "Python console/fr") :
...
Retrieved from "<http://wiki.freecad.org/index.php?title=OpenCamLib/fr&oldid=1246144>"