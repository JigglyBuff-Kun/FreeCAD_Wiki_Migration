---
title: FreeCAD Manual Converter
---
|  |
| --- |
| [Generic macro icon](/File:Text-x-python.png "Generic macro icon")  FreeCAD Manual Converter |
| Description |
| Script en Python qui génère automatiquement les versions PDF et EPUB du manuel FreeCAD.  Version macro : 0.1 Date dernière modification : 2024-12-16 Version FreeCAD : Toutes Auteur: Adrianos |
| Auteur |
| [Adrianos](/index.php?title=User:Adrianos&action=edit&redlink=1 "User:Adrianos (page does not exist)") |
| Téléchargement |
| *None* |
| Liens |
...
FreeCAD Manual Converter est un script en Python qui génère automatiquement les versions PDF et EPUB du manuel FreeCAD à partir du Wiki FreeCAD. Il crée un manuel hors ligne complet et correctement formaté qui inclut tous les chapitres, les images et le formatage du manuel en ligne.

### Contexte

Le [Manuel : Introduction](/Manual:Introduction/fr "Manual:Introduction/fr") est un document vivant qui évolue continuellement grâce aux contributions des membres de la communauté. Bien que cela en fasse une excellente ressource à jour, il arrive que les utilisateurs aient besoin d'un accès hors ligne au manuel ou préfèrent le lire sur des lecteurs électroniques et des tablettes. Ce script comble cette lacune en permettant aux utilisateurs de :

* Générer une copie hors ligne actualisée du manuel à tout moment
* Créer des formats PDF et EPUB pour différentes préférences de lecture
* Inclure toutes les dernières contributions et mises à jour de la communauté
* Maintenir un formatage et une qualité d'image appropriés
* Disposer d'une référence complète même sans accès à internet
...
2. Installer GTK3 runtime
3. Ouvrir l'invite de commande et installer les paquets Python :
...
Installer toutes les dépendances nécessaires comme :
...
Pour utiliser le script, il suffit de le télécharger et de l'exécuter. Le script créera deux fichiers dans votre répertoire courant :

* **FreeCAD\_User\_Manual.pdf** : version PDF complète du manuel
* **FreeCAD\_User\_Manual.epub** : version EPUB adaptée aux lecteurs électroniques
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD_Manual_Converter/fr&oldid=1537733>"