...
La bibliothèque PySide donne accès à la boîte à outils d'interface utilisateur graphique (GUI) Qt de [Python](/Python/fr "Python/fr"). Qt est une collection de bibliothèques C++, mais avec l'aide de PySide, les mêmes composants peuvent être utilisés à partir de [Python](/Python/fr "Python/fr"). Chaque interface graphique qui peut être créée en C++, peut également être créée et modifiée en Python. Un avantage de l'utilisation de Python est que les interfaces Qt peuvent être développées et testées en direct, car nous n'avons pas besoin de compiler les fichiers source.

Lorsque vous [installez](/Installing/fr "Installing/fr") FreeCAD, vous devriez obtenir à la fois Qt et PySide dans le package. Si vous [compilez](/Compiling/fr "Compiling/fr") vous-même, vous devez vérifier que ces deux bibliothèques sont installées pour que FreeCAD fonctionne correctement. Bien sûr, PySide ne fonctionnera que si Qt est présent.

Dans le passé, FreeCAD utilisait PyQt, une autre liaison Qt pour Python, mais en 2013 ([commit 1dc122dc9a](https://github.com/FreeCAD/FreeCAD/commit/1dc122dc9a)) le projet a migré vers PySide car il a une [licence](/License/fr "License/fr") plus permissible.

Pour plus d'informations, consultez :

* [Wikipédia : PySide](https://fr.wikipedia.org/wiki/PySide)
* [Différences entre PySide et PyQt](https://wiki.qt.io/Differences_Between_PySide_and_PyQt)
...
* [Exemples PySide Débutant](/PySide_Beginner_Examples/fr "PySide Beginner Examples/fr"), bonjour le monde, annonces, entrez du texte, entrez un numéro.
* [Exemples intermédiaires PySide](/PySide_Intermediate_Examples/fr "PySide Intermediate Examples/fr"), dimensionnement de la fenêtre, masquage des widgets, menus contextuels, position de la souris, événements de la souris.
* [Exemples avancés de PySide](/PySide_Advanced_Examples/fr "PySide Advanced Examples/fr"), de nombreux widgets.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PySide/fr&oldid=1393043>"