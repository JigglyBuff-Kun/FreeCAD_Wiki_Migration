---
title: Encapsuler une classe Cplusplus dans Python
---
:::caution
...
Le fichier XML `[YourClass]Py.xml` fournit des informations sur les fonctions et attributs que la classe Python implémente ainsi que la documentation utilisateur pour ces éléments qui s'affiche dans la [Console Python](/Python_console/fr "Python console/fr") de FreeCAD.
...
* [Exposer Cplusplus à Python](/index.php?title=Exposing_Cplusplus_to_Python/fr&action=edit&redlink=1 "Exposing Cplusplus to Python/fr (page does not exist)")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Wrapping_a_Cplusplus_class_in_Python/fr&oldid=1332570>"