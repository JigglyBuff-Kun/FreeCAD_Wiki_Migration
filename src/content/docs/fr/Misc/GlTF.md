...
Depuis la version 0.19.23074 de FreeCAD, la commande [Std Exporter](/Std_Export/fr "Std Export/fr") peut exporter au format gITF.
...
2. Utilisez la bibliothèque Python `cqparts` ([website](https://github.com/cqparts/cqparts)):
...
Retrieved from "<http://wiki.freecad.org/index.php?title=GlTF/fr&oldid=860554>"