...
Balbutiements FreeCAD, version inconnue.

![](/images/Part_BooleanOperations.png)

FreeCAD, version 0.7 de 2009.

### Comment tout a démarré

FreeCAD a commencé en janvier 2001 lorsque [Jürgen Riegel](/User:Jriegel "User:Jriegel") a commencé à travailler sur le projet Cas.CADE. Cas.CADE était un framework de développement logiciel commercial qui comprenait un [noyau de modélisation géométrique](/Glossary/fr#Geometric_modeling_kernel "Glossary/fr") (ou noyau CAO): il a été publié sous une licence open source en 2000 et renommé [Open CASCADE](/OpenCASCADE/fr "OpenCASCADE/fr"). Cela a rendu possible la réalisation d'un programme CAO 3D open source, car avoir à programmer un noyau CAO à partir de zéro aurait nécessité un travail énorme.
...
>
> —[Jürgen Riegel](/User:Jriegel "User:Jriegel"), *[Announcing FreeCAD Project](http://www.opencascade.org/org/forum/thread_6572/?forum=11)*
...
>
> —[Jürgen Riegel](/User:Jriegel "User:Jriegel"), *[Annonce du projet FreeCAD sur Sun, 08/17/2003 - 19:23](https://dev.opencascade.org/content/announcing-freecad-project)*
...
> *Eh bien, à cette époque, nous étions collègues (jusqu'en 2005), pour pouvoir discuter des choses en face à face. Après cette période, nous avions encore des réunions personnelles, mais nous avons discuté de la plupart des choses par e-mail ou par téléphone.*
...
> *En tant que troisième développeur principal, Yorik s'est joint à la fin de 2007, mais il a fallu encore 3 ou 4 ans pour que la communauté et le nombre de contributeurs commencent à augmenter de manière significative.*
...
> *Oui. Jürgen concevait et implémentait la plupart de la logique d'application et de document et je faisais les bases de l'interface graphique.*
...
> *Nous ne savions pas mais nous espérions. Bien sûr, nous ne pouvions pas prévoir à quoi ressemblerait exactement FreeCAD aujourd'hui.*
>
...
[Yorik van Havre](/User:Yorik "User:Yorik") a rejoint le projet en 2008 et a commencé à travailler sur l'[atelier Draft](/Draft_Workbench/fr "Draft Workbench/fr"). Auparavant, il n'existait aucun moyen de créer une géométrie 2D via l'[interface graphique](/Glossary/fr#GUI "Glossary/fr"). Ce module a été entièrement programmé en Python plutôt qu'en C++, le langage de programmation principal utilisé dans FreeCAD. Le nouvel atelier Draft a prouvé que l'intégration Python était un succès et pouvait être utilisée pour étendre ou personnaliser les fonctionnalités de FreeCAD. En plus de son travail sur le module Draft, Yorik a amélioré la documentation de FreeCAD et est devenu *de facto* "directeur artistique" de FreeCAD, créant de nombreuses icônes pour le GUI de FreeCAD et [définissant son style](/Artwork/fr "Artwork/fr").

La version 0.7 de FreeCAD publiée en avril 2009 a été la première à inclure le module Draft. Le module Part fournit un simple flux de travail [CSG](/Glossary/fr#Constructive_Solid_Geometry "Glossary/fr") avec la création de formes primitives et d'opérations booléennes accessibles via le menu de la pièce. L'extrusion de profils 2D et le filetage étaient également possibles.
...
La version 0.10 a été publiée en juillet 2010 et a introduit l'[atelier Sketcher](/Sketcher_Workbench/fr "Sketcher Workbench/fr"), basé sur Sketchsolve, un solveur basé sur les contraintes pour créer une géométrie 2D. La première version se limitait à la création de rectangles et de lignes.
...
| --- | --- | --- | --- | --- | --- |
| 1.1 | - | en cours de développement | [Notes de version 1.1](/Release_notes_1.1/fr "Release notes 1.1/fr") | [Branche principale](https://github.com/FreeCAD/FreeCAD/commits/main) |  |
| 1.0 | BGBSWW | 2024-11-18 | [Notes de la version 1.0](/Release_notes_1.0/fr "Release notes 1.0/fr") | [Version de validation 1.0](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-1-0) | [Branches avec corrections de bogues 1.0](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-1-0) |
| 0.21 | - | 2023-08-02 | [Notes de version 0.21](/Release_notes_0.21/fr "Release notes 0.21/fr") | [Version de validation 0.21](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-21) | [Branches avec corrections de bogues 0.21](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-21) |
| 0.20 | - | 2022-06-14 | [Notes de version 0.20](/Release_notes_0.20/fr "Release notes 0.20/fr") | [Version de validation 0.20](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-20) | [Branches avec corrections de bogues 0.20](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-20) |
| 0.19 | - | 2021-03-20 | [Notes de version 0.19](/Release_notes_0.19/fr "Release notes 0.19/fr") | [Version de validation 0.19](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-19) | [Branches avec corrections de bogues 0.19](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-19) |
| 0.18 | - | 2019-03-12 | [Notes de version 0.18](/Release_notes_0.18/fr "Release notes 0.18/fr") | [Version de validation 0.18](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-18) | [Branches avec corrections de bogues 0.18](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-18) |
| 0.17 | Roland | 2018-04-06 | [Notes de version 0.17](/Release_notes_0.17/fr "Release notes 0.17/fr") | [Version de validation 0.17](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-17) | [Branches avec corrections de bogues 0.17](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-17) |
| 0.16 | - | 2016-04-18 | [Notes de version 0.16](/Release_notes_0.16/fr "Release notes 0.16/fr") | [Version de validation 0.16](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-16) | [Branches avec corrections de bogues 0.16](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-16) |
| 0.15 | - | 2015-04-08 | [Notes de version 0.15](/Release_notes_0.15/fr "Release notes 0.15/fr") | [Version de validation 0.15](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-15) | [Branches avec corrections de bogues 0.15](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-15) |
| 0.14 | - | 2014-07-01 | [Notes de version 0.14](/Release_notes_0.14/fr "Release notes 0.14/fr") | [Version de validation 0.14](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-14) | [Branches avec corrections de bogues 0.14](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-14) |
| 0.13 | - | 2013-01-29 | [Notes de version 0.13](/Release_notes_0.13/fr "Release notes 0.13/fr") | [Version de validation 0.13](https://github.com/FreeCAD/FreeCAD/commits/releases/FreeCAD-0-13) | [Branches avec corrections de bogues 0.13](https://github.com/FreeCAD/FreeCAD/tree/releases/FreeCAD-0-13) |
| 0.12 | - | 2011-12-20 | [Notes de version 0.12](/Release_notes_0.12/fr "Release notes 0.12/fr") |  |  |
| 0.11 | - | 2011-05-03 | [Notes de version 0.11](/Release_notes_0.11/fr "Release notes 0.11/fr") |  |  |
| 0.10 | - | 2010-07-24 |  |  |  |
| 0.9 | - | 2010-01-16 |  |  |  |
| 0.8 | - | 2009-07-10 |  |  |  |
| 0.7 | - | 2009-04-24 |  |  |  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=History/fr&oldid=1529360>"