...
**Placement** (**Positionner** en français) est la manière dont FreeCAD spécifie l'emplacement et la position (orientation) d'un objet dans l'espace. Le positionnement peut être spécifié sous plusieurs formes et manipulé via un [script](/Python_scripting_tutorial/fr#Vecteurs_et_placements "Python scripting tutorial/fr"), l'[éditeur de propriétés](/Property_editor/fr "Property editor/fr") ou en sélectionnant **Édition → Positionner...** pour ouvrir le [panneau des tâches de Positionner](/Std_Placement/fr "Std Placement/fr").
...
Panneau de l'éditeur de propriétés

![](/images/PlacePyConv10.png)

Script Placement avec y/p/r, sa matrice et son [API](/Placement_API/fr "Placement API/fr").

![](/images/PlacementDialogv10.png)

Panneau des tâches de Positionnement
...
Panneau des tâches de placement: Angles d'Euler ![](/images/ComboBox.svg) sélectionné
...
PS : depuis la version 0.17, un nouvel objet Part a été introduit, cet objet a son placement, et l'objet Placement créé dans l'objet Part est incrémenté avec le Part placement. [introduced in 0.17](/Release_notes_0.17 "Release notes 0.17")
...
![Avant rotation](/images/RotationAboutZBefore.png)

Avant rotation

Avant rotation (vue de dessus)

![Après rotation autour de l'axe Z](/images/RotationAboutZAfter.png)

Après rotation autour de l'axe Z

Après rotation autour de l'axe Z (vue de dessus)

![Après rotation avec l'axe y=x](/images/RotationAboutYXAfter.png)

Après rotation avec l'axe y=x

Après rotation avec l'axe y=x (vue droite)

Rotation avec point central décalé :

![Avant rotation](/images/RotationOffsetBefore.png)

Avant rotation

Avant rotation (vue de dessus)

![Après rotation autour de l'axe Z](/images/RotationOffsetAfter.png)
...
![Avant rotation](/images/RotationEulerBefore.png)

Avant rotation

Avant rotation

![Après rotation](/images/RotationEulerAfter.png)
...
2 formes avec le même Placement
...
Définition du Placement entier dans une seule expression

**REMARQUE :** il est également possible de *créer* des objets Placement dans les expressions. Voir la page [Expressions](/Expressions/fr#Placement "Expressions/fr") pour plus de détails.
...
* Ce tutoriel : [Aéroplane](/Aeroplane/fr "Aeroplane/fr") traite largement des mécanismes de modifications de position d'un objet.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Placement/fr&oldid=1561001>"