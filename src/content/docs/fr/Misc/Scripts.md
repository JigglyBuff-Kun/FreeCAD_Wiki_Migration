...
Vous verrez des choses magiques, un nouveau document est ouvert nommé "Wiki\_example" et vous verrez dans la vue 3D un [Cube](/Part_Box/fr "Part Box/fr") comme ci-dessous.
...
Pas si surprenant ? Oui, mais il faut commencer quelque part, on peut faire la même chose avec un [Cylindre](/Part_Cylinder/fr "Part Cylinder/fr"), ajouter ces lignes de code après la fonction `my_box()` et avant la ligne : `# objects definition`.
...
Le concept de placement est relativement complexe, voir [tutoriel avion](/Aeroplane/fr "Aeroplane/fr") pour une explication plus approfondie.
...
Mais par rapport à d'autres considérations, une chose est cruciale, la géométrie **point de référence**, c'est-à-dire le point à partir duquel l'objet est modélisé par FreeCAD, comme décrit dans ce tableau, copié de [Placement](/Placement/fr "Placement/fr") :
...
|  |  |  |
| --- | --- | --- |
| Exemple d'un avion | Rotation de l'avion | Propriété de placement |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripts/fr&oldid=1463239>"