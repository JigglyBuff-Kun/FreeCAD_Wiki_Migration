---
title: VRML Préparation à la simulation de robot
---
|  |
| --- |
| Tutoriel |
...
Ce tutoriel explique comment utiliser FreeCAD et l'![](/images/Workbench_Robot.svg) [atelier de simulation Robot](/Robot_Workbench/fr "Robot Workbench/fr") pour simuler les mouvements d'un robot série à 6 axes. **Le tutoriel se concentre sur la création du fichier VRML** utilisé comme visualisation. La base du fichier VRML est un modèle FreeCAD. La version de FreeCAD utilisée est 0.11.4252ppa1 sur Ubuntu 32bit.
...
Cela correspond à une rotation autour de l'axe des y. Dans le modèle CAO, la rotation se fait autour de l'axe z. Ainsi, nous avons besoin d'une rotation autour de l'axe des x de 

π
{\displaystyle \pi }
![{\displaystyle \pi }](https://wikimedia.org/api/rest_v1/media/math/render/svg/9be4ba0bb8df3af72e90a0535fabcc17431e540a) avant la définition de l'axe FreeCAD et de 
...
Retrieved from "<http://wiki.freecad.org/index.php?title=VRML_Preparation_for_Robot_Simulation/fr&oldid=1167876>"