---
title: Icône personnalisée dans l'arborescence
---
## Introduction

Il s'agit d'un exemple de modification de l'icône d'un [viewprovider](/Viewprovider/fr "Viewprovider/fr") personnalisé qui est normalement ajouté aux [objets définis par script](/Scripted_objects/fr "Scripted objects/fr").
...
Téléchargez l'icône exemple et placez le dans votre répertoire de macro ![icône Exemple pour la macro](/images/FreeCADIco.png).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Custom_icon_in_tree_view/fr&oldid=1536774>"