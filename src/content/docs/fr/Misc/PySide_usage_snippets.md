---
title: Extraits d'utilisation de PySide
---
## Introduction

Ce sont des extraits de code utiles lors de la [création d'interfaces](/Dialog_creation/fr "Dialog creation/fr") avec [PySide](/PySide/fr "PySide/fr").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PySide_usage_snippets/fr&oldid=1565405>"