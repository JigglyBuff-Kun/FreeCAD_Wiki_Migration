---
title: Objets créés par script avec ancrage
---
## Introduction

Le but de cette page est de montrer un exemple minimal de fonctionnalité de [Part Ancrage](/Part_EditAttachment/fr "Part EditAttachment/fr") utilisant des [Objets créés par script](/Scripted_objects/fr "Scripted objects/fr") en Python.

Voir l'[Exemple minimal complet](#Exemple_minimal_complet) ci-dessous.
...
* [Part Ancrage](/Part_EditAttachment/fr "Part EditAttachment/fr")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_objects_with_attachment/fr&oldid=1495783>"