...
Les dépendances doivent être installées dans le système avant de procéder à la compilation. Voir [Compiler sous Linux](/Compile_on_Linux/fr "Compile on Linux/fr"), [Compiler sous Windows](/Compile_on_Windows/fr "Compile on Windows/fr") et [Compiler sous MacOS](/Compile_on_MacOS/fr "Compile on MacOS/fr") pour plus d'informations.
...
| Shiboken2 | *comme Qt* | <https://wiki.qt.io/Qt_for_Python/Shiboken> |
| PySide2 | *comme Qt* | <https://wiki.qt.io/Qt_for_Python/Shiboken> |
...
* pour écrire des [macros](/Macros/fr "Macros/fr") et l'enregistrement de macros,
* implémenter la logique d'application pour les packages standard,
* pour implémenter des outils auxiliaires tels que le ![](/images/Std_AddonMgr.svg) [gestionnaire des extensions](/Std_AddonMgr/fr "Std AddonMgr/fr"),
* mettre en place des ateliers complets comme [Draft](/Draft_Workbench/fr "Draft Workbench/fr") et [BIM](/BIM_Workbench/fr "BIM Workbench/fr"),
...
**Licence :** version 6.7.0 et les versions ultérieures sont régies par [GNU Lesser General Public License (LGPL) version 2.1 with additional exception](https://www.opencascade.com/content/licensing).
Les versions antérieures utilisent une licence légèrement différente : [Open CASCADE Technology Public License](https://www.opencascade.com/content/occt-public-license).
...
[Pivy](/Pivy/fr "Pivy/fr") est une bibliothèque qui enveloppe la bibliothèque Coin3d pour une utilisation dans [Python](/Python/fr "Python/fr"). Il n'est pas nécessaire de construire FreeCAD ou de le démarrer, mais il est nécessaire en tant que dépendance d'exécution par l'[atelier Draft](/Draft_Workbench/fr "Draft Workbench/fr") et par d'autres ateliers qui l'utilisent en interne, comme [BIM](/BIM_Workbench/fr "BIM Workbench/fr").
...
Ply est l'analyseur Python-Lex-Yacc. Il est utilisé comme dépendance d'exécution par le [OpenSCAD Workbench](/OpenSCAD_Workbench/fr "OpenSCAD Workbench/fr"). Si vous n'utilisez pas cet établi, vous n'aurez peut-être pas besoin de ce package.
...
Une copie de la bibliothèque est incluse avec le code source de l'[atelier CAM](/CAM_Workbench/fr "CAM Workbench/fr"). Elle est donc compilée avec celle-ci.
...
Si vous travaillez sous Linux, vous n’avez pas besoin de LibPack, car vous pouvez obtenir les dépendances dans les dépôts de votre distribution, comme indiqué à la page [Compiler sous Linux](/Compile_on_Linux/fr "Compile on Linux/fr").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Third_Party_Libraries/fr&oldid=1459680>"