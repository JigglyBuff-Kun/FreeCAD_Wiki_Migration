...
Pivy est une bibliothèque de liaison [Python](/Python/fr "Python/fr") pour [Coin](https://github.com/coin3d), la bibliothèque de rendu 3D utilisée dans FreeCAD pour afficher des éléments dans une [3D vue](/3D_view/fr "3D view/fr"). Coin est une implémentation open source de la spécification "Open Inventor" pour gérer les graphiques. Par conséquent, dans FreeCAD, les termes "Pivy", "Coin" ou "Open Inventor" se réfèrent essentiellement à la même chose.

Lorsqu'il est importé dans un interpréteur Python en cours d'exécution, Pivy nous permet de communiquer directement avec n'importe quel [graphe de scène](/Scenegraph/fr "Scenegraph/fr") de Coin, tel que la [vue 3D](/3D_view/fr "3D view/fr"), ou même d'en créer de nouveaux. Pivy n'est pas nécessaire pour compiler FreeCAD, mais il est requis lors de l'exécution lors de l'exécution d'ateliers basés sur Python qui créent des formes à l'écran, comme [Draft](/Draft_Workbench/fr "Draft Workbench/fr") et [BIM](/BIM_Workbench/fr "BIM Workbench/fr"). Pour cette raison, Pivy est normalement installé lors de l'installation d'une distribution de FreeCAD.
...
Nous avons vu à la page [Graphe de scène](/Scenegraph/fr "Scenegraph/fr") comment une scène Coin typique est organisée. Tout ce qui apparaît dans une [vue 3D](/3D_view/fr "3D view/fr") est un Graphe de scène Coin organisée de la même manière. Nous avons un nœud racine et tous les objets à l'écran sont ses enfants.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Pivy/fr&oldid=1459356>"