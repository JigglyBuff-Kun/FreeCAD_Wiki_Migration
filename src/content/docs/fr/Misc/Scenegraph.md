...
La géométrie qui apparaît dans la [vues 3D](/3D_view/fr "3D view/fr") de FreeCAD est rendue par la bibliothèque [Coin3D](https://en.wikipedia.org/wiki/Coin3D). Coin3D est une implémentation de la norme [Open Inventor](https://en.wikipedia.org/wiki/Open_Inventor). Le logiciel [OpenCASCADE](https://en.wikipedia.org/wiki/Open_Cascade_Technology) fournit également la même fonctionnalité mais il a été décidé au tout début de FreeCAD de ne pas utiliser la visionneuse OpenCASCADE intégrée mais plutôt de basculer vers le logiciel Coin3D plus performant. Un bon moyen de découvrir cette bibliothèque est le livre [Open Inventor Mentor](http://www-evasion.imag.fr/Membres/Francois.Faure/doc/inventorMentor/sgi_html/).
...
Image prise de [Inventor mentor](https://web.archive.org/web/20190807185912/http://www-evasion.imag.fr/~Francois.Faure/doc/inventorMentor/sgi_html/)
...
Mais nous avons aussi un module Python qui permet un accès complet à tout ce qui est géré par Coin3D, comme notre scenegraph FreeCAD. Alors, lisez la suite de [Pivy](/Pivy/fr "Pivy/fr").

## Exemples de codage

Voir les [snippets Coin3d](/Coin3d_snippets/fr "Coin3d snippets/fr") grâce aux recherches de MariwanJ pour l'[atelier Design456](/index.php?title=Design456_Workbench/fr&action=edit&redlink=1 "Design456 Workbench/fr (page does not exist)"). Le dépôt de code se trouve à l'adresse <https://github.com/MariwanJ/COIN3D_Snippet>.

[En haut](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Scenegraph/fr&oldid=1235570>"