...
如果你喜歡 FreeCAD 並且想要幫助這個項目，你有很多方式可以幫忙，不論你想投入時間或金錢、是否會寫程式碼。

## 捐款

雖然 FreeCAD 的開發布仰賴金錢，捐款可以幫助項目走得更遠更快，[捐助](/Donate "Donate")頁面列出了捐款給項目的所有選項。
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Help_FreeCAD/zh-tw&oldid=1559498>"