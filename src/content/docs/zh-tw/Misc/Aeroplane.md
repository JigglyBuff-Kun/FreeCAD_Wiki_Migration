...
We will be working in the [Part Workbench](/Part_Workbench "Part Workbench") - select it from menus via View->Workbench->Part or from the Workbench selector.
...
* Create a cylinder by clicking on the ![](/images/Part_Cylinder.png) [Cylinder](/Part_Cylinder "Part Cylinder") button.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Aeroplane/zh-tw&oldid=1251506>"