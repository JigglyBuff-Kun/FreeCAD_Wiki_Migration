---
title: Bancada de trabalho Raytracing
---
...
1. Crie ou abra um projeto do FreeCAD, adicione alguns objetos sólidos ( [Part-based](/Part_Workbench "Part Workbench") ou [PartDesign-based](/PartDesign_Workbench "PartDesign Workbench")); malhas atualmente não são suportadas.
...
- ![](/images/Raytracing_New.png) [Novo Projeto PovRay](/Raytracing_New "Raytracing New"): Insere um novo projeto PovRay no documento.
- ![](/images/Raytracing_Lux.png) [Novo Projeto LuxRender](/Raytracing_Lux "Raytracing Lux"): Insere um novo projeto LuxRender in no documento.
- ![](/images/Raytracing_InsertPart.png) [Inserir Peça](/Raytracing_InsertPart "Raytracing InsertPart"): Insere uma vista de uma Peça em um projeto do Raytracing.
- ![](/images/Raytracing_ResetCamera.png) [Redefinir camera](/Raytracing_ResetCamera "Raytracing ResetCamera"): Corresponde a posição da câmera de um projeto Raytracing à visão atual.
- ![](/images/Raytracing_ExportProject.png) [Exportar projeto](/Raytracing_ExportProject "Raytracing ExportProject"): Exporta um projeto raytracing para o arquivo de cena para renderizar em um renderizador externo.
- ![](/images/Raytracing_Render.png) [Renderizador](/Raytracing_Render "Raytracing Render"): Renderiza um projeto raytracing com um renderizador externo.

### Utilidades

Estas são ferramentas auxiliares para realizar tarefas específicas manualmente.

- ![](/images/Raytracing_WriteView.svg) [Exportar vista para povray](/Raytracing_WriteView "Raytracing WriteView"): Escreve uma vista 3D ativa com câmera e todo seu conteúdo para um arquivo povray.
- ![](/images/Raytracing_WriteCamera.svg) [Exportar câmera para o povray](/Raytracing_WriteCamera "Raytracing WriteCamera"): Exporta a posição da câmera de uma vista 3D ativa no formato POV-Ray para um arquivo.
- ![](/images/Raytracing_WritePart.svg) [Exportar peça para o povray](/Raytracing_WritePart "Raytracing WritePart"): Escreve a Peça selecionada (objeto) como um arquivo povray.

## Preferências

- ![](/images/Preferences-raytracing.svg) [Preferências](/Raytracing_Preferences "Raytracing Preferences"): Preferências disponíveis nas ferramentas do Raytracing.
...
Você será perguntado por um local para salvar o arquivo \* .pov resultante. Depois disso, você pode abri-lo em [[2]](http://www.povray.org/Povray) e renderizar:
...
Consulte o [Raytracing API example](/Raytracing_API_example "Raytracing API example") para obter informações sobre como escrever cenas programaticamente.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Raytracing_Workbench/pt-br&oldid=1260837>"
