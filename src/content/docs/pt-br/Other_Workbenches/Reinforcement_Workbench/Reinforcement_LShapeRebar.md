...
The [Reinforcement LShapeRebar](/Reinforcement_LShapeRebar "Reinforcement LShapeRebar") tool allows the user to create a set of L-shaped reinforcing bars inside an [Arch Structure](/Arch_Structure "Arch Structure") object.
...
Four sets of L-shaped reinforcement bars inside an [Arch Structure](/Arch_Structure "Arch Structure")
...
* Dados**Orientation**: It decides the orientation of the rebar (like a bottom, top, right and left).
* Dados**Front Cover**: The distance between rebar and selected face.
* Dados**Right Cover**: The distance between the right end of the rebar to right face of the structure.
* Dados**Left Cover**: The distance between the left end of the rebar to the left face of the structure.
...
* Dados**Rounding**: A rounding value to be applied to the corners of the bars, expressed in times the diameter.
* Dados**Amount**: The amount of rebars.
* Dados**Spacing**: The distance between the axes of each bar.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_LShapeRebar/pt-br&oldid=1433651>"