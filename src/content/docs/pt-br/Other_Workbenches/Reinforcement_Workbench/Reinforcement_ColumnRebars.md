...
* Dados**Rebar Type**: Type of x-direction rebars.
* Dados**Hook Orientation**: Orientation of LShaped hooks.
* Dados**Hook Extension**: Length of hook of LShape rebars.
* Dados**Rounding**: A rounding value to be applied to the corners of the LShape rebars, expressed in times the diameter.
* Dados**Top Offset**: The distance between rebar from the top face of the structure.
* Dados**Bottom Offset**: The distance between rebar from the bottom face of the structure.
* Dados**Number#Diameter**: Number#Diameter set of the x-direction rebars.

**YDir Secondary Rebars:** Rebars along y-direction except main rebars

* Dados**Rebar Type**: Type of y-direction rebars.
* Dados**Hook Orientation**: Orientation of LShaped hooks.
* Dados**Hook Extension**: Length of hook of LShape rebars.
* Dados**Rounding**: A rounding value to be applied to the corners of the LShape rebars, expressed in times the diameter.
* Dados**Top Offset**: The distance between rebar from the top face of the structure.
* Dados**Bottom Offset**: The distance between rebar from the bottom face of the structure.
* Dados**Number#Diameter**: Number#Diameter set of the y-direction rebars.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_ColumnRebars/pt-br&oldid=1433607>"