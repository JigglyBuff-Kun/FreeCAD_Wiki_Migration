...
* Dados**Anchor Length**: It is the arm's length of bent shape rebar.
* Dados**Bent Angle**: It decides angle in bent shape rebar.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_BentShapeRebar/pt-br&oldid=1433582>"