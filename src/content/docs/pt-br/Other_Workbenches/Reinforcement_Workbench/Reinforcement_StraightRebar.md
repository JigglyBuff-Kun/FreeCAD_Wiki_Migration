...
* Dados**Cover along**: These property facilities the user to specify either top or bottom cover.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_StraightRebar/pt-br&oldid=1433677>"