---
title: Lista de materiais para reforço
---
|  |
| --- |
...
* Dados**Rebars Stroke Width**: The stroke-width of rebars in the rebar shape cut list.
* Dados**Rebars Color Style**: The color style of rebars.
* Dados**Row Height**: The height of each row of rebar shape in the rebar shape cut list.
* Dados**Column Width**: The width of each column of rebar shape in the rebar shape cut list.
* Dados**Column Count**: The number of columns in the rebar shape cut list.
* Dados**Side Padding**: The padding on each side of the rebar shape.
* Dados**Horizontal Rebar Shape**: If True, then the rebar shape will be made horizontal by rotating the max length edge of the rebar shape.
* Dados**Include Mark**: If it is set to True, then rebar.Mark will be included for each rebar shape in the rebar shape cut list.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_BarShapeCutList/pt-br&oldid=1372718>"