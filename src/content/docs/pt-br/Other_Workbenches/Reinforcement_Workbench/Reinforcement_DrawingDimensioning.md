---
title: Desenhar e dimensionar um reforço
---
|  |
| --- |
...
* Dados**Structure**: The structure object acting as a Host for rebars to be included in the drawing.
* Dados**Rebars**: The list of rebar objects to be included in the drawing.
* Dados**View**: The reinforcement drawing view to be generated. It can be "Front", "Rear", "Left", "Right", "Top" or "Bottom".
* Dados**PositionType**: The position type of Reinforcement Drawing on Template. It can be "Automatic" to calculate drawing placement using Dados**LeftOffset**, Dados**TopOffset**, Dados**MinRightOffset** and Dados**MinBottomOffset** OR "Custom" to set placement using Dados**X** and Dados**Y**.
* Dados**RebarsStrokeWidth**: The stroke width of rebars in Reinforcement Drawing SVG.
* Dados**RebarsColorStyle**: The color style of rebars in Reinforcement Drawing SVG. Set it to "Automatic" to automatically select rebars color OR "Custom" to choose shape color value from Dados**RebarsColor**.
* Dados**RebarsColor**: The color of rebars in Reinforcement Drawing SVG.
* Dados**StructureStrokeWidth**: The stroke width of the structure in Reinforcement Drawing SVG.
* Dados**StructureColorStyle**: The color style of structure in Reinforcement Drawing SVG. Set it to "Automatic" to automatically select rebars color, "Custom" to choose shape color value from Dados**StructureColor** OR "None" to not fill structure.
* Dados**StructureColor**: The color of structure in Reinforcement Drawing SVG.
* Dados**Template**: The template for the Reinforcement Drawing view.
* Dados**Width**: The width of the Reinforcement Drawing view SVG.
* Dados**Height**: The height of Reinforcement Drawing view SVG.
* Dados**LeftOffset**: The left offset of Reinforcement Drawing view on a template.
* Dados**TopOffset**: The top offset of Reinforcement Drawing view on a template.
* Dados**MinRightOffset**: The minimum right offset of Reinforcement Drawing view on a template.
* Dados**MinBottomOffset**: The minimum bottom offset of Reinforcement Drawing view on a template.
* Dados**MaxWidth**: The maximum width of the Reinforcement Drawing view.
* Dados**MaxHeight**: The maximum height of the Reinforcement Drawing view.
* Dados**VisibleRebars**: The list of visible rebar objects in the drawing view.
* Dados**DimensionLeftOffset**: The left offset for each new ReinforcementDimensioning object.
* Dados**DimensionRightOffset**: The right offset for each new ReinforcementDimensioning object.
* Dados**DimensionTopOffset**: The top offset for each new ReinforcementDimensioning object.
* Dados**DimensionBottomOffset**: The bottom offset for each new ReinforcementDimensioning object.
...
* Dados**ParentDrawingView**: The parent ReinforcementDrawingView object containing the drawing of [Rebar](/Arch_Rebar "Arch Rebar") object.
* Dados**Rebar**: The [Rebar](/Arch_Rebar "Arch Rebar") object to perform dimensioning.
* Dados**WayPointsType**: The WayPoints type of dimension line. It can be "Automatic" (to automatically perform dimensioning of [Rebar](/Arch_Rebar "Arch Rebar") object) or "Custom" to use Dados**WayPoints** to perform dimensioning.
* Dados**WayPoints**: A list of vector points to be used to generate a dimension line.
* Dados**TextPositionType**: The position type of dimension text. It can be "StartOfLine", "MidOfLine" or "EndOfLine".
* Dados**DimensionFormat**: The dimension label format.
...
* Dados**Font**: The font family of dimension label.
* Dados**FontSize**: The font size of the dimension label.
* Dados**StrokeWidth**: The stroke width of the dimension line.
* Dados**LineStyle**: The stroke style of the dimension line. It can be "Continuous", "Dash", "Dot", "DashDot" or "DashDotDot".
* Dados**LineColor**: The color of the dimension line.
* Dados**TextColor**: The color of the dimension label.
* Dados**LineStartSymbol**: The start symbol of the dimension line. It can be "FilledArrow", "Tick", "Dot" or "None".
* Dados**LineEndSymbol**: The end symbol of the dimension line. It can be "FilledArrow", "Tick", "Dot" or "None".
* Dados**LineMidPointSymbol**: The midpoints symbol of the dimension line. It can be "Tick", "Dot" or "None".
* Dados**DimensionLeftOffset**: The left offset for automated reinforcement dimensioning.
* Dados**DimensionRightOffset**: The right offset for automated reinforcement dimensioning.
* Dados**DimensionTopOffset**: The top offset for automated reinforcement dimensioning.
* Dados**DimensionBottomOffset**: The bottom offset for automated reinforcement dimensioning.
* Dados**SingleRebar\_LineStartSymbol**: The dimension line start symbol, in case of single rebar is visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Dados**WayPointsType** is set to "Automatic".
* Dados**SingleRebar\_LineEndSymbol**: The dimension line end symbol, in case of single rebar is visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Dados**WayPointsType** is set to "Automatic".
* Dados**MultiRebar\_LineStartSymbol**: The dimension line start symbol, in case of multiple rebars are visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Dados**WayPointsType** is set to "Automatic".
* Dados**MultiRebar\_LineEndSymbol**: The dimension line end symbol, in case of multiple rebars are visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Dados**WayPointsType** is set to "Automatic".
* Dados**SingleRebar\_OuterDimension**: It specifies if dimension lines are to be outside of reinforcement drawing, in case of single rebar is visible. It is used only when Dados**WayPointsType** is set to "Automatic".
* Dados**MultiRebar\_OuterDimension**: It specifies if dimension lines are to be outside of reinforcement drawing, in case of multiple rebars are visible. It is used only when Dados**WayPointsType** is set to "Automatic".
* Dados**SingleRebar\_TextPositionType**: It specifies the dimension label position type, in case of single rebar is visible. It can be "StartOfLine", "MidOfLine" or "EndOfLine". It is used only when Dados**WayPointsType** is set to "Automatic".
* Dados**MultiRebar\_TextPositionType**: It specifies the dimension label position type, in case of multiple rebars are visible. It can be "StartOfLine", "MidOfLine" or "EndOfLine". It is used only when Dados**WayPointsType** is set to "Automatic".
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_DrawingDimensioning/pt-br&oldid=1372900>"