...
Three [Arch Axis](/Arch_Axis "Arch Axis") objects combined into one [Arch AxisSystem](/Arch_AxisSystem "Arch AxisSystem"). An [Arch Structure](/Arch_Structure "Arch Structure") object uses this system as its Dados**Axis** property, to have its shape duplicated at each intersection point.
...
5. Set the Dados**Axis** property of any Arch object to point to this system, to have its shape duplicated to the intersection points of this system.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_AxisSystem/pt-br&oldid=1432781>"