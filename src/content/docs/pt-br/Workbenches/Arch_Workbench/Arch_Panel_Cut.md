...
* Dados**Source**: The [Arch Panel](/Arch_Panel "Arch Panel") object shown by this Cut
* Dados**Tag Text**: The text to display. Can be %tag%, %label% or %description% to display the panel tag or label
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Panel_Cut/pt-br&oldid=1437866>"