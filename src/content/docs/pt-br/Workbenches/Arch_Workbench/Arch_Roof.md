...
| - |
| See also |
| [Arch Structure](/Arch_Structure/pt-br "Arch Structure/pt-br"), [Arch Wall](/Arch_Wall/pt-br "Arch Wall/pt-br") |
|  |
...
If your roof has a complex shape (e.g. contains pitched windows or other non-standard features) you can create a custom solid object using various other FreeCAD workbenches ([Part](/Part_Workbench "Part Workbench"), [Sketcher](/Sketcher_Workbench "Sketcher Workbench") etc.). And then use this solid as the Dados**Base** object of your roof:
...
[introduced in 1.0](/Release_notes_1.0 "Release notes 1.0"): It is possible to override the automatic subtraction volume by setting the Dados**Subvolume** property of the roof to a custom solid object.
...
* Dados**Angles** (`FloatList`): The list of angles of the roof segments.
* Dados**Border Length** (`Length`): The total length of the borders of the roof.
* Dados**Face** (`Integer`): The face number of the base object used to build the roof (not used).
* Dados**Flip** (`Bool`): Specifies if the direction of the roof should be flipped.
* Dados**Heights** (`FloatList`): The list of calculated heights of the roof segments.
* Dados**Id Rel** (`IntegerList`): The list of IDs of the relative profiles of the roof segments.
* Dados**Overhang** (`FloatList`): The list of overhangs of the roof segments.
* Dados**Ridge Length** (`Length`): The total length of the ridges and hips of the roof.
* Dados**Runs** (`FloatList`): The list of horizontal length projections of the roof segments.
* Dados**Subvolume** (`Link`): The volume to subtract. If specified it is used instead of the auto-generated subvolume. [introduced in 1.0](/Release_notes_1.0 "Release notes 1.0")
* Dados**Thickness** (`FloatList`): The list of thicknesses of the roof segments.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Roof/pt-br&oldid=1539743>"