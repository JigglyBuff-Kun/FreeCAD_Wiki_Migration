...
* Dados**Height**: The height of the sheet
* Dados**Width**: The width of the sheet
* Dados**Fill Ratio**: The percentage of the sheet area that is filled by cuts (automatic)
* Dados**Tag Text**: The text to display
* Dados**Tag Size**: The size of the tag text
* Dados**Tag Position**: The position of the tag text. Keep (0,0,0) for automatic center position
* Dados**Tag Rotation**: The rotation of the tag text
* Dados**Font File**: The font of the tag text
* Dados**Make Face**: If True, the panel is a Part Face, otherwise a Part Wire
* Dados**Grain Direction**: This allows you to inform the main direction of the panel fiber (clockwise direction, 0° means up)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Panel_Sheet/pt-br&oldid=1433141>"