...
* Dados**Only Solids**: If this is True, non-solid objects in the set will be disregarded
* Vista**Display Length**: The length of the section plane gizmo in the 3D view. Doesn't affect the resulting view
* Vista**Display Height**: The height of the section plane gizmo in the 3D view. Doesn't affect the resulting view
* Vista**Arrow Size**: The size of the arrows of the section plane gizmo in the 3D view. Doesn't affect the resulting view
* Vista**Cut View**: If this is `true`, the whole 3D view will be cut at the location of this section plane.
* Vista**Clip view**: if this is `true`, it will clip the view to the display height and length of the section plane. This effectively turns the section plane into an orthographic camera, limiting the field of view.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_SectionPlane/pt-br&oldid=1560776>"