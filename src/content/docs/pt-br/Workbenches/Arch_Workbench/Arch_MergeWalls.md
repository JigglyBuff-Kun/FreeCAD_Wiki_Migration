...
2. In both cases the walls must have the same Dados**Height**, Dados**Width** and Dados**Align** properties.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_MergeWalls/pt-br&oldid=1478724>"