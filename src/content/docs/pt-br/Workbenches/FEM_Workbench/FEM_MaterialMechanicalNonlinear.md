---
title: Material mecânico não linear
---
|  |
| --- |
...
2. To edit an existing MaterialMechanicalNonlinear object:
   ...
   3. Define yield points (stress [MPa] vs plastic strain). The first point must have a zero plastic strain. Press the ... button next to Dados**Yield Points** to input the points using a user-friendly list. The syntax is described in the [Notes](#Notes) section.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_MaterialMechanicalNonlinear/pt-br&oldid=1569411>"