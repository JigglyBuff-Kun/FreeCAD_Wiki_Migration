...
* To see the effect of the command change the Vista**Lighting** property of the reversed shape to `On side` and if required change **Edit → Preferences... → Display → 3D View → Rendering → Backlight color**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_ReverseShape/pt-br&oldid=1466417>"