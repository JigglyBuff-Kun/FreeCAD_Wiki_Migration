...
3. A new object is created labeled *Defeatured* in the Model [tree view](/Tree_view "Tree view"), and the original object is hidden from view.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Defeaturing/pt-br&oldid=1466742>"