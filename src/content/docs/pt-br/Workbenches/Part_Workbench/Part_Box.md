...
3. Optionally change the dimensions and Dados**Placement** of the box by doing one of the following:
...
* Dados**Length** (`Length`): The length of the box. This is the dimension in its X direction. The default is `10mm`.
* Dados**Width** (`Length`): The width of the box. This is the dimension in its Y direction. The default is `10mm`.
* Dados**Height** (`Length`): The height of the box. This is dimension in its Z direction. The default is `10mm`.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Box/pt-br&oldid=1466534>"