...
A ![](/images/Part_Point.svg) **Part Point** is a parametric point that can be created with the ![](/images/Part_Primitives.svg) [Part Primitives](/Part_Primitives "Part Primitives") command. Its coordinates are relative to the coordinate system defined by its Dados**Placement** property.
...
* Dados**X** (`Distance`): The X coordinate of the point. The default is `0mm`.
* Dados**Y** (`Distance`): The Y coordinate of the point. The default is `0mm`.
* Dados**Z** (`Distance`): The Z coordinate of the point. The default is `0mm`.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Point/pt-br&oldid=1106708>"