...
* Dados**Base**: The shape onto which the chamfer is to be applied.
* Dados**Placement**: Specifies the orientation and position of the shape in the 3D space.
* Dados**Label**: Label given to the object. Change to suit your needs.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Chamfer/pt-br&oldid=1282021>"