...
* Dados**Source** (`Link`): specifies the object that is mirrored.

Plane

* Dados**Base** (`Vector`): specifies the base point of the mirror plane.
* Dados**Normal** (`Vector`): specifies the normal direction of the mirror plane.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Mirror/pt-br&oldid=1513469>"