---
title: Bandeja de rascunho
---

## Description

The **Draft Tray** allows selecting the working plane, defining style settings, toggling construction mode, and specifying the active layer or group. The four buttons show the current settings. The Draft Tray is available in the ![](/images/Workbench_Draft.svg) [Draft Workbench](/Draft_Workbench "Draft Workbench") and the ![](/images/Workbench_BIM.svg) [BIM Workbench](/BIM_Workbench "BIM Workbench") and cannot be disabled.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Tray/pt-br&oldid=1456782>"
