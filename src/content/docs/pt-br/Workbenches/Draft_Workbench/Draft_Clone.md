...
| - |
| Veja também |
| [Draft Scale](/Draft_Scale/pt-br "Draft Scale/pt-br") |
|  |
...
* Dados**Fuse** (`Bool`): specifies if overlapping shapes in the clone are fused or not.
* Dados**Objects** (`LinkListGlobal`): specifies the objects that are cloned.
* Dados**Scale** (`Vector`): specifies the X, Y and Z scale factors.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Clone/pt-br&oldid=1550538>"