...
* An Object that is [attached](/Part_EditAttachment "Part EditAttachment") cannot be moved with the Draft Move command. To move it either its Dados**Support** object has to be moved, or its Dados**Attachment Offset** has to be changed.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Move/pt-br&oldid=1513415>"