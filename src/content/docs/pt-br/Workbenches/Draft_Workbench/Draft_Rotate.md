...
* An Object that is [attached](/Part_EditAttachment "Part EditAttachment") cannot be rotated with the Draft Rotate command. To rotate it either its Dados**Support** object has to be rotated, or its Dados**Attachment Offset** has to be changed.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Rotate/pt-br&oldid=1513494>"