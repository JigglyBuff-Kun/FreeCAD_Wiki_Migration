...
A Draft Arc is in fact a [Draft Circle](/Draft_Circle "Draft Circle") with a Dados**First Angle** that is not the same as its Dados**Last Angle**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Arc_3Points/pt-br&oldid=1513300>"