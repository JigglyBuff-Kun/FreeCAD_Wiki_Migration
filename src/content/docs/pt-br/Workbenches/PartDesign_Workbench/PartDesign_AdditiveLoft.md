...
* Dados**Profile**: the see base profile object of the loft.
* Dados**Midplane**: non applicable.
* Dados**Reversed**: non applicable.
* Dados**Up To Face**: non applicable.
* Dados**Allow Multi Face**: non applicable.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_AdditiveLoft/pt-br&oldid=1446887>"