---
title: Assembly CreateJointGears/pt-br
---
:::caution
...
* Radius1 and Radius2 refer to the pitch circle of gears or the outer diameter of friction wheels. They store their values in the Dados**Distance** and Dados**Distance2** properties and they define the ratio between both rotations.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Assembly_CreateJointGears/pt-br&oldid=1452294>"