...
title: Tutoriais
---
Esta página apresenta uma seleção de tutoriais escritos de alta qualidade. Uma lista completa e não classificada de tutoriais pode ser encontrada em [Category:Tutorials](/Category:Tutorials "Category:Tutorials"), uma lista completa e classificável pode ser encontrada em [tabela abaixo](#Tutoriais_-_Lista_completa).

Se você gostaria de contribuir escrevendo documentação e tutoriais wiki, veja as diretrizes gerais do wiki em [PaginasWiki](/WikiPages/pt-br "WikiPages/pt-br"),
e leia as [orientações para tutoriais](/index.php?title=Tutorial_guidelines/pt-br&action=edit&redlink=1 "Tutorial guidelines/pt-br (page does not exist)").
...
Observe que o fluxo de trabalho [Bancadas de trabalho PartDesign](/PartDesign_Workbench/pt-br "PartDesign Workbench/pt-br") foi consideravelmente alterado do FreeCAD 0.17 em diante; alguns dos tutoriais não foram atualizados e podem se referir à versão 0.16.

* [![Criando uma peça simples com a bancada Part Uma introdução ao FreeCAD e Bancada Part usando sólidos primitivos.](/images/GGTuto1_Vue.PNG)](/Creating_a_simple_part_with_Part_WB "Criando uma peça simples com a bancada Part Uma introdução ao FreeCAD e Bancada Part usando sólidos primitivos. ")

  [Criando uma peça simples com a bancada Part](/Creating_a_simple_part_with_Part_WB/pt-br "Creating a simple part with Part WB/pt-br")  
...
Aqui estão listados todos os tutoriais que não estão no manual *"independentemente de sua qualidade"*. Se um tutorial estiver listado no [Category:Tutorials/pt-br](/Category:Tutorials/pt-br "Category:Tutorials/pt-br") e não nesta tabela, favor inseri-lo aqui.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Tutorials/pt-br&oldid=1538579>"