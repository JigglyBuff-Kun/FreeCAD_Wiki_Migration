...
This example makes use of the [Part](/Part_Workbench "Part Workbench") module to create an octahedron, then creates its coin representation with pivy.
...
See [FeaturePython Custom Properties](/FeaturePython_Custom_Properties "FeaturePython Custom Properties") for an overview.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_objects/pt-br&oldid=1499138>"