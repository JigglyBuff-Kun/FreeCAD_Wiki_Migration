...
- Dados**Property Name 1** (`PropertyType`): Description of the property. (_Editor note:_ to find the `PropertyType` select **Show hidden** in the context menu of the [Property editor](/Property_editor "Property editor"). The tooltip of each property will then include this information. But the `PropertyType` can also be found in the source code.)
...
[Template:Workbench Tools navi/pt-br](/index.php?title=Template:Workbench_Tools_navi/pt-br&action=edit&redlink=1 "Template:Workbench Tools navi/pt-br (page does not exist)")

Retrieved from "<http://wiki.freecad.org/index.php?title=GuiCommand_model/pt-br&oldid=1560792>"
