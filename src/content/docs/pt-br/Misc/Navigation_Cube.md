...
O cubo de navegação é configurável, incluindo o ajuste de seu tamanho: **Editar → Preferências... → Tela → Navegação → Cubo de Navegação**  [introduced in 0.19](/Release_notes_0.19 "Release notes 0.19").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Navigation_Cube/pt-br&oldid=1277564>"