---
title: Ajude o FreeCAD
---
## Introdução

Se gosta do FreeCAD e gostaria de ajudar no seu desenvolvimento, para além de [doações](/Special:MyLanguage/Donate "Special:MyLanguage/Donate"), há muitas outras coisas que pode fazer, mesmo que não sendo um programador.
...
* Gravar [vídeos](http://www.youtube.com/user/FreeCADNews) mostrando como fez algo interessante no FreeCAD. Estes vídeos fazem normalmente um excelente trabalho mostrando novas funcionalidades.
* Escrever [tutoriais](http://freecad-tutorial.blogspot.com/) descrevendo ou ensinando algo interessante. Pode escrever tutoriais no seu próprio "blog", diretamente no nosso wiki, ou mesmo no fórum.
...
Para mais detalhes sobre a tradução, consulte [Localização](/Special:MyLanguage/Localisation "Special:MyLanguage/Localisation").
...
Para detalhes sobre tradução, consulte [Localização#Traduzindo o wiki do FreeCAD](/Special:MyLanguage/Localisation#Translate_the_FreeCAD_wiki "Special:MyLanguage/Localisation").

Por favor, certifique-se de que está familiarizado com os fundamentos de marcação wiki; ver [Ajuda:Editando](/Special:MyLanguage/Help:Editing "Special:MyLanguage/Help:Editing") como referência.

Depois dirija-se a [PáginasWiki](/Special:MyLanguage/WikiPages "Special:MyLanguage/WikiPages") para se familiarizar com o estilo utilizado neste wiki, particularmente quando se trata de modelos.
...
* Ajuda para promover o FreeCAD no GitHub dando ["Estrela" e "Observando"](https://help.github.com/articles/be-social/#watch-a-project) o [repositório FreeCAD](https://github.com/FreeCAD/FreeCAD)

## Reportar falhas e solicitar funcionalidades interessantes

![](/images/Bugreport-workflow.png)

Embora o local para relatar erros confirmados e sugerir novas funcionalidades seja eventualmente o  **[rastreador de erros do FreeCAD](/Special:MyLanguage/tracker "Special:MyLanguage/tracker")**, por favor, publique sempre primeiro os relatórios de erros e pedidos de funcionalidades no fórum. De modo a poupar tempo aos programadores (triagem e tratamento de erros difíceis de compreender podem ser muito demorados), e evitar frustrações porque o seu problema não foi tratado da forma que gostaria, por favor leia o seguinte:
...
* Não importa o quão certo está de que encontrou um erro, por favor discuta sempre os erros primeiro no [fórum (Help on using FreeCAD)](http://forum.freecadweb.org/viewforum.php?f=3).
...
Veja a página [Objetos gráficos](/Special:MyLanguage/Artwork "Special:MyLanguage/Artwork") e [Diretrizes para trabalhos gráficos](/Special:MyLanguage/Artwork_Guidelines "Special:MyLanguage/Artwork Guidelines") para orientações sobre a criação de ícones para o FreeCAD.

## Programe!

Escrever código para o FreeCAD não é difícil e você não precisa de nenhuma permissão para isso. Você pode começar a trabalhar em algo de que precisa agora mesmo e enviá-lo como um ‘patch’ por meio do [rastreador](http://www.freecadweb.org/tracker) ou solicitar sua integração a partir de um ['branch' no git](https://github.com/FreeCAD). Para evitar dores de cabeça, primeiro você precisa aceitar os seguintes pré-requisitos:
...
* Quase tudo pode ser feito em Python ou C++. As tarefas internas funcionam quase da mesma forma em ambas as línguas. Aconselhamos a leitura da página [Documentação para usuários avançados](/Special:MyLanguage/Power_users_hub "Special:MyLanguage/Power users hub"), mesmo que planeie programar em C++, pois dar-lhe-á uma boa visão geral do funcionamento interno.
...
* Desde 2016, o FreeCAD participa do [Google Summer of Code 2020](/Google_Summer_of_Code_2020 "Google Summer of Code 2020"). Não deixe de conferir nossas ideias aí se tiver interesse em participar da próxima edição.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Help_FreeCAD/pt-br&oldid=1559221>"