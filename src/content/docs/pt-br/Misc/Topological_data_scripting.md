---
title: Escrituração de dados topológicos
---
## Introdução
...
See the [Part API](/Part_API "Part API") page or this [autogenerated Python Part API documentation](https://freecad-python-stubs.readthedocs.io/en/latest/autoapi/Part/) for a complete list of available methods of the Part module.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Topological_data_scripting/pt-br&oldid=1311609>"