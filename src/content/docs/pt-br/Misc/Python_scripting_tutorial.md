---
title: Tutorial de script em Python
---
## Introdução
...
Another common feature of FreeCAD objects is their [placement](/Placement "Placement"). Each object has a Dados**Placement** property, which contains the Dados**Base** (position) and Dados**Rotation** (orientation) of the object. It is easy to manipulate, for example to move our object:
...
[Leia mais sobre o PySide aqui...](/PySide/pt-br "PySide/pt-br")
...
Agora você está pronto para scripts mais detalhados do FreeCAD. Então acesse o [Power users hub](/Power_users_hub/pt-br "Power users hub/pt-br")!

[Top](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Python_scripting_tutorial/pt-br&oldid=1296884>"