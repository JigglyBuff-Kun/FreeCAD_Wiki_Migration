---
title: Ferramenta de construção FreeCAD
---
## Overview
...
With [Python](http://en.wikipedia.org/wiki/Python_(programming_language) "wikipedia:Python (programming language)") correctly installed, *fcbt* can be invoked by the command
...
At the input prompt enter the abbreviated command you want to call. For example type "CM" for [creating a module](/Workbench_creation "Workbench creation").
...
The "CM" command [creates a new application module (Workbench)](/Workbench_creation "Workbench creation").

Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD_Build_Tool/pt-br&oldid=947337>"