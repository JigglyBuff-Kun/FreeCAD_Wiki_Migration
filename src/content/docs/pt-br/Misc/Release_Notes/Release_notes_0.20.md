---
title: Notas de lançamento 0.20
---
...
- For ![](/images/Draft_Dimension.svg) [Draft Dimensions](/Draft_Dimension "Draft Dimension") the `arch` Vista**Unit Override** for imperial architectural dimensions was introduced.

* ![](/images/Draft_Shape2DView.svg) [Draft Shape2DView](/Draft_Shape2DView "Draft Shape2DView") objects now have an Dados**Auto Update** property. Setting it to `false` can be useful if there are many Draft Shape2DViews in a document or if they are complex.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Release_notes_0.20/pt-br&oldid=1398009>"
