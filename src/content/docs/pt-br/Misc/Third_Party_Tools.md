...
The Qt-toolkit is a state of the art, platform independent user interface design tool. It is contained in the [LibPack](/Third_Party_Libraries "Third Party Libraries") of FreeCAD, but can also be downloaded at [Qt project](http://qt-project.org/downloads).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Third_Party_Tools/pt-br&oldid=1054050>"