...
Поскольку проект FreeCAD и его сообщество быстро растёт, и поскольку его легко расширять, сторонние разработчики и проекты членов сообщества и сторонних энтузиастов начинают появляться в самых неожиданных местах интернета. Большинство из этих внешних проектов представляют собой рабочие среды или макросы и могут быть легко установлены прямо из FreeCAD через [менеджер дополнений](/Std_AddonMgr/ru "Std AddonMgr/ru") (Addon Manager), находящийся в меню **Инструменты**. Менеджер дополнений позволит вам установить много интересных компонентов, например:
...
3. [Коллекция макросов](https://github.com/FreeCAD/FreeCAD-macros), которые так же доступны [на FreeCAD wiki](/Macros_recipes/ru "Macros recipes/ru") вместе с документацией об их использовании.
...
- [Дополнительные опции загрузки](/Download/ru "Download/ru")
...
- [Самостоятельная компиляция FreeCAD](/Compiling/ru "Compiling/ru")
- [Трансляция FreeCAD](https://crowdin.com/project/freecad)
- [Страница FreeCAD на github](https://github.com/FreeCAD)
- [Менеджер дополнений FreeCAD](/Std_AddonMgr/ru "Std AddonMgr/ru")

Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Installing/ru&oldid=1526234>"
