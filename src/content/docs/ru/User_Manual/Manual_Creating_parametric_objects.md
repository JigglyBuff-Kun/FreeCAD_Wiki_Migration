...
- [Репозиторий макросов FreeCAD](/Macros_recipes/ru "Macros recipes/ru")
- [Пример параметрического объекта](/Scripted_objects/ru "Scripted objects/ru")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Creating_parametric_objects/ru&oldid=1522553>"
