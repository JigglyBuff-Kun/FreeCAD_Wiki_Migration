---
title: Руководство по добавлению ограничений в верстак FEM
---
|  |
| --- |
| Руководство |
| Тема |
| Руководство по добавлению ограничений в верстак FEM |
| Уровень |
|  |
...
In this tutorial, we are going to add the flow velocity constraint to FreeCAD and implement support for the Elmer solver. Please make sure you have read and understood [Extend FEM Module](/Extend_FEM_Module "Extend FEM Module") before reading this tutorial.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Add_FEM_Constraint_Tutorial/ru&oldid=1354663>"