---
title: Моделирование Блока Цилиндров
---
:::caution
...
:   |  |  |
    | --- | --- |
    | X: 0,0 мм | Длина: 140,0 мм |
    | Y: -40,0 мм | Ширина: 80,0 мм |
    | Z: 0,0 мм | Высота: 110,0 мм |
...
Теперь мы вырежем первый цилиндр насквозь блока цилиндров. Для этого мы добавим цилиндр в модель с размером, который мы хотим просверлить и выполним двоичную операцию "subtract" вырезания материала из блока. Нажмите кнопку добавления цилиндра (![](/images/Part_Cylinder.png)) для его создания, выделите его в древе проекта и установите ему следующие параметры:

:   |  |  |
    | --- | --- |
    | X: 40,0 мм | Высота: 110,0 мм |
    | Y: 0,0 мм | Радиус: 25,0 мм |
    | Z: 0,0 мм |  |
...
:   *Читать далее:  [Режим конструирования](/Draft_ToggleConstructionMode/ru "Draft ToggleConstructionMode/ru")*
