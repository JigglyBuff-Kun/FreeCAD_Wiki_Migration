---
title: Макрос BoundingBox Tracing
---
|  |
| --- |
| Macro BoundingBox Tracing |
| Description |
| Creates a red outline of the BoundingBox (6 Faces with 6 rectangles) of an object, display the dimension of the rectangle, create volume of boundBox.  Macro version: 0.12 Last modified: 2021/07/10 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/60/BoundBoxTracing.png) Author: Mario52 |
| Author |
| [Mario52](/User:Mario52 "User:Mario52") |
| Download |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/60/BoundBoxTracing.png) |
| Links |
...
Конфигурирование: смотри строки с 61 по 84.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_BoundingBox_Tracing/ru&oldid=1279430>"