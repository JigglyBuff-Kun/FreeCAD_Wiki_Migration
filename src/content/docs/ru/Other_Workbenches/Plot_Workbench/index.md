...
- ![](/images/Plot_Save.png) [Сохранить диаграмму](/Plot_Save/ru "Plot Save/ru"): Сохраняет диаграмму в нескольких форматах. Вы так же можете выбрать размер и разрешение на выходе.
- ![](/images/Plot_Axes.png) [Настройка осей](/Plot_Axes/ru "Plot Axes/ru"): Добавить, убрать или редактировать оси диаграммы.
- ![](/images/Plot_Series.png) [Настройка числовых рядов](/Plot_Series/ru "Plot Series/ru"): Редактирует последовательности чисел в титлах и их стиль.
- ![](/images/Plot_Grid.png) [Показать/скрыть сетку](/Plot_Grid/ru "Plot Grid/ru"): Показывает/скрывает сетку.
- ![](/images/Plot_Legend.png) [Показать/скрыть легенду](/Plot_Legend/ru "Plot Legend/ru"): Показывает/скрывает легенду.
- ![](/images/Plot_Labels.png) [Настроить подписи](/Plot_Labels/ru "Plot Labels/ru"): Редактирует подписи.
- ![](/images/Plot_Positions.png) [Настройка расположения и размеров](/Plot_Positions/ru "Plot Positions/ru"): Устанавливает позиции элементов.
...
- [Plot Basic tutorial](/Plot_Basic_tutorial/ru "Plot Basic tutorial/ru")
- [Plot MultiAxes tutorial](/Plot_MultiAxes_tutorial/ru "Plot MultiAxes tutorial/ru")

Retrieved from "<http://wiki.freecad.org/index.php?title=Plot_Workbench/ru&oldid=1157584>"
