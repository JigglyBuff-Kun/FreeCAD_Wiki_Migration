---
title: Arch Армировать балку
---
|  |
| --- |
| Армировать балку |
| Расположение в меню |
| Arch → Rebar tools → Beam Reinforcement 3D/BIM → Reinforcement tools → Beam Reinforcement |
| Верстаки |
...
| 0.19 |
| См. также |
| [Reinforcement](/Reinforcement_Workbench/ru "Reinforcement Workbench/ru"), [Арматура по эскизу](/Arch_Rebar/ru "Arch Rebar/ru"), [Arch Rebar ColumnReinforcement TwoTiesSixRebars](/Arch_Rebar_ColumnReinforcement_TwoTiesSixRebars/ru "Arch Rebar ColumnReinforcement TwoTiesSixRebars/ru") |
|  |
...
* Данные**Left Cover**: The distance between the left end of the stirrup to the left face of the structure.
* Данные**Right Cover**: The distance between the right end of the stirrup to right face of the structure.
* Данные**Top Cover**: The distance between stirrup from the top face of the structure.
* Данные**Bottom Cover**: The distance between stirrup from the bottom face of the structure.
* Данные**Offset**: The distance between stirrup from the selected/back face of the structure.
* Данные**Diameter**: Diameter of the stirrup.
* Данные**Bent Angle**: Bent angle defines the angle at the ends of a stirrup.
* Данные**Extension Factor**: Extension Factor defines length of end of stirrup, expressed in times the diameter.
* Данные**Number**: The number of stirrup.
* Данные**Spacing**: The distance between the axes of each stirrup.

**Top/Bottom Reinforcement Rebars:** Rebars present at top/bottom side of beam

* Данные**NumberDiameterOffset**: A tuple of Number#Diameter@Offset string. Each element of tuple represents reinforcement for each new layer.
* Данные**Rebar Type**: List of tuple of type of reinforcement bars.
* Данные**Hook Orientation**: List of tuple of orientation of LShaped hooks.
* Данные**Hook Extension**: List of tuple of length of hook of LShaped rebars.
* Данные**Rounding**: List of tuple of a rounding value to be applied to the corners of the LShape rebars, expressed in times the diameter.
* Данные**Layer Spacing**: List of spacing between two consecutive reinforcement layers.

**Left/Right Reinforcement Rebars:** Rebars present at left/right side of beam

* Данные**NumberDiameterOffset**: String of Number#Diameter@Offset set for reinforcement bars.
* Данные**Rebar Type**: List of type of reinforcement bars.
* Данные**Hook Orientation**: List of orientation of LShaped hooks.
* Данные**Hook Extension**: List of length of hook of LShaped rebars.
* Данные**Rounding**: List of a rounding value to be applied to the corners of the LShape rebars, expressed in times the diameter.
* Данные**Rebar Spacing**: Clear spacing between consecutive reinforcement bars.
...
The Reinforcement BeamRebars tool can be used in [macros](/Macros "Macros") and from the [Python](/Python "Python") console by using the following function:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_BeamRebars/ru&oldid=1433575>"