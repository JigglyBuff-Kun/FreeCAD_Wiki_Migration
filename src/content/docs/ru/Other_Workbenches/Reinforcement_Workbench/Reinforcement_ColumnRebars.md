---
title: Arch Армировать колонну
---
|  |
| --- |
| Армировать колонну |
| Расположение в меню |
| Arch → Rebar tools → Column Reinforcement 3D/BIM → Reinforcement tools → Column Reinforcement |
| Верстаки |
...
| 0.19 |
| См. также |
| [Reinforcement](/Reinforcement_Workbench/ru "Reinforcement Workbench/ru"), [Арматура по эскизу](/Arch_Rebar/ru "Arch Rebar/ru"), [Спиральная арматура](/Arch_Rebar_Helical/ru "Arch Rebar Helical/ru"), [Arch ColumnReinforcement TwoTiesSixRebars](/Arch_Rebar_ColumnReinforcement_TwoTiesSixRebars/ru "Arch Rebar ColumnReinforcement TwoTiesSixRebars/ru") |
|  |
...
* Данные**Rebar Type**: Type of x-direction rebars.
* Данные**Hook Orientation**: Orientation of LShaped hooks.
* Данные**Hook Extension**: Length of hook of LShape rebars.
* Данные**Rounding**: A rounding value to be applied to the corners of the LShape rebars, expressed in times the diameter.
* Данные**Top Offset**: The distance between rebar from the top face of the structure.
...
* Данные**Rebar Type**: Type of y-direction rebars.
* Данные**Hook Orientation**: Orientation of LShaped hooks.
* Данные**Hook Extension**: Length of hook of LShape rebars.
* Данные**Rounding**: A rounding value to be applied to the corners of the LShape rebars, expressed in times the diameter.
* Данные**Top Offset**: The distance between rebar from the top face of the structure.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_ColumnRebars/ru&oldid=1433606>"