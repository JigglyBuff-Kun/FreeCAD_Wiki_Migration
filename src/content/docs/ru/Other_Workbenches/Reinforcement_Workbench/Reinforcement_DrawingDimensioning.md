---
title: Reinforcement DrawingDimensioning/ru
---
|  |
| --- |
...
* Данные**Structure**: The structure object acting as a Host for rebars to be included in the drawing.
* Данные**Rebars**: The list of rebar objects to be included in the drawing.
* Данные**View**: The reinforcement drawing view to be generated. It can be "Front", "Rear", "Left", "Right", "Top" or "Bottom".
* Данные**PositionType**: The position type of Reinforcement Drawing on Template. It can be "Automatic" to calculate drawing placement using Данные**LeftOffset**, Данные**TopOffset**, Данные**MinRightOffset** and Данные**MinBottomOffset** OR "Custom" to set placement using Данные**X** and Данные**Y**.
* Данные**RebarsStrokeWidth**: The stroke width of rebars in Reinforcement Drawing SVG.
* Данные**RebarsColorStyle**: The color style of rebars in Reinforcement Drawing SVG. Set it to "Automatic" to automatically select rebars color OR "Custom" to choose shape color value from Данные**RebarsColor**.
* Данные**RebarsColor**: The color of rebars in Reinforcement Drawing SVG.
* Данные**StructureStrokeWidth**: The stroke width of the structure in Reinforcement Drawing SVG.
* Данные**StructureColorStyle**: The color style of structure in Reinforcement Drawing SVG. Set it to "Automatic" to automatically select rebars color, "Custom" to choose shape color value from Данные**StructureColor** OR "None" to not fill structure.
* Данные**StructureColor**: The color of structure in Reinforcement Drawing SVG.
* Данные**Template**: The template for the Reinforcement Drawing view.
* Данные**Width**: The width of the Reinforcement Drawing view SVG.
* Данные**Height**: The height of Reinforcement Drawing view SVG.
* Данные**LeftOffset**: The left offset of Reinforcement Drawing view on a template.
* Данные**TopOffset**: The top offset of Reinforcement Drawing view on a template.
* Данные**MinRightOffset**: The minimum right offset of Reinforcement Drawing view on a template.
* Данные**MinBottomOffset**: The minimum bottom offset of Reinforcement Drawing view on a template.
* Данные**MaxWidth**: The maximum width of the Reinforcement Drawing view.
* Данные**MaxHeight**: The maximum height of the Reinforcement Drawing view.
* Данные**VisibleRebars**: The list of visible rebar objects in the drawing view.
* Данные**DimensionLeftOffset**: The left offset for each new ReinforcementDimensioning object.
* Данные**DimensionRightOffset**: The right offset for each new ReinforcementDimensioning object.
* Данные**DimensionTopOffset**: The top offset for each new ReinforcementDimensioning object.
* Данные**DimensionBottomOffset**: The bottom offset for each new ReinforcementDimensioning object.
...
* Данные**ParentDrawingView**: The parent ReinforcementDrawingView object containing the drawing of [Rebar](/Arch_Rebar "Arch Rebar") object.
* Данные**Rebar**: The [Rebar](/Arch_Rebar "Arch Rebar") object to perform dimensioning.
* Данные**WayPointsType**: The WayPoints type of dimension line. It can be "Automatic" (to automatically perform dimensioning of [Rebar](/Arch_Rebar "Arch Rebar") object) or "Custom" to use Данные**WayPoints** to perform dimensioning.
* Данные**WayPoints**: A list of vector points to be used to generate a dimension line.
* Данные**TextPositionType**: The position type of dimension text. It can be "StartOfLine", "MidOfLine" or "EndOfLine".
* Данные**DimensionFormat**: The dimension label format.
...
* Данные**Font**: The font family of dimension label.
* Данные**FontSize**: The font size of the dimension label.
* Данные**StrokeWidth**: The stroke width of the dimension line.
* Данные**LineStyle**: The stroke style of the dimension line. It can be "Continuous", "Dash", "Dot", "DashDot" or "DashDotDot".
* Данные**LineColor**: The color of the dimension line.
* Данные**TextColor**: The color of the dimension label.
* Данные**LineStartSymbol**: The start symbol of the dimension line. It can be "FilledArrow", "Tick", "Dot" or "None".
* Данные**LineEndSymbol**: The end symbol of the dimension line. It can be "FilledArrow", "Tick", "Dot" or "None".
* Данные**LineMidPointSymbol**: The midpoints symbol of the dimension line. It can be "Tick", "Dot" or "None".
* Данные**DimensionLeftOffset**: The left offset for automated reinforcement dimensioning.
* Данные**DimensionRightOffset**: The right offset for automated reinforcement dimensioning.
* Данные**DimensionTopOffset**: The top offset for automated reinforcement dimensioning.
* Данные**DimensionBottomOffset**: The bottom offset for automated reinforcement dimensioning.
* Данные**SingleRebar\_LineStartSymbol**: The dimension line start symbol, in case of single rebar is visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Данные**WayPointsType** is set to "Automatic".
* Данные**SingleRebar\_LineEndSymbol**: The dimension line end symbol, in case of single rebar is visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Данные**WayPointsType** is set to "Automatic".
* Данные**MultiRebar\_LineStartSymbol**: The dimension line start symbol, in case of multiple rebars are visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Данные**WayPointsType** is set to "Automatic".
* Данные**MultiRebar\_LineEndSymbol**: The dimension line end symbol, in case of multiple rebars are visible. It can be "FilledArrow", "Tick", "Dot" or "None". It is used only when Данные**WayPointsType** is set to "Automatic".
* Данные**SingleRebar\_OuterDimension**: It specifies if dimension lines are to be outside of reinforcement drawing, in case of single rebar is visible. It is used only when Данные**WayPointsType** is set to "Automatic".
* Данные**MultiRebar\_OuterDimension**: It specifies if dimension lines are to be outside of reinforcement drawing, in case of multiple rebars are visible. It is used only when Данные**WayPointsType** is set to "Automatic".
* Данные**SingleRebar\_TextPositionType**: It specifies the dimension label position type, in case of single rebar is visible. It can be "StartOfLine", "MidOfLine" or "EndOfLine". It is used only when Данные**WayPointsType** is set to "Automatic".
* Данные**MultiRebar\_TextPositionType**: It specifies the dimension label position type, in case of multiple rebars are visible. It can be "StartOfLine", "MidOfLine" or "EndOfLine". It is used only when Данные**WayPointsType** is set to "Automatic".
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_DrawingDimensioning/ru&oldid=1372896>"