---
title: Reinforcement BillOfMaterial/ru
---
|  |
| --- |
...
* Данные**Diameter Weight Map**: A dictionary with the diameter as key and corresponding weight as value.
...
* Данные**Rebar Objects**: A list of ArchRebar and/or rebar2 and/or structures (to select ArchRebar in that structure) objects.

**SVG:**

* Данные**Font Family**: Font Family of text in BOM SVG.
* Данные**Font Filename**: Font filename corresponding to font-family required in console mode.
* Данные**Font Size**: Font size in mm.
* Данные**Column Width**: Width of each column in the BOM SVG table.
* Данные**Row Height**: Height of each row in the BOM SVG table.
* Данные**Left Offset**: Left offset of BOM SVG table.
* Данные**Top Offset**: Top offset of BOM SVG table.
* Данные**Minimum Right Offset**: Minimum right offset of BOM SVG table.
* Данные**Minimum Bottom Offset**: Minimum bottom offset of the BOM SVG table.
* Данные**Maximum Width**: Maximum width of the BOM SVG table.
* Данные**Maximum Height**: Maximum height of the BOM SVG table.
* Данные**Template File**: Template SVG file for BOM SVG.
* Данные**Output File**: BOM SVG Output file.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_BillOfMaterial/ru&oldid=1441036>"