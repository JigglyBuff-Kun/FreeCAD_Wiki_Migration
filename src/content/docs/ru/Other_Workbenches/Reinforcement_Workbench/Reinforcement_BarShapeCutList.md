---
title: Армирование. Список формы сечение арматуры.
---
|  |
| --- |
...
* Данные**Rebars Stroke Width**: The stroke-width of rebars in the rebar shape cut list.
* Данные**Rebars Color Style**: The color style of rebars.
* Данные**Row Height**: The height of each row of rebar shape in the rebar shape cut list.
* Данные**Column Width**: The width of each column of rebar shape in the rebar shape cut list.
* Данные**Column Count**: The number of columns in the rebar shape cut list.
* Данные**Side Padding**: The padding on each side of the rebar shape.
* Данные**Horizontal Rebar Shape**: If True, then the rebar shape will be made horizontal by rotating the max length edge of the rebar shape.
* Данные**Include Mark**: If it is set to True, then rebar.Mark will be included for each rebar shape in the rebar shape cut list.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_BarShapeCutList/ru&oldid=1372735>"