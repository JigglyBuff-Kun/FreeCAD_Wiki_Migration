...
| 0.17 |
| См. также |
| [Reinforcement](/Reinforcement_Workbench/ru "Reinforcement Workbench/ru"), [Арматура по эскизу](/Arch_Rebar/ru "Arch Rebar/ru"), [Arch Rebar BOM](/Arch_Rebar_BOM/ru "Arch Rebar BOM/ru") |
|  |
...
Инструмент [Straight Rebar](/Arch_Rebar_Straight/ru "Arch Rebar Straight/ru") позволяет создавать набор прямых арматурных стержней внутри объектов [архитектурных структур](/Arch_Structure/ru "Arch Structure/ru").
...
* Данные**Cover along**: These property facilities the user to specify either top or bottom cover.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_StraightRebar/ru&oldid=1433676>"