---
title: Ship LoadExample/ru
---
|  |
| --- |
| Ship Load |
| Расположение в меню |
| Ship design → Загрузить пример геометрии судна |
| Верстаки |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Ship_LoadExample/ru&oldid=1133087>"