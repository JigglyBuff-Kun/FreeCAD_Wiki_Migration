---
title: Ship CreateShip/ru
---
|  |
| --- |
| Ship New‏‎ |
| Расположение в меню |
| Ship design → Задание параметров плавательного судна |
| Верстаки |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Ship_CreateShip/ru&oldid=1133093>"