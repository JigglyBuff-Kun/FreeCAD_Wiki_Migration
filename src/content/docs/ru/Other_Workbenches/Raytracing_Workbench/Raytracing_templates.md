---
title: Raytracing templates/ru
---
## Introduction

The [Raytracing Workbench](/Raytracing_Workbench "Raytracing Workbench") comes with some templates for povray and luxrender, but you can easily create your own. All you need to do is to create a scene file for the given renderer, then edit it manually with a text editor to insert special tags that FreeCAD will recognize and where it will insert its contents (camera and objects data).

Personal templates [introduced in 0.18](/Release_notes_0.18 "Release notes 0.18") can be placed under the path
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Raytracing_templates/ru&oldid=681439>"