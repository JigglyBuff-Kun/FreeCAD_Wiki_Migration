---
title: Drawing Landscape A3/ru
---
|  |
| --- |
| Drawing Landscape A3 |
| Расположение в меню |
| Чертёж → Вставить новый чертёж → A3 Ландшафтная |
| Верстаки |
...
If the page does not display, click on the ![](/images/View-refresh.png) refresh icon in the main toolbar, or go to *Edit → Refresh* menu, or shortcut CTRL+R.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Drawing_Landscape_A3/ru&oldid=1461914>"