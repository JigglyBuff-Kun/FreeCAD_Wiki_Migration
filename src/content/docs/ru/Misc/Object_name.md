...
* The Данные**Label2** attribute is normally hidden in the [property editor](/Property_editor "Property editor") but can be made visible by opening the context menu (right click) and selecting **Show hidden**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Object_name/ru&oldid=1560801>"