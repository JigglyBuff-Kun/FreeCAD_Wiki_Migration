---
title: Пример документирования комманды Gui
---

:::caution
На этой странице показан пример документированияGui команды. Ввыделяемом блокениже вы найдете тот же контент который отображается на этой странице в виде текста, который легко можно копировать для вставки в новую страницу.
:::
...
| Расположение в меню                                                                                             |
| Меню → Подменю → Текст меню для комманды                                                                        |
| Верстаки                                                                                                        |
| [Workbench](/index.php?title=Workbench_Name/ru&action=edit&redlink=1 "Workbench Name/ru (page does not exist)") |
| Быстрые клавиши                                                                                                 |
| F C                                                                                                             |
...
- Данные**Property Name 1** (`PropertyType`): Description of the property. (_Editor note:_ to find the `PropertyType` select **Show hidden** in the context menu of the [Property editor](/Property_editor "Property editor"). The tooltip of each property will then include this information. But the `PropertyType` can also be found in the source code.)

### View

Property Group

- Вид**Property Name 2** (`PropertyType`): Description of the property.
...
[Template:Workbench Tools navi/ru](/index.php?title=Template:Workbench_Tools_navi/ru&action=edit&redlink=1 "Template:Workbench Tools navi/ru (page does not exist)")

Retrieved from "<http://wiki.freecad.org/index.php?title=GuiCommand_model/ru&oldid=1560793>"
