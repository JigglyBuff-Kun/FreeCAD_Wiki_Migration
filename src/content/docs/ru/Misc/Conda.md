...
2. Verify your installation was successful and familiarize yourself with the `conda` **CLI**.
`$ conda --help`
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Conda/ru&oldid=1453371>"