---
title: WikiPages рекомендации по переводу страниц
---
...
* Если вы никогда раньше не использовали программное обеспечение wiki, пожалуйста, прочитайте [Help:Editing](/Help:Editing "Help:Editing"), чтобы ознакомиться с используемой разметкой.
...
:   [Верстак PartDesign](/PartDesign_Workbench/ru "PartDesign Workbench/ru"): верстак PartDesign, это верстак для проектирования деталей который предоставляет инструменты для моделирования сложных твердых деталей.

Пример хорошего описания
:   [Верстак PartDesign](/PartDesign_Workbench/ru "PartDesign Workbench/ru"): предоставляет инструменты для проектирования сложных твердых тел.
...
Плохая ссылка
:   Для получения более подробной информации по рисованию 2D объектов кликните [тута](/Draft_Workbench/ru "Draft Workbench/ru").

Хорошая ссылка
:   Для получения более подробной информации о рисовании 2D обратитесь к [верстаку Draft](/Draft_Workbench/ru "Draft Workbench/ru").
...
| --- | --- | --- |
| [Top](/Template:Top "Template:Top") | [наверх](#top) | Use it to add a link to the top of the page. |
| [Emphasis](/Template:Emphasis "Template:Emphasis") | *emphasis* | Используйте его, чтобы подчеркнуть фрагмент текста. |
| [KEY](/Template:KEY "Template:KEY") | Alt | Используйте его в случае, когда нужно указать клавишу клавиатуры, которую необходимо нажать. |
| [ASCII](/Template:ASCII "Template:ASCII") |  | Используйте его, для отображения клавиши в виде (.svg) изображения, которую нужно нажать. В качестве параметра, вы должны указать желаемый символ или номер ascii-кода символа. |
| [Button](/Template:Button "Template:Button") | Cancel | Используйте его для указания кнопки в графическом пользовательском интерфейсе, которую необходимо нажать. |
...
| [FileName](/Template:FileName "Template:FileName") | File name | Используйте его для указания имени файла или каталога. |
...
| [Incode](/Template:Incode "Template:Incode") | `import FreeCAD` | Используйте его для выделения блоков исходного кода написанного моноширинным шрифтом. Содержимое должно умещаться в одну строку. |
| [PropertyView](/Template:PropertyView "Template:PropertyView") | Вид**Color** | Use it to indicate a View property in the [property editor](/Property_editor "Property editor"). Examples of View properties include *Line Color*, *Line Width*, *Point Color*, *Point Size*, etc. |
| [PropertyData](/Template:PropertyData "Template:PropertyData") | Данные**Position** | Use it to indicate a Data property in the [property editor](/Property_editor "Property editor"). Data properties are different for different types of objects. |
...
| [Obsolete](/Template:Obsolete "Template:Obsolete") | [obsolete in 0.19](/Release_notes_0.19 "Release notes 0.19") | Используйте его, чтобы указать, что функция устарела в указанной версии FreeCAD. |
...
| [Version/ru](/Template:Version/ru "Template:Version/ru") | [представлено в версии 0.18](/Release_notes_0.18/ru "Release notes 0.18/ru") | Используйте его, чтобы указать, что функция была введена в указанной версии FreeCAD. |
...
Изображения можно загрузить через [Special:Upload](/Special:Upload/ru "Special:Upload/ru") страницу.
...
* 400x200 (или ширина=400 и высота<=200) для страниц [описывающих команнды Gui](/GuiCommand_model/ru "GuiCommand model/ru"), чтобы изображение помещалось в левой части страницы, а также для других стандартных снимков.
* 600x400 (или ширина=600 и высота<=400), для страниц [описывающих команнды Gui](/GuiCommand_model/ru "GuiCommand model/ru"), только когда вам действительно нужно изображение большего размера, и при этом старйтесь уместить изображение в левой части страницы, а также для других стандартных снимков.
...
Смотри [Глоссарий](/Glossary/ru "Glossary/ru").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=WikiPages/ru&oldid=1540455>"