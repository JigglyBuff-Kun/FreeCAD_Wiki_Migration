...
Существую так же другие способы как [помочь проекту](/Help_FreeCAD "Help FreeCAD") (документирование, перевод на другие языки).

## Способы

- Существует официальный [аккаунт команды FreeCAD](https://liberapay.com/FreeCAD); пожертвуйте с помощью кредитной карты, Paypal или банковского перевода SEPA. Любые деньги, полученные здесь, делятся поровну между перечисленными разработчиками. Это лучший вариант, так как он напрямую помогает разработчикам.
...
- Поддержите расходы на веб-хостинг, пожертвовав напрямую [Jürgen Riegel's PayPal аккаунт](https://www.paypal.com/cgi-bin/webscr?item_name=Donation+к+FreeCAD&cmd=_donations&business=Mail%40juergen-riegel.net). Юрген является оригинальным разработчиком FreeCAD.

## Funding a specific developer

- Некоторые разработчики будут выполнять определенную задачу за деньги или могут быть спонсированы, чтобы потратить время на работу над FreeCAD. В прошлом было несколько успешных экспериментов, таких как [Верстак Path](/Path_Workbench/ru "Path Workbench/ru") или [эксперимент по финансированию Ian Rees's](https://opendeveloperfunding.wordpress.com/). На данный момент спонсорами могут быть следующие разработчики:

  - [Yorik](/User:Yorik "User:Yorik") через [![yorikvanhavre](/images/Patreonporange.png)](https://www.patreon.com/yorikvanhavre "yorikvanhavre ") [Patreon](https://www.patreon.com/yorikvanhavre) или ![](/images/Liberapay_logo.svg) [Liberapay](https://liberapay.com/yorik) ([Модуль Draft](/Draft_Workbench/ru "Draft Workbench/ru"), [Модуль Arch](/Arch_Workbench/ru "Arch Workbench/ru"), [Верстак BIM](/BIM_Workbench/ru "BIM Workbench/ru"), IFC)
  - [Kurt Kremitzki](/User:Kkremitzki "User:Kkremitzki") через [![kkremitzki](/images/Patreonporange.png)](https://www.patreon.com/kkremitzki "kkremitzki ") [Patreon](https://www.patreon.com/kkremitzki) или ![](/images/Liberapay_logo.svg) [Liberapay](https://liberapay.com/kkremitzki) (инфраструктура, серверы, упаковка, Debian/Ubuntu)
  - Lei Zheng aka [Realthunder](https://github.com/realthunder) через [PayPal](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=2SM8GY3U2UUJN), ![](/images/Liberapay_logo.svg) [Liberapay](https://liberapay.com/realthunder/) или ![Patreon](/images/Patreonporange.png) [Patreon](https://www.patreon.com/thundereal) ([App Link](/App_Link "App Link"), [Assembly3](/Assembly3 "Assembly3"))
  - Lorenz aka looooo через ![](/images/Liberapay_logo.svg) [Liberapay](https://liberapay.com/looooo/donate) ([Верстак FCGears](https://github.com/looooo/freecad.gears), [Conda](/Conda/ru "Conda/ru") пакет)
  - Amritpal Singh aka amrit3701 через ![](/images/Liberapay_logo.svg) [Liberapay](https://liberapay.com/amrit3701) или ![Patreon](/images/Patreonporange.png) [Patreon](https://www.patreon.com/amrit3701) ([дополнение Rebar](https://github.com/amrit3701/FreeCAD-Reinforcement))
  - Brad Collette aka sliptonic через ![](/images/Liberapay_logo.svg) [Liberapay](https://liberapay.com/sliptonic/donate) или ![Patreon](/images/Patreonporange.png) [Patreon](https://www.patreon.com/sliptonic) ([Верстак Path](/Path_Workbench/ru "Path Workbench/ru"))
...
- Могут быть другие разработчики, заинтересованные в выполнении конкретной работы для проекта; если вы хотите ускорить разработку идеи или функции, подумайте о том, чтобы нанять разработчика. Вам предстоит разработать идею, обсудить ее на форуме и найти разработчиков, заинтересованных в этом. Вы можете предложить работу в [Подфорум предложений о работе](https://forum.freecadweb.org/viewforum.php?f=31).
- Моделлирование в качестве работы также приветствуется. Не каждый опытный пользователь FreeCAD является разработчиком. Опытные пользователи могут помочь вам перенести ваши проекты на FreeCAD, что способствует популяризации программного обеспечения в организациях. См. [FreeCAD, используемый в производстве](/FreeCAD_used_in_production/ru "FreeCAD used in production/ru").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Donate/ru&oldid=1530089>"
