---
title: Обходные пути для решения некоторых задач
---
## Введение
...
## Обходные решения для верстаков Part и Part Design
...
| 2 | Отображение центра масс модели (детали или сборочных единиц) | * [Макрос CenterOfMass](/Macro_CenterOfMass/ru "Macro CenterOfMass/ru") |
...
* Manually create and modify the views:
  1. If a section view has to be modified, use the [Part SectionCut](/Part_SectionCut "Part SectionCut") tool or boolean operations to cut the part in the same way as it would be done by the [section view](/TechDraw_SectionView "TechDraw SectionView") tool
  2. Use the [Draft Shape2DView](/Draft_Shape2DView "Draft Shape2DView") tool to create a 2D line representation of the view or section view
  3. Use the [Drafting](/Draft_Workbench#Drafting "Draft Workbench") tools with proper [snaps](/Draft_Workbench#Draft_Snap_toolbar "Draft Workbench") to modify the view
  4. Use the [Draft Draft2Sketch](/Draft_Draft2Sketch "Draft Draft2Sketch") tool to create a sketch out of the Draft objects
  5. Use the [Sketcher ValidateSketch](/Sketcher_ValidateSketch "Sketcher ValidateSketch") tool to make sure that the sketch has no missing coincidences, doubled lines and so on (those issues may impact the face selection in TechDraw)
  6. Use the [TechDraw View](/TechDraw_View "TechDraw View") tool to create a view of the sketch in TechDraw.
...
* Create a [standard view](/TechDraw_View "TechDraw View") from the correct direction. Workarounds for "View normal to a face" may help. Rotate and position the view as needed.
...
| № | Недостающая возможность | Предлагаемое решение |
| --- | --- | --- |
| 2 | Улучшенный внешний вид/рендеринг 3D-моделей | * [ветка по данной теме](https://github.com/realthunder/FreeCAD_assembly3/releases) |
...
| 9 | Больше возможностей для текстурирования | * Решения не найдено |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Workarounds/ru&oldid=1511146>"