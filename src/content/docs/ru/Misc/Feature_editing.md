---
title: Редактирование методом конструктивных элементов
---
## Введение

На этой странице объясняется, как использовать ![](/images/Workbench_PartDesign.svg) [Верстак PartDesign](/PartDesign_Workbench/ru "PartDesign Workbench/ru"), начиная с версии FreeCAD 0.17.

## Твёрдое тело

Работа в верстаке PartDesign, начинается с добавления ![](/images/PartDesign_Body.svg) **[Тела](/PartDesign_Body/ru "PartDesign Body/ru")**. Тело в PartDesign это контейнер, хранящий в себе последовательность добавления конструктивных элементов, совокупность которых формирует единое твёрдое тело.
...
Когда модель требует несколько тел, как в предыдущем примере деревянного стула, может быть использован [Part container](/Std_Part/ru "Std Part/ru") общего назначения для их группировки и совместного их перемещения как единого целого.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Feature_editing/ru&oldid=1511481>"