...
Данный пример использует [верстак Part](/Part_Workbench/ru "Part Workbench/ru") для создания октаэдра, затем создает собственное Coin представление с помощью Pivy.
...
Полное описание доступно на странице [методы FeaturePython](/FeaturePython_methods/ru "FeaturePython methods/ru").
...
Вы получите список доступных свойств, которые более подробно описаны на странице [пользовательских свойств объекта FeaturePython](/FeaturePython_Custom_Properties/ru "FeaturePython Custom Properties/ru"):
...
Attributes set using `setEditorMode` can be removed by the user. See [Property editor](/Property_editor#Context_menu "Property editor"). Note that read-only properties can still be changed from Python.
...
* [Scripted objects saving attributes](/Scripted_objects_saving_attributes/ru "Scripted objects saving attributes/ru")
* [Scripted objects migration](/Scripted_objects_migration/ru "Scripted objects migration/ru")
* [Scripted objects with attachment](/Scripted_objects_with_attachment/ru "Scripted objects with attachment/ru")
* [Viewproviders](/Viewprovider/ru "Viewprovider/ru")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_objects/ru&oldid=1499125>"