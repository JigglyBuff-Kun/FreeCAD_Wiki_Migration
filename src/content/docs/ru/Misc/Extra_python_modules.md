---
title: Дополнительные python модули
---
## Overview
...
PySide on Mac can be installed via homebrew or port. See [Install dependencies](/Compile_on_MacOS#Install_Dependencies "Compile on MacOS") for more information.
...
Начиная с Debian Squeeze и Ubuntu Lucid, pivy стал доступен напрямую через официальные репозитории, экономя ваше время. В то же время вы можете скачать один из пакетов что мы сделали (для debian и ubuntu karmic) доступных на странице [Загрузок](/Download "Download") , или скомпилировать их самостоятельно.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Extra_python_modules/ru&oldid=1460934>"