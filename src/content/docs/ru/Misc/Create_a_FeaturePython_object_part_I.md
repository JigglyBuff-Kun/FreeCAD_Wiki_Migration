---
title: Create a FeaturePython object part I/ru
---
## Введение
...
| `obj = ... addObject(...)` | Creates a new FreeCAD FeaturePython object with the name passed to the method. If there is no name clash, this will be the label and the name of the created object. Otherwise, a unique name and label will be created based on 'obj\_name'. |
...
You should see a new object appear in the [Tree view](/Tree_view "Tree view") labelled "my\_box".
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Create_a_FeaturePython_object_part_I/ru&oldid=1231221>"