...
**Размещение** это как FreeCAD определяет положение и ориентацию объекта в пространстве. Размещение может быть определено в нескольких формах и управляется через [скрипты](/Python_scripting_tutorial/ru#Vectors_and_Placements "Python scripting tutorial/ru"), панель Properties, или диалог **Расположение** (меню **Правка**).
...
Размещение в панели Просмотр свойств

![](/images/PlacePyConv10.png)

Скрипты размещения как y/p/r и Matrix и его [API](/index.php?title=Placement_API/ru&action=edit&redlink=1 "Placement API/ru (page does not exist)").
...
Оси вращения с углами в диалоге расположения
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Placement/ru&oldid=1560852>"