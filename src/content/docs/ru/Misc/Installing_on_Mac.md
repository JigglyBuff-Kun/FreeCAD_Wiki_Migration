...
После установки вы можете  [начать работать](/Getting_started "Getting started")!
...
Вы можете загрузить последнюю версию установщика со страницы [Download](/Download "Download"). После загрузки файла просто смонтируйте образ диска, затем перетащите его в папку «Приложение» или в папку по вашему выбору.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Installing_on_Mac/ru&oldid=1297713>"