---
title: Разработка диалогов
---
## Введение

На этой странице мы покажем как создать простой графический интерфейс с помощью [Qt Designer](http://qt-project.org/doc/qt-4.8/designer-manual.html), официальный инструмент Qt для создания интерфейсов, диалог будет сковертирован в код [Python](/Python/ru "Python/ru"), затем использован внутри FreeCAD. Мы будем полагать что пользователь знает в общих чертах как редактировать и запускать [Python](/Python/ru "Python/ru").
...
"Это все ребята"... Теперь вы можете попробовать разные вещи, например как вставить ваш виджет в FreeCAD интерфейс (смотри страницу [Отрывки кода](/Code_snippets/ru "Code snippets/ru") ), или создать более продвинутый пользовательский инструмент, используя другие элементы в вашем виджете.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Dialog_creation/ru&oldid=1392956>"