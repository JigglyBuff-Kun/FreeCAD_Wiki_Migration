---
title: Сборник Макросов
---

На этой странице перечислены [макросы](/Macros/ru "Macros/ru"), которые могут добавить функциональность FreeCAD'у.

Если вы написали макрос и хотите включить его в одну из категорий на этой странице, перейдите к [Документирование макросов](/Macro_documentation/ru "Macro documentation/ru"), чтобы узнать больше о правильном документировании макроса.
...
### Программирование и создание скриптов
...
- ![](/images/BoundBoxTracing.png) [Макрос BoundingBox Tracing](/Macro_BoundingBox_Tracing "Macro BoundingBox Tracing"): Этот макрос обводит красным контуром (можно редактировать) ограничивающую рамку с 6 прямоугольниками.
...
- ![](/images/FCInfo.png) [Макрос FCInfo](/Macro_FCInfo "Macro FCInfo"): Предоставляет ряд сведений о выбранной форме и может отображать пересчёт длины, наклона (градусы, радианы, грады), формы, поверхности, объёма и веса формы в плотность, выбранную в различных международных и англо-саксонских единицах.

- ![](/images/FCInfoToolBar.png) [Макрос FCInfo ToolBar](/Macro_FCInfo_ToolBar "Macro FCInfo ToolBar"): Предоставляет ряд сведений о выбранной форме в виде FCISnfo на мини-панели инструментов.
...
- ![](/images/Macro_FreeCAD_to_Kerkythea.png) [Макрос "FreeCAD to Kerkythea"](/Macro_FreeCAD_to_Kerkythea "Macro FreeCAD to Kerkythea"): Экспорт из FreeCAD в Kerkythea.
...
Используйте [Addon Manager](/Std_AddonMgr/ru "Std AddonMgr/ru") в меню **Инструменты → Менеджер дополнений** для установки макроса, включенного в [FreeCAD-macros](https://github.com/FreeCAD/FreeCAD-macros) репозиторий. [introduced in 0.17](/Release_notes_0.17 "Release notes 0.17")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macros_recipes/ru&oldid=1534319>"
