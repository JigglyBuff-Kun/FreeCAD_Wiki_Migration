...
* [Примеры PySide для начинающих](/PySide_Beginner_Examples/ru "PySide Beginner Examples/ru"), Hello World, анонсы, ввод текста, ввод чисел.
* [Примеры PySide среднего уровня сложности](/PySide_Intermediate_Examples/ru "PySide Intermediate Examples/ru"), изменение размеров окон, сокрытие виджетов, всплывающие меню, позиционирование мыши, события мыши.
* [Примеры PySide для продвинутых пользователей](/PySide_Advanced_Examples/ru "PySide Advanced Examples/ru"), много виджетов.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PySide/ru&oldid=1392736>"