---
title: Библиотека векторной математики FreeCAD
---
## Introduction

This is a [Python](/Python "Python") module containing a couple of useful functions to manipulate vectors. This library is included in the [Draft\_Workbench](/Draft_Workbench "Draft Workbench") and can be accessed like this from the Python interpreter:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD_vector_math_library/ru&oldid=984732>"