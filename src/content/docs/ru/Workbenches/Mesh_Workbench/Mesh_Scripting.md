---
title: Программирование полигональных сеток
---
## Введение
...
Так что если вы достаточно смелы, взгляните на [Unit Test module](https://github.com/FreeCAD/FreeCAD/blob/master/src/Mod/Mesh/App/MeshTestsApp.py).

Смотрите так же: [Mesh API](/index.php?title=Mesh_API/ru&action=edit&redlink=1 "Mesh API/ru (page does not exist)").

[наверх](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Mesh_Scripting/ru&oldid=1021047>"