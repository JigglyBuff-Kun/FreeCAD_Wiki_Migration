...
Преобразование сетки в высокоуровневый объект (обрабатываемый в FreeCAD [верстаком Деталь](/Part_Workbench/ru "Part Workbench/ru")) это не простая задача. Сетки могут содержать тысячи треугольников (например, когда они сгенерированы 3D сканером), и телом, состоящим из того же числа граней, будет чрезвычайно сложно управлять. Поэтому обычно хочется оптимизировать объект при преобразовании.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Mesh_to_Part/ru&oldid=1007520>"