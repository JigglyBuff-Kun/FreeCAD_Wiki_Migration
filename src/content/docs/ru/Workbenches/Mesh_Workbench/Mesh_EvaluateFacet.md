---
title: Mesh EvaluateFacet/ru
---
|  |
| --- |
| Mesh\_EvaluateFacet |
| Расположение в меню |
| Сетки → Анализ → Информация о поверхности |
| Верстаки |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Mesh_EvaluateFacet/ru&oldid=1332944>"