...
* Данные**Fixture**: Sets the current fixture point
* Данные**Active**: Defines if this command is active or not when inserted into a compound
...
Retrieved from "<http://wiki.freecad.org/index.php?title=CAM_Fixture/ru&oldid=1386431>"