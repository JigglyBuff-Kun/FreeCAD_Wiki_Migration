---
title: FEM Install/Установить МКЭ
---
## Введение

Чтобы можно было проводить анализ методом конечных элементов (finite element analysis, FEA) с помощью ![](/images/Workbench_FEM.svg) [FEM Workbench](/FEM_Workbench/ru "FEM Workbench/ru"), FreeCAD использует две внешние программы. Одна используется для генерации [сетки метода конечных элементов](/FEM_Mesh/ru "FEM Mesh/ru"), а другой - для решения системы уравнений. Вы можете проверить, готова ли ваша установка FreeCAD настроен для выполнения механического анализа методом конечных элементов, загрузив и проанализировав пример [FEM CalculiX Cantilever 3D](/FEM_CalculiX_Cantilever_3D/ru "FEM CalculiX Cantilever 3D/ru"), включаемый в любую установку FreeCAD, начиная с версии 0.17.
...
Смотрите это сообщение на форуме[FreeCAD Fem on OSX](https://forum.freecadweb.org/viewtopic.php?f=18&t=10979&p=198652#p198642) о том как установить CalculiX на OSX, и [обновлённые сообщения](https://forum.freecadweb.org/viewtopic.php?f=18&t=10979&start=90#p273746) насчёт более свежей информации.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_Install/ru&oldid=1552456>"