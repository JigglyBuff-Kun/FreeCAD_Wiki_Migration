...
The ![](/images/Workbench_BIM.svg) [BIM Workbench](/BIM_Workbench "BIM Workbench") обеспечивает современный рабочий процесс ([Building Information Modelling](https://en.wikipedia.org/wiki/Building_information_modeling)) информационного моделирования зданий в FreeCAD с полностью параметрическими объектами, такими как стены, балки, крыши, окна, лестницы, трубы и мебель. Он поддерживает [Industry Foundation Classes](/Arch_IFC "Arch IFC") (IFC) файлы и создание 2D-планов в сочетании с ![](/images/Workbench_TechDraw.svg) [TechDraw Workbench](/TechDraw_Workbench "TechDraw Workbench").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=BIM_Workbench/ru&oldid=1569897>"
