---
title: Sketcher "Ограничить угол"
---
|  |
| --- |
| Ограничить угол |
| Расположение в меню |
| Sketch → Ограничения эскиза → Ограничить угол |
| Верстаки |
...
| - |
| См. также |
| [Ограничить расстояние](/Sketcher_ConstrainDistance/ru "Sketcher ConstrainDistance/ru"), [Ограничить перпендикулярность](/Sketcher_ConstrainPerpendicular/ru "Sketcher ConstrainPerpendicular/ru") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainAngle/ru&oldid=1405850>"