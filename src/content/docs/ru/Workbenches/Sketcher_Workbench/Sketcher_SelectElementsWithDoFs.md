---
title: Sketcher "Выбрать геометрию имеющую неограниченные степени свободы"
---
|  |
| --- |
| Выбрать геометрию имеющую неограниченные степени свободы |
| Расположение в меню |
| Sketch → Инструменты для эскиза → Выбрать геометрию имеющую неограниченные степени свободы |
| Верстаки |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_SelectElementsWithDoFs/ru&oldid=1460747>"