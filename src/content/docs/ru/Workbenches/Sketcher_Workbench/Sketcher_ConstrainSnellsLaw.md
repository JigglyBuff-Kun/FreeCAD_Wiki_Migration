---
title: Sketcher "Ограничение преломления (закон Снеллиуса)"
---
|  |
| --- |
| Constraint SnellsLaw |
| Расположение в меню |
| Sketch → Ограничения эскиза → Ограничение преломления (закон Снеллиуса) |
| Верстаки |
| [Sketcher](/Sketcher_Workbench/ru "Sketcher Workbench/ru"), [PartDesign](/PartDesign_Workbench/ru "PartDesign Workbench/ru") |
| Быстрые клавиши |
| *Нет* |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainSnellsLaw/ru&oldid=1405868>"