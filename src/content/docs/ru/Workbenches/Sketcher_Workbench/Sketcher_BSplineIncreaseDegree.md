---
title: Sketcher "Увеличить степень B-сплайна"
---
|  |
| --- |
...
| 0.17 |
| См. также |
| [Показать/скрыть степень B-сплайна](/Sketcher_BSplineDegree/ru "Sketcher BSplineDegree/ru"), [Уменьшить степень B-сплайна](/Sketcher_BSplineDecreaseDegree/ru "Sketcher BSplineDecreaseDegree/ru") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_BSplineIncreaseDegree/ru&oldid=1403893>"