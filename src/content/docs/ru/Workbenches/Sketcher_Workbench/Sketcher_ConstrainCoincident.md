---
title: Sketcher Ограничение наложения точек
---
|  |
| --- |
...
| - |
| См. также |
| [Ограничение положения](/Sketcher_ConstrainLock/ru "Sketcher ConstrainLock/ru"), [Ограничить точку на объекте](/Sketcher_ConstrainPointOnObject/ru "Sketcher ConstrainPointOnObject/ru") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainCoincident/ru&oldid=1404864>"