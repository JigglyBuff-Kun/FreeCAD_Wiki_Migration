---
title: Sketcher Ограничение параллельности
---
|  |
| --- |
| Ограничение параллельности |
| Расположение в меню |
| Sketch → Ограничения эскиза → Ограничение параллельности |
| Верстаки |
...
| - |
| См. также |
| [Ограничение вертикальности](/Sketcher_ConstrainVertical/ru "Sketcher ConstrainVertical/ru"), [Ограничение горизонтальности](/Sketcher_ConstrainHorizontal/ru "Sketcher ConstrainHorizontal/ru") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainParallel/ru&oldid=1404979>"