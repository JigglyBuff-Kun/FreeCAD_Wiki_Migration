---
title: Sketcher "Выделить связанные ограничения"
---
|  |
| --- |
| Выделить связанные ограничения |
| Расположение в меню |
| Sketch → Инструменты для эскиза → Выделить связанные ограничения |
| Верстаки |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_SelectConstraints/ru&oldid=1414844>"