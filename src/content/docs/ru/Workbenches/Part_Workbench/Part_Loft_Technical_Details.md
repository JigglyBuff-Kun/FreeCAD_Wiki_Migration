---
title: Технические детали команды Профиль (Loft)
---
This page explains the details of how the [Loft](/Part_Loft "Part Loft") surface is created. This is also relevant to [Part Sweep](/Part_Sweep "Part Sweep") done along a straight path, although there are differences.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Loft_Technical_Details/ru&oldid=1550727>"