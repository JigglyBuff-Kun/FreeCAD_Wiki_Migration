...
| 0.19 |
| См. также |
| [Draft Wire](/Draft_Wire/ru "Draft Wire/ru"), [Draft BSpline](/Draft_BSpline/ru "Draft BSpline/ru"), [Draft BezCurve](/Draft_BezCurve/ru "Draft BezCurve/ru") |
|  |
...
The [Draft BezCurve](/Draft_BezCurve "Draft BezCurve") and the Draft CubicBezCurve commands use *control points* to define the position and curvature of the spline. The [Draft BSpline](/Draft_BSpline "Draft BSpline") command, on the other hand, specifies the *exact points* through which the curve will pass.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_CubicBezCurve/ru&oldid=1472992>"