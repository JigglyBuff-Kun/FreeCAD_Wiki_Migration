---
title: Draft SelectGroup/ru
---
|  |
| --- |
| Draft SelectGroup |
| Расположение в меню |
| Черчение → Утилиты → Выбрать группу |
| Верстаки |
...
| - |
| См. также |
| [Добавить в группу](/Draft_AddToGroup/ru "Draft AddToGroup/ru"), [Std CreateGroup](/Std_Group/ru "Std Group/ru") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_SelectGroup/ru&oldid=1547543>"