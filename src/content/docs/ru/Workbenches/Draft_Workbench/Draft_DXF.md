...
* точки [introduced in 0.13](/Release_notes_0.13 "Release notes 0.13")
* выноски [introduced in 0.13](/Release_notes_0.13 "Release notes 0.13")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_DXF/ru&oldid=1513611>"