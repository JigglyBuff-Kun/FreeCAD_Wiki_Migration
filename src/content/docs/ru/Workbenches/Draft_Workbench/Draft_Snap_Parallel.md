---
title: Draft Snap Parallel/ru
---
|  |
| --- |
| Draft Snap Parallel |
| Расположение в меню |
| Черчение → [Привязка](/Draft_Snap/ru "Draft Snap/ru") → Параллельно |
| Верстаки |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Snap_Parallel/ru&oldid=1513568>"