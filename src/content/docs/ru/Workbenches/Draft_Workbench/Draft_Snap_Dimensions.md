---
title: Draft Snap Dimensions/ru
---
|  |
| --- |
| Draft Snap Dimensions |
| Расположение в меню |
| Черчение→ [Привязка](/Draft_Snap/ru "Draft Snap/ru") → Размеры |
| Верстаки |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Snap_Dimensions/ru&oldid=1473481>"