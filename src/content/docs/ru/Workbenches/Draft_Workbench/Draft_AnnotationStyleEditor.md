---
title: Draft AnnotationStyleEditor/ru
---
|  |
| --- |
...
| 0.19 |
| См. также |
| [Draft Text](/Draft_Text/ru "Draft Text/ru"), [Draft Dimension](/Draft_Dimension/ru "Draft Dimension/ru"), [Draft Label](/Draft_Label/ru "Draft Label/ru") |
|  |
...
To apply an annotation style change the Вид**Annotation Style** property of annotation objects. This property can be found on the **View** tab of the [Property editor](/Property_editor "Property editor").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_AnnotationStyleEditor/ru&oldid=1473092>"