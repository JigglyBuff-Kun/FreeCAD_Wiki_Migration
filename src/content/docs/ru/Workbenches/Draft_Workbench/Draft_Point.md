...
* Данные**X** (`Distance`): specifies the X coordinate of the point.
* Данные**Y** (`Distance`): specifies the Y coordinate of the point.
* Данные**Z** (`Distance`): specifies the Z coordinate of the point.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Point/ru&oldid=1513343>"