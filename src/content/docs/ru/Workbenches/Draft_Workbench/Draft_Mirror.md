---
title: Draft "Отразить"
---
|  |
| --- |
| Отразить |
| Расположение в меню |
| Modification → Отразить |
| Верстаки |
...
* Данные**Source** (`Link`): specifies the object that is mirrored.

Plane

* Данные**Base** (`Vector`): specifies the base point of the mirror plane.
* Данные**Normal** (`Vector`): specifies the normal direction of the mirror plane.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Mirror/ru&oldid=1513409>"