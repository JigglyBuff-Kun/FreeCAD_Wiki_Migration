...
Этот инструмент преобразует  [Draft objects](/Draft_Workbench "Draft Workbench") в [Sketcher objects](/Sketcher_Workbench "Sketcher Workbench") и наоборот.
...
2. Нажмите кнопку ![](/images/Draft_Draft2Sketch.png) [Draft Draft2Sketch](/Draft_Draft2Sketch "Draft Draft2Sketch")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Draft2Sketch/ru&oldid=1040114>"