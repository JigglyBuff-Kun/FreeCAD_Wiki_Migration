...
Эта команда включает/выключает [привязку](/Draft_Snap/ru "Draft Snap/ru").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Snap_Lock/ru&oldid=1473345>"