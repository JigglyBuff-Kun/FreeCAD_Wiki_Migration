---
title: Настройки Draft
---
## Introduction

Настройки верстака Draft находятся в [Редакторе настроек](/Preferences_Editor/ru "Preferences Editor/ru"), в меню **Правка → Настройки → Draft**.
...
| **Fill** | Shortcut to toggle filled mode. If filled mode is on, the created object will have Данные**Make Face** set to `true`. |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Preferences/ru&oldid=1520958>"