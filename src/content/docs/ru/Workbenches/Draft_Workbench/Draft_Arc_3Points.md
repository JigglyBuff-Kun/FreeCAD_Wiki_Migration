...
| 0.19 |
| См. также |
| [Draft Arc](/Draft_Arc/ru "Draft Arc/ru"), [Draft Circle](/Draft_Circle/ru "Draft Circle/ru"), [Draft Ellipse](/Draft_Ellipse/ru "Draft Ellipse/ru") |
|  |
...
A Draft Arc is in fact a [Draft Circle](/Draft_Circle "Draft Circle") with a Данные**First Angle** that is not the same as its Данные**Last Angle**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Arc_3Points/ru&oldid=1513323>"