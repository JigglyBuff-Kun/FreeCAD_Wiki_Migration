---
title: PartDesign Множественное преобразование
---
|  |
| --- |
| Множественное преобразование |
| Расположение в меню |
| PartDesign → Apply a pattern → Множественное преобразование |
| Верстаки |
...
1. Check the Данные**Originals** property of the existing transformations to make sure they have been applied to the same features.
...
6. Edit the Данные**Tranformations** property of the created MultiTransform object:
...
13. To remove the edges along the axes of symmetry in the final result, set the Данные**Refine** property of the new feature to `true` in the [Property editor](/Property_editor "Property editor").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_MultiTransform/ru&oldid=1485266>"