---
title: PartDesign Линейный массив
---
|  |
| --- |
| Линейный массив |
| Расположение в меню |
| Part Design → Apply a pattern → Линейный массив |
| Верстаки |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_LinearPattern/ru&oldid=1485292>"