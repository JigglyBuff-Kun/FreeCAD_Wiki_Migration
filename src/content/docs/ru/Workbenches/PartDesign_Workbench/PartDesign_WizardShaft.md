---
title: PartDesign Мастер проектирования вала
---
|  |
| --- |
...
Данный инструмент позволяет создать вал на основе значений таблицы, также проводить анализ силы и моментов. Мастер можно запустить через меню **Part Design → ![](/images/PartDesign_WizardShaft.svg) Мастер проектирования вала...**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_WizardShaft/ru&oldid=1461411>"