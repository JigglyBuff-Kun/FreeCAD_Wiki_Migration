---
title: PartDesign Аддитивная спираль
---
|  |
| --- |
| Аддитивная спираль |
| Расположение в меню |
| PartDesign → Create an additive feature → Аддитивная спираль |
| Верстаки |
...
| 0.19 |
| См. также |
| [Субтрактивная спираль](/PartDesign_SubtractiveHelix/ru "PartDesign SubtractiveHelix/ru") |
|  |
...
* Данные**Outside**: Not used (Used in SubtractiveHelix)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_AdditiveHelix/ru&oldid=1513016>"