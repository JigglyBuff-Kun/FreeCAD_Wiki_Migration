---
title: TechDraw "Указать горизонтальный габаритный размер"
---
|  |
| --- |
...
| 0.19 |
| См. также |
| [Указать длину](/TechDraw_LengthDimension/ru "TechDraw LengthDimension/ru"), [Указать вертикальный габаритный размер](/TechDraw_VerticalExtentDimension/ru "TechDraw VerticalExtentDimension/ru") |
|  |
...
* Данные**Measure Type** (`Enumeration`): Not yet implemented for extent dimensions.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=TechDraw_HorizontalExtentDimension/ru&oldid=1486745>"