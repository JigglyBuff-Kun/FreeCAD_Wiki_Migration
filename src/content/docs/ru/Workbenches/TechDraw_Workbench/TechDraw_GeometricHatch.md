---
title: TechDraw "Применить геометрическую штриховку к грани"
---
|  |
| --- |
...
| - |
| См. также |
| [Штриховать грань, используя файл изображения](/TechDraw_Hatch/ru "TechDraw Hatch/ru"), [Штриховка](/TechDraw_Hatching/ru "TechDraw Hatching/ru") |
|  |

## Описание

Инструмент GeometricHatch заполняет замкнутый регион внутри вида шаблоном, базирующимся на спецификации AutoDesk PAT hatching. **В качестве альтернативы**, инструмент [Hatch](/TechDraw_Hatch/ru "TechDraw Hatch/ru") использует качестве рисунка штриховки файл в формате [SVG](/SVG/ru "SVG/ru") или [растровый](/Bitmap/ru "Bitmap/ru"), подробности см. в [Hatching](/TechDraw_Hatching/ru "TechDraw Hatching/ru").
...
* Данные**File Pattern**: The location of the PAT file to use.
* Данные**Name Pattern**: The name of the PAT specification within File Pattern.
* Данные**Scale Pattern**: The scale to be applied to the pattern (must be > 0.0).
* Вид**Weight Pattern**: The thickness of the pattern lines.
* Вид**Color Pattern**: The color for the pattern lines.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=TechDraw_GeometricHatch/ru&oldid=1486089>"