...
| Description                                                                                                                                                                                                |
| Creates an ImagePlane and aligns it to an existing Draft Rectangle. Macro version: 0.1 Last modified: 2023-01-30 Author: heda                                                                              |
| Author                                                                                                                                                                                                     |
...
Creates an [ImagePlane](/Image_CreateImagePlane "Image CreateImagePlane") and aligns it to an existing [Draft Rectangle](/Draft_Rectangle "Draft Rectangle").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Place_Image/en&oldid=1225451>"
