...
| ArrayCopy                                                                                                                                                                                                                                                                                                                    |
| Description                                                                                                                                                                                                                                                                                                                  |
| This macro copies the selected object several times, on an array grid You can define the number of rows and columns and the distance between them. Macro version: 1.0 Last modified: 2014-05-04 FreeCAD version: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/9/9d/Macro_ArrayCopy.png) Author: Yorik |
| Author                                                                                                                                                                                                                                                                                                                       |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_ArrayCopy/en&oldid=692015>"
