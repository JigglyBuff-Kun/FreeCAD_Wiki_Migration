...
| Description                                                                                                                                                                                                 |
| This macro shows a list of US Imperial Arch scales list with the corresponding factor to apply to TechDraw pages or views Macro version: 0.1 Last modified: 2021-06-01 FreeCAD version: 0.18+ Author: Yorik |
| Author                                                                                                                                                                                                      |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_ImperialScales/en&oldid=949173>"
