---
title: Tutorial FreeCAD POV ray
---
:::caution
...
Questo tutorial mostra come produrre un'immagine renderizzata in FreeCAD, usando il renderizzatore POV-Ray. Si presuppone che l'utente abbia già creato una parte o un assieme in FreeCAD o ne abbia importato una in esso. Usa l'ambiente [Raytracing](/Raytracing_Workbench/it "Raytracing Workbench/it") per produrre il file per il rendering.

Questo tutorial è basato sul post [FreeCAD / pov ray tutorial](https://forum.freecadweb.org/viewtopic.php?f=36&t=32745) di schupin nel forum, che include anche il file `.pov` richiesto per produrre il rendering.

![](/images/Povray_before_after.png)

Esempio di schupin di un modello 3D e del rendering di alta qualità prodotto con FreeCAD e POV-Ray.

I file utilizzati in questo tutorial sono nel post #8 [nella stessa discussione](https://forum.freecadweb.org/viewtopic.php?f=36&t=32745#p305169).

## Basic setup

Follow the basic workflow outlined in the [Raytracing Workbench](/Raytracing_Workbench "Raytracing Workbench") documentation.
...
The [Raytracing Workbench](/Raytracing_Workbench "Raytracing Workbench") has three default templates:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Tutorial_FreeCAD_POV_ray/it&oldid=1251789>"