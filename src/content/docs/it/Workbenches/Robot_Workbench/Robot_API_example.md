...
Definire la rappresentazione visiva e la definizione cinematica (vedere [Robot 6-Axis](/Robot_6-Axis/it "Robot 6-Axis/it") e [Preparazione VRML per la simulazione di robot](/VRML_Preparation_for_Robot_Simulation/it "VRML Preparation for Robot Simulation/it") per dettagli su questo)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Robot_API_example/it&oldid=1224832>"