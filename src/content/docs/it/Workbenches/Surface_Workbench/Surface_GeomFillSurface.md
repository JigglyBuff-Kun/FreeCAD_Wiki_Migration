---
title: Surface Riempi le curve del contorno
---
|  |
| --- |
...
Lo strumento ![](/images/Surface_GeomFillSurface.svg) Surface GeomFillSurface crea una superficie da due, tre o quattro bordi, cercando di creare una transizione graduale tra di loro.
...
1. Premere il pulsante ![](/images/Surface_GeomFillSurface.svg) Fill boundary curves.
...
Sono disponibili tre diversi stili di riempimento: Curved, [Coons](https://en.wikipedia.org/wiki/Coons_patch), Stretch.
...
Dati**Fill Type**: L'algoritmo di riempimento applicato
...
When the surface's Vista**Lighting** property is `One side`, a face will be painted completely black if its normal direction points into the [3D view](/3D_view "3D view") (away from the current viewer), indicating a flipped face with respect to the other colored faces.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Surface_GeomFillSurface/it&oldid=1463770>"