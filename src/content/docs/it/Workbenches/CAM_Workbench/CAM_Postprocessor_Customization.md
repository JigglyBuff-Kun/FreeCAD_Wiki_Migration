---
title: Path Personalizzare il Postprocessore
---
...
Per fare un paragone si possono guardare i postprocessori che vengono forniti con l'installazione di FreeCAD. Si trovano sotto la directory Mod in Path/PathScripts/post. Molto usati sono i postprocessori ![](/images/Linuxcnc.png) [linuxcnc](http://linuxcnc.org/) e ![](/images/Grbl.png) [grbl](https://github.com/grbl/grbl). Studiare il loro codice può dare indicazioni utili.
...
- ![](/images/Path_PostProcess.svg) [Path PostProcesso](/Path_Post/it "Path Post/it")

Retrieved from "<http://wiki.freecad.org/index.php?title=CAM_Postprocessor_Customization/it&oldid=1482928>"
