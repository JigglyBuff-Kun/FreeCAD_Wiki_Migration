...
* [Come importare e esportare in FreeCAD](/FreeCAD_Howto_Import_Export "FreeCAD Howto Import Export")
* [Preferenze di Importa/Esporta](/Import_Export_Preferences/it "Import Export Preferences/it")

Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_SHP/it&oldid=1437229>"