...
| - |
| Vedere anche |
| [Allinea](/Std_Alignment/it "Std Alignment/it"), [Posizionamento](/Placement/it "Placement/it") |
|  |

## Descrizione

Il comando **Posizionamento** visualizza la [scheda azioni](/Task_panel/it "Task panel/it") per il posizionamento di un oggetto selezionato.
...
1. Selezionare un singolo oggetto che ha una proprietà Dati**Placement**.
2. Selezionare l'opzione **Modifica → ![](/images/Std_Placement.svg) Posizionamento...** dal menu.
...
La finestra di dialogo può essere avviata anche facendo clic sul pulsante con i puntini di sospensione ... che appare nell'[Editor delle proprietà](/Property_editor/it "Property editor/it") quando si fa clic sulla proprietà Dati**Placement**.

## Note

* Per ulteriori informazioni sui parametri di posizionamento, vedere la pagina [Posizionamento](/Placement/it "Placement/it") e il tutorial [Aereo](/Aeroplane/it "Aeroplane/it").
...
Vedere il [tutorial di script Python](/Python_scripting_tutorial/it#Vettori_e_posizionamenti "Python scripting tutorial/it").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_Placement/it&oldid=1451005>"