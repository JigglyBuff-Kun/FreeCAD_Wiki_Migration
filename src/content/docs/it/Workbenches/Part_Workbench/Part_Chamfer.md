...
| - |
| Vedere anche |
| [Part Raccorda](/Part_Fillet/it "Part Fillet/it") |
|  |
...
1. Esistono diversi modi per richiamare il comando:
   * Premere il pulsante ![](/images/Part_Chamfer.svg) Smussa....
...
* Dati**Base**: La forma su cui lo smusso deve essere applicato.
* Dati**Placement**: Specifica l'orientamento e la posizione della forma nello spazio 3D.
* Dati**Label**: L'etichetta che attiva l'oggetto. Modificabile secondo le esigenze.

## Limitazioni

Lo smusso potrebbe non fare nulla se il risultato tocca o attraversa il bordo adiacente successivo. Quindi, se non si ottiene il risultato atteso, provare con un valore inferiore. Lo stesso vale per ![](/images/Part_Fillet.svg) [Part Raccorda](/Part_Fillet/it "Part Fillet/it").

Notare inoltre che la funzione Smusso è soggetta al problema della [denominazione topologica](/Topological_naming_problem/it "Topological naming problem/it") quando viene apportata una qualsiasi modifica a una fase di modellazione precedente nella catena che influenza il numero di sfaccettature o vertici. Ciò può causare risultati imprevedibili. Fino a quando ciò non viene risolto, si consiglia di applicare le operazioni di smusso e di [raccordo](/Part_Fillet/it "Part Fillet/it") negli ultimi passi della catena.

## Script

Lo strumento smusso può essere utilizzato nelle [macro](/Macros/it "Macros/it") e dalla console [Python](/Python/it "Python/it") aggiungendo un oggetto smusso al documento.
...
* Crea un cubo di 5 mm a cui applicare lo smusso dei bordi. Per una spiegazione del metodo makeBox vedere [Part\_API](/Part_API/it "Part API/it").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Chamfer/it&oldid=1356875>"