---
title: Tutorial divertente di BIM
---
:::caution
...
There are many ways to create BIM objects in FreeCAD. You can use the native [BIM tools](/BIM_Workbench "BIM Workbench") from this workbench, or use any other FreeCAD tool from other [workbenches](/Workbenches "Workbenches"). Both the *2D Drafting* and the *3D/BIM* tools from this workbench, unlike other workbenches such as Part Design, make extensive use of **working planes** and **snapping**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=BIM_ingame_tutorial/it&oldid=1551606>"