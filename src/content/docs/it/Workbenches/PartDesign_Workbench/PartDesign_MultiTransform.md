---
title: Part Design Multitrasformazione
---
|  |
| --- |
| MultiTrasformazione |
...
Crea una combinazioni di trasformazioni - Lo strumento ![](/images/PartDesign_MultiTransform.svg) Multitrasformazione utilizza una (o una serie di) funzioni come input e consente all'utente di applicare progressivamente più trasformazioni a tale funzione (o set di funzioni), in sequenza, creando una trasformazione combinata o composta.
...
1. Check the Dati**Originals** property of the existing transformations to make sure they have been applied to the same features.
...
6. Edit the Dati**Tranformations** property of the created MultiTransform object:
...
13. To remove the edges along the axes of symmetry in the final result, set the Dati**Refine** property of the new feature to `true` in the [Property editor](/Property_editor "Property editor").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_MultiTransform/it&oldid=1485273>"