---
title: PartDesign Serie lineare
---
|  |
| --- |
| Schiera lineare |
| Posizione nel menu |
| PartDesign → Serie lineare |
| Ambiente |
...
Lo strumento ![](/images/PartDesign_LinearPattern.svg) **Serie lineare** crea copie equidistanti di una funzione in una direzione lineare. A partire da v0.17, è in grado di replicare più funzioni.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_LinearPattern/it&oldid=1485282>"