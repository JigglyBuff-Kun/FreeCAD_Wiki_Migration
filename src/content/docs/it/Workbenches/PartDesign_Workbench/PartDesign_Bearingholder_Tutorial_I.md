---
title: Prima parte del tutorial per creare un supporto per cuscinetto con PartDesign
---
:::caution
...
[PartDesign Bearingholder Tutorial II](/PartDesign_Bearingholder_Tutorial_II/it "PartDesign Bearingholder Tutorial II/it")
...
Potete trovare la versione di Jrheinlaender (l'autore di questo articolo) della parte creata con questo tutorial a [[questo link](http://ubuntuone.com/5gok0J4dye3Fo4BKWMGWVa)].  *Il file non è più disponibile, ne verrà fornito uno nuovo in un secondo momento* .
...
Supporto per cuscinetto con i due più importanti piani dello scheletro
...
Piani di base e tutti i piani di Riferimento
...
Schizzo della parte da asportare dal fianco dell'estrusione
...
Sketch dello scavo interno al pad
...
Geometria principale della parte superiore del supporto

La parte dovrebbe apparire come nell'immagine a destra. Notare come i diversi scavi si combinano per produrre un spessore pressoché uniforme, cosa che renderà il getto più facile e meno suscettibile ad avere dei pori.
...
Geometria finita della parte superiore del supporto (senza sformi e raccordi)

Creare una funzione di rivoluzione dal disegno e poi rifletterla sul piano YZ. Questa è tutta la geometria solida che si deve modellare. Il resto sono sformi e raccordi.

## Applicare uno sformo alla faccia laterale

![](/images/HolderTop1-10.jpg)

Il piano neutro per creare gli sformi
...
Applicare uno sformo alla faccia laterale del supporto
...
Raccordare l'esterno del supporto
...
Raccordare l'interno del supporto - bordo problematico
...
La parte con i bordi arrotondati (tranne per il bordo impossibile)
...
Lavorazione della parte superiore e inferiore del supporto

![](/images/HolderTop1-17.jpg)

Lavorazione della parte interna del supporto
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Bearingholder_Tutorial_I/it&oldid=1075235>"