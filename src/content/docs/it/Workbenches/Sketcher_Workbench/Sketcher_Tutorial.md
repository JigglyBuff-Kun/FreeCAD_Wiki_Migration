...
* Uno o due angoli dati: Devono essere selezionati due lati del triangolo. Con un click su ![](/images/Constraint_InternalAngle.png) si apre una finestra di dialogo per definire l'angolo.
