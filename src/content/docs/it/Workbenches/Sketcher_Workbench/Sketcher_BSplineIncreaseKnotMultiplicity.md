---
title: Sketcher Aumentare la molteplicità dei nodi di una BSpline
---
|  |
| --- |
...
2. Richiamare lo strumento usando uno di questi metodi:
   * Premere il pulsante ![](/images/Sketcher_BSplineIncreaseKnotMultiplicity.svg) Aumenta la molteplicità del nodo nella barra degli strumenti.
   * Usare la voce **Sketch → Strumenti B-spline → ![](/images/Sketcher_BSplineIncreaseKnotMultiplicity.svg) Aumenta la molteplicità del nodo** dal menu principale.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_BSplineIncreaseKnotMultiplicity/it&oldid=1403932>"