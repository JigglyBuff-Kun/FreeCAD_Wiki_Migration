---
title: Preferenze di Sketcher
---
## Introduction

Le preferenze per l'ambiente [Sketcher](/Sketcher_Workbench "Sketcher Workbench") si trovano nel [Editor delle preferenze](/Preferences_Editor/it "Preferences Editor/it"), nel menu **Modifica → Preferenze → Sketcher**.
