---
title: FEM Materiale per solidi
---
|  |
| --- |
| FEM Materiale per solidi |
| Posizione nel menu |
| Modello → Materiale solido |
| Ambiente |
...
* Cliccare su ![](/images/FEM_MaterialSolid.png) o scegliere Modello → ![](/images/FEM_MaterialSolid.png) Materiale solido dal menu principale.
* Fare doppio clic sull'oggetto ![](/images/FEM_MaterialSolid.png) Materiale solido appena creato
...
* Cliccare su Chiudi per chiudere la finestra di dialogo e creare un oggetto ![](/images/FEM_MaterialSolid.png) Materiale solido
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_MaterialSolid/it&oldid=1321987>"