---
title: Cerchio da 3 punti 3D
---

|                                                                                                                                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cerchio da 3 punti 3D                                                                                                                                                                                                                                               |
| Descrizione                                                                                                                                                                                                                                                         |
| Crea un cerchio passante per tre punti selezionati nello spazio. Versione macro: 01.00 Ultima modifica: 2013-03-16 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/1/10/Macro_Draft_Circle_3_Points.png) Autore: galou_breizh |
| Autore                                                                                                                                                                                                                                                              |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Draft_Circle_3_Points_3D/it&oldid=1186364>"
