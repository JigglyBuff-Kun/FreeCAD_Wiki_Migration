...
| Rectellipse                                                                                                                                                                                                                                                     |
| Descrizione                                                                                                                                                                                                                                                     |
| Crea un rettangolo parametrico con i vertici arrotondati Versione macro: 1.0 Ultima modifica: 2013-12-24 Versione FreeCAD: Tutte versione Download: [Icona per la ToolBar](https://www.freecadweb.org/wiki/images/b/bf/Macro_Rectellipse.png) Autore: fcaponi78 |
| Autore                                                                                                                                                                                                                                                          |
| [fcaponi78](/index.php?title=User:Fcaponi78&action=edit&redlink=1 "User:Fcaponi78 (page does not exist)")                                                                                                                                                       |
| Download                                                                                                                                                                                                                                                        |
| [Icona per la ToolBar](https://www.freecadweb.org/wiki/images/b/bf/Macro_Rectellipse.png)                                                                                                                                                                       |
| Link                                                                                                                                                                                                                                                            |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Rectellipse/it&oldid=692461>"
