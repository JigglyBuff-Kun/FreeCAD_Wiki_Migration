...
| Taglia Cerchio                                                                                                                                                                                                                                                                                                                           |
| Descrizione                                                                                                                                                                                                                                                                                                                              |
| Taglia cerchi o archi in più archi. Gli archi creati possono essere colorati alternativamente per distinguerli. (Riga di comando, incolla la macro completa nella console Python). Versione macro: 00.03 Ultima modifica: 2019-07-02 Download: [ToolBar Icon](https://wiki.freecad.org/images/9/93/Macro_Cut_Circle.png) Autore: mario52 |
| Autore                                                                                                                                                                                                                                                                                                                                   |
...
1. Incollare la macro **cutCircle** nella [Console Python](/Python_console/it "Python console/it").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Cut_Circle/it&oldid=1450999>"
