...
| Descrizione                                                                                                                                                                                                                                                                       |
| Misura il tempo necessario per ricalcolare ogni funzione del progetto Versione macro: 0.1 Ultima modifica: 2017-04-03 Versione FreeCAD: 0.17.10644 e più alto Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/c/ca/Macro_Recompute_Profiler.png) Autore: DeepSOIC |
| Autore                                                                                                                                                                                                                                                                            |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Recompute_Profiler/it&oldid=1232745>"
