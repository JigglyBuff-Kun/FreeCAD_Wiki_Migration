...
|                                                                                                                                                                                                                                                          |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Allinea la vista alla faccia                                                                                                                                                                                                                             |
| Descrizione                                                                                                                                                                                                                                              |
| Questa macro allinea la vista corrente a una faccia selezionata Versione macro: 3.1 Ultima modifica: 2023/11/12 Versione FreeCAD: Tutte Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/d/d7/Macro_Align_View_to_Face.png) Autore: Rockn |
| Autore                                                                                                                                                                                                                                                   |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Align_View_to_Face/it&oldid=1326395>"
