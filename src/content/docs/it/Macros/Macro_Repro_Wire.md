...
| Descrizione                                                                                                                                                                                                                                                                                                                               |
| Questa macro crea un duplicato di un sottoelemento subObject ... selezionato. (Incluso con la versione FreeCAD 0.19 : Menu → Part → Creare una copia) Versione macro: 00.04 Ultima modifica: 2020-03-14 Versione FreeCAD: Tutte Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/a/a3/Macro_ReproWire.png) Autore: Mario52 |
| Autore                                                                                                                                                                                                                                                                                                                                    |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Repro_Wire/it&oldid=856795>"
