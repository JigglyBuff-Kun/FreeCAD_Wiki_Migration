...
| Snip                                                                                                                                                                                                                              |
| Descrizione                                                                                                                                                                                                                       |
| Macro per catturare facilmente screenshot di FreeCAD. Versione macro: 1.07 Ultima modifica: 2019-08-05 Versione FreeCAD: Tutti Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/b/b5/Snip.png) Autore: TheMarkster |
| Autore                                                                                                                                                                                                                            |
| [TheMarkster](/index.php?title=User:TheMarkster&action=edit&redlink=1 "User:TheMarkster (page does not exist)")                                                                                                                   |
| Download                                                                                                                                                                                                                          |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/b/b5/Snip.png)                                                                                                                                                              |
| Link                                                                                                                                                                                                                              |
...
| Tutti                                                                                                                                                                                                                             |
| Scorciatoia                                                                                                                                                                                                                       |
| Su Windows: Windows Key + Shift + S Su Mac: Command + Shift + 4 Su Linux: gnone-screenshot utility                                                                                                                                |
| Vedere anche                                                                                                                                                                                                                      |
| [Macro Copia la vista 3D negli appunti](/Macro_Copy3DViewToClipboard/it "Macro Copy3DViewToClipboard/it") [Macro Screen Wiki](/Macro_Screen_Wiki/it "Macro Screen Wiki/it")                                                       |
|                                                                                                                                                                                                                                   |
|                                                                                                                                                                                                                                   |

## Descrizione

Usare questa macro per pubblicare facilmente screenshot nel [forum di FreeCAD](https://forum.freecadweb.org).
...
Icona della barra degli strumenti ![](/images/Snip.png)
...
La discussione sul forum [Snip macro](https://forum.freecadweb.org/viewtopic.php?f=9&t=38328&sid=385bf3174dcae7fb8bdf529f4e76dfed)

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Snip/it&oldid=1460923>"
