...
| SimpleProperties                                                                                                                                                                                                                                                                                          |
| Descrizione                                                                                                                                                                                                                                                                                               |
| Questa macro fornisce proprietà semplici dell'oggetto selezionato (volume, boundbox, ...) Versione macro: 0.7 Ultima modifica: 2019-06-10 Versione FreeCAD: 0.17+ Download: [Icona della barra degli strumenti](https://www.freecadweb.org/wiki/images/d/da/Macro_SimpleProperties.png) Autore: OpenBrain |
| Autore                                                                                                                                                                                                                                                                                                    |
| [OpenBrain](/index.php?title=User:OpenBrain&action=edit&redlink=1 "User:OpenBrain (page does not exist)")                                                                                                                                                                                                 |
| Download                                                                                                                                                                                                                                                                                                  |
| [Icona della barra degli strumenti](https://www.freecadweb.org/wiki/images/d/da/Macro_SimpleProperties.png)                                                                                                                                                                                               |
| Link                                                                                                                                                                                                                                                                                                      |
...
| _Nessuna_                                                                                                                                                                                                                                                                                                 |
| Vedere anche                                                                                                                                                                                                                                                                                              |
| [Arch Survey](/Arch_Survey/it "Arch Survey/it"), [Macro FCInfo](/Macro_FCInfo/it "Macro FCInfo/it")                                                                                                                                                                                                       |
|                                                                                                                                                                                                                                                                                                           |
|                                                                                                                                                                                                                                                                                                           |
...
Per spiegazioni più dettagliate, consultare la pagina [Come installare le macro](/How_to_install_macros/it "How to install macros/it").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_SimpleProperties/it&oldid=1367612>"
