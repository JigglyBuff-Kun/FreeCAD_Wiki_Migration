...
| Proprietà Memo                                                                                                                                                                                                           |
| Descrizione                                                                                                                                                                                                              |
| Crea una proprietà aggiuntiva. Versione macro: 00.02 Ultima modifica: 2015-10-19 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f2/PropertyMemo.png) Autore: Mario52            |
| Autore                                                                                                                                                                                                                   |
...
* ![](/images/CheckBoxTrue.svg) UnCheck for String : casella di controllo per la scelta tra stringa o elenco (By default)
...
- ![Una proprietà Memo nella lista.](/images/Macro_FCPropertyMemo_02.png)

  Una proprietà Memo nella lista.

- ![La finestra con l'elenco delle Memo.](/images/Macro_FCPropertyMemo_03.png)

  La finestra con l'elenco delle Memo.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_PropertyMemo/it&oldid=1336615>"
