...
| Croce di Malta                                                                                                                                                                                                                          |
| Descrizione                                                                                                                                                                                                                             |
| Consente all'utente di creare un meccanismo Croce di Malta da zero. Versione macro: 1.0 Ultima modifica: 2014-09-21 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/8/8d/GW_Dim.png) Autore: Drei |
| Autore                                                                                                                                                                                                                                  |
...
[Macro Geneva Wheel GUI](/Macro_Geneva_Wheel_GUI/it "Macro Geneva Wheel GUI/it"): Una interfaccia grafica che permette all'utente di impostare i valori per creare un meccanismo Croce di Malta da zero.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Geneva_Wheel/it&oldid=1080438>"
