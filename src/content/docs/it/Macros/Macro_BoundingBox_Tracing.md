...
| Traccia contenitore                                                                                                                                                                                                                                                          |
| Descrizione                                                                                                                                                                                                                                                                  |
| Questa macro crea una traccia rossa (modificabile) intorno al BoundingBox con 6 rettangoli. Versione macro: 0.12 Ultima modifica: 2021/07/10 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/60/BoundBoxTracing.png) Autore: Mario52 |
| Autore                                                                                                                                                                                                                                                                       |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_BoundingBox_Tracing/it&oldid=1279429>"
