---
title: Strumenti per foglio di calcolo
---

|                                                                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Macro Strumenti per foglio di calcolo                                                                                                                                                                                                                                    |
| Descrizione                                                                                                                                                                                                                                                              |
| Gestione delle celle all'interno del foglio di calcolo di FreeCAD. Versione macro: 0.2.08 Ultima modifica: 2017-11-03 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/3/35/Macro_SpreadsheetTools.png) Autore: Wilfried Hortschitz |
| Autore                                                                                                                                                                                                                                                                   |
...
Questa macro aiuta a gestire le celle all'interno dell'ambiente Spreadsheet di FreeCAD. Con il suo aiuto si è in grado di:

- Tagliare o cancellare dati e/o informazioni alias nell'area selezionata delle celle.
- Copiare negli appunti i dati e/o le informazioni di un alias nell'area selezionata delle celle.
- Incollare dagli appunti i dati e/o le informazioni di un alias nell'area selezionata delle celle.

Sul forum di FreeCAD si trovano ulteriori informazioni in: <http://forum.freecadweb.org/> e in particolare in <https://forum.freecadweb.org/viewtopic.php?f=22&t=20508&hilit=spreadsheet#p158443> and on Github on <https://github.com/HoWilgh/FCSpreadsheetTools/blob/master/README.md> .
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_SpreadsheetTools/it&oldid=692538>"
