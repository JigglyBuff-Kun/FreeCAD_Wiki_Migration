...
| Sviluppa solido                                                                                                                                                                                                          |
| Descrizione                                                                                                                                                                                                              |
| Crea lo sviluppo di un solido con facce piane. Versione macro: 1.0.1 Ultima modifica: 2020-03-10 Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/e/e4/Macro_Unfold_Box.png) Autore: Hervé B.             |
| Autore                                                                                                                                                                                                                   |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Unfold_Box/it&oldid=1166307>"
