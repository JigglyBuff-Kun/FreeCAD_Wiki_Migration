...
| StraightenObject                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Descrizione                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Questa macro allinea un oggetto con il sistema di coordinate FC secondo gli elementi di riferimento (faccia/bordo) Questa macro è stata scritta principalmente per riallineare gli oggetti importati (es. STEP) con i principali piani/assi di FreeCAD. A utilizzare la macro, selezionare gli elementi di riferimento, eventualmente altri oggetti, quindi eseguire la macro. Se vuoi allineare il tuo oggetto con un altro piano/asse, usa la macro e poi la funzione Trasforma di FreeCAD. Vedere il capitolo "Dettagli" per la selezione di più oggetti. Versione macro: 0.8 Ultima modifica: 2019-06-10 Versione FreeCAD: 0.17+ Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/c/c9/Macro_StraightenObject.png) Autore: OpenBrain |
| Autore                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| _Nessuna_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Vedere anche                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| [Macro PlacementAbsolufy](/Macro_PlacementAbsolufy/it "Macro PlacementAbsolufy/it")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
Per utilizzare la macro, selezionare gli elementi di riferimento, eventualmente altri oggetti, quindi eseguire la macro.
...
La macro è disponibile tramite [Addon Manager](/Std_AddonMgr/it "Std AddonMgr/it").
Il codice viene fornito in questa pagina per comodità nel caso in cui il sistema dell'utente non abbia git-python. Anche se dovrebbe essere aggiornato, l'ultima versione è sempre disponibile all'indirizzo [FreeCAD-macro repository](https://github.com/FreeCAD/FreeCAD-macros/blob/master/Utility/StraightenObject.FCMacro)

Per spiegazioni più dettagliate, consultare la pagina [Come installare una macro](/How_to_install_macros/it "How to install macros/it").
...
- Gli oggetti raddrizzati devono essere in un sistema di coordinate corrispondente a quello globale. Se hai usato i contenitori Parte per individuare i tuoi oggetti, dovresti prima usare [Macro PlacementAbsolufy](/Macro_PlacementAbsolufy/it "Macro PlacementAbsolufy/it") ![](/images/Macro_PlacementAbsolufy.png) sul tuo modello. Se questa condizione non viene soddisfatta, possono accadere cose strane.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_StraightenObject/it&oldid=692548>"
