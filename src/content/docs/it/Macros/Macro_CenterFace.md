...
| Macro CenterFace                                                                                                                                                                                                                                              |
| Descrizione                                                                                                                                                                                                                                                   |
| Questa macro marca con un punto rosso (modificabile) il centro della faccia (massa) e stampa le sue coordinate. Versione macro: 0.2 Ultima modifica: 2018-10-07 Download: [ToolBar Icon](https://wiki.freecad.org/images/1/16/CenterFace.png) Autore: Mario52 |
| Autore                                                                                                                                                                                                                                                        |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_CenterFace/it&oldid=1358332>"
