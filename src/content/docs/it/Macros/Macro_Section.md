...
| Sezione                                                                                                                                                                                                                                                                  |
| Descrizione                                                                                                                                                                                                                                                              |
| Implementazione alternativa di [Sezione](/Part_Section/it "Part Section/it") (parametrica) Versione macro: 1.1 Ultima modifica: 2018-04-28 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/f7/Part_Section.svg) Autore: DeepSOIC |
| Autore                                                                                                                                                                                                                                                                   |
...
Lo strumento [Part Sezione](/Part_Section/it "Part Section/it") produce dei bordi discontinui e gran numero di segmenti (nodi), e questo non è molto adatto per il percorso di [Sweep](/Part_Sweep/it "Part Sweep/it").

Questa macro fa la stessa cosa estraendo i bordi della sezione dal risultato di una fusione generale (GFA). Il risultato è più continuo e ha meno nodi. Non è ancora perfetto per lo sweep, ma il risultato è più soddisfacente che utilizzando semplicemente la Sezione di Part.

Richiede FreeCAD v0.17+ built against OCC no less than 6.9.0 (testato con 7.0.0).

## Installazione

Scaricare questo file e salvarlo nella directory delle macro:
...
2. Nel menu di FreeCAD: Macro → Macro... → fare doppio clic su MacroSection.FCMacro . Viene creato un nuovo oggetto.

Dopo aver eseguito la macro una volta, puoi aggiungere un pulsante della barra degli strumenti. Vai su Strumenti → Personalizza, Barre degli strumenti, seleziona MacroSelezione nell'elenco a discesa a sinistra e aggiungi il comando a una qualsiasi delle tue barre degli strumenti personalizzate.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Section/it&oldid=692500>"
