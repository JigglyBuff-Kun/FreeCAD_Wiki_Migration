---
title: Cablaggio e Tubazioni
---

|                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Icona macro generica. Crea la tua icona personale con lo stesso nome della macro](/File:Text-x-python.png "Icona macro generica. Crea la tua icona personale con lo stesso nome della macro") Macro Wiring And Hoses    |
| Descrizione                                                                                                                                                                                                              |
| Queste macro supportano la creazione e la manutenzione di cablaggi e tubazioni. Autore: Piffpoof                                                                                                                         |
| Autore                                                                                                                                                                                                                   |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Wiring_And_Hoses/it&oldid=925203>"
