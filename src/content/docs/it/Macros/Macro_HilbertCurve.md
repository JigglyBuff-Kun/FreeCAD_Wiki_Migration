...
|                                                                                                                                                                                                                                                           |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Icona macro generica. Crea la tua icona personale con lo stesso nome della macro](/File:Text-x-python.png "Icona macro generica. Crea la tua icona personale con lo stesso nome della macro") HilbertCurve                                               |
| Descrizione                                                                                                                                                                                                                                               |
| Questa macro crea una curva di Hilbert in 2 o 3 dimensioni con varie iterazioni. Ultima modifica: 2021-02-13 Versione FreeCAD: 0.16 to 0.19 Download: [ToolBar Icon](https://wiki.freecad.org/images/6/69/Hilbert_curve_icon.png) Autore: Simone Bignetti |
| Autore                                                                                                                                                                                                                                                    |
...
Questa macro crea un wire della [Curva di Hilbert](https://it.wikipedia.org/wiki/Curva_di_Hilbert/%7C) in 2 or 3 dimensioni con varie iterazioni.

## Utilizzo

1. Avvia la macro in un documento di FreeCAD.
2. Nel dialogo che si apre scegli i parametri per la curva di Hilbert:
   - Seleziona se la curva deve essere bidimensionale: ![](/images/CheckBoxTrue.svg) 2D, o tridimensionale: ![](/images/CheckBoxFalse.svg) 3D.
   - Specifica il numero di iterazioni 1 ![](/images/SpinBox.svg). "Attenzione!" Aumentando il numero d'iterazioni aumenterà anche il tempo di calcolo.
   - Specifica la lunghezza del segmento del wire: 10.00 ![](/images/SpinBox.svg).
...
Un wire di Hilbert in 3D e 2 iterazioni.

Puoi utilizzare una curva di Hilbert come path per uno [Sweep](/Part_Sweep "Part Sweep"), ma prima è meglio applicare un raggio al wire, o lo sweep sarà mal formato.

![Il wire della curva di Hilbert con il raggio.](/images/HilbertCurveWireRadius.png)

Il wire della curva di Hilbert con il raggio.
...
Un solido ottenuto con lo sweep di un cerchio lungo la curva di Hilbert.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_HilbertCurve/it&oldid=1348547>"
