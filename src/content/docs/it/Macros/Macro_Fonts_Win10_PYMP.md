...
| Descrizione                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| New version GUI modifyed for the HD dpi (QGridLayout) run only FC version 0.18 and more (PySide2 Qt5) For the precedent version see [Macro Fonts Win10 PYMP](https://gist.githubusercontent.com/mario52a/e7aa19a9dc8ea28ad4f03944ffc8f731/raw/0f5d54209d6c242b49519c83e96c548b06a8f4c6/Macro_Fonts_Win10_PYMP.FCMacro) and install it manually. Questa piccola macro è dedicata agli utenti di Windows 10. I font dentro il browser per utilizzare ShapeString sono invisibili e questa piccola macro può aiutarvi a vedere il font in modo efficace. Versione macro: 02.00 Ultima modifica: 2020-06-06 Versione FreeCAD: 0.18 è piu Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/fa/Macro_Fonts_Win10_PYMP.png) Autore: Mario52 |
| Autore                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [Mario52](/User:Mario52 "User:Mario52")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Download                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/f/fa/Macro_Fonts_Win10_PYMP.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Link                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
- 10.00 ![](/images/SpinBox.svg) : dimensione del testo di lavoro dentro la vista 3D

* ![](/images/CheckBoxFalse.svg) Text : crea uno testo in modo text con il testo ShapeString

- 20.00 ![](/images/SpinBox.svg) : dimensione del testo su la finestra della macro
...
- _'SwitchModeTextList'_
  - `false` la modalità di testo normale (e nera) taglia switchFontComBox
  - `true` consente switchFontComBox
- _'SwitchFontComBox'_
...
- _'SeTtextAlignement'_
  - 0 = AlignLeft (impostazione predefinita)
  - 1 = AlignCenter
  - 2 = AlignRight
- **setFontByDefault** = "ARIAL" l'ultimo carattere utilizzato viene salvato in questo campo
- **setLastFontPath** = "PolicePath" l'ultimo percorso utilizzato viene salvato in questo campo
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Fonts_Win10_PYMP/it&oldid=1241420>"
