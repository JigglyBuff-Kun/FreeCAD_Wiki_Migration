...
| Macro Polyhedrons                                                                                                                                                                                                                                                                                                                                                                                   |
| Description                                                                                                                                                                                                                                                                                                                                                                                         |
| Questa macro crea poliedri parametrici: tetraedro, esaedro, ottaedro, dodecaedro, icosaedro, icosaedro_troncato Parametri raggio e lato possono essere regolati. Macro version: 01.02 Last modified: 2020-01-10 FreeCAD version: All Download: Icona della barra degli strumenti [Icon ToolBar](https://www.freecadweb.org/wiki/images/a/a4/Dodecahedron.svg) Author: Eddy Verlinden, Genk, Belgium |
| Author                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Download                                                                                                                                                                                                                                                                                                                                                                                            |
| Icona della barra degli strumenti [Icon ToolBar](https://www.freecadweb.org/wiki/images/a/a4/Dodecahedron.svg)                                                                                                                                                                                                                                                                                      |
| Links                                                                                                                                                                                                                                                                                                                                                                                               |
...
| _None_                                                                                                                                                                                                                                                                                                                                                                                              |
| See also                                                                                                                                                                                                                                                                                                                                                                                            |
| [Macro Pyramid](/Macro_Pyramid/it "Macro Pyramid/it")                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                                                                                                                                                                                                                                                                                                                     |
|                                                                                                                                                                                                                                                                                                                                                                                                     |
...
- Installa: usa Strumenti / Addon manager / Macro ![](/images/AddonManager.svg) per installare la macro.
- Una volta installato, apri Menu → Macro → Macro. Fare clic su polyhedrons.py e quindi fare clic sul pulsante esegui.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Polyhedrons/it&oldid=1345582>"
