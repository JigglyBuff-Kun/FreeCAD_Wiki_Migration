---
title: Cerchio da 3 punti 2D
---

|                                                                                                                                                                                                                                      |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Cerchio da 3 punti 2D                                                                                                                                                                                                                |
| Descrizione                                                                                                                                                                                                                          |
| Crea un cerchio da 3 punti selezionati. Versione macro: 01.00 Ultima modifica: 2013-03-11 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/c/c7/Macro_Make_Circle_3_Points.png) Autore: Mario52 |
| Autore                                                                                                                                                                                                                               |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Draft_Circle_3_Points/it&oldid=1186376>"
