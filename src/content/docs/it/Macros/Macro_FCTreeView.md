...
| Macro FCTreeView                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Descrizione                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Nuova versione GUI modificata per HD dpi (QGridLayout) eseguibile solo dalla versione FC 0.18 e successive (PySide2 Qt5) Macro per elencare tutti gli oggetti nel progetto in un elenco senza gerarchia, opzioni di ordinamento per nome, etichetta, visibilità, gruppo, opzioni di ricerca per lunghezza nome, etichetta .... senza distinzione tra maiuscole e minuscole o con distinzione tra maiuscole e minuscole e per selezionare tutti gli oggetti visualizzati nella finestra macro. [Pacchetto icone Macro FCTreeView](https://forum.freecadweb.org/download/file.php?id=70498) decomprimere il file .zip e copiare l'icona nella directory delle macro. Per la versione precedente cfr [Macro_FCTreeView.FCMacro](https://gist.githubusercontent.com/mario52a/67517ef758ff20005d0a6adcfd8c9190/raw/0a92d7f591a0a179f84b2fc417046723b4d7b0e6/Macro_FCTreeView.FCMacro) e installarla manualmente. Versione macro: 00.09 Ultima modifica: 2020-09-24 Versione FreeCAD: 0.18 and below Download: [ToolBar Icon](https://wiki.freecad.org/images/6/64/Macro_FCTreeView.png) Autore: Mario52 |
| Autore                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
![Icona utilizzata per il nome dell'oggetto](/images/Macro_FCTreeView_00.png) Icona utilizzata per il nome dell'oggetto (la barra di scorrimento è colorata in blu)
...
[![Icon used for visualise if the object is status Visible (mouse click for Hidden)](/images/Macro_FCTreeView_01.png)](/File:Macro_FCTreeView_01.png  "Icon used for visualise if the object is status Visible (mouse click for Hidden)")Icona utilizzata per visualizzare se l'oggetto è in stato Visibile (clic del mouse per Nascosto) (la barra di scorrimento è colorata in verde)

[![Icon used for visualise if the object is status Hidden (mouse click for Visible)](/images/Macro_FCTreeView_02.png)](/File:Macro_FCTreeView_02.png  "Icon used for visualise if the object is status Hidden (mouse click for Visible)") Icona utilizzata per visualizzare se l'oggetto è in stato Nascosto (clic del mouse per Visibile) (la barra di scorrimento è colorata in rosso)

[![icona utilizzata per il nome contiene oggetti (o gruppo di cartelle)](/images/Macro_FCTreeView_17.png)](/File:Macro_FCTreeView_17.png  "icona utilizzata per il nome contiene oggetti (o gruppo di cartelle)") L'icona utilizzata per il nome contiene oggetti (o gruppo di cartelle)

[![Icona usata per informare l'oggetto in un gruppo, gli oggetti numerici sono visualizzati nel gruppo in alto (la barra di scorrimento è colorata in rosso)](/images/Macro_FCTreeView_03.png)](/File:Macro_FCTreeView_03.png  "Icona usata per informare l'oggetto in un gruppo, gli oggetti numerici sono visualizzati nel gruppo in alto (la barra di scorrimento è colorata in rosso)") Icona usata per informare l'oggetto in un gruppo, gli oggetti numerici sono visualizzati nel gruppo in alto (la barra di scorrimento è colorata in rosso)

[![Icona utilizzata per visualizzare il singolo oggetto (non il gruppo)](/images/Macro_FCTreeView_04.png)](/File:Macro_FCTreeView_04.png  "Icona utilizzata per visualizzare il singolo oggetto (non il gruppo)") Icona utilizzata per visualizzare il singolo oggetto (non il gruppo)

### Section **Ordina per :**

![](/images/Macro_FCTreeView_10.png) Name Icona usata per il flip/flop normale/invertire la lista dei dati ordinata per nome

![](/images/Macro_FCTreeView_11.png) Label Icona usata per il flip/flop normale/invertire la lista dei dati ordinata per etichetta

![](/images/Macro_FCTreeView_12.png) Visible Icona usata per il flip/flop normale/rovescia l'ordinamento della lista dei dati per Visibile/Nascosto

![](/images/Macro_FCTreeView_13.png) Group Icona usata per il flip/flop normale/inverte l'ordinamento della quotazione dei dati per Gruppo/Oggetto singolo

![](/images/Macro_FCTreeView_19.png) Length Se questa casella di controllo è selezionata, l'ordinamento viene creato in base alla lunghezza con il pulsante su cui è stato fatto clic (Nome, Etichetta ...)

### Section **Global**

![](/images/Macro_FCTreeView_21.png) Split flip/flop Dividi la lista dei nomi

![](/images/Macro_FCTreeView_22.png) Split flip/flop Dividi il nome e l'elenco delle etichette

![](/images/Macro_FCTreeView_14.png) Expend flip/flop l'elenco dei dati Fold/Expend

![](/images/Macro_FCTreeView_15.png) Expend capovolgere/flopare l'elenco di dati Spiega/Piega
...
![](/images/Macro_FCTreeView_16.png) Reload Ricarica i dati nel progetto

![](/images/Macro_FCTreeView_18.png) Original ritorno nell'organizzazione originale dopo l'operazione visibilità/Nascosto

![](/images/Macro_FCTreeView_01.png) All Visible visualizza se l'oggetto è stato Visibile

![](/images/Macro_FCTreeView_02.png) All Hidden visualizza se l'oggetto è stato Nascosto

### Section **Search**

![](/images/Macro_FCTreeView_20.png) Clear Cancella la modifica della riga di ricerca
...
![](/images/Macro_FCTreeView_23.png) Select flip/flop per Selezionati tutti gli oggetti visualizzati nella finestra

![](/images/Macro_FCTreeView_24.png) Unselected flip/flop per Selezionati tutti gli oggetti visualizzati nella finestra

![](/images/Macro_FCTreeView_25.png) S Sheet accesso nelle opzioni del foglio di calcolo
...
![](/images/Macro_FCTreeView_28.png) Select : Seleziona tutta l'opzione checkBox per salvare

![](/images/Macro_FCTreeView_29.png) Select : unSeleziona tutta l'opzione checkBox per salvare
...
![](/images/Macro_FCTreeView_28.png) Select seleziona tutte le opzioni della casella di controllo

![](/images/Macro_FCTreeView_29.png) Unselect deselezionate tutte le opzioni della casella di controllo

![](/images/Macro_FCTreeView_27.png) Save salva i dati nel foglio di calcolo visualizzato. se nessun foglio di calcolo è attivo, viene creato il foglio di calcolo denominato **FCSpreadSheet**

![](/images/Macro_FCTreeView_26.png) Quit esci dalle opzioni del foglio di calcolo
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCTreeView/it&oldid=1362375>"
