...
| FCCamGroover                                                                                                                                                                                                                                                                                                                               |
| Descrizione                                                                                                                                                                                                                                                                                                                                |
| Questa macro crea un solco in un cilindro. L'oggetto è mostrato in questa video [youtube video](https://youtu.be/io1JL1U7kUs). Versione macro: 2020.06.13 Ultima modifica: 2020.06.13 Versione FreeCAD: 019 and above Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/b/ba/Cam-groover-icon-32x32.png) Autore: TheMarkster |
| Autore                                                                                                                                                                                                                                                                                                                                     |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCCamGroover/it&oldid=1186356>"
