...
| Descrizione                                                                                                                                                                                                                                                |
| Questa macro crea faccia e schizzo da un file DXF Versione macro: 02.00 Ultima modifica: 2017-10-23 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/6/6d/Macro_DXF_to_Face_and_Sketch.png) Autore: shoogen, easyw-fc |
| Autore                                                                                                                                                                                                                                                     |
...
- Precedente versione [Macro Creating faces from a DXF file](/Macro_Creating_faces_from_a_DXF_file/it "Macro Creating faces from a DXF file/it")

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_DXF_to_Face_and_Sketch/it&oldid=692137>"
