...
| Dispiega lamiera                                                                                                                                                                                                                                   |
| Descrizione                                                                                                                                                                                                                                        |
| Questa macro dispiega dei semplici pezzi in lamiera. Versione macro: 17.0 Ultima modifica: 2018-08-14 Versione FreeCAD: 17.0 Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/1/16/Macro_Sheet_Metal_Unfolder.png) Autore: ulrich1a |
| Autore                                                                                                                                                                                                                                             |
| [ulrich1a](/index.php?title=User:Ulrich1a&action=edit&redlink=1 "User:Ulrich1a (page does not exist)")                                                                                                                                             |
| Download                                                                                                                                                                                                                                           |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/1/16/Macro_Sheet_Metal_Unfolder.png)                                                                                                                                                         |
| Link                                                                                                                                                                                                                                               |
...
Questa macro permette di distendere dei semplici pezzi di lamiera. Le parti devono avere uno spessore uniforme, che è la caratteristica tipica dei pezzi metallici in lamiera. Vedere l'esempio:

Temporary code for external macro link. Do not use this code. This code is used exclusively by [Addon Manager](/Std_AddonMgr "Std AddonMgr"). _Link for optional manual installation: [Macro](https://raw.githubusercontent.com/ulrich1a/sheet_ufo/master/sheet_ufo.py)_
...
Selezionare una faccia piana di una Parte nella vista 3D, poi avviare la macro.

## Osservazioni

La macro crea una grande quantità di testo nel report-view. si tratta di rimanenze del processo di debug di questa macro. I bordi della lamiera possono essere sia arrotondati che smussati. Quando si attraversa la lastra dalla faccia superiore alla faccia inferiore non si deve attraversare più di una faccia.
Nel caso migliore la macro genera dall'oggetto Parte originale un nuovo solido piano. Se la macro incontra dei problemi, si può però ottenere solo un guscio piatto o un gruppo di facce appiattite o solo un messaggio di errore.

La macro può essere pensata come un compagno dello strumento AddWall di JMG pubblicato qui: [FreeCAD: Sheet metal tool "Add Wall"](http://linuxforanengineer.blogspot.com.es/2014/12/freecad-sheet-metal-tool-add-wall.html)

## Link

La pagina della discussione nel forum: [Sheet metal: add wall tool](http://forum.freecadweb.org/viewtopic.php?f=24&t=8789)

Una versione aggiornata è disponibile in: <https://github.com/ulrich1a/sheet_ufo>
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Sheet_Metal_Unfolder/it&oldid=692512>"
