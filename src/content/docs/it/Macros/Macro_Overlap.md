...
|                                                                                                                                                                                                                                                                                                                                    |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Sovrapposizione Booleana                                                                                                                                                                                                                                                                                                           |
| Descrizione                                                                                                                                                                                                                                                                                                                        |
| Strumento booleano intermedio tra [Part Unione](/Part_Fuse/it "Part Fuse/it") e [Part Intersezione](/Part_Common/it "Part Common/it"). Parametrico. Versione macro: 0.2 Ultima modifica: 2018-08-31 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/a/ac/Macro_Overlap.png) Autore: DeepSOIC |
| Autore                                                                                                                                                                                                                                                                                                                             |
| [DeepSOIC](/User:DeepSOIC "User:DeepSOIC")                                                                                                                                                                                                                                                                                         |
| Download                                                                                                                                                                                                                                                                                                                           |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/a/ac/Macro_Overlap.png)                                                                                                                                                                                                                                                      |
| Link                                                                                                                                                                                                                                                                                                                               |
...
\* si può fare anche due forme, ma l'azione dello strumento è equivalente a [Part Intersezione](/Part_Common/it "Part Common/it") or [Part Unione](/Part_Fuse/it "Part Fuse/it"), e quindi si consiglia di utilizzare gli strumenti di Part.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Overlap/it&oldid=1189384>"
