...
| Descrizione                                                                                                                                                                                                                                                                                                                                                         |
| Questa macro fornisce una GUI per consentire una rotazione di precisione degli oggetti nella vista. Versione macro: 1.0 Ultima modifica: 2012-01-04 Versione FreeCAD: Tutte Download: [Icons Package](http://forum.freecadweb.org/download/file.php?id=453) [Icon ToolBar](https://www.freecadweb.org/wiki/images/a/af/Macro_View_Rotation.png) Autore: Joe Dowsett |
| Autore                                                                                                                                                                                                                                                                                                                                                              |
...
| _Nessuna_                                                                                                                                                                                                                                                                                                                                                           |
| Vedere anche                                                                                                                                                                                                                                                                                                                                                        |
| [Macro Rotate View](/Macro_Rotate_View/it "Macro Rotate View/it") [Macro FCCamera](/Macro_FCCamera/it "Macro FCCamera/it")                                                                                                                                                                                                                                          |
|                                                                                                                                                                                                                                                                                                                                                                     |
|                                                                                                                                                                                                                                                                                                                                                                     |
...
L'ultima versione della macro è disponibile all'indirizzo [ViewRotation.FCMacro](https://github.com/FreeCAD/FreeCAD-macros/blob/master/PureGui/ViewRotation.FCMacro) ma il modo più semplice per installare questa macro è tramite [Addon Manager](/Std_AddonMgr/it "Std AddonMgr/it").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_View_Rotation/it&oldid=1346263>"
