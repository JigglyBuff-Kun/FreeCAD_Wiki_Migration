...
| Descrizione                                                                                                                                                                                                                                                                                                                                                   |
| Questa macro crea un'elica (o molla) attorno a un oggetto solido qualunque sia la sua forma, l'elica segue l'intera superficie dell'oggetto (è richiesto Python2) Versione macro: 00.01 Ultima modifica: 2024/01/15 Versione FreeCAD: 0.18 o superiore Download: [ToolBar Icon](https://wiki.freecad.org/images/3/38/FCSpring_On_Surface.png) Autore: Mario52 |
| Autore                                                                                                                                                                                                                                                                                                                                                        |
...
| _Nessuna_                                                                                                                                                                                                                                                                                                                                                     |
| Vedere anche                                                                                                                                                                                                                                                                                                                                                  |
| [Macro FCSpring Helix Variable](/Macro_FCSpring_Helix_Variable/it "Macro FCSpring Helix Variable/it")                                                                                                                                                                                                                                                         |
|                                                                                                                                                                                                                                                                                                                                                               |
|                                                                                                                                                                                                                                                                                                                                                               |
...
- **Pas :** Il tono dell'elica (Difetto: 1)
- **Height :** L'altezza dell'elica. Difetto, l'altezza è l'altezza massima del boundBox dell'oggetto.
- **Precision :** Numero di punti per un giro dell'oggetto, massimo 360 (Difetto: 36)
...
- **BSpline :** Viene creata un'elica Bspline
- **Wire :** Viene creato un Wire per elica
- **Points :** Viene creato un punto in tutte le coordinate create per la creazione di Bspline o Wire
- **Reverse :** L'elica è invertita (Difetto: antiorario)
- Se è selezionato si può vedere la progressione nella vista 3D
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCSpring_On_Surface/it&oldid=1491608>"
