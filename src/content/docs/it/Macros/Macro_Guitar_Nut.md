...
| Macro Guitar Nut                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Create [guitar nuts](https://wikipedia.org/wiki/Guitar#Nut). Macro di FreeCAD per creare forme complesse di capotasti per chitarra. In particolare, può creare un capotasto con la parte inferiore delle fessure delle corde all'altezza desiderata sopra una tastiera col raggio desiderato. Il diametro di ciascuna corda è configurabile e le fessure possono essere adattate per tenere conto della larghezza necessaria per evitare legature. Consulta la sezione [Utilizzo](#Utilizzo) per ulteriori dettagli. Macro version: 0.1 Last modified: 2020-01-27 FreeCAD version: All Download: [ToolBar Icon](https://wiki.freecad.org/images/9/94/Macro_Guitar_Nut.png) Author: jsiddall |
| Author                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
1. Scaricare la macro dal [Addon Manager](/Std_AddonMgr/it "Std AddonMgr/it")
2. Eseguire la macro
...
Icona della barra degli strumenti ![](/images/Macro_Guitar_Nut.png)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Guitar_Nut/it&oldid=1358370>"
