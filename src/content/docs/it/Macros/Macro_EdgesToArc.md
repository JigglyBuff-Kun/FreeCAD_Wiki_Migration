...
| Da Segmento a Arco                                                                                                                                                                                                                                                                                                               |
| Descrizione                                                                                                                                                                                                                                                                                                                      |
| Sostituisce, se possibile, i segmenti selezionati con un arco di cerchio. Utile per il ripristino di archi discretizzati. Versione macro: 1.0 Ultima modifica: 2014-01-02 Versione FreeCAD: Tutte versione Download: [Icona per la ToolBar](https://www.freecadweb.org/wiki/images/6/65/Macro_EdgesToArc.png) Autore: Jreinhardt |
| Autore                                                                                                                                                                                                                                                                                                                           |
| [Jreinhardt](/index.php?title=User:Jreinhardt&action=edit&redlink=1 "User:Jreinhardt (page does not exist)")                                                                                                                                                                                                                     |
| Download                                                                                                                                                                                                                                                                                                                         |
| [Icona per la ToolBar](https://www.freecadweb.org/wiki/images/6/65/Macro_EdgesToArc.png)                                                                                                                                                                                                                                         |
| Link                                                                                                                                                                                                                                                                                                                             |
...
| _Nessuna_                                                                                                                                                                                                                                                                                                                        |
| Vedere anche                                                                                                                                                                                                                                                                                                                     |
| [Macro SuperWire](/Macro_SuperWire/it "Macro SuperWire/it")                                                                                                                                                                                                                                                                      |
|                                                                                                                                                                                                                                                                                                                                  |
|                                                                                                                                                                                                                                                                                                                                  |
...
Per utilizzare questa macro, è necessario degradare il contorno e scomporlo in singoli segmenti con la funzione ![](/images/Draft_Downgrade.svg) [Draft Downgrade](/Draft_Downgrade/it "Draft Downgrade/it"). Dopo basta selezionare i segmenti che si desidera sostituire con un arco di cerchio ed eseguire la macro. Servono almeno due segmenti.
...
A causa di piccole imprecisioni nei calcoli, la funzione ![](/images/Draft_Upgrade.svg) [Draft Upgrade](/Draft_Upgrade/it "Draft Upgrade/it") può talvolta non riuscire a ricombinare gli altri bordi e gli archi in un unico contorno. In questo caso la [Macro_SuperWire](/Macro_SuperWire/it "Macro SuperWire/it") fornisce un modo più efficace per fare questo.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_EdgesToArc/it&oldid=1225771>"
