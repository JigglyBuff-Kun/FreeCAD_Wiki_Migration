...
| Stile di disegno                                                                                                                                                                                                                                |
| Descrizione                                                                                                                                                                                                                                     |
| Cambia lo Stile di disegno dell'oggetto selezionato. Versione macro: 2.0 Ultima modifica: 2020-02-02 Versione FreeCAD: >=0.17 Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/0b/Macro_Toggle_Drawstyle.png) Autore: Piffpoof |
| Autore                                                                                                                                                                                                                                          |
...
| _Nessuna_                                                                                                                                                                                                                                       |
| Vedere anche                                                                                                                                                                                                                                    |
| [Macro Toggle Drawstyle Optimized](/Macro_Toggle_Drawstyle_Optimized/it "Macro Toggle Drawstyle Optimized/it") per tutte le lingue                                                                                                              |
|                                                                                                                                                                                                                                                 |
|                                                                                                                                                                                                                                                 |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Toggle_Drawstyle/it&oldid=692565>"
