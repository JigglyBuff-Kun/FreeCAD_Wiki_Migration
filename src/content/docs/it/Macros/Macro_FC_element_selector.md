...
| Descrizione                                                                                                                                                                                                                                      |
| Questa macro mostra tutti gli elementi sotto il mouse. Versione macro: 01.00 Ultima modifica: 2016-12-26 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/07/Macro_FC_element_selector.png) Autore: HoWil |
| Autore                                                                                                                                                                                                                                           |
...
| _Nessuna_                                                                                                                                                                                                                                        |
| Vedere anche                                                                                                                                                                                                                                     |
| [Macro Mouse over cb](/Macro_Mouse_over_cb/it "Macro Mouse over cb/it")                                                                                                                                                                          |
|                                                                                                                                                                                                                                                  |
|                                                                                                                                                                                                                                                  |
...
Altra macro similare [Macro Mouse over cb](/Macro_Mouse_over_cb/it "Macro Mouse over cb/it")

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FC_element_selector/it&oldid=1303397>"
