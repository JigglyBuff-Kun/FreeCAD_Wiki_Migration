---
title: GUI per creare un prisma da apotema
---
...
| Prisma da apotema                                                                                                                                                                                                                                                                |
| Descrizione                                                                                                                                                                                                                                                                      |
| Interfaccia grafica per creare un prisma basato sull'apotema (inraggio) inserita dall'utente. Versione macro: 1.0 Ultima modifica: 2014-12-31 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/4/4e/Part_Prism_Apothem.svg) Autore: Quick61 |
| Autore                                                                                                                                                                                                                                                                           |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Apothem_Based_Prism_GUI/it&oldid=692009>"
