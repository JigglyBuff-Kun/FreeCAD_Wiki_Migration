...
|                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Icona macro generica. Crea la tua icona personale con lo stesso nome della macro](/File:Text-x-python.png "Icona macro generica. Crea la tua icona personale con lo stesso nome della macro") TreeToAscii               |
| Descrizione                                                                                                                                                                                                              |
| Questa macro genera una rappresentazione in stile ASCII dell'albero degli oggetti selezionati Versione macro: 0.6 Ultima modifica: 2020-03-23 Versione FreeCAD: 0.17+ Autore: OpenBrain                                  |
| Autore                                                                                                                                                                                                                   |
...
Questa macro è stata scritta principalmente per documentare la costruzione del modello.
...
- **_Modern_** : (default) uses Unicode characters to display forks and branches
- **_Baroque_** : another Unicode style with larger indentation
- **_ASCII_** : pure ASCII representation of forks and branches
...
- **_{LBL}_** : object Label (displayed label)
- **_{NAM}_** : object Name (internal name) eg. 'Box001'
- **_{SNAM}_** : object ShortName (without digits) eg. 'Box001' will be displayed as 'Box'
- **_{TYP}_** : object Type eg. 'Part::MultiFuse'
- **_{BTYP}_** : object BaseType eg. 'Part::MultiFuse' will be displayed as 'Part'
- **_{STYP}_** : object ShortType (without base) eg. 'Part::MultiFuse' will be displayed as 'MultiFuse'

Default pattern is '{LBL} ({SNAM})', which means eg. object 'Box001' labeled 'myCube' will be displayed as 'myCube (Box001)'.
...
- **_Copy to clipboard_** : copies the whole tree to your clipboard
- **_Save to file_** : saves the whole tree to an arbitrary file on your system
- **_Embed in text file_** : stores the whole tree in a text file embedded in the document (available since FC 0.18.4)
...
Code is provided on this page for convenience in case user system doesn't have git-python. Though it should be up-to-date, latest release is always available at [FreeCAD-macro repository](https://github.com/FreeCAD/FreeCAD-macros/blob/master/Information/TreeToAscii.FCMacro)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_TreeToAscii/it&oldid=1290081>"
