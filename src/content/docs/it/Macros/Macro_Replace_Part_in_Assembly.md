---
title: Sostituisci Parte in Assembly
---

|                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Sostituisci Parte in Assembly                                                                                                                                                                                            |
| Descrizione                                                                                                                                                                                                              |
| Sostituisce una Parte in un assemlaggio Versione macro: 1.0 Ultima modifica: 2014-09-10 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/07/Replace_Part.png) Autore: ralvejd     |
| Autore                                                                                                                                                                                                                   |
| [ralvejd](/index.php?title=User:Ralvejd&action=edit&redlink=1 "User:Ralvejd (page does not exist)")                                                                                                                      |
| Download                                                                                                                                                                                                                 |
| [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/07/Replace_Part.png)                                                                                                                                             |
| Link                                                                                                                                                                                                                     |
...
1. Avviare macro.
2. Selezionare il documento di FreeCAD appropriato e selezionare la nuova parte nella vista ad albero.
3. Quindi cliccare su "Select New Part".
4. Selezionare il documento di FreeCAD appropriato e nella vista ad albero selezionare la parte che deve essere sostituita.
5. Quindi cliccare su "Select Old Part".
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Replace_Part_in_Assembly/it&oldid=1186362>"
