---
title: ImperialScales
---

|                                                                                                                                                                                                                                                           |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Icona macro generica. Crea la tua icona personale con lo stesso nome della macro](/File:Text-x-python.png "Icona macro generica. Crea la tua icona personale con lo stesso nome della macro") ImperialScales                                             |
| Descrizione                                                                                                                                                                                                                                               |
| Questa macro mostra un elenco di scale dell'Arco Imperiale degli Stati Uniti con il fattore corrispondente da applicare alle pagine o alle visualizzazioni TechDraw Versione macro: 0.1 Ultima modifica: 2021-06-01 Versione FreeCAD: 0.18+ Autore: Yorik |
| Autore                                                                                                                                                                                                                                                    |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_ImperialScales/it&oldid=1350197>"
