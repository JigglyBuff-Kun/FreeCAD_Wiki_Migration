...
| Descrizione                                                                                                                                                                                                                 |
| Crea un sito Arch da una serie di contorni. Versione macro: 1.0 Ultima modifica: 2018-08-30 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/File:Macro_Site_From_Contours.png) Autore: yorik |
| Autore                                                                                                                                                                                                                      |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Site_From_Contours/it&oldid=692517>"
