...
| Polilinea da XYZ                                                                                                                                                                                                                                                                                      |
| Descrizione                                                                                                                                                                                                                                                                                           |
| Crea una linea spezzata con le coordinate x y z. (Riga di comando, incolla questa macro completa nella console Python). Versione macro: 0.3 Ultima modifica: 2020-10-16 Versione FreeCAD: All Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/0/0a/Macro_WireXYZ.png) Autore: Mario52 |
| Autore                                                                                                                                                                                                                                                                                                |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_WireXYZ/it&oldid=783367>"
