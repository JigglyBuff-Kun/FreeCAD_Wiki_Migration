...
Completa documentazione su [https://github.com/mwganson/FCHoneycombMaker](https://github.com/mwganson/FCHoneyMaker)

Argomento dell'annuncio della funzione nella conversazione del forum [FCHoneycombMaker Macro](https://forum.freecadweb.org/viewtopic.php?f=9&t=37490)

Altra macro a nido d'ape simile [Honeycomb Array](https://forum.freecadweb.org/viewtopic.php?t=11008)

## Versione

2019-07-04 : prima

Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_FCHoneycombMaker/it&oldid=1186341>"
