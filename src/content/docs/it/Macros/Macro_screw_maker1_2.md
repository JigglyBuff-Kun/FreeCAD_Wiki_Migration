...
|  |
| --- |
| Macro\_screw\_maker1\_2 |
| Descrizione |
| Crea viti, bulloni,... con o senza la filettatura  Versione macro: 2.3.1 Ultima modifica: 2018-10-22 Versione FreeCAD: Tutte le versioni Download: [Icona per la ToolBar](https://www.freecadweb.org/wiki/images/0/00/Macro_screw_maker1_2.png) Autore: Ulrich Brammer |
| Autore |
| [Ulrich Brammer](/index.php?title=User:Ulrich_Brammer&action=edit&redlink=1 "User:Ulrich Brammer (page does not exist)") |
| Download |
| [Icona per la ToolBar](https://www.freecadweb.org/wiki/images/0/00/Macro_screw_maker1_2.png) |
| Link |
...
Temporary code for external macro link. Do not use this code. This code is used exclusively by [Addon Manager](/Std_AddonMgr "Std AddonMgr"). *Link for optional manual installation: [Macro](https://raw.githubusercontent.com/FreeCAD/FreeCAD-macros/master/ObjectCreation/ScrewMaker.FCMacro)*
...
Quando si seleziona una combinazione di proprietà non disponibile l'utente viene informato con un messaggio.

* ![L'interfaccia di screw_maker e alcuni tipi di viti.](/images/Macro_screw_maker_02.png)

  L'interfaccia di **screw\_maker** e alcuni tipi di viti.
* ![Un bullone con la filettatura](/images/Macro_screw_maker_03.png)

  Un bullone con la filettatura

Creare il filetto richiede molto tempo. Siate pazienti e date un'occhiata all'utilizzo della CPU.

## Codice

L'ultima versione della macro è disponibile all'indirizzo [ScrewMaker.FCMacro](https://github.com/FreeCAD/FreeCAD-macros/blob/master/ObjectCreation/ScrewMaker.FCMacro) ma il modo più semplice per installare questa macro è tramite [Addon Manager](/Std_AddonMgr/it "Std AddonMgr/it").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_screw_maker1_2/it&oldid=1346235>"