...
Potete trovare altre informazioni nella pagina [FreeCAD-Ship](/Ship_Workbench/it "Ship Workbench/it")
...
:::caution
Attenzione, prima di modificare qualsiasi cosa!Ora si sta lavorando con il file originale del modello.Per preservare l'esempio originale, senza modificarlo,è necessario salvarlo come nuovo file, prima di apportare delle modifiche
:::
...
Per disegnare queste sezioni si può utilizzare il modulo [Drawing](/Drawing_Workbench/it "Drawing Workbench/it"):
...
* **TAP**: Immersione nella perpendicolare avanti, prora.
* **TFP**: Immersione nella perpendicolare addietro, poppa .
...
Quando si preme il pulsante **OK** viene prodotto un grafico (vedere la documentazione del modulo [Plot](/Plot_Workbench/it "Plot Workbench/it")) e un foglio di calcolo (vedere la documentazione del modulo [Spreadsheet](/Spreadsheet_Workbench/it "Spreadsheet Workbench/it")).
...
Ora si è pronti per continuare la lettura su [Ship](/Ship_Workbench/it "Ship Workbench/it"), [qui](/FreeCAD-Ship_s60_tutorial_(II)/it "FreeCAD-Ship s60 tutorial (II)/it") c'è il secondo capitolo sulle barche della Serie 60, dell'Università di Iowa.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD-Ship_s60_tutorial/it&oldid=1252280>"