...
* [Installation of IfcOpenShell](https://forum.freecadweb.org/viewtopic.php?f=39&t=48971);
* [IFC installation](https://forum.freecadweb.org/viewtopic.php?f=39&t=12368&start=10#p117883); vecchia discussione nel forum.
* [IfcPlusPlus compiled on Gentoo - questions and alternatives?](https://forum.freecadweb.org/viewtopic.php?f=39&t=33254)
* [Importare/Esportare IFC - compilare IfcOpenShell](/Import/Export_IFC_-_compiling_IfcOpenShell/it "Import/Export IFC - compiling IfcOpenShell/it"); una vecchia guida che descrive il processo generale. Potrebbe non essere più necessario poiché IfcOpenShell è ora distribuito insieme a FreeCAD grazie a [Conda](/Conda/it "Conda/it").
* Pagine che puntano a [IfcOpenShell](/Special:WhatLinksHere/IfcOpenShell "Special:WhatLinksHere/IfcOpenShell").

Retrieved from "<http://wiki.freecad.org/index.php?title=IfcOpenShell/it&oldid=1433913>"