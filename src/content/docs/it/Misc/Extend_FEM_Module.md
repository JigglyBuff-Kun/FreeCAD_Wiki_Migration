...
* Script Python in FreeCAD.
  + [Tutorial sugli script di FreeCAD](/Python_scripting_tutorial/it "Python scripting tutorial/it")
  + [Nozioni di base sugli script di FreeCAD](/FreeCAD_Scripting_Basics/it "FreeCAD Scripting Basics/it")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Extend_FEM_Module/it&oldid=1485151>"