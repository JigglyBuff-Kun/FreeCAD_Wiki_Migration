...
- [Note di rilascio della versione 1.1](/Release_notes_1.1/it "Release notes 1.1/it") - _Versione di sviluppo con aggiornamenti settimanali_
- **[Note di rilascio della versione 1.0](/Release_notes_1.0/it "Release notes 1.0/it") - Novembre 2024**
- [Note di rilascio della versione 0.21](/Release_notes_0.21/it "Release notes 0.21/it") - Agosto 2023
- [Note di rilascio della versione 0.20](/Release_notes_0.20/it "Release notes 0.20/it") - Giugno 2022
- [Note di rilascio della versione 0.19](/Release_notes_0.19/it "Release notes 0.19/it") - Marzo 2021
- [Note di rilascio della versione 0.18](/Release_notes_0.18/it "Release notes 0.18/it") - Marzo 2019
- [Note di rilascio della versione 0.17](/Release_notes_0.17/it "Release notes 0.17/it") - Aprile 2018
- [Note di rilascio della versione 0.16](/Release_notes_0.16/it "Release notes 0.16/it") - Aprile 2016
- [Note di rilascio della versione 0.15](/Release_notes_0.15/it "Release notes 0.15/it") - Marzo 2015
- [Note di rilascio della versione 0.14](/Release_notes_0.14/it "Release notes 0.14/it") - Marzo 2014
- [Note di rilascio della versione 0.13](/Release_notes_0.13/it "Release notes 0.13/it") - Gennaio 2013
- [Note di rilascio della versione 0.12](/Release_notes_0.12/it "Release notes 0.12/it") - Dicembre 2011
- [Note di rilascio della versione 0.11](/Release_notes_0.11/it "Release notes 0.11/it") - Marzo 2011

## Funzioni principali

- ![](/images/Feature1.jpg)

  Un **kernel geometrico** (nucleo) basato su [OpenCasCade](http://it.wikipedia.org/wiki/Open_CASCADE_Technology) permette operazioni complesse su profili di varia natura, anche molto articolati. È presente il supporto nativo al [BREP](http://it.wikipedia.org/wiki/B-Rep), alle curve e alle superfici [NURBS](http://it.wikipedia.org/wiki/NURBS), una vasta gamma di entità geometriche, di operazioni booleane e [raccordi](<https://en.wikipedia.org/wiki/Fillet_(mechanics)>), e il supporto interno per i file [STEP](https://it.wikipedia.org/wiki/ISO_10303) e [IGES](https://it.wikipedia.org/wiki/IGES).

- ![](/images/Feature3.jpg)

  Un **modellatore interamente parametrico**. Tutti gli oggetti di FreeCAD sono nativamente parametrici, il che significa che la loro forma può essere basata sulle [proprietà](/Property/it "Property/it") o anche dipendere da altri oggetti. Tutte le modifiche possono essere ricalcolate a richiesta, e registrate dall'albero delle operazioni annulla o ripeti. Possono essere aggiunti facilmente nuovi tipi di oggetti, e possono anche essere [completamente programmati in Python](/Scripted_objects/it "Scripted objects/it").

- ![](/images/Feature4.jpg)

  Una **architettura modulare** che consente ai plugin (moduli e ambienti di lavoro) di aggiungere funzionalità all'applicazione principale. Un'estensione può essere complessa, come un'intera nuova applicazione programmata in C++ o essere semplice, come uno [script Python](/Power_users_hub/it "Power users hub/it") o una [macro](/Macros/it "Macros/it") auto-registrata. Attraverso l'utilizzo della riga di comando integrata nella GUI, è possibile accedere praticamente a tutte le funzionalità del software per mezzo di semplici comandi **Python**. Si possono [creare e/o modificare oggetti geometrici](/Topological_data_scripting/it "Topological data scripting/it"), interagire con [l'ambiente di lavoro](/Scenegraph/it "Scenegraph/it") o addirittura [personalizzare l'interfaccia grafica](/PySide/it "PySide/it") del programma.

- ![](/images/Feature5.jpg)

  È possibile importare ed esportare molti dei **formati standard** di rappresentazione 3D, come ad esempio: [STEP](https://it.wikipedia.org/wiki/ISO_10303), [IGES](https://it.wikipedia.org/wiki/IGES), [OBJ](https://en.wikipedia.org/wiki/Obj), [STL](<https://it.wikipedia.org/wiki/STL_(formato_di_file)>), [DXF](https://it.wikipedia.org/wiki/AutoCAD_DXF), [SVG](https://it.wikipedia.org/wiki/Scalable_Vector_Graphics), [DAE](https://it.wikipedia.org/wiki/COLLADA), [IFC](https://en.wikipedia.org/wiki/Industry_Foundation_Classes) oppure [OFF](http://people.sc.fsu.edu/~jburkardt/data/off/off.html), [NASTRAN](https://it.wikipedia.org/wiki/Nastran), [VRML](https://it.wikipedia.org/wiki/VRML), oltre al formato nativo di FreeCAD [FCStd](/File_Format_FCStd/it "File Format FCStd/it"). Il livello di compatibilità tra FreeCAD e un formato di file specifico è variabile, dipende dal'ambiente di lavoro che lo implementa.

- ![](/images/Feature7.jpg)

  Un ambiente di [sketch](/Sketcher_Workbench/it "Sketcher Workbench/it") dotato di strumenti per disegnare sagome in 2D vincolate. Questa funzionalità permette di vincolare in diversi modi le geometrie tracciate e poi di utilizzarle come base per la costruzione delle forme 3D.

- ![](/images/Feature8.jpg)

  Un nuovo ambiente di lavoro comodo per creare [fogli di disegno tradizionali](/TechDraw_Workbench/it "TechDraw Workbench/it") con opzioni per viste di dettaglo, sezioni trasversali, quotatura e altre, che consente di inserire delle viste 2D dei modelli 3D su un foglio. Questo ambiente di lavoro produce quindi fogli SVG o PDF pronti per l'esportazione.

- ![](/images/Feature-arch.jpg)

  Un ambiente [BIM](/BIM_Workbench/it "BIM Workbench/it") compatibile con il modello [BIM](http://it.wikipedia.org/wiki/Building_Information_Modeling) e con l'[IFC](http://en.wikipedia.org/wiki/Industry_Foundation_Classes).

- ![](/images/Feature-CAM.jpg)

  Un ambiente [CAM](/CAM_Workbench/it "CAM Workbench/it") dedicato alle lavorazioni meccaniche e al [Computer Aided Manufacturing](https://it.wikipedia.org/wiki/Computer-aided_manufacturing) (CAM). L'ambiente CAM è in grado di produrre, visualizzare e modificare il [Codice G](https://it.wikipedia.org/wiki/Codice_G) utilizzato per controllare la macchina di destinazione.

- ![](/images/Feature_spreadsheet.png)

  Un [foglio di calcolo integrato](/Spreadsheet_Workbench/it "Spreadsheet Workbench/it") e un [parser delle espressioni](/Expressions/it "Expressions/it") per creare modelli basati su formule e organizzare i dati del modello in una posizione centrale.
...
- **può essere importato come un [modulo Python](/Embedding_FreeCAD/it "Embedding FreeCAD/it")**. FreeCAD può essere importato in qualsiasi applicazione in grado di eseguire script Python. Come in modalità riga di comando, la parte di interfaccia di FreeCAD non è disponibile, ma tutti gli strumenti di geometria sono accessibili.

- **concepito in Ambienti**. Nell'interfaccia di FreeCAD gli strumenti sono raggruppati all'interno di [workbenches](/Workbenches/it "Workbenches/it") (ambienti di lavoro). Questo permette che vengano visualizzati soltanto gli strumenti necessari all'azione specifica che si deve compiere, ottenendo un'area di lavoro pulita, facile da gestire e veloce da caricare.
...
- **elementi topologici** quali **vertici**, **spigoli**, **contorni** e **piani** facilmente ottenibili anche tramite [script Python](/Scripting/it "Scripting/it").
...
- **registrazione e editazione di [macro](/Macros/it "Macros/it").**. I comandi Python generati quando l'utente manipola l'interfaccia possono essere registrati, modificati, e se necessario, salvati per essere poi riprodotti in seguito.

- **formato dei file composto (basato su ZIP)**. I documenti di FreeCAD vengono salvati con un'estensione .[FCStd](/File_Format_FCStd/it "File Format FCStd/it"). Il documento può contenere molti tipi diversi di informazioni come la geometria, gli script o le icone delle miniature. Il file .FCStd è esso stesso un contenitore zip; un file di FreeCAD salvato è già compresso.
...
- **creazione di miniature** (per ora disponibile solo su piattaforme GNU/Linux). le icone dei documenti salvati in formato [.fcstd](/Fcstd_file_format/it "Fcstd file format/it") forniscono una comoda anteprima del loro contenuto in molte applicazioni di gestione dei file, come Nautilus di Gnome, rendendo facile individuare i propri elaborati.
...
Gli utenti esperti hanno creato vari [ambienti complementari](/External_workbenches/it "External workbenches/it") personalizzati.

Retrieved from "<http://wiki.freecad.org/index.php?title=Feature_list/it&oldid=1544597>"
