...
---
:::caution
Lo sviluppo del modulo Drawing è stato interrotto in FreeCAD 0.16 con il proposito di sostituirlo con il nuovo moduloTechDrawche sarà introdotto nella versione 0.17. Nella versione 0.17 sono forniti entrambi i moduli, ma il modulo Drawing potrebbe essere rimosso nelle versioni future.
:::
...
### [freecad:EditableText](#Example_of_code_freecad:EditableText)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Svg_Namespace/it&oldid=1484372>"