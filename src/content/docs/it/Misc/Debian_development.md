...
[Debian Unstable](/Debian_Unstable/it "Debian Unstable/it") è una buona distribuzione su cui lavorare per lo sviluppo di FreeCAD su Linux poiché fornisce i pacchetti più aggiornati possibile, come distribuzione continua. Si può contribuire sia allo sviluppo di FreeCAD su Debian sia al suo ecosistema di pacchetti e dipendenze correlati.

Retrieved from "<http://wiki.freecad.org/index.php?title=Debian_development/it&oldid=621754>"