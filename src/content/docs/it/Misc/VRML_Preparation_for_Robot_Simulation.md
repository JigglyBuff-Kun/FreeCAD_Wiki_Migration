---
title: Preparare il file VRML per la simulazione
---
|  |
| --- |
| Tutorial |
...
Per costruire la tabella di [Denavit-Hartenberg](http://it.wikipedia.org/wiki/Denavit-Hartenberg) (vedere [6-Axis\_Robot](/Robot_6-Axis/it "Robot 6-Axis/it") ) e per preparare il file [VRML](http://it.wikipedia.org/wiki/VRML), è necessario ottenere le caratteristiche del Robot.  
...
Pertanto, è necessaria una rotazione intorno all'asse X di 

π
{\displaystyle \pi }
![{\displaystyle \pi }](https://wikimedia.org/api/rest_v1/media/math/render/svg/9be4ba0bb8df3af72e90a0535fabcc17431e540a) prima della definizione dell'asse di FreeCAD e di -

π
{\displaystyle \pi }
![{\displaystyle \pi }](https://wikimedia.org/api/rest_v1/media/math/render/svg/9be4ba0bb8df3af72e90a0535fabcc17431e540a) dopo di essa.  
...
Retrieved from "<http://wiki.freecad.org/index.php?title=VRML_Preparation_for_Robot_Simulation/it&oldid=633035>"