---
title: Icona personalizzata nella vista ad albero
---
## Introduzione

Questo è un esempio di modifica dell'icona di un [viewprovider](/Viewprovider/it "Viewprovider/it") personalizzato, che viene normalmente aggiunto agli [creati da script](/Scripted_objects/it "Scripted objects/it").
...
Scaricare l'icona di esempio e posizionarla nella stessa directory della macro ![icon Example for the macro](/images/FreeCADIco.png)

Utilizzo di un'icona per tre diversi casi d'uso: icon\_in\_file\_disk (formato .png), icon\_XPM\_in\_macro (formato .XPM) e icon\_resource\_FreeCAD
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Custom_icon_in_tree_view/it&oldid=1536759>"