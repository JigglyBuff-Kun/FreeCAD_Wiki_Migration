---
title: Frammenti di codice per l'utilizzo di PySide
---
## Introduzione

These are snippets of code that are useful when [creating interfaces](/Dialog_creation "Dialog creation") with [PySide](/PySide "PySide").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PySide_usage_snippets/it&oldid=1068436>"