...
In passato, il codice sorgente era ospitato come repository SVN, `https://free-cad.svn.sourceforge.net/svnroot/free-cad`. Questo è stato spostato su GitHub il 10 ottobre 2011, con [commit 120ca87015](https://github.com/FreeCAD/FreeCAD/commit/120ca87015).

:   Pertanto, ci sono molte modifiche apportate prima di questo momento che non sono registrate nella cronologia recente dei commit di Git. Maggiori informazioni su questo argomento nella pagina [La storia di FreeCAD](/History/it "History/it").
...
* `origin` è il proprio fork personale del repository ufficiale di FreeCAD, ovvero `https://github.com/GITHUB_USERNAME/FreeCAD`
* `upstream` è il repository ufficiale di FreeCAD, ovvero `https://github.com/FreeCAD/FreeCAD`
...
* Andare al repository ufficiale di FreeCAD: `https://github.com/FreeCAD/FreeCAD`
* In alto a destra nella pagina premere il pulsante "Fork". Questo creerà una copia personale del repository di FreeCAD con il proprio nome utente GitHub: `https://github.com/GITHUB_USERNAME/FreeCAD`
...
:::caution
Non sviluppare mai sul ramo "main" (principale). Creare invece un ramo per lo sviluppo e quindi unire questo ramo al ramo principale. Si prega di leggereGit Branching,Basic Branching and Merging, eGitHub - Contributing to a projectper saperne di più.
:::
...
* [Sviluppo di FreeCAD con GitKraken](/Developing_FreeCAD_with_GitKraken/it "Developing FreeCAD with GitKraken/it"), una guida per utilizzare un'interfaccia grafica con Git.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Source_code_management/it&oldid=1501599>"