---
title: Raccolta di macro
---

Questa pagina lista [macro](/Macros/it "Macros/it") che possono aggiungere delle funzionalità alla propria installazione di FreeCAD.

Se avete scritto una macro e volete includerla in una delle categorie su questa pagina, allora consultate **[Documentazione delle macro](/Macro_documentation/it "Macro documentation/it")** per saperne di più su come documentarla correttamente.

## Macros

### Operazioni di visualizzazione 3D

- ![](/images/Macro_Align_Face_Object_to_View.png) [Macro Align Face Object to View](/Macro_Align_Face_Object_to_View/it "Macro Align Face Object to View/it"): Questa macro allinea la vista corrente a una faccia selezionata.

- ![](/images/Macro_Align_View_to_Face.png) [Macro Align View to Face](/Macro_Align_View_to_Face/it "Macro Align View to Face/it"): Questa macro allinea la vista corrente a una faccia selezionata.

- ![](/images/Macro_Copy3DViewToClipboard.png) [Macro Copy3DViewToClipboard](/Macro_Copy3DViewToClipboard/it "Macro Copy3DViewToClipboard/it"): Copia negli appunti il ​​contenuto di 3DView ridimensionato a 640, 480 px.

- ![](/images/FCCamera_00.png) [Macro FCCamera](/Macro_FCCamera/it "Macro FCCamera/it"): Questa macro può ruotare lo schermo di un angolo definito e rispetto ad un asse definito in modo da creare un piano su cui affacciare lo schermo e creare una forma nel piano specificato posizionando la faccia selezionata di fronte allo schermo, e rilevare la posizione della telecamera.

- ![](/images/Macro_Mouse_Cross.png) [Macro Mouse Cross](/Macro_Mouse_Cross/it "Macro Mouse Cross/it"): Questa piccola macro trasforma la freccia del mouse in una croce di precisione.

- ![](/images/Macro_Rotate_View_view_90_Degrees.png) [Macro Rotate View](/Macro_Rotate_View/it "Macro Rotate View/it"): Questa macro ruota la vista corrente di 90° a sinistra. Funziona solo se si è nella visualizzazione [![Std_ViewTop](/images/View-top.svg)](/Std_ViewTop "Std_ViewTop ") [XY (in alto)](/Std_ViewTop/it "Std ViewTop/it").

- ![](/images/Text_console_python.png) [Macro Rotate View Free](/Macro_Rotate_View_Free/it "Macro Rotate View Free/it"): Questa macro viene utilizzata nella console Python e ruota la vista corrente nell'angolo e nel piano indicati.

- ![](/images/Macro_Rotate_View_with_Y_pointing_upwards_.png) [Macro Rotate ViewAxonometric](/Macro_Rotate_ViewAxonometric/it "Macro Rotate ViewAxonometric/it"): Questa macro ruota la vista corrente in Vista Assonometrica.

- ![](/images/Macro_Screen_Wiki.png) [Macro Screen Wiki](/Macro_Screen_Wiki/it "Macro Screen Wiki/it"): Questa macro consente di salvare la Vista 3D nel formato desiderato. La Vista 3D o la finestra 3D completa di FreeCAD assume le dimensioni desiderate.

- ![](/images/Snip.png) [Macro Snip](/Macro_Snip/it "Macro Snip/it"): Pubblica facilmente screenshot sul forum di FreeCAD.
...
- ![](/images/Zoom1_1.svg) [Macro Zoom 1:1](/Macro_Zoom1_1 "Macro Zoom1 1"): 1:1 Zoom so objects appear their actual size on the screen.
...
- ![](/images/Macro_Python_Assistant_Window.png) [Macro Python Assistant Window](/Macro_Python_Assistant_Window "Macro Python Assistant Window"): This macro provides a cut/copy/paste workspace for Python code, it is segmented so different sections can be selected and it is persistent between FreeCAD sessions.
...
- ![](/images/Applications-python.svg) [Macro Iges PyImporter](/Macro_Iges_PyImporter "Macro Iges PyImporter"): Imports an iges file with entity 128, for example an iges-file from FreeShip, into FreeCAD.
...
- ![](/images/Macro_FCInfoGlass.png) [Macro FCInfoGlass](/Macro_FCInfoGlass "Macro FCInfoGlass"): Gives a series of information about the selected shape and displayed in screen 3D.
...
- ![](/images/Macro_3D_Parametric_Curve.png) [Macro 3D Parametric Curve](/Macro_3D_Parametric_Curve "Macro 3D Parametric Curve"): Draw a function described by parametric equations x(t), y(t) and z(t).
...
- ![](/images/FCSpring_On_Surface.png) [Macro FCSpring On Surface](/Macro_FCSpring_On_Surface "Macro FCSpring On Surface"): This macro creates one spring (helix) on the surface of the object (solide).
...
- ![](/images/Macro_Solid_Sweep.png) [Macro Solid Sweep](/Macro_Solid_Sweep "Macro Solid Sweep"): Creates a solid by sweeping a 2D profile along a trajectory previously selected in the 3D view. The 2D elements can be created through the regular tools in FreeCAD's GUI.
...
- ![](/images/Macro_JointWire.png) [Macro JointWire](/Macro_JointWire "Macro JointWire"): Allows to find and joint all non connected edge to the closest non connected one using a line.
...
- ![](/images/Workbench_Image.svg) [Macro Colorize](/Macro_Colorize "Macro Colorize"): Easily set colors of faces, edges, and vertices, including individual transparency levels.
...
- [![](https://upload.wikimedia.org/wikipedia/commons/8/82/Text-x-python.svg)](/File:Text-x-python.svg) [Macro FreeCAD to Kerkythea](/index.php?title=Text-x-python&action=edit&redlink=1 "Text-x-python (page does not exist)"): Esporta da FreeCAD a Kerkythea
...
- ![](/images/Applications-python.svg) [Macro Convert 021](/Macro_Convert_021 "Macro Convert 021"): Converts a FreeCAD file saved with a post-0.21 version back to 0.21 format.
...
- ![](/images/Macro_Select_Hovering.png) [Macro Select Hovering](/Macro_Select_Hovering "Macro Select Hovering"): This macro select a choice Face, Edge, Vertex hovering by the mouse.
...
- ![](/images/Macro_Sheet_Metal_Unfolder.png) [Macro Sheet Metal Unfolder](/Macro_Sheet_Metal_Unfolder "Macro Sheet Metal Unfolder"): Creates an unfolded part from a sheet-metal-part.
...
Vedere la pagina [Come installare le macro](/How_to_install_macros/it "How to install macros/it") per una descrizione completa, e [Come personalizzare la barra degli strumenti](/Customize_Toolbars/it "Customize Toolbars/it") per aggiungere la macro a una barra degli strumenti per un accesso veloce.

L'installazione di molte macro equivale all'installazione di un nuovo workbenchambiente; vedere la pagina [Come installare ambienti aggiuntivi](/How_to_install_additional_workbenches/it "How to install additional workbenches/it") per queste informazioni.
...
Se non si utilizza [Addon Manager](/Std_AddonMgr/it "Std AddonMgr/it"), la macro può essere installata manualmente.

- Copiare il codice [Python](/Python/it "Python/it") dalla pagina della macro corrispondente.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macros_recipes/it&oldid=1534325>"
