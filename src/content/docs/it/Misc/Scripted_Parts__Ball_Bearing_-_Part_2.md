---
title: Parti con script Cuscinetto a sfere - Parte 2
---
...
- Utilizzare il comando _Muovi_ per spostare la sfera nella posizione corretta
...
Quindi usiamo lo stesso metodo usato in [Parti con script: Cuscinetto a sfere - Parte 1](/Scripted_Parts:_Ball_Bearing_-_Part_1/it "Scripted Parts: Ball Bearing - Part 1/it").
...
[Parti con script: Cuscinetto a sfere - Parte 1](/Scripted_Parts:_Ball_Bearing_-_Part_1/it "Scripted Parts: Ball Bearing - Part 1/it"): Costruirlo con primitive di Parte  
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_Parts:_Ball_Bearing_-_Part_2/it&oldid=1231906>"
