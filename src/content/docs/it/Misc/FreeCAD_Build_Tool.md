---
title: Strumento di compilazione di FreeCAD
---
## Introduzione
...
Con [Python](http://en.wikipedia.org/wiki/Python_(programming_language) "wikipedia:Python (programming language)") installato correttamente, *fcbt* può essere richiamato con il comando
...
Al prompt inserire il comando abbreviato che si desidera utilizzare. Ad esempio digitare "CM" per [creare un modulo](/Module_Creation/it "Module Creation/it").
...
Il comando "CM" [crea un nuovo modulo dell'applicazione (Workbench)](/Workbench_creation/it "Workbench creation/it").

Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD_Build_Tool/it&oldid=1250468>"