...
* La pagina [Espressioni](/Expressions#Units "Expressions") per una lista dei tutte le unità conosciute.
* La documentazione [Quantity](/Quantity/it "Quantity/it").
* Lo strumento [Convertitore di unità](/Std_UnitsCalculator/it "Std UnitsCalculator/it").

Retrieved from "<http://wiki.freecad.org/index.php?title=Units/it&oldid=1515236>"