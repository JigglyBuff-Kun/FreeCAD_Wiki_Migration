...
Se si conoscono già le B-spline e la loro applicazione, è possibile continuare direttamente con la sezione [B-spline in FreeCAD](#B-splines_in_FreeCAD/it).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=B-Splines/it&oldid=1504267>"