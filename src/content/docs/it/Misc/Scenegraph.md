...
Immagine tratta da [Inventor mentor](https://web.archive.org/web/20190807185912/http://www-evasion.imag.fr/~Francois.Faure/doc/inventorMentor/sgi_html/)
...
Inoltre, c'è anche un modulo Python che consente l'accesso completo a tutto quello che è gestito da Coin3D, come il grafo della scena di FreeCAD. Continuate quindi la lettura in [Pivy](/Pivy/it "Pivy/it").

## Esempi di codifica

Si veda [Coin3d snippets](/Coin3d_snippets "Coin3d snippets") per gentile concessione della ricerca di MariwanJ per [Design456 Workbench](/Design456_Workbench "Design456 Workbench"). Il repository di codice può essere trovato su <https://github.com/MariwanJ/COIN3D_Snippet>.

[Inizio](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Scenegraph/it&oldid=1463516>"