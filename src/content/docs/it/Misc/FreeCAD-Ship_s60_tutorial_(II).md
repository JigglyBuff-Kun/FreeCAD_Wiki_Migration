...
Prima di iniziare questo tutorial è bene eseguire il [primo tutorial](/FreeCAD-Ship_s60_tutorial/it "FreeCAD-Ship s60 tutorial/it").

Altre informazioni sono disponibili nella pagina [FreeCAD-Ship](/Ship_Workbench/it "Ship Workbench/it")
...
Per creare i serbatoi caricare il [Modulo Part](/Part_Workbench/it "Part Workbench/it") e creare un solido parallelepipedo (box).
...
Riattivare il [modulo FreeCAD-Ship](/FreeCADShip_Workbench/it "FreeCADShip Workbench/it") per rendere disponibile lo strumento generatore delle istanze serbatoio.
...
Naturalmente questo esempio non è realistico (anche perché i serbatoi del carburante non possono essere collocati nella struttura del doppio fondo, o senza avere un doppio scafo), ma è un buon esempio per imparare ad utilizzare [Ship](/Ship_Workbench/it "Ship Workbench/it").

Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD-Ship_s60_tutorial_(II)/it&oldid=1133166>"