...
In FreeCAD tale simulazione è fatta con l'ambiente [FEM](/FEM_Workbench/it "FEM Workbench/it"). Si tratta di diverse fasi: preparare la geometria, impostare il suo materiale, eseguire la meshing, dividere in parti più piccole, come abbiamo fatto nel capitolo [Preparare gli oggetti per la stampa 3D](/Manual:Preparing_models_for_3D_printing/it "Manual:Preparing models for 3D printing/it"), ed infine calcolare la simulazione.
...
- Ora siamo pronti per iniziare una analisi FEM. Passare all'ambiente [FEM](/FEM_Workbench/it "FEM Workbench/it")
- Selezionare l'oggetto fuso
- Premere il pulsante ![](/images/FEM_Analysis.svg) [Nuova analisi](/FEM_Analysis/it "FEM Analysis/it")
...
- Ora possiamo definire il materiale da applicare alla mesh. Questo è importante perché secondo la resistenza del materiale,l'oggetto reagisce in modo diverso alle forze ad esso applicate. Selezionare l'oggetto Analisi e premere il pulsante ![](/images/FEM_MaterialSolid.svg) [Nuovo materiale](/FEM_MaterialSolid/it "FEM MaterialSolid/it").
...
- Ora siamo pronti ad applicare le forze. Iniziamo specificando quali facce sono fissate nel terreno e, pertanto, non possono muoversi. Premere il pulsante ![](/images/FEM_ConstraintFixed.svg) [Vincolo fissaggio](/FEM_ConstraintFixed/it "FEM ConstraintFixed/it").
...
- Ora aggiungeremo un carico sulla faccia superiore, che potrebbe rappresentare, per esempio, un peso massiccio distribuito sul tetto. Per questo useremo un vincolo pressione. Premere il pulsante ![](/images/FEM_ConstraintPressure.svg) [Vincolo pressione](/FEM_ConstraintPressure/it "FEM ConstraintPressure/it").
...
- Ora siamo pronti per iniziare il calcolo. Selezionare l'oggetto **CalculiX** nella vista ad albero, e premere il pulsante ![](/images/FEM_SolverControl.svg) [Calcola](/FEM_SolverControl/it "FEM SolverControl/it").
...
- [L'ambiente FEM](/FEM_Workbench/it "FEM Workbench/it")
- [Installazione dei componenti richiesti da FEM](/FEM_Install/it "FEM Install/it")
- [CalculiX](http://www.calculix.de)
- [NetGen](https://sourceforge.net/projects/netgen-mesher)

Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Creating_FEM_analyses/it&oldid=1541855>"
