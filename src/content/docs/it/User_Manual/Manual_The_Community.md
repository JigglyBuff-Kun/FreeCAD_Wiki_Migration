...
- **Riportare i bug**: La stabilità di FreeCAD si basa in gran parte sulla correzione dei bug. Dato che gli sviluppatori di FreeCAD non possono testare tutti i possibili casi d'uso, gli utenti devono segnalare i problemi quando li rilevano. Se ritenete di aver trovato un bug, leggete le [linee guida](https://forum.freecad.org/viewtopic.php?f=3&t=5236) , e poi scrivete una relazione nel [bug tracker](https://github.com/FreeCAD/FreeCAD/issues).
...
- **Scrivere script e macro**: FreeCAD ha una lista crescente di [Macro](/Macros_recipes/it "Macros recipes/it"). Se avete scritto alcune funzionalità interessanti, considerate di condividerle.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:The_Community/it&oldid=1522857>"
