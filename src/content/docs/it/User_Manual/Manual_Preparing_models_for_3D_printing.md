---
title: Preparare i modelli per la stampa 3D
---
...
- Fare in modo che gli oggetti 3D sono **solidi**. Gli oggetti del mondo reale sono solidi, anche il modello 3D deve essere solido. Abbiamo visto nei capitoli precedenti che FreeCAD aiuta molto in questo proposito, e che l'ambiente [PartDesign](/PartDesign_Workbench/it "PartDesign Workbench/it") vi avvisa se fate un'operazione che impedisce al vostro modello di rimanere solido. L'ambiente [Part](/Part_Workbench/it "Part Workbench/it") contiene anche lo strumento ![](/images/Part_CheckGeometry.svg) [Controlla geometria](/Part_CheckGeometry/it "Part CheckGeometry/it") che è comodo per controllare ulteriormente se ci sono difetti.
...
- Passare all'ambiente [Mesh](/Mesh_Workbench/it "Mesh Workbench/it")
...
- Caricare il file che contiene il pezzo di Lego, e passare all'ambiente [CAM](/CAM_Workbench/it "CAM Workbench/it").
...
- Selezionare la faccia superiore e premere il pulsante ![](/images/CAM_Profile.svg) [Profilo](/CAM_Profile/it "CAM Profile/it").
...
- Poi, duplichiamo questo primo ciclo alcune volte, in modo che lo strumento ritagli l'intero blocco. Selezionare il percorso Profile, e premere il pulsante ![](/images/CAM_Array.svg) [Matrice](/CAM_Array/it "CAM Array/it").
...
- Selezionare la faccia superiore, e premere il pulsante ![](/images/CAM_Pocket_Shape.svg) [Tasca](/CAM_Pocket_Shape/it "CAM Pocket Shape/it"). Impostare la proprietà **Offset** a 1mm, e la **retraction height** a 20mm. Questo è l'altezza a cui l'utensile viaggerà nel passaggio da un ciclo all'altro. Altrimenti, l'utensile può tagliare una delle bugne:

- Ora tutto ciò che rimane da fare è unire queste due operazioni in una sola. Questo può essere fatto con una [Lavorazione CAM](/CAM_Job/it "CAM Job/it"). Premere il pulsante ![](/images/CAM_Job.svg) [Lavorazione](/CAM_Job/it "CAM Job/it").
...
- [L'ambiente Mesh](/Mesh_Workbench/it "Mesh Workbench/it")
...
- [L'Ambiente CAM](/CAM_Workbench/it "CAM Workbench/it")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Preparing_models_for_3D_printing/it&oldid=1526271>"
