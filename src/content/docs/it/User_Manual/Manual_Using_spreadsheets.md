...
- Iniziare passando all'ambiente [Part](/Part_Workbench/it "Part Workbench/it"), e creare alcuni oggetti: un ![](/images/Part_Box.svg) [box](/Part_Box/it "Part Box/it"), un ![](/images/Part_Cylinder.svg) [cilindro](/Part_Cylinder/it "Part Cylinder/it") e una ![](/images/Part_Sphere.svg) [sfera](/Part_Sphere/it "Part Sphere/it").
- Modificare le loro proprietà **Placement** (o usare lo strumento ![](/images/Draft_Move.svg) [Muovi](/Draft_Move/it "Draft Move/it")) per separarli, in modo che si possa vedere meglio gli effetti di quello che faremo:

![](/images/Exercise_spreadsheet_01.jpg)

- Ora, si tratta di estrarre alcune informazioni su questi oggetti. Passare all'ambiente [Spreadsheet](/Spreadsheet_Workbench/it "Spreadsheet Workbench/it")
- Premere il pulsante ![](/images/Spreadsheet_Create.png) **Nuovo foglio di calcolo**
...
Nella pagina [L'ambiente foglio di calcolo](/Spreadsheet_Workbench/it "Spreadsheet Workbench/it") sono descritte più in dettaglio tutte le possibili operazioni e le funzioni disponibili nei fogli di calcolo.
...
- Premere nuovamente il pulsante ![](/images/Spreadsheet_Create.png) **Nuovo foglio di calcolo**
...
- Nel editor di proprietà, fare clic sulla piccola icona ![](/images/Bound-expression-unset.png) **espressioni** sul lato destro del campo **Length**. Si apre l'[editor delle espressioni](/Expressions/it "Expressions/it"), dove si può scrivere **Spreadsheet001.cubedims**. Ripetere questa operazione per Height e Width:
...
- [L'ambiente Foglio di calcolo](/Spreadsheet_Workbench/it "Spreadsheet Workbench/it")
- [Le espressioni](/Expressions/it "Expressions/it")

Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Using_spreadsheets/it&oldid=1526544>"
