---
title: Ambiente OSE Piping
---
## Introduzione

L'ambiente OSE Piping crea tubi e raccordi. Supporta l'ambiente [Flamingo](/Flamingo_Workbench/it "Flamingo Workbench/it"). È una parte di [Open Source Ecology](https://www.opensourceecology.org/).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=OSE_Piping_Workbench/it&oldid=1205667>"