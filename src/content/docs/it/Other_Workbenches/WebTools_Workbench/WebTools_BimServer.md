...
**Nota:** A partire da FreeCAD v0.17, questo strumento è stato rimosso dall'ambiente Arch e ora fa parte dell'[ambiente esterno Webtools](/WebTools_Workbench/it "WebTools Workbench/it") che è possibile installare tramite il menu Strumenti → [Addons Manager](/Std_AddonMgr/it "Std AddonMgr/it").
...
* Tutti i trasferimenti di file con il BIMServer sono fatti con dei file IFC. Pertanto, è necessario sapere come lavorare con i [Ifile FC](/Arch_IFC/it "Arch IFC/it").

## Utilizzo

1. Assicurarsi che i requisiti di cui sopra siano soddisfatti, e si ha accesso a un'istanza BIMServer in esecuzione
2. Selezionare il menu Arch -> Utilità -> ![](/images/WebTools_BimServer.svg) [BIM Server](/Arch_BimServer/it "Arch BimServer/it")
...
* Scegliere il **Root object** (l'oggetto radice) che si desidera caricare. Deve essere un oggetto [Sito Arch](/Arch_Site/it "Arch Site/it") o un [Edificio Arch](/Arch_Building/it "Arch Building/it"). Saranno caricati solo gli oggetti che appartengono a tale oggetto principale.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=WebTools_BimServer/it&oldid=1110511>"