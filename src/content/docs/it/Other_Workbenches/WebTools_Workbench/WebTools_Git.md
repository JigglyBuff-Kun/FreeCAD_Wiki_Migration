...
3. Selezionare il menu Arch → Utilità → ![](/images/WebTools_Git.svg) [Git](/Arch_Git/it "Arch Git/it")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=WebTools_Git/it&oldid=1365091>"