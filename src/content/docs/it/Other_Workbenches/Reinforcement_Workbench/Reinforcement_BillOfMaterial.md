...
| Distinta dei ferri                                                                                                                                                                                                        |
| Posizione nel menu                                                                                                                                                                                                        |
| Reinforcement → Distinta dei ferri                                                                                                                                                                                        |
| Ambiente                                                                                                                                                                                                                  |
...
| 0.19                                                                                                                                                                                                                      |
| Vedere anche                                                                                                                                                                                                              |
| [Bar Bending Schedule](/Reinforcement_Bar_Bending_Schedule/it "Reinforcement Bar Bending Schedule/it"), [Quotare l'armatura](/Arch_Rebar_Drawing_Dimensioning/it#Quotare_l'armatura "Arch Rebar Drawing Dimensioning/it") |
|                                                                                                                                                                                                                           |
...
- Dati**Column Headers**: A dictionary with column_data as key and tuple (column_display_header, column_sequence) as value.
- Dati**Column Units**: A dictionary with keys: "Diameter", "RebarLength", "RebarsTotalLength" and their corresponding units as value.
- Dati**Diameter Weight Map**: A dictionary with the diameter as key and corresponding weight as value.
...
- Dati**Rebar Objects**: A list of ArchRebar and/or rebar2 and/or structures (to select ArchRebar in that structure) objects.

**SVG:**

- Dati**Font Family**: Font Family of text in BOM SVG.
- Dati**Font Filename**: Font filename corresponding to font-family required in console mode.
- Dati**Font Size**: Font size in mm.
- Dati**Column Width**: Width of each column in the BOM SVG table.
- Dati**Row Height**: Height of each row in the BOM SVG table.
- Dati**Left Offset**: Left offset of BOM SVG table.
- Dati**Top Offset**: Top offset of BOM SVG table.
- Dati**Minimum Right Offset**: Minimum right offset of BOM SVG table.
- Dati**Minimum Bottom Offset**: Minimum bottom offset of the BOM SVG table.
- Dati**Maximum Width**: Maximum width of the BOM SVG table.
- Dati**Maximum Height**: Maximum height of the BOM SVG table.
- Dati**Template File**: Template SVG file for BOM SVG.
- Dati**Output File**: BOM SVG Output file.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_BillOfMaterial/it&oldid=1441034>"
