---
title: Armatura Sagomatura dei ferri
---
|  |
| --- |
| Sagomatura dei ferri |
| Posizione nel menu |
| Reinforcement → Sagomatura dei ferri |
| Ambiente |
...
| 0.19 |
| Vedere anche |
| [Disegna e dimensiona un'armatura](/Arch_Rebar_Drawing_Dimensioning/it "Arch Rebar Drawing Dimensioning/it"), [Distinta dei ferri](/Arch_Rebar_BOM/it "Arch Rebar BOM/it") |
|  |
...
* Dati**Rebars Stroke Width**: The stroke-width of rebars in the rebar shape cut list.
* Dati**Rebars Color Style**: The color style of rebars.
* Dati**Row Height**: The height of each row of rebar shape in the rebar shape cut list.
* Dati**Column Width**: The width of each column of rebar shape in the rebar shape cut list.
* Dati**Column Count**: The number of columns in the rebar shape cut list.
* Dati**Side Padding**: The padding on each side of the rebar shape.
* Dati**Horizontal Rebar Shape**: If True, then the rebar shape will be made horizontal by rotating the max length edge of the rebar shape.
* Dati**Include Mark**: If it is set to True, then rebar.Mark will be included for each rebar shape in the rebar shape cut list.
...
The Reinforcement BarShapeCutList tool can be used in [macros](/Macros "Macros") and from the [Python](/Python "Python") console by using the following function:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Reinforcement_BarShapeCutList/it&oldid=1372730>"