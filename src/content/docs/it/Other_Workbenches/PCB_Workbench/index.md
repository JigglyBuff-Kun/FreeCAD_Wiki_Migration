...
Questo ambiente può essere installato dal [Addon Manager](/Std_AddonMgr/it "Std AddonMgr/it").
...
* [Ricette macro](/Macros_recipes/it "Macros recipes/it")
* [Scaricare FreeCAD](/Download/it "Download/it")
* [Portale della comunità FreeCAD](/FreeCAD_Community_Portal/it "FreeCAD Community Portal/it")

Retrieved from "<http://wiki.freecad.org/index.php?title=PCB_Workbench/it&oldid=1289756>"