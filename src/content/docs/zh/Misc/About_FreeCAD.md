...
**FreeCAD**是一个通用参数化3D [**CAD**](http://en.wikipedia.org/wiki/CAD)建模软件。它的开发完全符合[开源](http://en.wikipedia.org/wiki/Open_source)（LGPL许可）。 FreeCAD直接针对[机械工程](http://en.wikipedia.org/wiki/Mechanical_engineering)和[产品设计](http://en.wikipedia.org/wiki/Product_design)，也适用于更广泛的工程设计用途，如建筑、有限元分析、3D打印机其他任务。
...
有关FreeCAD功能的更多信息，请查看[功能列表](/Feature_list "Feature list")， [最新发布说明](/Feature_list/zh "Feature list/zh")，[入门](/Getting_started "Getting started")文章，或查看更多[截图集锦](/Screenshots "Screenshots")。

### 关于FreeCAD项目

FreeCAD项目最早始于2001年，详细内容详见[历史](/History "History")页面。

FreeCAD由热情的开发人员和用户组成的社区进行维护和开发（参见[志愿者](/Contributors "Contributors")页面）。他们在空闲时间志愿地为FreeCAD工作。他们无法保证FreeCAD包含您希望的所有内容，但他们通常会尽力而为！ 社区聚集在[FreeCAD论坛](http://forum.freecadweb.org)上，讨论了大多数想法和决定。加入我们吧！
...
Retrieved from "<http://wiki.freecad.org/index.php?title=About_FreeCAD/zh&oldid=1295131>"