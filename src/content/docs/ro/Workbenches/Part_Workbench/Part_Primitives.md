---
title: Part Crearea de Primitive Geometrice
---
...
The properties of a Part Primitive can also be changed in the [Property editor](/Property_editor "Property editor"), and its Date**Placement** can also be changed with the ![](/images/Std_TransformManip.svg) [Std TransformManip](/Std_TransformManip "Std TransformManip") command.

- Currently this tools can create a parametric
  - [Plane](/Part_Plane "Part Plane")
  - [Box](/Part_Box "Part Box")
  - [Cylinder](/Part_Cylinder "Part Cylinder")
  - [Cone](/Part_Cone "Part Cone")
  - [Sphere](/Part_Sphere "Part Sphere")
  - [Ellipsoid](/Part_Ellipsoid "Part Ellipsoid")
  - [Torus](/Part_Torus "Part Torus")
  - [Prism](/Part_Prism "Part Prism") [introduced in 0.14](/Release_notes_0.14 "Release notes 0.14")\*:
  - [Wedge](/Part_Wedge "Part Wedge")
  - [Helix](/Part_Helix "Part Helix")
  - [Spiral](/Part_Spiral "Part Spiral") [introduced in 0.14](/Release_notes_0.14 "Release notes 0.14")\*:
  - [Circle](/Part_Circle "Part Circle")
  - [Ellipse](/Part_Ellipse "Part Ellipse")
  - [Line](/Part_Line "Part Line") (Edge)
  - [Point](/Part_Point "Part Point") (Vertex)
  - [Regular Polygon](/Part_RegularPolygon "Part RegularPolygon") [introduced in 0.14](/Release_notes_0.14 "Release notes 0.14")\*:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_Primitives/ro&oldid=1466598>"
