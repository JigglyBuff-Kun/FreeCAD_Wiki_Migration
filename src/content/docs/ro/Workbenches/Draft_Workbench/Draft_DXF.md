...
* points [introduced in 0.13](/Release_notes_0.13 "Release notes 0.13")
* leaders [introduced in 0.13](/Release_notes_0.13 "Release notes 0.13")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_DXF/ro&oldid=1513612>"