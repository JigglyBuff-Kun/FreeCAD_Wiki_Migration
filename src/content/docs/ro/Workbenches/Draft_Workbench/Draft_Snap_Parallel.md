---
title: Draft Parallel
---
|  |
| --- |
| Draft Snap Parallel |
| Menu location |
| Draft → [Snap](/Draft_Snap "Draft Snap") → Parallel |
| Workbenches |
...
2. Celementați elementul care trebuie inserat în documentul FreeCAD
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Snap_Parallel/ro&oldid=1513576>"