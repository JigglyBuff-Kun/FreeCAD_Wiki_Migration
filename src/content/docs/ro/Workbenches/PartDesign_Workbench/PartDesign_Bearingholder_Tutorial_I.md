---
title: PartDesign Bearingholder Tutorial I
---
:::caution
...
Bearing Holder Tutorial - Locaș de rulment finalizat (top)
...
Aceasta este prima parte a tutorialului. Acesta va folosi ceea ce s-ar putea numi fluxul de lucru "un singur corp", folosind partea superioară (mai simplă) a suportului ca exemplu.

Obviously, to follow through this tutorial you must activate the PartDesign workbench.

You can find my version of the part created by this tutorial [[here](http://ubuntuone.com/5gok0J4dye3Fo4BKWMGWVa)]. *The file is no longer available, a new one will be provided at some later date*.

## Design data

Suportul trebuie să poată găzdui un alezaj cu un diametru de 90 mm cu o lățime de până la 33 mm (e.g. DIN 630 type 2308). The bearing requires a shoulder height of at least 4.5mm in the holder (and on the shaft). The top part of the holder will be bolted to the bottom with two 12mm bolts. There should be a groove on both sides of the bearing able to hold a standard shaft sealing ring DIN 3760: 38x55x7 or 40x55x7 on one side, 50x68x8 on the other side.
...
[PartDesign Bearingholder Tutorial II](/PartDesign_Bearingholder_Tutorial_II "PartDesign Bearingholder Tutorial II")

Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Bearingholder_Tutorial_I/ro&oldid=1075236>"