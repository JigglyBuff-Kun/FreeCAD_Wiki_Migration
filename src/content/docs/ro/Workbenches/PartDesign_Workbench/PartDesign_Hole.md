...
1. Apăsați butonul ![](/images/PartDesign_Hole.png) **Hole** .
...
3. Define the Hole parameters. See [Options](#Options).
4. Apăsați tasta OK.
...
* Date**Reversed**: true or false. Reverses extrusion direction.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Hole/ro&oldid=1561171>"