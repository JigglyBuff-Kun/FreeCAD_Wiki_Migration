---
title: PartDesign Forme Legate
---
|  |
| --- |
| PartDesign Forme Legate |
| poziția meniului |
...
| [PartDesign Clone/ro](/PartDesign_Clone/ro "PartDesign Clone/ro") |
|  |
...
A ShapeBinder will track the relative placement of the referenced geometry, which is useful in the context of creating [assemblies](/Assembly "Assembly"), if its Date**Trace Support** property is set to `true`. See the [Example](#Example) below to understand how this works.
...
2. Press the ![](/images/PartDesign_ShapeBinder.png) **Create a shape binder** button.
...
* A PartDesign SubShapeBinder always tracks the relative placement of the referenced geometry. For a PartDesign ShapeBinder this behavior is optional through its Date**Trace Support** property.
...
* Date**Label**: numele dat obiectului, acest nume poate fi modificat dacă vă este comod.
* Date**Trace Support**: La setarea acestei opțiuni la adevărat, Shapebinder respectă destinațiile de plasare relative ale părților și corpurilor. [introduced in 0.18](/Release_notes_0.18 "Release notes 0.18")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_ShapeBinder/ro&oldid=1458301>"