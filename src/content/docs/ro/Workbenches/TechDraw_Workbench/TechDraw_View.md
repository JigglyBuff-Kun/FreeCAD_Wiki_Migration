...
* Date**Scrub Count** (`Integer`): The number of times FreeCAD should try to clean the HLR result. [introduced in 0.21](/Release_notes_0.21 "Release notes 0.21")
...
* Vizualizare**Extra Width** (`Length`): Not implemented yet.
