---
title: Path scripting
---
## Introducere

Atelierul Traiectori oferă instrumente pentru a importa, crea, manipula și exporta[machine toolpaths](http://en.wikipedia.org/wiki/G-code) în FreeCAD. Cu aceasta, utilizatorul poate importa, vizualiza și modifica programele gcode existente, poate genera traiectorii din forme 3D și poate exporta aceste traiectorii în gcode.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=CAM_scripting/ro&oldid=1483638>"