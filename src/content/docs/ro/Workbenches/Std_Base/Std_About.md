...
| - |
| See also |
| [Standard Menu](/Standard_Menu "Standard Menu") |
|  |

## Description

Oferă informații despre versiunea FreeCAD folosită și despre bibliotecile necesare (Python, Qt, Coin și OCC).
...
Click pe**Copy to clipboard** și faceți paste cu informația în postarea dvs, care va rezulta de forma:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_About/ro&oldid=1454792>"