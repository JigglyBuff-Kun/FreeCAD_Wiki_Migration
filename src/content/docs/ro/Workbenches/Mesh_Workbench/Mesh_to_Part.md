---
title: Piese construite din Plase poligonale
---
## Conversia obiectelor Piese în Plasă

Conversia obiectelor de nivel superior, cum ar fi [Part shell](/Part_Workbench "Part Workbench") în obiecte mai simple, cum ar fi [meshes](/Mesh_Workbench "Mesh Workbench") este o operație simplă, în care toate fațetele unui obiect Piesă i se aplică o discretizarea în triunghiur. Rezultatul acestei discretizări(tessellation) este apoi folosit pentru a construi o plasă: (să presupunem că documentul nostru conține un obiect de piesă)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Mesh_to_Part/ro&oldid=1000031>"