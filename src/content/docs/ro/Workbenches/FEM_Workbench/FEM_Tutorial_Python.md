...
Acest exemplu este menit a arăta cât de simplă este Metoda Elementelor Finite(Finite Element Analysis (FEA)) în FreeCADs [FEM Workbench](/FEM_Workbench "FEM Workbench") este realizată prin Python. Modelul de la [FEM\_CalculiX\_Cantilever\_3D](/FEM_CalculiX_Cantilever_3D "FEM CalculiX Cantilever 3D") va fi luat drept exemplu.
...
* O definirea a modului FEM. Verificați [FEM\_CalculiX\_Cantilever\_3D](/FEM_CalculiX_Cantilever_3D "FEM CalculiX Cantilever 3D")
...
**Note:** Check out the [Additional Information](#Additional_Information) section below for how to script mesh generation with GMSH or Netgen mesh object.
...
1. Run all processes together at once (see ["All in one"](#All_in_one) section below)
2. Run processes one after the other (see ["Step by step"](#Step_by_step) section below)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_Tutorial_Python/ro&oldid=1251699>"