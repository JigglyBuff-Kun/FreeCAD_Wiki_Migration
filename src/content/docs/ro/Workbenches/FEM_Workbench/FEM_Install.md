---
title: FEM Install/Instalare MEF
---
## Introducere

Pentru a putea face o analiză a elementelor finite (FEA) utilizând [FEM Worbench](/FEM_Workbench "FEM Workbench") FreeCAD folosește două programe externe. Una este folosită pentru generarea FEM-Mesh, iar cealaltă pentru rezolvarea sistemului de ecuații. Dacă FreeCAD este configurat pentru a face analiza elementului mecanic finit, ar putea fi ușor verificată prin încărcarea și analizarea unui fișier exemplu. Vedeți [FEM\_CalculiX\_Cantilever\_3D](/FEM_CalculiX_Cantilever_3D "FEM CalculiX Cantilever 3D")
...
A se vedea acest forum post [FreeCAD Fem on OSX](https://forum.freecadweb.org/viewtopic.php?f=18&t=10979&p=198652#p198642) cum se instalează CalculiX pe OSX
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_Install/ro&oldid=1552460>"