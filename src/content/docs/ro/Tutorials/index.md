...
title: Tutoriale
---
Această pagină prezintă o selecție de tutoriale scrise de înaltă calitae. O listă completă și nesortată de tutoriale puteți găsi la : [Category:Tutorials](/Category:Tutorials "Category:Tutorials").

If you'd like to contribute with writing wiki documentation and tutorials, see the general wiki guidelines in [WikiPages](/WikiPages "WikiPages"),
and read the [tutorial guidelines](/Tutorial_guidelines "Tutorial guidelines").
...
* [![Arch tutorial Basele medelării arhitecturale.](/images/Arch_tutorial_00.jpg)](/Arch_tutorial "Arch tutorial Basele medelării arhitecturale. ")

  [Arch tutorial](/Arch_tutorial "Arch tutorial")   
  Basele medelării arhitecturale.
* [![Arch panel tutorial Modelarea unui acoperiș în două ape la o casă mică.](/images/Arch_panel_tutorial_01.jpg)](/Arch_panel_tutorial "Arch panel tutorial Modelarea unui acoperiș în două ape la o casă mică. ")

  [Arch panel tutorial](/Arch_panel_tutorial "Arch panel tutorial")   
  Modelarea unui acoperiș în două ape la o casă mică.
* [![BIM modeling Cum se face un model de casă mică și produce planul.](/images/Exercise_arch_01.jpg)](/Manual:BIM_modeling "BIM modeling Cum se face un model de casă mică și produce planul. ")
...
FreeCAD furnizează două fluxuri de lucru la modelarea pieselor: combinarea obiectelor (o metodă numită [constructive solid geometry (CSG)](http://en.wikipedia.org/wiki/Constructive_solid_geometry "wikipedia:Constructive solid geometry")) utilizând [Part workbench](/Part_Workbench "Part Workbench"), sau utilizând metoda de editare [feature](/Glossary#Feature "Glossary") cu Atelierul PartDesign [PartDesign workbench](/PartDesign_Workbench "PartDesign Workbench"). Vă rugăm să notați că PartDesign work flow s-a schimbat considerabil de la v0.17 încoace: unele dintre tutoriale trebuie updatate.

* combinarea obiectelor, o metodă numită [geometrie solidă constructivă (CSG)](https://en.wikipedia.org/wiki/Constructive_solid_geometry) utilizând  [Workbench part](/Part_Workbench "Part Workbench") și

 \* folosind modelarea parametrică și editarea caracteristică cu  [PartDesign workbench](/PartDesign_Workbench "PartDesign Workbench").
...
* [![Creating a simple part with PartDesign An intro to v0.17 PartDesign workflow](/images/GGTuto1_Vue.PNG)](/Creating_a_simple_part_with_PartDesign "Creating a simple part with PartDesign An intro to v0.17 PartDesign workflow ")

  [Creating a simple part with PartDesign](/Creating_a_simple_part_with_PartDesign "Creating a simple part with PartDesign")   
  An intro to v0.17 PartDesign workflow
* [![Basic Part Design Tutorial 017 Model a simple part using a feature editing methodology (updated for version 0.17)](/images/PD_WB_Tutorial018.png)](/Basic_Part_Design_Tutorial_017  "Basic Part Design Tutorial 017 Model a simple part using a feature editing methodology (updated for version 0.17)")

  [Basic Part Design Tutorial 017](/Basic_Part_Design_Tutorial_017 "Basic Part Design Tutorial 017")   
  Model a simple part using a feature editing methodology (updated for version 0.17)
* [![Model a Toothbrush Head Stand in PartDesign v0.16](/images/TBHS-model.png)](/Toothbrush_Head_Stand "Model a Toothbrush Head Stand in PartDesign v0.16 ")

  [Model a Toothbrush Head Stand](/Toothbrush_Head_Stand "Toothbrush Head Stand")   
  in PartDesign v0.16
* [![Modeling for product design Modeling a Lego block v0.16](/images/Exercise_lego_01.jpg)](/Manual:Modeling_for_product_design "Modeling for product design Modeling a Lego block v0.16 ")

  [Modeling for product design](/Manual:Modeling_for_product_design "Manual:Modeling for product design")   
  Modeling a Lego block v0.16
* [![Traditional modeling, the CSG way Model a table using a simple CSG work flow.](/images/Exercise_table_complete.jpg)](/Manual:Traditional_modeling,_the_CSG_way "Traditional modeling, the CSG way Model a table using a simple CSG work flow. ")
...
* [![Draft ShapeString tutorial Create engraved text on a solid.](/images/TutorialDraftShapeString_Complete.jpg)](/Draft_ShapeString_tutorial "Draft ShapeString tutorial Create engraved text on a solid. ")

  [Draft ShapeString tutorial](/Draft_ShapeString_tutorial "Draft ShapeString tutorial")   
  Create engraved text on a solid.
* [![Create a Whiffle Ball from Part primitives.](/images/Tutorial_WhiffleBall.jpg)](/Whiffle_Ball_tutorial "Create a Whiffle Ball from Part primitives. ")

  [Create a Whiffle Ball](/Whiffle_Ball_tutorial "Whiffle Ball tutorial")   
  from Part primitives.
* [![Basic modeling tutorial Create an iron angle in 2 simple methods.](/images/Tutorial-normand06.jpg)](/Basic_modeling_tutorial "Basic modeling tutorial Create an iron angle in 2 simple methods. ")
...
* [![Traditional 2D drafting](/images/Exercise_cabin_01.jpg)](/Manual:Traditional_2D_drafting "Traditional 2D drafting ")

  [Traditional 2D drafting](/Manual:Traditional_2D_drafting "Manual:Traditional 2D drafting")
* [![Draft tutorial Introducerea în atelierul Desen 2 D( Draft workbench) .](/images/Draft_tutorial_result.png)](/Draft_tutorial  "Draft tutorial Introducerea în atelierul Desen 2 D( Draft workbench) .")

  [Draft tutorial](/Draft_tutorial "Draft tutorial")   
  Introducerea în atelierul Desen 2 D( Draft workbench) .
* ![Basic Sketcher Tutorial Introducere în Sketcher.](/images/Sketcher_tutorial_result.png)

  [Basic Sketcher Tutorial](/Basic_Sketcher_Tutorial/ro "Basic Sketcher Tutorial/ro")   
  Introducere în Sketcher.
* [![Sketcher Micro Tutorial Învățai să constrângeți eficient un pătrat.](/images/Constrain3.png)](/Sketcher_Micro_Tutorial_-_Constraint_Practices "Sketcher Micro Tutorial Învățai să constrângeți eficient un pătrat. ")

  [Sketcher Micro Tutorial](/Sketcher_Micro_Tutorial_-_Constraint_Practices "Sketcher Micro Tutorial - Constraint Practices")   
...
* [![Basic TechDraw Tutorial Intro to creating drawings with the TechDraw workbench.](/images/TDTut_ProjGroup21.png)](/Basic_TechDraw_Tutorial "Basic TechDraw Tutorial Intro to creating drawings with the TechDraw workbench. ")

  [Basic TechDraw Tutorial](/Basic_TechDraw_Tutorial "Basic TechDraw Tutorial")  
  Intro to creating drawings with the TechDraw workbench.
* [![Creating a new background template Instructions to create a new page template in Inkscape for using with the TechDraw Workbench.](/images/FCTemplateHow.png)](/TechDraw_TemplateHowTo "Creating a new background template Instructions to create a new page template in Inkscape for using with the TechDraw Workbench. ")

  [Creating a new background template](/TechDraw_TemplateHowTo "TechDraw TemplateHowTo")  
...
* [![FEM Analysis example](/images/FEM_example01_pic00.jpg)](/FEM_CalculiX_Cantilever_3D "FEM Analysis example ")

  [FEM Analysis example](/FEM_CalculiX_Cantilever_3D "FEM CalculiX Cantilever 3D")
* [![FEM Shear of a Composite Block](/images/Figure_11_Deformed_Mesh.png)](/FEM_Shear_of_a_Composite_Block "FEM Shear of a Composite Block ")

  [FEM Shear of a Composite Block](/FEM_Shear_of_a_Composite_Block "FEM Shear of a Composite Block")
* [![FEM tutorial Introducerea în atelierul MEF (FEM workbench).](/images/FEM_tutorial_result.png)](/FEM_tutorial  "FEM tutorial Introducerea în atelierul MEF (FEM workbench).")
...
* [![Path Walkthrough for the Impatient Prezentarea rapidă a Atelierului Traiectorie (Path module).](/images/Path-WalkThroughResult.gif)](/Path_Walkthrough_for_the_Impatient  "Path Walkthrough for the Impatient Prezentarea rapidă a Atelierului Traiectorie (Path module).")

  [Path Walkthrough for the Impatient](/Path_Walkthrough_for_the_Impatient "Path Walkthrough for the Impatient")   
  Prezentarea rapidă a Atelierului Traiectorie (Path module).
* [![Preparing models for 3D printing](/images/Exercise_meshing_03.jpg)](/Manual:Preparing_models_for_3D_printing "Preparing models for 3D printing ")
...
* [![Creating renderings With POV-Ray and LuxRender.](/images/Exercise_raytracing_05.jpg)](/Manual:Creating_renderings "Creating renderings With POV-Ray and LuxRender. ")

  [Creating renderings](/Manual:Creating_renderings "Manual:Creating renderings")   
  With POV-Ray and LuxRender.
* [![Raytracing tutorial Introduce fluxului de muncă a Atelierului de Randare(Raytracing workbench).](/images/Raytracing_tutorial_result.png)](/Raytracing_tutorial  "Raytracing tutorial Introduce fluxului de muncă a Atelierului de Randare(Raytracing workbench).")

  [Raytracing tutorial](/Raytracing_tutorial "Raytracing tutorial")   
...
* [![Robot tutorial simularea mișcării la Robot.](/images/Robot_Tutorial_RobotSimulation.gif)](/Robot_tutorial "Robot tutorial simularea mișcării la Robot. ")

  [Robot tutorial](/Robot_tutorial "Robot tutorial")   
...
| [Aeroplane](/Aeroplane/ro "Aeroplane/ro") | Part Workbench | Beginner | 0:10 | Hughthecat |  |  | No |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Tutorials/ro&oldid=1538595>"