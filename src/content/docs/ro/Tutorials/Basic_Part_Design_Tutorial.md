---
title: Basic Part Design Tutorial 017
---
|  |
| --- |
| Tutorial |
...
Acest tutorial introduce noul utilizator la unele dintre instrumentele și tehnicile utilizate în[Part Design Workbench](/PartDesign_Workbench "PartDesign Workbench"). Tutorialul acesta nu este un ghid complet și cuprinzător al Workbench Part Design și multe dintre instrumentele și capabilitățile nu sunt acoperite. Acest tutorial va conduce utilizatorul prin pașii necesari pentru a modela partea ilustrată în imaginea de mai jos folosind schițe.
...
1. Click on ![](/images/PartDesign_Body.png) [Create new body](/PartDesign_Body "PartDesign Body") to create and activate a new Body Container. *Note: this step can be omitted. When creating a sketch, if no existing Body is found, a new one will be automatically created and activated.*
2. Click on ![](/images/PartDesign_NewSketch.png) [Create new sketch](/PartDesign_NewSketch "PartDesign NewSketch"). This will create the sketch within the just created body.
...
1. Click on ![](/images/PartDesign_Body.svg) [Create new body](/PartDesign_Body "PartDesign Body") to create and activate a new Body Container. *Note: this step can be omitted. When creating a sketch, if no existing Body is found, a new one will be automatically created and activated.*
...
3. We need to define where the sketch will be attached. We will attach it to a plane from the Body´s [Origin](/Glossary#Origin "Glossary").
4. In the [Tasks tab](/Task_panel "Task panel") from the [Combo view](/Combo_view "Combo view"), select **YZ\_Plane** in the list and press OK:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Basic_Part_Design_Tutorial/ro&oldid=1213849>"