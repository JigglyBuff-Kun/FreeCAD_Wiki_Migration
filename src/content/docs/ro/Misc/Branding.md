...
Următoarele linii definesc intrările Config ale aplicației dvs. FooApp. O descriere a Config și a intrărilor pe care le găsiți în [Start up and Configuration](/Start_up_and_Configuration "Start up and Configuration").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Branding/ro&oldid=1091262>"