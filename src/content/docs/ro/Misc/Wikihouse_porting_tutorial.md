...
This is not how we will proceed in FreeCAD. Since one of the most powerful features of FreeCAD is [Constrained Sketches](/Sketcher_Workbench "Sketcher Workbench"), we'd better take advantage of this, and base all our Wikihouse elements on Sketches. That way, modifying any part can be done in the Sketcher, which is much more comfortable.
...
1. To make sure everything will stay in the XY plane, it is advised to set the [Workign Plane](/Draft_SelectPlane "Draft SelectPlane") to XY (top)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Wikihouse_porting_tutorial/ro&oldid=1092185>"