...
**[Lesser General Public Licence, version 2 or superior (LGPL2+)](http://en.wikipedia.org/wiki/LGPL "wikipedia:LGPL")**
Toate sursele de cod FreeCAD poate fi găsit aici [official Git repository](https://github.com/FreeCAD/FreeCAD)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=License/ro&oldid=1392644>"