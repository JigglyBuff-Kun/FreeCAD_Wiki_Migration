...
O **proprietate** este o informație ca un șir de caractere sau un text care este atașat unui document FreeCAD sau unui obiect dintr-un document. Proprietățile pot fi vizualizate și modificate prin [Property editor](/Property_editor "Property editor").
...
Obiecte personalizate [scripted objects](/Scripted_objects "Scripted objects") în FreeCAD pot avea următoarele tipuri de proprietăți:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Property/ro&oldid=1268629>"