---
title: Script de Piese Rulment cu bile - Part 1
---
...
For doing a scripted part with revolved sketches have a look at the tutorial [Scripted Parts: Ball Bearing - Part 2](/Scripted_Parts:_Ball_Bearing_-_Part_2 "Scripted Parts: Ball Bearing - Part 2").

### Links

[Scripted objects](/Scripted_objects "Scripted objects"): Pagina wiki explică elementele de bază ale scripting-ului  
[Topological data scripting](/Topological_data_scripting "Topological data scripting"): Un tutorial care acoperă elementele de bază ale scripturilor  
[Scripted Parts: Ball Bearing - Part 2](/Scripted_Parts:_Ball_Bearing_-_Part_2 "Scripted Parts: Ball Bearing - Part 2"): Doing it with sketches  
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_Parts:_Ball_Bearing_-_Part_1/ro&oldid=742499>"
