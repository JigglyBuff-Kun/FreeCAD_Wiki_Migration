...
* [Git](http://git-scm.com/) Aici sunt câteva dintre alternative ca GitCola, Tortoise Git, și altele.
* [CMake](http://www.cmake.org/cmake/resources/software.html) versiunea 2.x.x sau Cmake 3.x.x
...
[CI](https://github.com/FreeCAD/FreeCAD/blob/master/appveyor.yml) utilizează versiunea din 2013.
...
Pentru cei care doresc să evite instalarea imensului Visual Studio pentru simplul scop de a avea un compilator, vezi [CompileOnWindows - Reducing Disk Footprint](/CompileOnWindows_-_Reducing_Disk_Footprint "CompileOnWindows - Reducing Disk Footprint").
...
**FREECAD\_LIBPACK\_DIR** is unset.
...
| FREECAD\_BUILD\_CAM | Build the CAM module, experimental! | OFF |
| FREECAD\_BUILD\_INSTALLER | Create the project files for the Windows installer. | OFF |
| FREECAD\_BUILD\_DOXYGEN\_DOCU | Create the project files for source code documentation. | OFF |
| FREECAD\_MAINTAINERS\_BUILD | Switch on stuff needed only when you do a Release build. | OFF |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Compile_on_Windows/ro&oldid=1561186>"