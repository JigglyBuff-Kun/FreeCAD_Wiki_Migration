---
title: FEM Modul Suplimentar MEF
---
...
Adăugarea de noi constrângeri este destul de simplă. Pentru nou-veniți, există un tutorial: [Add FEM Constraint Tutorial](/Add_FEM_Constraint_Tutorial "Add FEM Constraint Tutorial").

Retrieved from "<http://wiki.freecad.org/index.php?title=Extend_FEM_Module/ro&oldid=1289703>"
