...
Înainte de a trece prin durerea de a depana utilizați [Test framework](/Testing/ro "Testing/ro") pentru a verifica dacă testele standard funcționează corect. Dacă acestea nu se execută complet, este posibil să fie o instalare defectuoasă.
...
* o depanare a variantei compilate a FreeCAD (în acest moment disponibilă prin [building from source](/Compile_on_Linux#For_a_Debug_build "Compile on Linux"))
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Debugging/ro&oldid=1305334>"