...
You can learn more about [FreeCAD-Ship here](/Ship_Workbench "Ship Workbench")
...
In order to plot these sections you can use the [drawing workbench](/Drawing_Workbench "Drawing Workbench"):
...
Atunci când sunt apăsate butoanele Accept  **(vezi [plot module documentation](/Plot_Workbench "Plot Workbench")) și o foaie de calul este generată (vezi [Spreadsheet workbench documentation](/Spreadsheet_Workbench "Spreadsheet Workbench")).**
...
Acum sunteți gata să continuați să învățați  [Ship](/Ship_Workbench "Ship Workbench"),  [aici](/FreeCAD-Ship_s60_tutorial_(II) "FreeCAD-Ship s60 tutorial (II)") este al doilea capitol din seria 60 de la nava universitară din Iowa.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD-Ship_s60_tutorial/ro&oldid=1252284>"