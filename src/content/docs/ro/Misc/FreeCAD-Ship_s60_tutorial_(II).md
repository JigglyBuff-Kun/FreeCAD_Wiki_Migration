---
title: tutorial FreeCAD-Ship s60 (II)
---
|  |
| --- |
| Tutorial |
...
Înainte de a începe acest tutorial, vă rugăm să vă asigurați că ați parcurs deja [prima parte](/FreeCAD-Ship_s60_tutorial "FreeCAD-Ship s60 tutorial").

Puteți învăța mai mult despre vapoare [FreeCAD-Ship here](/Ship_Workbench "Ship Workbench")
...
Pentru a genera rezervoare, încărcăm [Part module](/Part_Workbench "Part Workbench") și creăm o cutie solidă.
...
Dacă reîncărcați  [FreeCAD-Ship module](/Ship_Workbench "Ship Workbench") încă o dată, putem găsi unealtă generator de variante de rezervor.
...
Now we can select **StarboardTankGeom** and execute tank instnace generation tool, where some data must be provided. We will set 40% of filling level, and 925 kg/m
...
Desigur, acest exemplu nu este real (mai întâi pentru toate cisternele de combustibil nu pot fi plasate în structura dublă a fundului, sau folosind structura cocăi), dar este un bun exemplu pentru a învăța să folosești [FreeCAD-Ship](/Ship_Workbench "Ship Workbench").

Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD-Ship_s60_tutorial_(II)/ro&oldid=1133168>"