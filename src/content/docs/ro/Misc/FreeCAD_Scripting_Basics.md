...
Acum puteți începe să jucați cu FreeCAD! Pentru a vedea ce puteți face cu [Part Workbench](/Part_Workbench "Part Workbench"), citiți pagina  [Pare scripting](/Topological_data_scripting "Topological data scripting"), sau pagina [Mesh Scriptingpentru](/Mesh_Scripting "Mesh Scripting") a lucra cu [Mesh Workbench](/Mesh_Workbench "Mesh Workbench").Rețineți că, deși modulele Parte și Mesh sunt cele mai complete și utilizate pe scară largă, alte module cum ar fi [Draft Workbench](/Draft_Workbench "Draft Workbench") au, de asemenea, [scripting](/Draft_API "Draft API") APIs care vă pate fi utili.Pentru o listă completă a fiecărui modul și a instrumentelor disponibile, vizitați secțiunea [Category:API](/Category:API "Category:API").

[Top](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD_Scripting_Basics/ro&oldid=1058135>"