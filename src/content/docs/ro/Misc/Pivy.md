...
Am văzut în pagina [Scenegraph](/Scenegraph "Scenegraph") cum Coin organizează o scenă tipică. Tot ce este afișat 3D în FreeCAD este construit și festionat de către Coin. Avem o rădăcină, iar toate obiectele de pe ecran sunt copiii lui.legat prin noduri
...
La [callback mechanism](http://en.wikipedia.org/wiki/Callback_%28computer_science%29), Un mecanism de Callback este sistem care permite unei bilbioteci pe caer o utilizați , ca de ex bilbioteca Coin de a trece în argumente a unei alte funcții pentru l'Objet Python în curs de execuție.
...
Vezi de asemenea [complete list](/Code_snippets#Observing_mouse_events_in_the_3D_viewer_via_Python "Code snippets") a posibilelor evenimente și parametrii lor, sau în [official coin documentation](http://doc.coin3d.org/Coin/classes.html).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Pivy/ro&oldid=1457031>"