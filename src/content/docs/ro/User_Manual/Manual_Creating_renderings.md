...
Vom folosi tabela pe care am modelat-o în capitolul [traditional modeling](/Manual:Traditional_modeling,_the_CSG_way "Manual:Traditional modeling, the CSG way") pentru a produce randări cu PovRay și Luxrender.

- Start by loading the table.FCStd file that we modelled earlier or from the link at the bottom of this chapter.
- Press the small down arrow next to the ![](/images/Raytracing_New.png) [New Povray project](/Raytracing_New "Raytracing New") button, and choose the **RadiosityNormal** template
...
- The new project has adopted the point of view of the 3D view as it was at the moment we pressed the button. We can change the view, and update the view position stored in the Povray project anytime, by pressing the ![](/images/Raytracing_ResetCamera.png) [Reset camera](/Raytracing_ResetCamera "Raytracing ResetCamera") button.
- Atelierul de Raytracing funcționează în același mod ca [Drawing Workbench](/Drawing_Workbench "Drawing Workbench"): Odată ce a fost creat un folder pentru proiect, trebuie să adăugăm **Views** a obiectelor noastre la el.

Acum putem face acest lucru prin selectarea tuturor obiectelor care compun masa și apăsați pe butonul ![](/images/Raytracing_InsertPart.png) [Insert part](/Raytracing_InsertPart "Raytracing InsertPart") :
...
- We are now ready to produce our first Povray render. Press the ![](/images/Raytracing_Render.png) [Render](/Raytracing_Render "Raytracing Render") button.
...
- Press the little down arrow next to the ![](/images/Raytracing_Lux.png) [New Luxrender project](/Raytracing_Lux "Raytracing Lux") button and choose the **LuxOutdoor** template.
...
- Press the ![](/images/Raytracing_InsertPart.png) [Insert part](/Raytracing_InsertPart "Raytracing InsertPart") button.
- Select the Luxrender project, and press the ![](/images/Raytracing_Render.png) [Render](/Raytracing_Render "Raytracing Render") button.
...
- [The Raytracing Workbench](/Raytracing_Workbench "Raytracing Workbench")
- [Blender](http://www.blender.org)
- [POV-Ray](http://www.povray.org)
- [Luxrender](http://www.luxrender.net)

Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Creating_renderings/ro&oldid=1522565>"
