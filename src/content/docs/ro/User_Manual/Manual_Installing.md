...
3. O colecție [collection of macros](https://github.com/FreeCAD/FreeCAD-macros), care este de asemenea disponibilă [on the FreeCAD wiki](/Macros_recipes "Macros recipes") cu documentație despre cum se utilizeză. Wikipedia conține mult mai multe macrocomenzi.
...
- [Detailed installation instructions](/Installing "Installing")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Installing/ro&oldid=1526230>"
