---
title: O introducere cu duhul blândeții
---
...
FreeCAD are de asememene un [macros system](/Macros "Macros"), care vă permite să vă înregistrați acțiunile pentru a fi reluate mai târziu. Acest sistem utilizează, de asemenea, consola Python, care înregistrează pur și simplu tot ceea ce se face în interior.

În acest capitol, vom descoperi într-un mod foarte general limbajul Python. Dacă doriți să aflați mai multe, documentația wiki din FreeCAD are o secțiune extensivă despre programarea Python.[Python programming](/Power_users_hub "Power users hub").
...
Dacă este prima dată când utilizați Python, luați în considerare citirea acestei scurte introduceri în programarea Python înainte de a merge mai departe [introduction to Python programming](/Introduction_to_Python "Introduction to Python"). Acest lucru va face conceptele de baza ale Python sa vă fie mai clare.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:A_gentle_introduction/ro&oldid=1521697>"
