---
title: Crearea și manipularea geometriei
---
...
De asemenea, am văzut că marea majoritate a atelierelor de lucru FreeCAD depind de una foarte fundamentală: [Part Workbench](/Part_Workbench "Part Workbench"). De fapt, multe alte ateliere de lucru, cum ar fi [Draft](/Draft_Workbench "Draft Workbench") și [Arch](/Arch_Workbench "Arch Workbench"), fac exact ceea ce vom face în acest capitol: utilizează codul Python pentru a crea și manipula geometria pieselor.
...
Toate cele de mai sus, și multe altele, sunt explicate în detaliu pe pagina [Part Scripting](/Topological_data_scripting "Topological data scripting"), împreună cu exemple.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Creating_and_manipulating_geometry/ro&oldid=1521722>"
