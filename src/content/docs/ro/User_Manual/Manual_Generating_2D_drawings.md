...
În FreeCAD, atelierul destinat pentru crearea acestui tip de reprezentări grafice este [Desenare](/TechDraw_Workbench "TechDraw Workbench").
...
Pe parcursul următorului exerciţiu, vom vedea cum se realizează un desen simplu, precum cel al modelului de scaun aflat în [Biblioteca FreeCAD](https://github.com/FreeCAD/FreeCAD-library) mergând pe calea (Furniture -> Chairs -> IkeaChair). Biblioteca FreeCAD poate fi adăugată ușor la instalarea FreeCAD (raportați-vă la capitolul acestui manual [installing](/Manual:Installing "Manual:Installing") ), sau puteți descărca pur și simplu modelul din pagina web a bibliotecii sau prin intermediul link-ului direct furnizat în partea de jos a acestui capitol.
...
- Comutați pe [Drawing Workbench](/Drawing_Workbench "Drawing Workbench")
- Apăsați mica săgeată alăturată butonului ![](/images/Drawing_Landscape_A3.png) [New Drawing Page](/Drawing_Landscape_A3 "Drawing Landscape A3") button.
...
- Apăsați butonul ![](/images/Drawing_View.png) [Insert view](/Drawing_View "Drawing View") .
...
Vom plasa cote și indicații pe desenul nostru. Există două moduri de a adăuga cotelor unui model, unul este plasarea cotelor în interiorul modelului 3D, folosind ![](/images/Draft_Dimension.png) [Dimension](/Draft_Dimension "Draft Dimension") instrumentul [Draft Workbench](/Draft_Workbench/ro "Draft Workbench/ro"), și apoi plasați o vedere a acestor cote pe foaia noastră cu instrumetnul ![](/images/Drawing_DraftView.png) [Draft View](/index.php?title=Drawing_DraftView&action=edit&redlink=1 "Drawing DraftView (page does not exist)") (care pot fi utilizate cu o singură cotă sau cu un grup care conține cote), sau putem face lucruri direct pe foaia Desen, folosind [Drawing Dimensioning Workbench](https://github.com/hamish2014/FreeCAD_drawing_dimensioning), care este instalabil din [FreeCAD addons](https://github.com/FreeCAD/FreeCAD-addons). Vom folosi aici această metodă din urmă.
...
- [Atelierul Desenare](/TechDraw_Workbench/ro "TechDraw Workbench/ro")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Generating_2D_drawings/ro&oldid=1522922>"
