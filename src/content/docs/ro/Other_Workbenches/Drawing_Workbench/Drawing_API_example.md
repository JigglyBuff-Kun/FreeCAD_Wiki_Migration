---
title: Drawing API example/ro
---
## Introducere

Fluxul de lucru pentru interfața grafică pentru [Drawing Workbench](/Drawing_Workbench "Drawing Workbench") este limitat, astfel încât API-ul de scripting este mai interesant.
...
*See also:* [Drawing Dimensioning Addon](/Drawing_Dimensioning_Addon "Drawing Dimensioning Addon")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Drawing_API_example/ro&oldid=1536797>"