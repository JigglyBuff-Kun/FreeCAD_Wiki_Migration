...
| Macro_Mouse_Cross                                                                                                                                                                                                                                                       |
| Descripción                                                                                                                                                                                                                                                             |
| This macro turns the arrow of the mouse in a precision cross. Versión macro : 0.05 Fecha última modificación : 2020-08-06 Versión FreeCAD : 0.18 and more Descargar : [ToolBar icon](https://www.freecadweb.org/wiki/images/f/ff/Macro_Mouse_Cross.png) Autor : Mario52 |
| Autor                                                                                                                                                                                                                                                                   |
...
Pequeño ejemplo de uso de la clase **ViewObserver()** y el uso del teclado con **[SoKeyboardEvent](/Code_snippets#Observing_mouse_events_in_the_3D_viewer_via_Python "Code snippets")**
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Mouse_Cross/es&oldid=1345604>"
