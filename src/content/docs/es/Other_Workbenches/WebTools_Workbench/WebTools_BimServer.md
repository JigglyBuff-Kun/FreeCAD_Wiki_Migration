---
title: HerramientasWeb BimServer
---
|  |
| --- |
| HerramientasWeb BimServer |
| Ubicación en el Menú |
| Herramientas Web → BIM server |
| Entornos de trabajo |
...
:::caution
A partir de FreeCAD v0.17, esta herramienta se ha eliminado del Ambiente de trabajos Arquitectura y ahora forma parte delAmbiente de trabajos HerramientasWebexterno que puedes instalar a través del menú Herramientas →.Administrador de complementos.
:::
...
* Todas las transferencias de archivos con el BIMServer se hacen con archivos IFC. Por lo tanto, es necesario saber trabajar con [Archivos IFC](/Arch_IFC/es "Arch IFC/es").
...
2. Selecciona el menú **Herramientas Web → ![](/images/WebTools_BimServer.svg) BIM Server**
...
* Elija el **Objeto raíz'** que desea cargar. Debe ser un [Arquitectura Site](/Arch_Site/es "Arch Site/es") o un [Arquitectura Edificio](/Arch_Building/es "Arch Building/es"). Sólo se subirán los objetos que pertenezcan a ese objeto raíz.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=WebTools_BimServer/es&oldid=1064371>"