---
title: Entorno de trabajo KicadStepUp
---
...
* Diseñe un nuevo borde de PCB con el [entorno de trabajo Sketcher](/Sketcher_Workbench/es "Sketcher Workbench/es") de FreeCAD y ENVÍELO a una placa de PCB KiCad existente
...
KicadStepUp es parte de los [entornos de trabajo externos](/External_workbenches/es "External workbenches/es"), y puede instalarse automáticamente usando el ![](/images/Std_AddonMgr.svg) [Gestor de complementos de FreeCAD](/Std_AddonMgr/es "Std AddonMgr/es") que viene incluido con FreeCAD 0.17 en adelante, en el menú **Herramientas → Administrador de complementos**.
...
Los ambientes de trabajo de FreeCAD son fáciles de programar en [Python](/Python/es "Python/es"), por lo que hay mucha gente desarrollando ambientes de trabajo adicionales fuera de los desarrolladores principales de FreeCAD.

La página [Ambientes de trabajo externos](/External_workbenches/es "External workbenches/es") tiene información y tutoriales sobre algunos de ellos, y el proyecto [FreeCAD Complementos](https://github.com/FreeCAD/FreeCAD-addons) pretende reunirlos y hacerlos fácilmente instalables desde FreeCAD.

Nuevos ambientes de trabajo están en desarrollo, ¡esté atento!

Retrieved from "<http://wiki.freecad.org/index.php?title=KicadStepUp_Workbench/es&oldid=1527706>"