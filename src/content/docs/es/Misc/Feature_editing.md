---
title: Edición de operaciones
---
## Introducción

Esta página explica la forma en que [Ambiente de trabajo Diseño de piezas](/PartDesign_Workbench/es "PartDesign Workbench/es") está destinado a ser utilizado a partir de FreeCAD 0.17.

## Cuerpo

Trabajar en PartDesign requiere primero crear un ![](/images/PartDesign_Body.png) **[Cuerpo](/PartDesign_Body/es "PartDesign Body/es")**. El Diseño de piezas Cuerpo es un contenedor que agrupa una secuencia de operaciones formando un único sólido continuo.
...
Cuando una pieza requiere del empleo de varios cuerpos, estos pueden ser agrupados dentro de un contenedor de propósito general llamado ![](/images/Std_Part.svg) [contenedor de Pieza](/Std_Part/es "Std Part/es"). De esta forma todos los cuerpos se pueden trasladar de forma solidaria como si fueran un único objeto.
...
Sólo puede haber una característica visible a la vez. Es posible [cambiar la visibilidad](/index.php?title=Std_ToggleVisibility/es&action=edit&redlink=1 "Std ToggleVisibility/es (page does not exist)") de cualquier característica en el cuerpo, seleccionándola en el árbol del Modelo y presionando la Barra espaciadora, en efecto retrocediendo en la historia del cuerpo.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Feature_editing/es&oldid=1511456>"