...
Pero también tenemos un módulo de Python que permite un acceso completo a todo lo controlado por Coin3d, como la escena gráfica (scenegraph) de FreeCAD. Sigue leyendo en [Pivy](/Pivy/es "Pivy/es").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scenegraph/es&oldid=1207344>"