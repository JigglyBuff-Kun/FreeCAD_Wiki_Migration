---
title: Ejemplos de principiantes en PySide
---
## Introducción

El propósito de esta página es cubrir ejemplos de nivel de principiante del [PySide](/PySide/es "PySide/es") Administrador de la interfaz gráfica de usuario (hay páginas que acompañan a [Ejemplos intermedios de PySide](/index.php?title=PySide_Intermediate_Examples/es&action=edit&redlink=1 "PySide Intermediate Examples/es (page does not exist)") y [Ejemplos avanzados de PySide](/index.php?title=PySide_Advanced_Examples/es&action=edit&redlink=1 "PySide Advanced Examples/es (page does not exist)")).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PySide_Beginner_Examples/es&oldid=1231342>"