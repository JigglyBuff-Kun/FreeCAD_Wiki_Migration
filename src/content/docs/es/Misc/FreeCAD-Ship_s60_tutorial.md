---
title: Tutorial de FreeCAD-Nave s60
---
|  |
| --- |
| Tutorial |
...
Más información sobre ![](/images/Workbench_Ship.svg) [Ambiente de trabajo de naves](/Ship_Workbench/es "Ship Workbench/es").

## Cargando geometría

### Fondo

El ![](/images/Workbench_Ship.svg) [Ambiente de trabajo nave](/Ship_Workbench/es "Ship Workbench/es") trabaja sobre **Entidades de nave**, que deben ser creadas sobre la geometría proporcionada. La geometría debe ser un sólido (o conjunto de sólidos), se deben tener en cuenta los siguientes criterios:
...
Icono del cargador de geometrías de naves de ejemplo
...
:::caution
'¡Atención, antes de editar nada!Ahora está trabajando con el archivo de ejemplo original.Para preservar el ejemplo original sin editar,debes guardarlo primero como un nuevo archivo antes de editar nada
:::
...
Herramienta de creación nave

Icono de la herramienta de creación de naves

Se mostrará el diálogo de la tarea de creación de una nave y algunas anotaciones en la [vista 3D](/3D_view/es "3D view/es"). Las anotaciones desaparecerán cuando cierres la herramienta de creación de naves, así que no te preocupes por esto.

Se deben introducir los datos más relevantes del nave (el ![](/images/Workbench_Ship.svg) El ambiente de trabajo nave utiliza un sistema de introducción de datos progresivo, por lo que las operaciones básicas pueden realizarse conociendo sólo los datos básicos del nave, siendo necesaria más información a medida que las operaciones se hacen más complejas).
...
Para trazar estas secciones puedes utilizar el [Ambiente de trabajo de dibujo](/Drawing_Workbench/es "Drawing Workbench/es"):
...
* TAP*: Después del calado perpendicular.*
* TFP*: Calado perpendicular a proa.*
...
Cuando se pulsa el botón Aceptar se realiza un trazado (dependiendo de la complejidad de la geometría puede llevar algún tiempo, puedes ver el progreso en el terminal, y detener el trabajo pulsando Ctrl+C). Cuando la tarea ha terminado FreeCAD generará un gráfico (ver la documentación del [Ambiente de trabajo diagrama](/Plot_Workbench/es "Plot Workbench/es")) y una hoja de cálculo (ver la documentación del [Ambiente de trabajo Hoja de cálculo](/Spreadsheet_Workbench/es "Spreadsheet Workbench/es")).
...
Cuando se pulsa el botón **Aceptar** se realizan gráficos (ver la documentación de [Ambiente de trabajo diagrama](/index.php?title=Plot_Workbench/rs&action=edit&redlink=1 "Plot Workbench/rs (page does not exist)")) y se genera una hoja de cálculo (ver la documentación de [Ambiente de trabajo hoja de cálculo](/Spreadsheet_Workbench/es "Spreadsheet Workbench/es")).
...
El [Tutorial de FreeCAD-Nave s60 (II)](/FreeCAD-Ship_s60_tutorial_(II)/es "FreeCAD-Ship s60 tutorial (II)/es") es el segundo capítulo de la serie 60 de la nave universitaria de Iowa.

Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD-Ship_s60_tutorial/es&oldid=1252279>"