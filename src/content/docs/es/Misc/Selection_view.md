---
title: Vista de selección
---
## Introducción

La vista de selección es un panel en la [interfaz](/Interface "Interface") localizada por defecto en debajo de la [vista combo](/Combo_view/es "Combo view/es"). Justo como el [editor de propiedades](/Property_editor/es "Property editor/es"), muestra más información sobre los objetos seleccionados actualmente.

Se puede hacer una selección eligiendo un objeto en la [vista 3D](/3D_view/es "3D view/es") o en la [vista de árbol](/Tree_view/es "Tree view/es"). Se pueden seleccionar varios cuerpos manteniendo presionado Ctrl.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Selection_view/es&oldid=1342075>"