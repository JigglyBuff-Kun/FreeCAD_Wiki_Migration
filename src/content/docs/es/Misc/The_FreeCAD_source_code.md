---
title: El código fuente de FreeCAD
---
...
* The [Power users hub](/Power_users_hub "Power users hub") contains a lot of documentation about modules, OpenCascade and Coin3D, mainly for the Python programmer. However, as the functionality is similar, these pages will be of interest to the C++ programmer as well.
* [FCStd](/File_Format_FCStd "File Format FCStd") - the FreeCAD file format

Retrieved from "<http://wiki.freecad.org/index.php?title=The_FreeCAD_source_code/es&oldid=866154>"