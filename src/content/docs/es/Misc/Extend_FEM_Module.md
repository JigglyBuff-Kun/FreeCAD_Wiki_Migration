...
Agregar nuevas restricciones es bastante sencillo. Para los recién llegados hay un tutorial:[Add FEM Constraint Tutorial](/Add_FEM_Constraint_Tutorial "Add FEM Constraint Tutorial").

Retrieved from "<http://wiki.freecad.org/index.php?title=Extend_FEM_Module/es&oldid=1485152>"