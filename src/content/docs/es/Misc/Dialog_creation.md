...
Y eso es todo amigos... Ahora puedes probar todo tipo de cosas, como por ejemplo insertar tu widget en la interfaz de FreeCAD (mira la página [Pedazos de código](/Code_snippets/es "Code snippets/es")), o la creación de herramientas personalizadas mucho más avanzado, mediante el uso de otros elementos en tu widget o complemento.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Dialog_creation/es&oldid=1392707>"