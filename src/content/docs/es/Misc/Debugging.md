...
Antes de pasar por la molestia de la depuración, utilice el [Marco de pruebas](/Testing "Testing") para comprobar si las pruebas estándar funcionan correctamente. Si no se ejecutan por completo, es posible que haya una instalación defectuosa.
...
* una versión de depuración de FreeCAD (en este momento solo está disponible mediante la [compilación desde el código fuente](/Compile_on_Linux#For_a_Debug_build "Compile on Linux"))
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Debugging/es&oldid=1363238>"