---
title: VRML Preparación per la simulación de robots
---
|  |
| --- |
| Tutorial |
...
Este corresponde a la rotación alrededor del eje Y. En el modelo de CAD, la rotación es alrededor del eje Z. Así, necesitamos una rotación alrededor del eje X de 

π
{\displaystyle \pi }
![{\displaystyle \pi }](https://wikimedia.org/api/rest_v1/media/math/render/svg/9be4ba0bb8df3af72e90a0535fabcc17431e540a) antes de la definición del eje en FreeCAD y de 

−
π
{\displaystyle -\pi }
![{\displaystyle -\pi }](https://wikimedia.org/api/rest_v1/media/math/render/svg/f2359073fe90a84a705e02f0c1e63b32df850a60) después de ella. También, se necesita una traslación de (-xd, -yd, -zd) antes de la correspondencia del grupo a la definición de FOREARM para expresarlo centrado en el cuadro de referencia relativa en D. Esto significa que la traslación de (xd, yd, zd) debe insertarse antes de la primera rotación.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=VRML_Preparation_for_Robot_Simulation/es&oldid=751259>"