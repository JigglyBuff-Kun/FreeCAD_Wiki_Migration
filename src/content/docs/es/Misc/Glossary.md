...
title: Glosario
---
Esta página es un glosario de términos y definiciones comunes en FreeCAD. (Ver la [página de Discusión](/Talk:Glossary/es "Talk:Glossary/es"), por favor.)

Ir a la letra [0-9](#0-9) [A](#A) [B](#B) [C](#C) [D](#D) [E](#E) [F](#F) [G](#G) [H](#H) [I](#I) [J](#J) [K](#K) [L](#L) [M](#M) [N](#N) [O](#O) [P](#P) [Q](#Q) [R](#R) [S](#S) [T](#T) [U](#U) [V](#V) [W](#W) [X](#X) [Y](#Y) [Z](#Z) [(Top)](#top)
...
Arco
:   Una porción o segmento de un círculo.

[Arch](/Arch_Workbench/es "Arch Workbench/es")
:   Abreviatura del [Banco de Trabajo](#Workbench) de Arquitectura el cual se usa principalmente para modelar edificios y estructuras. Muy relacionado con el Banco de Trabajo [Boceto](#Draft).
...
Backtrace
:   Salida de un programa de depurado que muestra la serie de instrucciones que FreeCAD siguio antes de que un problema ocurriera.

Curva Bezier
:   Un tipo de curva paramétrica. Ver [Curva Bezier](http://en.wikipedia.org/wiki/B%C3%A9zier_curve)

Impresión-azúl
:   Antiguo termino utilizado para [dibujos](#Drawing), y acuñado por su originalidad en el [proceso de reproducción](http://en.wikipedia.org/wiki/Blueprint).

Cuerpo
:   Un tipo de contenedor utilizado dentro del banco de trabajo diseño de parte que agrupa una secuencia de operaciones de ([bosquejo](#Sketch), construcción de geometrías y [caracteristicas](#Feature)) para crear un solido simple contiguo.(Introducido en FreeCAD V0.17.)

Logica booleana
:   Un metodo de manipulación de datos utilizando los operadores: AND, OR, NOT.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Glossary/es&oldid=1484016>"