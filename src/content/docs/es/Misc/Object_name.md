...
Todos los objetos del programa tienen un nombre de objeto que los identifica de forma única en un documento determinado.
...
* The Datos**Label2** attribute is normally hidden in the [property editor](/Property_editor "Property editor") but can be made visible by opening the context menu (right click) and selecting **Show hidden**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Object_name/es&oldid=1560810>"