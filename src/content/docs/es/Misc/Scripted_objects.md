...
En este ejemplo se hace uso del [Módulo de Pieza](/Part_Workbench/es "Part Workbench/es") para crear un octaedro, a continuación, se crea su representación Coin con Pivy.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Scripted_objects/es&oldid=1499141>"