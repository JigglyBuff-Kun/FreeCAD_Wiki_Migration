---
title: Tutoriales de vídeo para el diseño de productos
---
:::caution
...
Los tutoriales que se enumeran aquí son los que tratan del diseño de productos físicos para la fabricación o la impresión en 3D. Para otros temas, consulte la página general [video tutoriales](/Video_tutorials/es "Video tutorials/es").
...
Videos que pasan por el modelado de varios objetos sólidos usando ambientes de trabajo como ![](/images/Workbench_Part.svg) [Part](/Part_Workbench/es "Part Workbench/es"), ![](/images/Workbench_PartDesign.svg) [PartDesign](/PartDesign_Workbench/es "PartDesign Workbench/es"), and ![](/images/Workbench_Sketcher.svg) [Sketcher](/Sketcher_Workbench/es "Sketcher Workbench/es")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Video_tutorials_for_product_design/es&oldid=1399877>"