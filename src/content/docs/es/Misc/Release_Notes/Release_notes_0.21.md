---
title: Notas del lanzamiento 0.21
---

**FreeCAD 0.21** fue lanzado el **2 de agosto del 2023**, consíguelo desde la página [Descarga](/Download/es "Download/es"). Este es un resumen de las nuevas características y los cambios más interesantes.
...
El esquema de nombres de archivos de respaldo predeterminado ahora es FCBak. El formato anterior (FCStd#) está obsoleto y se eliminará en una versión futura. Los usuarios con el esquema anterior habilitado recibirán una advertencia al iniciar.
...
|     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     | El [Cubo de navegación](/Navigation_Cube/es "Navigation Cube/es") ha sido actualizado. Ya no se muestra el cubo en perspectiva si la [vista 3D](/3D_view "3D view") está en modo de vista ortográfica. Las caras de las esquinas se han hecho hexagonales y más grandes para que sea más fácil hacer clic en ellas. Se han agregado bordes alrededor de los botones. Se ha mejorado la selección y el tamaño de fuente predeterminados. El menú Mini-cubo ahora incluye una casilla de verificación para alternar la movilidad del cubo. Se han agregado varios parámetros nuevos, véa la página [Cubo de navegación](/Navigation_Cube/es "Navigation Cube/es") para más información. [Pull request #7876](https://github.com/FreeCAD/FreeCAD/pull/7876), [Pull request #8266](https://github.com/FreeCAD/FreeCAD/pull/8266), [Pull request #8646](https://github.com/FreeCAD/FreeCAD/pull/8646) y [Pull request #9356](https://github.com/FreeCAD/FreeCAD/pull/9356). |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Release_notes_0.21/es&oldid=1485807>"
