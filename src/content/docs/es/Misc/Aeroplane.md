...
Trabajaremos en el ![](/images/Workbench_Part.svg)[Ambiente de trabajo Piezas](/Part_Workbench/es "Part Workbench/es") - selecciona el módulo de piezas en **Vista → Entorno → Pieza** o desde el [Selector Ambiente de trabajos](/Std_Workbench/es "Std Workbench/es").

* Crea un nuevo documento vacío.
* Cambia a ![](/images/Std_ViewIsometric.svg) [vista isometrica](/index.php?title=Std_ViewIsometric/es&action=edit&redlink=1 "Std ViewIsometric/es (page does not exist)").
* Alternar la cruz del eje ON (a través del menú Vista).
* Asegúrese de que tiene la [Combo Vista](/Combo_view/es "Combo view/es") mostrando (a través de **Vista → Vistas**).

* Crea un cilindro pulsando en el botón ![](/images/Part_Cylinder.svg) [Cilindro](/Part_Cylinder/es "Part Cylinder/es").
...
Haga clic en [Colocación](/Placement/es "Placement/es") (fíjate en la pequeña [+]) y aparecerá un botón con tres puntos .... Haga clic en él. (También puede seleccionar: **Menú → Editar → Colocación**) Aparecerá el visor de tareas.
...
Ahora vamos a añadir y modificar una caja así que haz clic en el botón ![](/images/Part_Box.svg) [Cubo](/Part_Box/es "Part Box/es"). Selecciónalo haciendo clic en Caja en el visor de proyectos.
Cambia el Alto a 1mm, el Largo a 5mm y el Ancho a 20mm.

Haga clic en [Colocación → ...](/Placement/es "Placement/es") para obtener el visor de Tareas. Utilizando el cuadro de traducción introduzca Y: -10 y Z: -1. Haga clic en Aceptar.

Ahora vamos a fusionar estas dos formas con una operación booleana. Haz clic en el botón ![](/images/Part_Boolean.svg) [Operaciones Booleanas](/Part_Boolean/es "Part Boolean/es") y el visor de Tareas mostrará el selector de Operaciones Booleanas.
...
Ahora necesitamos unir nuestra Fusión a la Caja001, así que lo haremos de la manera más rápida. Haga clic en Fusion en el visor de proyectos y Ctrl+clic en Box001. Esto selecciona ambas partes juntas. Ahora haz clic en el ![](/images/Part_Fuse.svg) [Fuse](/Part_Fuse/es "Part Fuse/es") para obtener **Fusion001**.
...
Haga clic en Caja y obtenga su [Colocación en Tareas](/Placement/es "Placement/es"). Observa que ya tiene Y: -10 y Z: -1 en la Traducción. Cambia la traducción de X a 3 y haz clic en Aplicar. Así está mejor. Haga clic en Aceptar.

## Rotaciones

Haz clic en Aeroplano y obtén su [Colocación en Tareas](/Placement "Placement"). En la sección de Rotación cambia donde dice 'Eje de rotación con ángulo' por 'Ángulos de Euler' porque son mucho más fáciles de trabajar.

![izquierda](/images/Tache_Placement_Lacet_fr_Mini.gif)**Desvío** es la rotación alrededor del **eje Z**, es decir la rotación de izquierda a derecha. (El ángulo de desvío es **Psi ψ**).

![izquierda](/images/Tache_Placement_Tangage_fr_Mini.gif)**Paso** es la rotación alrededor del **eje Y**, es decir nariz arriba y nariz abajo. (El ángulo de paso es el **Phi φ**).

![izquierda](/images/Tache_Placement_Roulis_fr_Mini.gif)**Volteado** es la rotación alrededor del **eje X**, es decir alas arriba y abajo. (El ángulo del rollo es el **Thêta θ**).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Aeroplane/es&oldid=1251521>"