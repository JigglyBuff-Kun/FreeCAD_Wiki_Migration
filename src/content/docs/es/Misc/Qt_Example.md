...
| Macro Qt Ejemplo |
| Descripción |
| Describe los comandos de Qt.  Versión macro : 0.4 Fecha última modificación : 2019-06-19 Versión FreeCAD : Todos Descargar : [MEpipe01](https://www.freecadweb.org/wiki/images/a/a7/MEpipe01.png)  [MEpipe02](https://www.freecadweb.org/wiki/images/5/5b/MEpipe02.png)  [MEPlan](https://www.freecadweb.org/wiki/images/e/e4/MEPlan.png)  [MEPlanD](https://www.freecadweb.org/wiki/images/3/30/MEPlanD.png)  [MEPlanF](https://www.freecadweb.org/wiki/images/d/d8/MEPlanF.png)  [MEPlanT](https://www.freecadweb.org/wiki/images/9/9f/MEPlanT.png)  [MEPlanI](https://www.freecadweb.org/wiki/images/f/f2/MEPlanI.png)  [MEPlanFC](https://www.freecadweb.org/wiki/images/e/e6/MEPlanFC.png)  [MEPlanPY](https://www.freecadweb.org/wiki/images/d/d2/MEPlanPY.png) Autor : Mario52 |
| Autor |
| [Mario52](/User:Mario52 "User:Mario52") |
| Descargar |
| [MEpipe01](https://www.freecadweb.org/wiki/images/a/a7/MEpipe01.png)  [MEpipe02](https://www.freecadweb.org/wiki/images/5/5b/MEpipe02.png)  [MEPlan](https://www.freecadweb.org/wiki/images/e/e4/MEPlan.png)  [MEPlanD](https://www.freecadweb.org/wiki/images/3/30/MEPlanD.png)  [MEPlanF](https://www.freecadweb.org/wiki/images/d/d8/MEPlanF.png)  [MEPlanT](https://www.freecadweb.org/wiki/images/9/9f/MEPlanT.png)  [MEPlanI](https://www.freecadweb.org/wiki/images/f/f2/MEPlanI.png)  [MEPlanFC](https://www.freecadweb.org/wiki/images/e/e6/MEPlanFC.png)  [MEPlanPY](https://www.freecadweb.org/wiki/images/d/d2/MEPlanPY.png) |
| Enlace |
...
| *None* |
| Ver también |
| [Creación\_de\_diálogo](/Dialog_creation/es "Dialog creation/es") |
|  |
|  |

Esta macro es un ejemplo del uso de los comandos de Qt en sus conexiones, extracción y asignación de datos.

* ![Qt ejemplo](/images/Qt_Example_00.png)

  Qt ejemplo
* ![Qt ejemplo detalles](/images/Qt_Example_01.png)
...
3. **progressBar horizontal** : barra de progreso horizontal su conexión y extracción de datos / asignación
4. **verticalSlider** : deslizador vertical su conexión y extracción / asignación de datos
5. **progressBar vertical** : barra de progreso vertical su conexión y extracción de datos / asignación
6. **lineEdit** : línea editar su conexión y extracción de datos / asignación
7. **lineEdit** : línea editar su conexión y extracción de datos / asignación
8. **doubleSpinBox** : doble spinbox su conexión y extracción de datos / asignación
9. **doubleSpinBox** :
10. **doubleSpinBox** :
11. **buttom** : buttom its connection
12. **buttom** :
13. **radioButtom** : botón de radio con iconos su conexión y comprobado
14. **checkBox** : casilla con el icono de su conexión marcada y desmarcada
...
**3: *entonces en una consola Dos escriba*** *convertuitopy myproject* (No dé la extensión que el comando agrega automáticamente)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Qt_Example/es&oldid=1077051>"