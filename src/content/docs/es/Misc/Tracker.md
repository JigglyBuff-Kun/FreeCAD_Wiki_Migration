...
* Antes de enviar cualquier cosa, lee las [FAQ - Preguntas más frecuentes](/FAQ "FAQ"), haz una búsqueda en el [foro](http://forum.freecadweb.org/), y asegúrate de que el mismo error no se ha informado antes, haciendo una búsqueda en el bug tracker.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Tracker/es&oldid=1328548>"