...
Una [propiedad](/Property "Property") es una pieza de información como un número o una cadena de texto que se adjunta a un documento FreeCAD o a un objeto en un documento. Las propiedades públicas se pueden ver y modificar en el [Editor de propiedades](/Property_editor "Property editor").

Las propiedades juegan un papel muy importante en FreeCAD. Como los objetos en FreeCAD son "paramétricos", esto significa que su comportamiento está definido por sus propiedades y cómo estas propiedades se utilizan como entrada para sus métodos de clase. Consulte también [Propiedades personalizadas de FeaturePython](/FeaturePython_Custom_Properties "FeaturePython Custom Properties") y [PropertyLink: InList y OutList](/PropertyLink:_InList_and_OutList "PropertyLink: InList and OutList")

## Todos los tipos de propiedades

Los [objetos creados por script](/Scripted_objects "Scripted objects") personalizados pueden utilizar cualquiera de los tipos de propiedades definidos en el sistema base:
...
*Conosulte también:* [Cuestiones básicas de FreeCAD scripting](/FreeCAD_Scripting_Basics "FreeCAD Scripting Basics")

Un [objeto creado por script](/Scripted_objects "Scripted objects") es creado primero, y luego las propiedades son asignadas.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Property/es&oldid=1504875>"