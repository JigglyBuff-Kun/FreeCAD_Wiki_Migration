---
title: Importación de FreeCAD y DXF
---
## Fondo

DXF es un formato de datos CAD propietario para dibujos 2D que se originó con AutoCAD. Se pueden encontrar más detalles en la página wiki [DXF](/DXF/es "DXF/es").
...
Para ver un resumen de todas las preferencias relacionadas con DXF, consulte [Preferencias de importación y exportación](/Import_Export_Preferences/es#DXF "Import Export Preferences/es").

Retrieved from "<http://wiki.freecad.org/index.php?title=FreeCAD_and_DXF_Import/es&oldid=1329437>"