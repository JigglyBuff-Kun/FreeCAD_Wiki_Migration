---
title: Guionización datos topológicos
---
## Introducción

Aquí te explicaremos cómo controlar el módulo [Pieza](/Part_Workbench/es "Part Workbench/es") directamente desde el intérprete de Python de FreeCAD, o desde cualquier guión externo. Asegúrate de navegar por la sección [Guionización](/Scripting/es "Scripting/es") y las páginas [Básicos de Guionización FreeCAD](/FreeCAD_Scripting_Basics/es "FreeCAD Scripting Basics/es") si necesitas más información sobre cómo funciona el guionización de Python en FreeCAD. Si eres nuevo en Python, es una buena idea leer primero la [Introducción a Python](/Introduction_to_Python/es "Introduction to Python/es").

### Ver también

* [Guionización Pieza](/Part_scripting/es "Part scripting/es")
* [OpenCASCADE](/OpenCASCADE/es "OpenCASCADE/es")

## Diagrama de clase

Este es un resumen [Lenguaje Unificado de Modelado (UML)](http://es.wikipedia.org/wiki/Lenguaje_Unificado_de_Modelado) de las clases más importantes del módulo Pieza:

![Clases de Python del módulo Pieza](/images/Part_Classes.jpg)
...
Ver la página [Pieza API](/Part_API/es "Part API/es") para una lista completa de los métodos disponibles del módulo Pieza.
...
arc\_edge es lo que queríamos conseguir, y podemos visualizar utilizando Part.show (arc\_edge).
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Topological_data_scripting/es&oldid=1311603>"