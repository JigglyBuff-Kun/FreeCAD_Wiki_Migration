...
FreeCAD no sería lo que es sin las generosas contribuciones de muchas personas. Aquí hay un resumen de las personas y empresas que han contribuido a FreeCAD a lo largo del tiempo. Para ver los créditos de las librerías de terceros vea la página [Librerías de terceros](/Third_Party_Libraries/es "Third Party Libraries/es").
...
Personas que escribieron la documentación de esta [wiki](/Main_Page/es "Main Page/es"):
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Contributors/es&oldid=1550566>"