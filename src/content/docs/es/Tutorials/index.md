...
title: Tutoriales
---
Esta página presenta una selección de tutoriales escritos de alta calidad. Una lista completa y sin clasificar de tutoriales se puede encontrar en [Category:Tutorials](/Category:Tutorials "Category:Tutorials"), una completa y ordenable se puede encontrar en la [tabla de abajo](#Tutoriales_-_Lista_completa).

Visite también [tutoriales de vídeo](/Video_tutorials/es "Video tutorials/es") y [tutoriales externos](/index.php?title=Offsite_tutorials/es&action=edit&redlink=1 "Offsite tutorials/es (page does not exist)") para ver los tutoriales alojados en sitios externos. Una fuente útil de tutoriales de vídeo es [YouTube](https://YouTube.com).

Si quieres contribuir a escribir documentación y tutoriales del wiki, consulta las directrices generales del wiki en [Páginas Wiki](/WikiPages/es "WikiPages/es"),
y leer las [Directrices del tutorial](/index.php?title=Tutorial_guidelines/es&action=edit&redlink=1 "Tutorial guidelines/es (page does not exist)").
...
* [![Arch tutorial (v0.14) Esta es la introducción esencial al Ambiente de trabajo Arquitectura. Es extensa y muestra un flujo de trabajo típico, desde la importación de planos en formato DXF hasta la construcción del modelo 3D.](/images/Arch_tutorial_00.jpg)](/Arch_tutorial  "Arch tutorial (v0.14) Esta es la introducción esencial al Ambiente de trabajo Arquitectura. Es extensa y muestra un flujo de trabajo típico, desde la importación de planos en formato DXF hasta la construcción del modelo 3D.")

  [Arch tutorial](/Arch_tutorial "Arch tutorial") (v0.14)   
  Esta es la introducción esencial al Ambiente de trabajo Arquitectura. Es extensa y muestra un flujo de trabajo típico, desde la importación de planos en formato DXF hasta la construcción del modelo 3D.
* [![BIM modeling Cómo modelar una pequeña casa, producir un plano con TechDraw y exportar a IFC.](/images/Exercise_arch_01.jpg)](/Manual:BIM_modeling "BIM modeling Cómo modelar una pequeña casa, producir un plano con TechDraw y exportar a IFC. ")

  [BIM modeling](/Manual:BIM_modeling "Manual:BIM modeling")   
  Cómo modelar una pequeña casa, producir un plano con TechDraw y exportar a IFC.
* [![Ventanas y puertas abiertas (v0.18) Cómo mostrar ventanas y puertas abiertas, con símbolos de alzado y planta, y producir un plano básico con TechDraw.](/images/11_T01_window_all_symbol_top.png)](/Tutorial_for_open_windows/es  "Ventanas y puertas abiertas (v0.18) Cómo mostrar ventanas y puertas abiertas, con símbolos de alzado y planta, y producir un plano básico con TechDraw.")

  [Ventanas y puertas abiertas](/index.php?title=Tutorial_for_open_windows/es&action=edit&redlink=1 "Tutorial for open windows/es (page does not exist)") (v0.18)   
  Cómo mostrar ventanas y puertas abiertas, con símbolos de alzado y planta, y producir un plano básico con TechDraw.
* [![Diseñar ventanas personalizadas. (v0.18) Cómo dibujar puertas y ventanas personalizadas usando el Sketcher, y ajustar sus normales para colocarlas correctamente en los muros.](/images/17_T02_sketch_2_attached_correctly.png)](/Tutorial_custom_placing_of_windows_and_doors/es  "Diseñar ventanas personalizadas. (v0.18) Cómo dibujar puertas y ventanas personalizadas usando el Sketcher, y ajustar sus normales para colocarlas correctamente en los muros.")

  [Diseñar ventanas personalizadas](/index.php?title=Tutorial_custom_placing_of_windows_and_doors/es&action=edit&redlink=1 "Tutorial custom placing of windows and doors/es (page does not exist)"). (v0.18)   
  Cómo dibujar puertas y ventanas personalizadas usando el Sketcher, y ajustar sus normales para colocarlas correctamente en los muros.
* [![Arch panel tutorial (v0.15) Modelando un panel de techo de microcasa utilizando el Sketcher, la herramienta Ventana y la herramienta Panel.](/images/Arch_panel_tutorial_01.jpg)](/Arch_panel_tutorial  "Arch panel tutorial (v0.15) Modelando un panel de techo de microcasa utilizando el Sketcher, la herramienta Ventana y la herramienta Panel.")

  [Arch panel tutorial](/Arch_panel_tutorial "Arch panel tutorial") (v0.15)   
  Modelando un panel de techo de microcasa utilizando el Sketcher, la herramienta Ventana y la herramienta Panel.
* [![Modelado de la WikiHouse Remodelación del proyecto WikiHouse utilizando bocetos y paneles, partiendo de la importación de un modelo de malla creado en SketchUp.](/images/Arch_Wikihouse_01.jpg)](/Wikihouse_porting_tutorial/es "Modelado de la WikiHouse Remodelación del proyecto WikiHouse utilizando bocetos y paneles, partiendo de la importación de un modelo de malla creado en SketchUp. ")

  [Modelado de la WikiHouse](/Wikihouse_porting_tutorial/es "Wikihouse porting tutorial/es")   
...
Aquí están listados todos los tutoriales que no están en el manual **independientemente de su calidad'**. Si un tutorial está listado en la [Category:Tutorials](/Category:Tutorials "Category:Tutorials") y no en esta tabla, por favor insértelo.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Tutorials/es&oldid=1538589>"