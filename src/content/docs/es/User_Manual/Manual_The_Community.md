...
- **Escribir scripts y macros**: FreeCAD tiene una lista creciente de [Macros](/Macros_recipes/es "Macros recipes/es"). Si has escrito alguna funcionalidad interesante, considera compartirla allí.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:The_Community/es&oldid=1521940>"
