---
title: Importación y exportación a otros tipos de archivos
---
...
- [Todos los formatos de archivo soportados por FreeCAD](/Import_Export/es "Import Export/es")
- [Trabajar con archivos DXF en FreeCAD](/Draft_DXF/es "Draft DXF/es"):
- [Trabajar con archivos SVG en FreeCAD](/Draft_SVG/es "Draft SVG/es")
- [Importar y exportar a IFC](/Arch_IFC/es "Arch IFC/es")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Manual:Import_and_export_to_other_filetypes/es&oldid=1521797>"
