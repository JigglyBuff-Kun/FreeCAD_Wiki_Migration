...
The most basic object that can be created is a [Part Feature](/Part_Feature "Part Feature"), which has a simple Datos**Placement** property, and basic properties to define its color and appearance.
...
* [Guiones de datos topológicos](/Topological_data_scripting/es "Topological data scripting/es")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_scripting/es&oldid=1268488>"