...
| 0.19 |
| Ver también |
| [Borrador BezCurva](/Draft_BezCurve/es "Draft BezCurve/es"), [Borrador BSpline](/Draft_BSpline/es "Draft BSpline/es") |
|  |

## Descripción

El comando ![](/images/Draft_CubicBezCurve.svg) Borrador CubicBezCurva crea una [Curva de Bézier](https://es.wikipedia.org/wiki/Curva_de_B%C3%A9zier) de tercer grado (se requieren cuatro puntos).

La Curva de Bézier es una de las curvas más utilizadas en infografía. Este comando permite crear una spline continua formada por varios segmentos de Bézier de tercer grado, de forma similar a la herramienta Bézier de [Inkscape](https://inkscape.org/). Una curva Bézier general de cualquier grado puede ser creada con el comando [Borrador BezCurva](/Draft_BezCurve/es "Draft BezCurve/es").

Los comandos [Borrador de BezCurva](/Draft_BezCurve/es "Draft BezCurve/es") y Borrador de CubicBezCurve utilizan *puntos de control* para definir la posición y la curvatura de la spline. El comando [Borrador BSpline](/Draft_BSpline/es "Draft BSpline/es"), en cambio, especifica los *puntos exactos* por los que pasará la curva.
...
Ver también: [Bandeja de borrador](/Draft_Tray/es "Draft Tray/es"), [Borrador Snap](/Draft_Snap/es "Draft Snap/es") y [Borrador Constreñido](/Draft_Constrain/es "Draft Constrain/es").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_CubicBezCurve/es&oldid=1472995>"