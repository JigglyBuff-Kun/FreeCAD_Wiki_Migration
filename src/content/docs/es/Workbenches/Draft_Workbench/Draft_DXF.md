...
El borrador DXF es un módulo de software utilizado por el ![](/images/Std_Open.svg) [Std Abrir](/Std_Open/es "Std Open/es"), ![](/images/Std_Import.svg) [Std Importar](/Std_Import/es "Std Import/es") y ![](/images/Std_Export.svg) [Std Exportar](/index.php?title=Std_Export/es&action=edit&redlink=1 "Std Export/es (page does not exist)") para manejar el formato de archivo DXF.
...
Por razones de licencia, las librerías de importación/exportación [DXF](/DXF/es "DXF/es") necesarias para la versión antigua del importador no forman parte del código fuente de FreeCAD.
Para más información ver: [Importación FreeCAD y DXF](/FreeCAD_and_DXF_Import/es "FreeCAD and DXF Import/es").

## Preferencias

Para más información, consulte: [Preferencias de exportación](/Import_Export_Preferences/es "Import Export Preferences/es").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_DXF/es&oldid=1513609>"