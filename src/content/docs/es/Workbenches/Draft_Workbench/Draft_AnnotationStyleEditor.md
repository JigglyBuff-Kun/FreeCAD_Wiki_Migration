---
title: Borrador EditorEstiloAnotación
---
|  |
| --- |
...
| Entornos de trabajo |
| [Borrador](/Draft_Workbench/es "Draft Workbench/es") |
| Atajo de teclado por defecto |
| *Ninguno* |
| Introducido en versión |
| 0.19 |
| Ver también |
| [Borrador Texto](/Draft_Text/es "Draft Text/es"), [Borrador Etiqueta](/Draft_Label/es "Draft Label/es"), [Borrador Dimensión](/Draft_Dimension/es "Draft Dimension/es") |
|  |

## Descripción

El ![](/images/Draft_AnnotationStyleEditor.svg) comando **Borrador EditorEstiloAnotación** permite definir estilos que afectan a las propiedades visuales de los objetos tipo anotación, como los creados por los comandos [Borrador Texto](/Draft_Text/es "Draft Text/es"), [Borrador Dimensión](/Draft_Dimension/es "Draft Dimension/es") y [Borrador Etiqueta](/Draft_Label/es "Draft Label/es").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_AnnotationStyleEditor/es&oldid=1473091>"