---
title: Trayectoria PREGUNTAS FRECUENTES
---
## ¿Cuántos ejes puede manejar Ambiente de trabajo Trayectoria?

At the moment, CAM Workbench can handle up to 3 axis milling. Currently, 4th-axis capabilities are not officially included but [experimental implementations](/CAM_fourth_axis "CAM fourth axis") exist.
...
Operations such as [Pocket 3D](/CAM_Pocket_3D "CAM Pocket 3D"), [Pocket Shape](/CAM_Pocket_Shape "CAM Pocket Shape"), and [MillFace](/CAM_MillFace "CAM MillFace"), but not Contour Operations have a configuration option to keep the tool down, in the Data tab of the Property View.
...
The [Postprocessor](/CAM_Post "CAM Post") is used to tailor output code to target CNC controllers for various machines, in their G-Code dialect.
...
CAM Workbench allows control of the display of path lines by toggling the visibility of the Job by selecting it in the [Combo View](/Combo_view "Combo view"). The visibility of individual or groups of Operations are then toggled from the Combo View.
...
[CAM scripting](/CAM_scripting "CAM scripting")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=CAM_FAQ/es&oldid=1482957>"