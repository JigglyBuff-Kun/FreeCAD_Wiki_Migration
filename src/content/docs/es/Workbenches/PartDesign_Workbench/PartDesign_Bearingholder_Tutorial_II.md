---
title: PartDesign Soporte de rodamiento Tutorial II
---
:::caution
...
:::caution
Este tutorial fue escrito originalmente para una versión de desarrollo ya obsoleta de FreeCAD. A partir de abril de 2016 estas características han sido integradas en la versión de pre-desarrollo 0.17 disponibleaquí.Tenga en cuenta que esta versión de FreeCAD está todavía en una fase temprana de desarrollo. Además, este tutorial puede necesitar ser actualizado. Si desea participar en su revisión y actualización, por favor, envíe un mensaje a la sección Wiki delforo.
:::
![](/images/HolderTop2-19.jpg)

Tutorial de soporte de rodamiento - Soporte de rodamiento terminado (arriba)
...
Puedes encontrar mi versión de la parte creada en este tutorial [[aquí](http://ubuntuone.com/39PTZ3Y3LUnmZzpZQPcJT4)] *El archivo ya no está disponible, se proporcionará uno nuevo en una fecha posterior*.
...
El soporte será un molde de arena con un espesor mínimo de pared de 5 mm, un ángulo de tiro de 2 grados, y un radio mínimo de filete de 3 mm.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Bearingholder_Tutorial_II/es&oldid=894401>"