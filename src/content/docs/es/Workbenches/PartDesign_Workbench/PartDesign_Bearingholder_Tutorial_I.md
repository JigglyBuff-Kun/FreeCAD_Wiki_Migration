---
title: PartDesign Soporte de rodamiento Tutorial I
---
:::caution
...
Esta es la primera parte del tutorial. Utilizará lo que podría llamarse el flujo de trabajo de "un solo cuerpo", usando la parte superior (más simple) del soporte como ejemplo.

Obviamente, para seguir este tutorial debes activar la mesa de trabajo de PartDesign.

Puedes encontrar mi versión de la parte creada por este tutorial [[aquí](http://ubuntuone.com/5gok0J4dye3Fo4BKWMGWVa)]. *El archivo ya no está disponible, se proporcionará uno nuevo más adelante*.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Bearingholder_Tutorial_I/es&oldid=1075238>"