---
title: Línea PartDesign
---
|  |
| --- |
| Línea PartDesign |
| Ubicación en el Menú |
| Part Design → Crear una línea de referencia |
| Entornos de trabajo |
...
| 0.17 |
| Ver también |
| [Punto PartDesign](/PartDesign_Point/es "PartDesign Point/es"), [Plano PartDesign](/PartDesign_Plane/es "PartDesign Plane/es") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Line/es&oldid=1460139>"