...
| Sketch → Geometrías de croquis → Alternar geometría de construcción |
| Entornos de trabajo |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ToggleConstruction/es&oldid=1414833>"