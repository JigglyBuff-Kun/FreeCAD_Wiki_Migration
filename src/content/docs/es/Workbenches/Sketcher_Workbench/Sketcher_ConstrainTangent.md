---
title: Croquizador RestringirTangente
---
|  |
| --- |
| Croquizador RestringirTangent |
| Ubicación en el Menú |
| Croquis → Restricciones Croquizador → Restringir Tangent |
| Entornos de trabajo |
...
| - |
| Ver también |
| [Restriccion Punto sobre objeto](/Sketcher_ConstrainPointOnObject/es "Sketcher ConstrainPointOnObject/es") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainTangent/es&oldid=1437887>"