...
| - |
| Ver también |
| [Restricción de bloqueo](/Sketcher_ConstrainLock/es "Sketcher ConstrainLock/es"), [Punto en objeto](/Sketcher_ConstrainPointOnObject/es "Sketcher ConstrainPointOnObject/es") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainCoincident/es&oldid=1404859>"