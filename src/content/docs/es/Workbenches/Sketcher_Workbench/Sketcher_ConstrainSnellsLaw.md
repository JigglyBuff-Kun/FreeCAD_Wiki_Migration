---
title: Restricción de refracción (Ley de Snell)
---
|  |
| --- |
| Restricción de refracción (Ley de Snell) |
| Ubicación en el Menú |
| Sketch → Restricciones de croquis → Restricción de refracción (Ley de Snell) |
| Entornos de trabajo |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_ConstrainSnellsLaw/es&oldid=1413852>"