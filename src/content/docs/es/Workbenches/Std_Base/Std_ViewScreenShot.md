...
| [Herramientas](/Std_Tools_Menu/es "Std Tools Menu/es") -> Guardar imagen... |
| Entornos de trabajo |
| Todos |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_ViewScreenShot/es&oldid=1463897>"