...
Así que si eres lo suficientemente audaz, echa un vistazo al módulo [Unit Test](https://github.com/FreeCAD/FreeCAD/blob/master/src/Mod/Mesh/App/MeshTestsApp.py).

Ver también: [Interfaz de programación de aplicaciones Malla](/Mesh_API "Mesh API").

[Inicio](#top)

Retrieved from "<http://wiki.freecad.org/index.php?title=Mesh_Scripting/es&oldid=1042679>"