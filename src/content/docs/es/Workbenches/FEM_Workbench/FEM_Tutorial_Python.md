...
Este ejemplo pretende mostrar cómo Python realiza un simple Análisis de elementos finitos (FEA) en FreeCADs [FEM Workbench](/FEM_Workbench "FEM Workbench"). El modelo de [FEM\_CalculiX\_Cantilever\_3D](/FEM_CalculiX_Cantilever_3D "FEM CalculiX Cantilever 3D") se tomará para este ejemplo.
...
* Un módulo de configuración FEM. Marque [FEM\_CalculiX\_Cantilever\_3D](/FEM_CalculiX_Cantilever_3D "FEM CalculiX Cantilever 3D")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_Tutorial_Python/es&oldid=1251685>"