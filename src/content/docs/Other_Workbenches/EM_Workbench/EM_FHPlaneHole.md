...
- Data**X**: the X coordinate of the FHPlaneHole
- Data**Y**: the Y coordinate of the FHPlaneHole
- Data**Z**: the Z coordinate of the FHPlaneHole
- Data**Length**: the Rectangular hole length (along x from FHPlaneHole base point)
- Data**Width**: the Rectangular hole width (along y from FHPlaneHole base point)
- Data**Radius**: the Circular hole radius
- Data**Type**: the type of FastHenry plane hole. Can be "Point", "Rect" or "Circle".
...
Retrieved from "<http://wiki.freecad.org/index.php?title=EM_FHPlaneHole/en&oldid=1078811>"
