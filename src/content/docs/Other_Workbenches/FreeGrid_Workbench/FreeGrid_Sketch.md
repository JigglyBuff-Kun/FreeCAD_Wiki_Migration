...
2. There are several ways to invoke the tool:
   - Press the ![](/src/assets/images/FreeGrid_Sketch.svg) [Sketch](/FreeGrid_Sketch "FreeGrid Sketch") button.
   - Select the **FreeGrid → ![](/src/assets/images/FreeGrid_Sketch.svg) Sketch** option from the menu.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FreeGrid_Sketch/en&oldid=1507967>"
