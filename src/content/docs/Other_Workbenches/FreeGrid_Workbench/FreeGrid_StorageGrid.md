...
1. There are several ways to invoke the tool:
   - Press the ![](/src/assets/images/FreeGrid_StorageGrid.svg) [Storage grid](/FreeGrid_StorageGrid "FreeGrid StorageGrid") button.
   - Select the **FreeGrid → ![](/src/assets/images/FreeGrid_StorageGrid.svg) Storage grid** option from the menu.
