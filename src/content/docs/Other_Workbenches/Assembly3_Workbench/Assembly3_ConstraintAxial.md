...
Assuming the first object is already locked in place by the ![](/src/assets/images/Assembly_ConstraintLock.svg) [Lock constraint](/Assembly3_ConstraintLock "Assembly3 ConstraintLock") then the following objects are moved to positions where the z-axes are collinear .
...
3. Activate the ![](/src/assets/images/Assembly_ConstraintAxial.svg) **Assembly3 ConstraintAxial** command using:
   - The ![](/src/assets/images/Assembly_ConstraintAxial.svg) [Create "AxialAlignment" constraint](/Assembly3_ConstraintAxial "Assembly3 ConstraintAxial") button.
...
![](/src/assets/images/Assembly3_ConstraintAxial-01.png) ![](/src/assets/images/Button_right.svg)
![](/src/assets/images/Assembly3_ConstraintAxial-02.png) ![](/src/assets/images/Button_right.svg)
![](/src/assets/images/Assembly3_ConstraintAxial-03.png)
