...
![](/src/assets/images/OSE_Piping_workbench_screenshot.png)
...
To create a pipe, click ![](/src/assets/images/OSE_Piping_create_pipe_icon.svg) in OSE piping workbench. Select pipe dimensions and click "OK".

![](/src/assets/images/OSE_Pining_create_pipe_screenshot.png)
...
To create an elbow, click ![](/src/assets/images/OSE_Piping_create_elbow_icon.svg).

![](/src/assets/images/OSE_Piping_create_elbow_screenshot.png)

![](/src/assets/images/OSE_Piping_elbow_CAD_screenshot.png)

To add new elbows, adjust **elbow.csv** file.

# Sweep Elbow

A sweep elbow is a special elbow with larger radius of the bent part. It is described by outer pipe diameter POD, pipe thickness **PThk**, **G**, **H**, and **M**. To create a sweep elbow, click ![](/src/assets/images/OSE_Piping_create_sweep_elbow_icon.svg).

![](/src/assets/images/OSE_Piping_create_sweep_elbow_screenshot.png)

![](/src/assets/images/OSE_Piping_sweep_elbow_CAD_screenshot.png)
