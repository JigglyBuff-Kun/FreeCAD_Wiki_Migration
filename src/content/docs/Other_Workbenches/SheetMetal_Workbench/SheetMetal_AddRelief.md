...
The ![](/images/SheetMetal_AddRelief.svg) [SheetMetal AddRelief](/SheetMetal_AddRelief "SheetMetal AddRelief") command creates corner reliefs, cutouts, at the points where three sections (base plate/walls/flanges) of a sheet metal object meet. Without these reliefs the object will not be unfoldable.
...
2. There are several ways to invoke the command:
   - Press the ![](/images/SheetMetal_AddRelief.svg) [Make Relief](/SheetMetal_AddRelief "SheetMetal AddRelief") button.
   - Select the **SheetMetal → ![](/images/SheetMetal_AddRelief.svg) Make Relief** option from the menu.
   - Right-click in the [Tree view](/Tree_view "Tree view") or the [3D view](/3D_view "3D view") and select the **Sheet Metal → ![](/images/SheetMetal_AddRelief.svg) Make Relief** option from the context menu.
