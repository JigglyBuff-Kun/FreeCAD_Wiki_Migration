...
The ![](/images/Sheetmetal_workbench_icon.svg) [SheetMetal workbench](/SheetMetal_Workbench "SheetMetal Workbench") (an [external workbench](/External_workbenches "External workbenches") available through the [Addon Manager](/Std_AddonMgr "Std AddonMgr")) has grown quite powerful and merits to be appropriately documented.
...
![](/images/PartDesign_Pocket.svg) [PartDesign Pocket](/PartDesign_Pocket "PartDesign Pocket"),
![](/images/PartDesign_Hole.svg) [PartDesign Hole](/PartDesign_Hole "PartDesign Hole"),
![](/images/SheetMetal_Unfold.svg) [Unfold](/SheetMetal_Unfold "SheetMetal Unfold").

### Hinge step by step

1. Create a profile (a line and a tangent arc), preferably using the ![](/images/Workbench_Sketcher.svg) [Sketcher Workbench](/Sketcher_Workbench "Sketcher Workbench").
2. Activate the ![](/images/SheetMetal_AddBase.svg) [Make Base Wall](/SheetMetal_AddBase "SheetMetal AddBase") command to create a BaseBend object.
...
4. Create a cut-out contour with the ![](/images/Workbench_Sketcher.svg) [Sketcher Workbench](/Sketcher_Workbench "Sketcher Workbench").
5. Use the ![](/images/PartDesign_Pocket.svg) [PartDesign Pocket](/PartDesign_Pocket "PartDesign Pocket") command to cut off one half of the Round bit.
6. Create a hole pattern with the ![](/images/Workbench_Sketcher.svg) [Sketcher Workbench](/Sketcher_Workbench "Sketcher Workbench").
7. Use the ![](/images/PartDesign_Hole.svg) [PartDesign Hole](/PartDesign_Hole "PartDesign Hole") command. Avoid the countersink and counterbore options to keep the body unfoldable.
8. Activate the ![](/images/SheetMetal_Unfold.svg) [Unfold](/SheetMetal_Unfold "SheetMetal Unfold") command to get an Unfold object.
9. Done!
...
Workflow Paper Clip:
![](/images/SheetMetal_AddBase.svg) [Make Base Wall](/SheetMetal_AddBase "SheetMetal AddBase"),
![](/images/SheetMetal_SketchOnSheet.svg) [Sketch on Sheet](/SheetMetal_SketchOnSheet "SheetMetal SketchOnSheet"),
clone, flip and fuse,
![](/images/SheetMetal_Unfold.svg) [Unfold](/SheetMetal_Unfold "SheetMetal Unfold").

### Paper clip step by step

1. Create a profile, preferably using the ![](/images/Workbench_Sketcher.svg) [Sketcher Workbench](/Sketcher_Workbench "Sketcher Workbench") on the XZ plane.  
   ![Profile sketch](/images/SheetMetal_Example-02e.png)
2. Activate the ![](/images/SheetMetal_AddBase.svg) [Make Base Wall](/SheetMetal_AddBase "SheetMetal AddBase") command to create a BaseBend object.
3. Edit the BaseBend object's parameters in the properties panel:  
    ![BaseBend object and highlighted sketch](/images/SheetMetal_Example-02f.png)
   - Set Data**Mid Plane** to `true`to let the profile extend symmetrically to both sides of the sketch plane.
   - Set Data**length** to 32 mm.
   - Set Data**radius** to 2 mm.
   - Set Data**thickness** to 0.3 mm.
4. Select the face between the round sections and activate the ![](/images/Workbench_Sketcher.svg) [Sketcher Workbench](/Sketcher_Workbench "Sketcher Workbench").  
   ![Face to support the sketch](/images/SheetMetal_Example-02g.png)
5. To hide the curled part use the ![](/images/Sketcher_ViewSection.svg) [Sketcher View section](/Sketcher_ViewSection "Sketcher ViewSection") command.
6. Create the cut-out contour.  
   ![Cut-out contour](/images/SheetMetal_Example-02h.png) ![Cut-out contour slightly touching the selected face](/images/SheetMetal_Example-02i.png)
7. Finish the sketch using the ![](/images/Sketcher_LeaveSketch.svg) [Sketcher Leave sketch](/Sketcher_LeaveSketch "Sketcher LeaveSketch") command.
8. Select the face again and add the Cut-out sketch to the selection.  
   ![Face and sketch selected](/images/SheetMetal_Example-02j.png)
9. Use the ![](/images/SheetMetal_SketchOnSheet.svg) [Sketch on Sheet](/SheetMetal_SketchOnSheet "SheetMetal SketchOnSheet") command to cut around the curled bit.  
   ![Finished first half](/images/SheetMetal_Example-02b.png)
10. One side is finished. We now need to find a way to mirror the body.

**Potential mirror options:**

- The ![](/images/PartDesign_Mirrored.svg) [PartDesign Mirrored](/PartDesign_Mirrored "PartDesign Mirrored") command fails because it cannot handle SheetMetal features for some reason. So that does not work.
- The ![](/images/Part_Mirror.svg) [Part Mirror](/Part_Mirror "Part Mirror") command creates a mirrored part, but this is no longer unfoldable. So that does not work either.
...
2. Use the ![](/images/PartDesign_Clone.svg) [PartDesign Clone](/PartDesign_Clone "PartDesign Clone") command. It adds a new body containing a clone object.  
   ...
   ![Cloned half](/images/SheetMetal_Example-02b.png) ![](/images/Button_right.svg) ![Flipped cloned half](/images/SheetMetal_Example-02l.png)
3. With the body still active, use the ![](/images/PartDesign_Boolean.svg) [PartDesign Boolean operation](/PartDesign_Boolean "PartDesign Boolean") command to add the body of the clone and fuse both halves.  
   ![Fused halves](/images/SheetMetal_Example-02c.png)
4. Activate the ![](/images/SheetMetal_Unfold.svg) [Unfold](/SheetMetal_Unfold "SheetMetal Unfold") command to get an Unfold object.  
   ![Clip and Unfold object](/images/SheetMetal_Example-02m.png) ![Unfold object](/images/SheetMetal_Example-02d.png)
5. Done!

**Mirror using a link object:**

1. Select the body from the tree view.
2. Use the ![](/images/Std_LinkMake.svg) [Make link](/Std_LinkMake "Std LinkMake") command. This adds a new link object.
...
6. Activate the ![](/images/Part_Fuse.svg) [Part Fuse](/Part_Fuse "Part Fuse") command to fuse both halves.  
   ![Fused halves](/images/SheetMetal_Example-02c.png)
7. Activate the ![](/images/SheetMetal_Unfold.svg) [Unfold](/SheetMetal_Unfold "SheetMetal Unfold") command to get an Unfold object.  
   ![Clip and Unfold object](/images/SheetMetal_Example-02m.png) ![Unfold object](/images/SheetMetal_Example-02d.png)
8. Done!
...
![](/images/SheetMetal_AddBase.svg) [Make Base Wall](/SheetMetal_AddBase "SheetMetal AddBase"),
![](/images/PartDesign_Hole.svg) [PartDesign Hole](/PartDesign_Hole "PartDesign Hole"),
![](/images/PartDesign_Fillet.svg) [PartDesign Fillet](/PartDesign_Fillet "PartDesign Fillet"),
![](/images/SheetMetal_Unfold.svg) [Unfold](/SheetMetal_Unfold "SheetMetal Unfold").
...
Workflow Hex Bowl:
![](/images/SheetMetal_AddBase.svg) [Make Base Wall](/SheetMetal_AddBase "SheetMetal AddBase"),
![](/images/SheetMetal_AddWall.svg) [Make Wall](/SheetMetal_AddWall "SheetMetal AddWall"),
6x ![](/images/SheetMetal_AddCornerRelief.svg) [Add Corner Relief](/SheetMetal_AddCornerRelief "SheetMetal AddCornerRelief"),
![](/images/SheetMetal_Unfold.svg) [Unfold](/SheetMetal_Unfold "SheetMetal Unfold").
...
![](/images/SheetMetal_AddBase.svg) [Make Base Wall](/SheetMetal_AddBase "SheetMetal AddBase"),
![](/images/PartDesign_Pocket.svg) [PartDesign Pocket](/PartDesign_Pocket "PartDesign Pocket"),
3x ![](/images/SheetMetal_AddWall.svg) [Make Wall](/SheetMetal_AddWall "SheetMetal AddWall"),
![](/images/SheetMetal_Unfold.svg) [Unfold](/SheetMetal_Unfold "SheetMetal Unfold").
...
![](/images/SheetMetal_AddBase.svg) [Make Base Wall](/SheetMetal_AddBase "SheetMetal AddBase"),
![](/images/SheetMetal_AddWall.svg) [Make Wall](/SheetMetal_AddWall "SheetMetal AddWall"),
![](/images/SheetMetal_Extrude.svg) [Extend Face](/SheetMetal_Extrude "SheetMetal Extrude"),
![](/images/SheetMetal_Extrude.svg) [Extend Face](/SheetMetal_Extrude "SheetMetal Extrude"),
![](/images/SheetMetal_Unfold.svg) [Unfold](/SheetMetal_Unfold "SheetMetal Unfold").
