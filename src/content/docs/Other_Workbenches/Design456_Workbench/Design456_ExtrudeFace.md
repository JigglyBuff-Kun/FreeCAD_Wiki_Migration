...
| Menu location                                           |
| Design456_Tools → 3DTools → Extrude Face                |
| Workbenches                                             |
...
3. Press the ![](/images/Design456_ExtrudeFace.svg) Extrude Face command. A copy of the face will be created and the command ask you for the length of the extrusion. Later the extruded face will be created on the same direction of the face.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Design456_ExtrudeFace&oldid=1219101>"
