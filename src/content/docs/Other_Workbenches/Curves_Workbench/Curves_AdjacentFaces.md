...
|                                                |
| ---------------------------------------------- |
| Curves AdjacentFaces                           |
| Menu location                                  |
| Misc. → Select Adjacent faces                  |
| Workbenches                                    |
...
- This tool only extends the selection, it doesn't create any object.

Retrieved from "<http://wiki.freecad.org/index.php?title=Curves_AdjacentFaces&oldid=1570899>"
