...
When you press Accept button, a new Ship instance named **Ship** is created at _Tags & Attributes_ dialog. The geometry is not needed anymore, so feel free to hide or remove it.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Ship_CreateShip/en&oldid=1133097>"
