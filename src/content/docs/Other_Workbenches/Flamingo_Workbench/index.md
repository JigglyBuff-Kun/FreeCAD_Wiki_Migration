...
: "_Flamingo_" workbench is dedicated for versions using Python >2.7 syntax and Qt4 toolkit.

: "_Dodo_" workbench is for Python >3.6 and Qt5.
...
_Only in **dodo**: the above piping components can be inserted also wfrom the dedicated pie-menu._
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Flamingo_Workbench/en&oldid=884327>"
