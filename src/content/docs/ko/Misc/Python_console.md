...
*For absolute beginners, see:* [Introduction to Python](/Introduction_to_Python "Introduction to Python"), and [Python scripting tutorial](/Python_scripting_tutorial "Python scripting tutorial").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Python_console/ko&oldid=1461237>"