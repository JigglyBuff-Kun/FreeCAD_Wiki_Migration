...
Another common feature of FreeCAD objects is their [placement](/Placement "Placement"). Each object has a 데이터**Placement** property, which contains the 데이터**Base** (position) and 데이터**Rotation** (orientation) of the object. It is easy to manipulate, for example to move our object:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Python_scripting_tutorial/ko&oldid=1427735>"