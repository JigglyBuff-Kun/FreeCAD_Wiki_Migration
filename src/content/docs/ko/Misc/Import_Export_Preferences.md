---
title: 가져오기 내보내기 환경 설정(Import Export Preferences)
---
## 소개

FreeCAD는 다양한 파일 형식을 가져오고 내보낼 수 있습니다. 일부 형식의 경우 전용 기본 설정이 있습니다. 메뉴에서 **Edit → Preferences...**를 선택한 다음 **Import-Export**를 선택합니다.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Import_Export_Preferences/ko&oldid=1521251>"