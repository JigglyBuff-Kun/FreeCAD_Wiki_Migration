...
FreeCAD history began in January 2001 when [Jürgen Riegel](/User:Jriegel "User:Jriegel") started working on the Cas.CADE project, a commercial software development framework including a [geometric modeling kernel](/Glossary#Geometric_modeling_kernel "Glossary") (or CAD kernel) that in 2000 had been released under an open source license and renamed as [Open Cascade](/Glossary#Open_CASCADE "Glossary"). This made the realization of an open source 3D CAD program possible, as having to program a CAD kernel from scratch would have required a huge amount of work.
...
이 프로젝트는 2003 년 [OpenCascade 포럼](http://www.opencascade.org/org/forum)에 일반 대중에게 발표되었습니다. Jürgen의 말에 따르면:
The project was announced to the general public on the [OpenCascade Forum](http://www.opencascade.org/org/forum) in 2003. Again, in Jürgen's words:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=History/ko&oldid=1508933>"