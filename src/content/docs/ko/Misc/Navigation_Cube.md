...
**항해 입방체**는 현재 [3차원 보기](/3D_view/ko "3D view/ko")의 카메라 방향에 대한 시각적 정보를 제공하며 이를 변경하는 데 사용할 수 있습니다. 기본적으로 표시되며 보기의 오른쪽 상단에 위치합니다.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Navigation_Cube/ko&oldid=1493134>"