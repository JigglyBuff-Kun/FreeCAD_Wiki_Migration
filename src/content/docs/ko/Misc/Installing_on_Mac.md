...
title: Mac 시스템에 설치
---
macOS 에서는 프로그램 파일 폴더에 끌어넣기 할 수 있는 \*.dmg 패키지로 부터 프리캐드를 설치 할 수 있습니다. [Download](/Download "Download") 페이지를 읽어 보세요.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Installing_on_Mac/ko&oldid=1484272>"