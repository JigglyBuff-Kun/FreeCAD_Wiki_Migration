...
이 페이지에서는 FreeCAD 사용자와 개발자가 만든 동영상 자습서를 제공합니다. 더 많은 링크를 보려면 [자습서 및 비디오](https://forum.freecadweb.org/viewforum.php?f=36) 하위 포럼을 방문하세요. 유용한 동영상 자습서들은 [YouTube](https://YouTube.com)에 많이 있습니다.
...
위키 문서 및 자습서 작성에 기여하고 싶다면 [FreeCAD 돕기](/Help_FreeCAD/ko "Help FreeCAD/ko"), [위키페이지](/WikiPages/ko "WikiPages/ko")의 일반 위키 지침을 참조하고 [Tutorial guidelines](/Tutorial_guidelines "Tutorial guidelines")(페이지 번역 버튼 안보임)을 따르세요. .
...
이 주제를 다루는 동영상이 많이 있으므로 [제품 설계 동영상 자습서](/Video_tutorials_for_product_design/ko "Video tutorials for product design/ko")를 방문하세요
...
* [FreeCAD TechDraw 작업대 소개](https://www.youtube.com/watch?v=TnYMfpdNQoo) Glasson Design Studio 제작. 이는 특히 목공예가를 대상으로 하지만 일반 고체에도 사용할 수 있습니다.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Video_tutorials/ko&oldid=1494797>"