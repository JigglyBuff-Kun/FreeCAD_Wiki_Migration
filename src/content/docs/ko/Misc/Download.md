...
프리캐드 0.21.1 버전이 2023-09-01 에 출시 되었습니다. 새로운 성능에 대해서는, [개선 기록](/Release_notes_0.21 "Release notes 0.21") 를 눌러 보세요.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Download/ko&oldid=1509144>"