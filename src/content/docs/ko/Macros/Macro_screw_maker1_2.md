...
| Description |
| Creates a screw, bolt... with or without thread, according to ISO standards.  Macro version: 2.3.1 Last modified: 2018-10-22 FreeCAD version: All Download: [ToolBar Icon](https://wiki.freecad.org/images/0/00/Macro_screw_maker1_2.png) Author: Ulrich Brammer |
| Author |
...
이 매크로는 ISO표준에 따라 나사산이 있거나 없는 나사를 만듭니다.
...
* ![Interface of screw_maker and a few types of screws.](/images/Macro_screw_maker_02.png)
  ...
  Interface of **screw\_maker** and a few types of screws.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_screw_maker1_2/ko&oldid=1555881>"