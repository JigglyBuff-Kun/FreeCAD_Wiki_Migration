---
title: Unfold Box 매크로
---
|  |
| --- |
| Macro Unfold Box |
| Description |
| 이 매크로를 이용하면 어떤 모양의 상자든지 표면을 펼쳐서 평면에 그릴 수 있습니다.  Macro version: 1.1 Last modified: 2022-07-28 Download: [ToolBar Icon](https://www.freecadweb.org/wiki/images/e/e4/Macro_Unfold_Box.png) Author: Hervé B., heda |
| Author |
...
토론장 주제: [Macro for unfolding box surfaces](http://forum.freecadweb.org/viewtopic.php?f=17&t=4587).
...
1. 예를 들어 [부품 작업대의 로프트](/index.php?title=Part_Loft/ko&action=edit&redlink=1 "Part Loft/ko (page does not exist)") 도구로 만든 상자를 선택하세요.
2. 분할된 면으로 [도면 다운그레이드](/index.php?title=Draft_Downgrade/ko&action=edit&redlink=1 "Draft Downgrade/ko (page does not exist)")를 합니다.
3. 분할된 면들을 선택합니다.
4. 매크로를 실행합니다.
...
4. [도면 이동](/index.php?title=Draft_Move/ko&action=edit&redlink=1 "Draft Move/ko (page does not exist)")과 [도면 회전](/index.php?title=Draft_Rotate/ko&action=edit&redlink=1 "Draft Rotate/ko (page does not exist)")을 사용하여 펼쳐진 복제된 면을 다시 배치합니다(포착기능을 사용할 경우 면당 몇 번의 클릭).
...
도구모음에 표시되는 아이콘 ![](/images/Macro_Unfold_Box.png)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Macro_Unfold_Box/ko&oldid=1545103>"