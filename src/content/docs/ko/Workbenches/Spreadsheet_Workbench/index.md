...
![](/images/Workbench_Spreadsheet.svg) **스프레드시트 작업대**를 사용하면 스프레드시트를 만들고 편집할 수 있으며, 스프레드시트의 데이터를 모델의 매개변수로 사용할 수 있으며, 모델에서 검색한 데이터로 스프레드시트를 채우고 계산을 수행한 후 LibreOffice 또는 Microsoft Excel과 같은 다른 스프레드시트 응용프로그램으로 데이터를 내보낼 수 있습니다.

![](/images/Spreadsheet_screenshot.jpg)

텍스트와 수량으로 채워진 특정 셀이 있는 스프레드시트

## 도구

- ![](/images/Spreadsheet_CreateSheet.svg) [시트 생성](/Spreadsheet_CreateSheet "Spreadsheet CreateSheet"): 새 스프레드시트를 만든다.
...
- Alias: Define an [alias](/Spreadsheet_SetAlias "Spreadsheet SetAlias") for this cell. This alias can be used in cell formulas and also in general [expressions](/Expressions "Expressions"); see section [Spreadsheet data in expressions](#Spreadsheet_data_in_expressions) for more information.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Spreadsheet_Workbench/ko&oldid=1506726>"
