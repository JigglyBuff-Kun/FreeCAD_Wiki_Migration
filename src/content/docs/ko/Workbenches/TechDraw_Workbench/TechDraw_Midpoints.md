...
| 0.19                                                                                                                                           |
| See also                                                                                                                                       |
| [기술도면 꾸밈점](/TechDraw_CosmeticVertex/ko "TechDraw CosmeticVertex/ko"), [기술도면 사분점](/TechDraw_Quadrants/ko "TechDraw Quadrants/ko") |
|                                                                                                                                                |

## 설명

**기술도면 중간점** 도구는 선택한 하나 이상의 모서리 중간점에 [꾸밈점](/TechDraw_CosmeticVertex/ko "TechDraw CosmeticVertex/ko")을 추가합니다.
...
1. 보기에서 하나 이상의 모서리를 선택합니다.
2. 도구를 호출하는 방법은 여러 가지가 있습니다.
   - ![](/images/TechDraw_Midpoints.svg) 중간점 추가 버튼을 누르세요.
   * 메뉴에서 **기술도면→ 점 추가 → ![](/images/TechDraw_Midpoints.svg) 중간점 추가**를 선택하세요.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=TechDraw_Midpoints/ko&oldid=1567360>"
