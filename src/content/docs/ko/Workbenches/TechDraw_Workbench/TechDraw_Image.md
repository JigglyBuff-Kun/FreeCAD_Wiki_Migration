...
* 데이터**Image File** (`File`): The file containing this bitmap.
* 데이터**Image Included** (`FileIncluded`): Embedded image file. System use only.
* 데이터**Width** (`Float`): The width of the cropped image in mm. Only used if 보기**Crop** is `true`.
* 데이터**Height** (`Float`): The height of the cropped image in mm. Idem.

### View

Image

* 보기**Crop** (`Bool`): Crop the image to 데이터**Width** x 데이터**Height**.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=TechDraw_Image/ko&oldid=1563105>"