...
5. Objects can also be added and removed by editing the 데이터**Group** property of the Group.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_Group/ko&oldid=1560709>"