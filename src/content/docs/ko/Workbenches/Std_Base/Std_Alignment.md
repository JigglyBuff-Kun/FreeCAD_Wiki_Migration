...
| - |
| 참조 |
| [표준 위치 설정](/Std_Placement/ko "Std Placement/ko") |
|  |
...
2. Ctrl 키를 누른 채로 배치를 변경하려는 개체를 선택합니다.
3. 메뉴에서 **편집 → 정렬...** 옵션을 선택합니다.
4. 새 창이 [주 보기 영역](/Main_view_area/ko "Main view area/ko")에 나타납니다. 이 창은 두 개의 보기로 구성되어 있습니다. 왼쪽의 보기에는 움직일 개체가 보이며 오른쪽 보기에는 고정된 개체가 보입니다.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Std_Alignment/ko&oldid=1449024>"