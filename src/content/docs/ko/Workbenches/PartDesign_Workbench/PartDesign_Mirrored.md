...
| - |
| See also |
| [다중복사](/PartDesign_MultiTransform/ko "PartDesign MultiTransform/ko") |
|  |

## 설명

부품설계 작업대에서![](/images/PartDesign_Mirrored.svg)**대칭복사** 도구는 하나 이상의 도형특징을 대칭복사 합니다.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PartDesign_Mirrored/ko&oldid=1485298>"