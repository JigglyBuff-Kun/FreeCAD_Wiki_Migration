...
![](/images/Workbench_CAM.svg) **CAM 작업대** 는 프리캐드 3D 모델을 [CNC machines](https://en.wikipedia.org/wiki/CNC_router) 로 만들 때 입력하는 기계의 동작 명령들을 구성하는 환경입니다. 그 명령들이 밀링머신, 선반,레이져 커터 등의 CNC 기계를 통해 3D 실물을 생산 합니다. 명령들은 전문가용 [G-code](https://en.wikipedia.org/wiki/G-code) 형식으로 되어 있습니다. 기본적 구성으로 된 예가 [general CNC lathe tool path sequence simulation example](https://www.ange-softs.com/SIMULCNCHTML/index.html) 에 있습니다.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=CAM_Workbench/ko&oldid=1494602>"
