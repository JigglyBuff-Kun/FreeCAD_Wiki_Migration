...
Цей підручник спрямований на надання вам основ роботи з **Робочим Простором Архітектора (Arch Workbench)** в подальшому **[Arch модуль](/Arch_Workbench/uk "Arch Workbench/uk")**. Я буду намагатися зробити це якнайпростіше, щоб вам не потрібен був досвід роботи з FreeCAD, але досвід роботи з 3D або програмами що використовують технологію [BIM](http://uk.wikipedia.org/wiki/Building_Information_Modeling) буде корисний. У будь-якому випадку, ви повинні бути готові самі шукати щоб отримати додаткову інформацію стосовно того, як працює FreeCAD, за допомогою  [Вікі документації FreeCAD](/Main_Page/uk "Main Page/uk"). Ви маєте прочитати сторінку  [Розпочати](/Getting_started/uk "Getting started/uk"), якщо у вас немає досвіду роботи з FreeCAD. Також перевірте наш розділ  [Підручники](/Tutorials "Tutorials"), а на каналі [YouTube](http://www.youtube.com/results?search_query=freecad) ви знайдете ще більше уроків стосовно FreeCAD.
...
At the time I'm writing this, though, the [Arch Workbench](/Arch_Workbench "Arch Workbench"), as the rest of FreeCAD, suffers some limitations. Most are being worked on, though, and will disappear in the future.
...
The [Arch Workbench](/Arch_Workbench "Arch Workbench") is mainly made for two kinds of workflows:
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_tutorial/uk&oldid=1433559>"