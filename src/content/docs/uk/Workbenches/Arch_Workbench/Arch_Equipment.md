...
| - |
| Дивись також |
| [3 views from mesh](/Arch_3Views "Arch 3Views") |
|  |
...
As of version 0.17, equipment objects also have a Дані**HiRes** property where a [Mesh](/Mesh_Workbench "Mesh Workbench") object can be attached. Equipment objects can then be made to display that mesh in the 3D view instead of their shape, which allows to use any high-resolution mesh objects such as detailed pieces of furniture commonly found on websites.
...
* Дані**Model**: A description of the model of this equipment.
* Дані**Url**: An URL of the product page where more information about this equipment can be found.
* Дані**Mesh**: A [Mesh](/Mesh_Workbench "Mesh Workbench") representation to use for this equipment. When set, the **Mesh** display mode becomes available.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Equipment/uk&oldid=1539663>"