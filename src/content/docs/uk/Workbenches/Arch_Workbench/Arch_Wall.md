...
* Walls can be made to display blocks, instead of one single solid, by turning their Дані**Make Blocks** property on. The size and offset of blocks can be configured with different properties, and the amount of blocks is automatically calculated.
...
* Дані**Block Height**: The height of each block.
* Дані**Block Length**: The length of each block.
* Дані**Count Broken**: The number of broken blocks (read-only).
* Дані**Count Entire**: The number of entire blocks (read-only).
* Дані**Joint**: The size of the joints, the empty space, between blocks.
* Дані**Make Blocks**: Enables block generation.
* Дані**Offset First**: The horizontal offset of the first and every uneven line of blocks.
* Дані**Offset Second**: The horizontal offset of the second and every even line of blocks.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Wall/uk&oldid=1548502>"