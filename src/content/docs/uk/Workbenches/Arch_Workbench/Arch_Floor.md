...
| - |
| Дивись також |
| [Arch Building](/Arch_Building/uk "Arch Building/uk"), [Arch Site](/Arch_Site/uk "Arch Site/uk") |
|  |
...
An Arch Floor object shares all properties from an [Arch BuildingPart](/Arch_BuildingPart "Arch BuildingPart"), with the Дані**Ifc Type** set to `"Building Storey"`.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Floor/uk&oldid=1537460>"