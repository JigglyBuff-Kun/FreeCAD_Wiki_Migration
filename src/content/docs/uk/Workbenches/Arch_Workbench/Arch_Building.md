...
| - |
| Дивись також |
| [Arch Floor](/Arch_Floor/uk "Arch Floor/uk"), [Arch Site](/Arch_Site/uk "Arch Site/uk") |
|  |
...
* Starting from FreeCAD version 0.18, the Building object is actually a [BuildingPart](/Arch_BuildingPart "Arch BuildingPart") with its Дані**IFC Type** property set to "Building". You can convert any BuildingPart to a Building simply by changing its IFC Type.
...
* Дані**Building Type**: The type of this building, to choose from a list
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Building/uk&oldid=1432807>"