...
Робочий простір Arch вміщює всі інструменти з [Робочого простору Draft](/Draft_Workbench/uk "Draft Workbench/uk").
...
- [IFC](/Arch_IFC "Arch IFC") : Industry foundation Classes (тільки імпорт)
- [DAE](/Arch_DAE "Arch DAE") : [[Меш](http://uk.wikipedia.org/wiki/Полігональна_сітка%7C)] в форматі Collada
- [OBJ](/Arch_OBJ "Arch OBJ") : [[|Меш](http://uk.wikipedia.org/wiki/Полігональна_сітка)] в форматі Obj (тільки експорт)

## API

Архітектурний модуль Arch може бути використаний в сценаріях на мові Python або [макросах](/Macros "Macros") за допомогою функцій [Arch Python API](http://www.freecadweb.org/api/Arch.html).

## Посібники

- [Посібник Arch](/Arch_tutorial/uk "Arch tutorial/uk")
- [Посібники Arch на блозі Yorik'а](http://yorik.uncreated.net/guestblog.php?2012=180)

Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Workbench/uk&oldid=1433523>"
