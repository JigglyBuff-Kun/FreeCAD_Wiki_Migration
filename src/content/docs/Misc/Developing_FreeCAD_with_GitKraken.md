---
title: Developing FreeCAD with GitKraken
---
...
For more information on general Git usage from the command line see [Source code management](/Source_code_management "Source code management"), and the online [Pro Git](https://git-scm.com/book/en/v2) book. To compile FreeCAD see [Compiling](/Compiling "Compiling").
...
_Local_ indicates your local machine
...
_Remote_ indicates a remote repository, for example in GitHub
...
- [Developing FreeCAD with KDevelop](/Developing_FreeCAD_with_KDevelop "Developing FreeCAD with KDevelop")

Retrieved from "<http://wiki.freecad.org/index.php?title=Developing_FreeCAD_with_GitKraken/en&oldid=1119530>"
