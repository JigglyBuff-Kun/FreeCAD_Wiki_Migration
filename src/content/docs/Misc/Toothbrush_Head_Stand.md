...
- From the start-page, select ![](/images/Workbench_PartDesign.svg) _Part Design_, or create a new document and select the _Part Design_ workbench.
...
- Create a new document and select the ![](/images/Workbench_PartDesign.svg) _Part Design_ workbench.
