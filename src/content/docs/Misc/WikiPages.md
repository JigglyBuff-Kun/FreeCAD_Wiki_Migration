...
Image link
: [![Optional text that is shown when you hover the image](/src/assets/images/Draft_Wire.svg)](/Draft_Wire "Optional text that is shown when you hover the image ")
...
: ![](/src/assets/images/Draft_Wire.svg) [Draft Wire](/Draft_Wire "Draft Wire")
...
To create a screenshots you can use the options provided by your operating system, or one of these macros: ![](/src/assets/images/Snip.png) [Macro Snip](/Macro_Snip "Macro Snip") and ![](/src/assets/images/Macro_Screen_Wiki.png) [Macro Screen Wiki](/Macro_Screen_Wiki "Macro Screen Wiki").
