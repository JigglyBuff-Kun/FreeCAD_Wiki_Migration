...
**NOTE:** It's also possible to _create_ Placement objects in expressions. See the [Expressions](/Expressions#Placement "Expressions") page for details.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Placement/en&oldid=1560850>"
