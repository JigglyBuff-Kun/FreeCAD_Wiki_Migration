---
title: Example Slab Having LShape Rebars Reinforcement Mesh
---
...
![](/src/assets/images/L-Shape_Rebars_isometric_view.png)
...
: ![](/src/assets/images/L-Shape_Rebars_parallel_direction_input.png)
...
: ![](/src/assets/images/L-Shape_Rebars_cross_direction_inputs.png)
...
- Data**Hook Orientation**: It represents orintation of hook of parallel L-Shape rebar if parallel_rebar_type is LShapeRebar. It can have three values "Left", "Right","Alternate".
...
- Data**Hook Orientation**: It represents orintation of hook of corss L-Shape rebar if cross_rebar_type is LShapeRebar. It can have three values "Left", "Right","Alternate".
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Example_Slab_Having_LShape_Rebars_Reinforcement_Mesh/en&oldid=1372632>"
