...
PDF is based on the PostScript language, which is a vector-based format to describe pages. In this sense it's similar to [SVG](/SVG "SVG"), as it allows scaling a drawing to any size without losing its shape or amount of details.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=PDF/en&oldid=836658>"
