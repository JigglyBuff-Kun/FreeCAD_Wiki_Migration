...
Users can run these scripts either as a [macro](/Macros "Macros") or directly in the [Python console](/Python_console "Python console"). Please notice that many of the functions have 'Exe' or 'Execu', short for 'Execute', in their name.

These files are also mentioned in the
[Inventor Mentor tutorial](http://www-evasion.imag.fr/Membres/Francois.Faure/doc/inventorMentor/sgi_html/pr01.html) for the C language.
...
3. Generally, COIN3D doesn't provide good primitive drawings. The widget system Design456 does provide some: some basic shapes, and also some complex shapes. The arrow widget and the line widget used by the [Design456 Workbench](/Design456_Workbench "Design456 Workbench") are examples.

Retrieved from "<http://wiki.freecad.org/index.php?title=Coin3d_snippets/en&oldid=1070466>"