...
- [Developing FreeCAD with GitKraken](/Developing_FreeCAD_with_GitKraken "Developing FreeCAD with GitKraken"), a guide to use a graphical interface with Git.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Source_code_management/en&oldid=1481430>"
