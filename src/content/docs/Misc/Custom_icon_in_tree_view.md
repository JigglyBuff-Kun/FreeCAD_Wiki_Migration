...
This is an example of modifying the icon of a custom [viewprovider](/Viewprovider "Viewprovider"), which are normally added to [scripted objects](/Scripted_objects "Scripted objects").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Custom_icon_in_tree_view/en&oldid=741110>"
