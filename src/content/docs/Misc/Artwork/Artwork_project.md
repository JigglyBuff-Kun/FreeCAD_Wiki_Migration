...
**Artwork project** is a project dedicated to coming up with a new logo, icons, and pictures. Not to be confused with [Artwork](/Artwork "Artwork") page which captures the current state of the art ;) . See also [Artwork Guidelines](/Artwork_Guidelines "Artwork Guidelines") which describe the current agreed-upon rules.
...
![](/src/assets/images/Logo_proposals_2020.png)
...
[Artwork](/Artwork "Artwork") is proposed less often as there are dozens and hundreds of icons in FreeCAD. Only a few people dared to try this. The traditional artwork is done by a single man years ago. There are currently 2 proposals in progress.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Artwork_project&oldid=1189192>"
