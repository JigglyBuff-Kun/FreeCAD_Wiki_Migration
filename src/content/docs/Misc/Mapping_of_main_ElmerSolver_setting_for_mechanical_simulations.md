---
title: Mapping of main ElmerSolver setting for mechanical simulations
---
This page is dedicated to the description of the [Google Summer of Code 2017](/Google_Summer_of_Code_2017 "Google Summer of Code 2017") project idea regarding completely setting up mechanical simulations from within FreeCAD while using ElmerFEM as external solver.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Mapping_of_main_ElmerSolver_setting_for_mechanical_simulations&oldid=1189092>"