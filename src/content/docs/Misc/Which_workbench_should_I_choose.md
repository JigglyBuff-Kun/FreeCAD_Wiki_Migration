---
title: Which workbench should I choose
---
If you are new to FreeCAD, chances are high that you are wondering which [workbench](/Workbenches "Workbenches") you should start to work with. This page will help you to choose where to start.
...
FreeCAD comes with several [built-in workbenches](/Workbenches "Workbenches"), but [many more are available](/External_workbenches "External workbenches") and can easily be installed via the [addons manager](/Std_AddonMgr "Std AddonMgr").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Which_workbench_should_I_choose/en&oldid=1460890>"