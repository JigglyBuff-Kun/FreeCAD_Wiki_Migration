...
1. Starting with a blank FreeCAD project, we build our bimetal strip in the ![](/src/assets/images/Workbench_Part.svg) [Part Workbench](/Part_Workbench "Part Workbench")
2. Draw a ![](/src/assets/images/Part_Box.svg) [Cube](/Part_Box "Part Box") Solid and rename it to `aluminium`.
...
6. Select both solids (using the Shift key + mouse click) and create ![](/src/assets/images/Part_BooleanFragments.svg) [Boolean Fragments](/Part_BooleanFragments "Part BooleanFragments") from them
7. Rename these Boolean Fragments to `bimetal strip`
8. In the [Property editor](/Property_editor "Property editor"), we change the mode from View**Standard** to View**CompSolid**. (It should also work by using the [Part Compound](/Part_Compound "Part Compound") command instead of ![](/src/assets/images/Part_BooleanFragments.svg) [Boolean Fragments](/Part_BooleanFragments "Part BooleanFragments"), however, with more complex intersecting shapes, there might be trouble with the FEM analysis later. So, better get used to using Boolean Fragments in the first place.) The result should look like this:

[![](/src/assets/images/Transient_FEM_Bimetal_%281%29.JPG)

## Preparing and running the FEM analysis

### Assigning the materials

In the FEM workbench we create a new ![](/src/assets/images/FEM_Analysis.svg) analysis and add a new ![](/src/assets/images/FEM_MaterialSolid.svg) material to the analysis. In the upcoming task window, we select one of the predefined aluminium alloys. Under 'geometry reference selector', we assign the material to the lower strip of our model by setting the selection mode to 'solid', clicking 'add' and selecting a face or an edge of the lower strip. In the list view, 'BooleanFragments:Solid1' should show up.

![](/src/assets/images/Transient_FEM_Bimetal_%282%29.JPG)
...
![](/src/assets/images/Transient_FEM_Bimetal_%286%29.JPG)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Transient_FEM_analysis/en&oldid=1251796>"
