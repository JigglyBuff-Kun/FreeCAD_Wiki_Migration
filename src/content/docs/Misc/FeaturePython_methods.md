---
title: FeaturePython methods
---
## Introduction

This page serves as a reference for the available overridable methods on [Create a FeaturePython object part I](/Create_a_FeaturePython_object_part_I "Create a FeaturePython object part I") or [Scripted objects](/Scripted_objects "Scripted objects").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FeaturePython_methods/en&oldid=870402>"