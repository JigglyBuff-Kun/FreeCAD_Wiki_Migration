...
- ![](/src/assets/images/Std_DlgMacroRecord.svg) [Macro recording...](/Std_DlgMacroRecord "Std DlgMacroRecord")
- ![](/src/assets/images/Std_MacroStopRecord.svg) [Stop macro recording](/Std_MacroStopRecord "Std MacroStopRecord")
- ![](/src/assets/images/Std_DlgMacroExecute.svg) [Macros...](/Std_DlgMacroExecute "Std DlgMacroExecute")
- ![](/src/assets/images/Std_DlgMacroExecuteDirect.svg) [Execute macro](/Std_DlgMacroExecuteDirect "Std DlgMacroExecuteDirect")
...
* ![](/src/assets/images/Std_MacroStartDebug.svg) [Debug macro](/Std_MacroStartDebug "Std MacroStartDebug")
* ![](/src/assets/images/Std_MacroStopDebug.svg) [Stop debugging](/Std_MacroStopDebug "Std MacroStopDebug")
...
1. Open the menu **Macro → ![](/src/assets/images/Std_DlgMacroExecute.svg) [Macros...](/Std_DlgMacroExecute "Std DlgMacroExecute")** to open the [Execute macro dialog](/Std_DlgMacroExecute "Std DlgMacroExecute").

![](/src/assets/images/Dxf_Importer_Install_01.png)
...
![](/src/assets/images/Dxf_Importer_Install_02.png)
...
![](/src/assets/images/Dxf_Importer_Install_03.png)
...
![](/src/assets/images/Dxf_Importer_Install_04.png)
...
We will use ![](/src/assets/images/Part_Prism_Apothem.svg) [Macro Apothem Based Prism GUI](/Macro_Apothem_Based_Prism_GUI "Macro Apothem Based Prism GUI") as an example.

1. Go to the macro wiki page, which should be listed in [Macros recipes](/Macros_recipes "Macros recipes").

If there is a custom icon download it; click on it with the right mouse button and select `Save image as...`; place the icon in the macros directory. This icon can be used as a shortcut for the macro in a [custom toolbar](/Customize_Toolbars "Customize Toolbars"). The default icon is ![](/src/assets/images/Text-x-python.png).

![](/src/assets/images/Macro_Install_HowTo_28.png)
...
3. In FreeCAD, open the menu **Macro → ![](/src/assets/images/Std_DlgMacroExecute.svg) [Macros...](/Std_DlgMacroExecute "Std DlgMacroExecute")** to open the [Execute macro dialog](/Std_DlgMacroExecute "Std DlgMacroExecute").
...
![](/src/assets/images/Macro_Install_HowTo_27.png)

Asking for confirmation to save the code

9. Open the menu again, **Macro → ![](/src/assets/images/Std_DlgMacroExecute.svg) [Macros...](/Std_DlgMacroExecute "Std DlgMacroExecute")**, select the new macro and press Execute.

![](/src/assets/images/Macro_Install_HowTo_21.png)

Selecting the macro to run it

10. The macro now runs. Fill in the fields with your values and click the OK button.

![](/src/assets/images/Macro_Install_HowTo_22.png)
...
Create a new document with **File → ![](/src/assets/images/Std_New.svg) [New](/Std_New "Std New")**, and then repeat the previous steps to execute the macro.

![](/src/assets/images/Macro_Install_HowTo_23.png)
...
![](/src/assets/images/Macro_Install_HowTo_24.png)

Object created by the macro

13. You can open the macro in the editor again to run it or modify it. Go to **Macro → ![](/src/assets/images/Std_DlgMacroExecute.svg) [Macros...](/Std_DlgMacroExecute "Std DlgMacroExecute")**, select the macro and press Edit.

![](/src/assets/images/Macro_Install_HowTo_25.png)

Opening the macro in the editor

14. The macro can now be run with **Macro → ![](/src/assets/images/Std_DlgMacroExecuteDirect.svg) [Execute macro](/Std_DlgMacroExecuteDirect "Std DlgMacroExecuteDirect")**, or by clicking on the ![](/src/assets/images/Std_DlgMacroExecuteDirect.svg) [Std DlgMacroExecuteDirect](/Std_DlgMacroExecuteDirect "Std DlgMacroExecuteDirect") button in the toolbar.

![](/src/assets/images/Macro_Install_HowTo_26.png)
...
We will use ![](/src/assets/images/Text-x-python.png) [Macro screw maker](/Macro_screw_maker1_2 "Macro screw maker1 2") as an example.
...
![](/src/assets/images/Macro_Install_HowTo_05.png)

Placing the macro file in the macro directory

7. In FreeCAD, open the menu **Macro → ![](/src/assets/images/Std_DlgMacroExecute.svg) [Macros...](/Std_DlgMacroExecute "Std DlgMacroExecute")** to open the [Execute macro dialog](/Std_DlgMacroExecute "Std DlgMacroExecute").

![](/src/assets/images/Macro_Install_HowTo_06.png)

Opening the Execute macro dialog

8. Select the new macro and press Execute.

![](/src/assets/images/Macro_Install_HowTo_07.png)

Selecting the macro to run it

9. The macro now runs. Select the desired options, and click the Create button.

![](/src/assets/images/Macro_Install_HowTo_08.png)

The macro in action; select the desired options, and press Create when ready

![](/src/assets/images/Macro_Install_HowTo_30.png)
...
![](/src/assets/images/Macro_Install_HowTo_11.png)
...
![](/src/assets/images/Macro_Install_HowTo_12.png)
...
![](/src/assets/images/Macro_Install_HowTo_14.png)
...
![](/src/assets/images/Macro_Install_HowTo_15.png)
...
![](/src/assets/images/Macro_Install_HowTo_16.png)
...
![](/src/assets/images/Macro_Install_HowTo_31.png)

![](/src/assets/images/Macro_Install_HowTo_32.png)

Making the panels visible in the menu View → Panels

2. Enable the `Report view` and the `Python console`.

![](/src/assets/images/Macro_Install_HowTo_33.png)
...
![](/src/assets/images/Macro_Install_HowTo_34.png)
...
![](/src/assets/images/Macro_Install_HowTo_35.png)

Going into the preferences editor

2. Go to **Python** section, and then **Output window → Python interpreter**.

![](/src/assets/images/Macro_Install_HowTo_36.png)

Output window preferences

3. Check both boxes:

- ![](/src/assets/images/Case_a_cocher_O.png) Redirect internal Python output to report view

- ![](/src/assets/images/Case_a_cocher_O.png) Redirect internal Python errors to report view

and then press the OK button.

![](/src/assets/images/Macro_Install_HowTo_37.png)

Redirecting the Python output to the report view

![](/src/assets/images/Macro_Install_HowTo_38.png)
