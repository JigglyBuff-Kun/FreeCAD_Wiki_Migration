...
Update original [Arch Tutorial](/Arch_tutorial "Arch tutorial") by [Yorik van Havre](http://yorik.uncreated.net/) .
...
_For dxf files, they are placed in a directory named ./ref/dxf below the project directory._
