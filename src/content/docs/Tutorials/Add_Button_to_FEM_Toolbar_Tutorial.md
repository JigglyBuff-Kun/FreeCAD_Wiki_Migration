---
title: Add Button to FEM Toolbar Tutorial
---
|  |
| --- |
| Tutorial |
...
For the button, we need an icon file. You can use any of your favorite tools to create it, but it must be in the SVG format. Here we will use the FEM\_testButton.svg file as an example.
...
**Result**: You should have just successfully added a test button to a FEM workbench toolbar and menu. Now, you can [compile FreeCAD](/Compiling "Compiling") and test your new button.

## Related

* [Extend FEM Module](/Extend_FEM_Module "Extend FEM Module")
* [Onboarding FEM Devs](/Onboarding_FEM_Devs "Onboarding FEM Devs")

Retrieved from "<http://wiki.freecad.org/index.php?title=Add_Button_to_FEM_Toolbar_Tutorial/en&oldid=1354648>"