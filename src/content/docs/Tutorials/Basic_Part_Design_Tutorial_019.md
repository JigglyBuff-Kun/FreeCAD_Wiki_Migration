...
: Click ![](/images/PartDesign_NewSketch.svg) [Create sketch](/PartDesign_NewSketch "PartDesign NewSketch") and create a sketch attached to the **YZ_Plane**. FreeCAD will assign the name **Sketch001**.
...
: Click ![](/images/PartDesign_NewSketch.svg) [Create sketch](/PartDesign_NewSketch "PartDesign NewSketch") and create a sketch attached to the **XZ_Plane**. The sketch will be named **Sketch002**.
...
2. Click ![](/images/PartDesign_NewSketch.svg) [Create sketch](/PartDesign_NewSketch "PartDesign NewSketch") and create a new sketch attached to the **XY_Plane**. The sketch will be named **Sketch003**.
...
2. Click ![](/images/PartDesign_NewSketch.svg) [Create sketch](/PartDesign_NewSketch "PartDesign NewSketch") and create a new sketch attached to the **YZ_Plane**. The sketch will be named **Sketch004**.
