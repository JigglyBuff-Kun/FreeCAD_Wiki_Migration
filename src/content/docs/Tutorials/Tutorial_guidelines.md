...
This is meant as a test for a new style guideline for tutorials.Feel free to add any ideas or test formatting. DO NOT TRANSLATE!
...
| {{{Topic}}}                         |
| Level                               |
| What level of user is it meant for? |
| Time to complete                    |
| How long does it take to complete?  |
| Authors                             |
| Add a link to your forum profile    |
| FreeCAD version                     |
| What FreeCAD version are you using? |
| Example files                       |
| _None_                              |
| See also                            |
| _None_                              |
...
[Tutorial Guidelines](/Tutorial_Guidelines "Tutorial Guidelines"): Links and descriptions within the template Rightbox should be meant as a tool to reference other wiki pages that may aid in the comprehension of the tutorial. Such as a link to the [Part Workbench](/Part_Workbench "Part Workbench").

[Video tutorials](/Video_tutorials "Video tutorials"): Discover the extensive collections of FreeCAD videos made by community members
...
Remember that it is possible to use boxes to occupy the entire width of the page. This can be useful to highlight something or to create a gallery. Below are two styles to present a gallery.
...
- [![Macropodus opercularis (Paradise fish)](https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Macropodus_opercularis_-_front_%28aka%29.jpg/246px-Macropodus_opercularis_-_front_%28aka%29.jpg)](</File:Macropodus_opercularis_-_front_(aka).jpg> "Macropodus opercularis (Paradise fish)")
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Tutorial_guidelines&oldid=986690>"
