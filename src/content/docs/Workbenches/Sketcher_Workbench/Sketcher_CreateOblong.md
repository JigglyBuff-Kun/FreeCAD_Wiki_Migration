...
1. There are several ways to invoke the tool:
   - Press the ![](/images/Sketcher_CreateOblong.svg) [Rounded rectangle](/Sketcher_CreateOblong "Sketcher CreateOblong") button.
   - Select the **Sketcher → Sketcher geometries → ![](/images/Sketcher_CreateOblong.svg) Create rounded rectangle** option from the menu.
