...
3. There are several ways to invoke the tool:
   - Select the **Sketch → Sketcher constraints → ![](/src/assets/images/Sketcher_ConstrainSnellsLaw.svg) Constrain refraction (Snell's law)** option from the menu.
