...
The ![](/src/assets/images/Sketcher_MapSketch.svg) [Sketcher MapSketch](/Sketcher_MapSketch "Sketcher MapSketch") tool attaches a sketch to selected geometry.
...
2. There are several ways to invoke the tool:
   - Press the ![](/src/assets/images/Sketcher_MapSketch.svg) [Attach sketch...](/Sketcher_MapSketch "Sketcher MapSketch") button.
   - Select the **Sketch → ![](/src/assets/images/Sketcher_MapSketch.svg) Attach sketch...** option from the menu.
