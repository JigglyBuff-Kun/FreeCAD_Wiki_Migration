...
![](/src/assets/images/PartDesign_Body_tree-04.png)

## Usage

1. In the Model tree, right-click on the feature to set as tip.
2. Select from the list in the context menu ![](/src/assets/images/PartDesign_MoveTip.svg) **Set tip**.
