...
- **Construction line**: selects a construction line from the sketch used by the revolution. The dropdown list will contain an entry for each construction line. The first construction line will be labelled _Construction line 1_.
...
- Data**Base** (`Vector`): (read-only)
- Data**Axis** (`Vector`): (read-only)
- Data**Angle** (`Angle`)
- Data**Up To Face** (`LinkSub`)
- Data**Angle2** (`Angle`)
