...
2. Click on ![](/src/assets/images/Robot_RestoreHomePos.svg) or choose Robot → ![](/src/assets/images/Robot_RestoreHomePos.svg) Move to home from the top menu.
...
- If no home position has been specified via ![](/src/assets/images/Robot_SetHomePos.svg) [Robot SetHomePos](/Robot_SetHomePos "Robot SetHomePos") the position of the robot as inserted in the scene will be used as home position.
