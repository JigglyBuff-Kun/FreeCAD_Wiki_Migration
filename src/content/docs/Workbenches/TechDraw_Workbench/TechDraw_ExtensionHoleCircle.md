...
3. There are several ways to invoke the tool:
   - Press the ![](/images/TechDraw_ExtensionHoleCircle.svg) [Add Bolt Circle Centerlines](/TechDraw_ExtensionHoleCircle "TechDraw ExtensionHoleCircle") button.
   - Select the **TechDraw → Extensions: Centerlines/Threading → ![](/images/TechDraw_ExtensionHoleCircle.svg) Add Bolt Circle Centerlines** option from the menu.
