...
2. There are several ways to invoke the tool:
   - Press the ![](/images/TechDraw_AxoLengthDimension.svg) [Axonometric length dimension](/TechDraw_AxoLengthDimension "TechDraw AxoLengthDimension") button.
   - Select the **TechDraw → Annotations → ![](/images/TechDraw_AxoLengthDimension.svg) Axonometric length dimension** option from the menu.
