...
1. Create a closed wire with following the counter-clockwise direction and select it.
   ...
   : ![](/src/assets/images/CounterclockwiseWire.png)

2. Press the ![](/src/assets/images/Arch_Roof.svg) [Roof](/Arch_Roof "Arch Roof") button, or press R then F keys
...
4. After creating the default roof, double click on the object in the [tree view](/Tree_view "Tree view") to access and edit all the properties. Angle must be between 0 and 90.
   ...
   : ![](/src/assets/images/RoofTable.png)
...
8. Finally, set an Angle to 90° to make a gable.
   ...
   : ![](/src/assets/images/RoofProfil.png)
...
2. Press the ![](/src/assets/images/Arch_Roof.svg) [Arch Roof](/Arch_Roof "Arch Roof") button, or press R then F keys.
...
![](/src/assets/images/Arch_Roof_Subtract_Default.png) ![](/src/assets/images/Arch_Roof_Subtract_Subvolume.png) ![](/src/assets/images/Arch_Roof_Subvolume_Example.png)
