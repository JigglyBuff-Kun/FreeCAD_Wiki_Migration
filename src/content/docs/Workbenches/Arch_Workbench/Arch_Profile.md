...
- Data**Height**: The overall height of the profile
- Data**Width**: The overall width of the profile
- Data**Diameter**: The diameter of the profile (circular profiles only)
- Data**Thickness**: The thickness of the tube wall (circular and rectangular hollow profiles only)
- Data**Web Thickness**: The thickness of the profile web (H and I profiles only)
- Data**Flange Thickness**: The thickness of the profile flange (H and I profiles only)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Profile/en&oldid=1481133>"
