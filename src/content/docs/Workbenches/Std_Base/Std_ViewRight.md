...
1. There are several ways to invoke the command:
   - Press the ![](/src/assets/images/Std_ViewRight.svg) [Right](/Std_ViewRight "Std ViewRight") button.
   - Select the **View → Standard views → ![](/src/assets/images/Std_ViewRight.svg) Right** option from the menu.
   - Select the **Standard views → ![](/src/assets/images/Std_ViewRight.svg) Right** option from the [3D view](/3D_view "3D view") context menu.
