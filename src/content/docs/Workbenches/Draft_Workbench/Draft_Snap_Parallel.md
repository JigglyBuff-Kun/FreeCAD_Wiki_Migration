...
The ![](/src/assets/images/Draft_Snap_Parallel.svg) **Draft Snap Parallel** option snaps to an imaginary line parallel to straight edges. The edges can belong to [Draft](/Draft_Workbench "Draft Workbench") or [BIM](/BIM_Workbench "BIM Workbench") objects but also to objects created with other [workbenches](/Workbenches "Workbenches").
...
![](/src/assets/images/Draft_Snap_Parallel_example.png)
...
2. If **Draft Snap Parallel** is not active do one of the following:
   - Press the ![](/src/assets/images/Draft_Snap_Parallel.svg) [Snap parallel](/Draft_Snap_Parallel "Draft Snap Parallel") button in the Draft snap toolbar.
   - [Draft](/Draft_Workbench "Draft Workbench"): Hold down the ![](/src/assets/images/Draft_Snap_Lock.svg)![](/src/assets/images/Toolbar_flyout_arrow.svg) button in the [Draft snap widget](/Draft_snap_widget "Draft snap widget") and in the menu that opens select the **![](/src/assets/images/Draft_Snap_Parallel.svg) Snap parallel** option.
   - [BIM](/BIM_Workbench "BIM Workbench"): Select the **Snapping → ![](/src/assets/images/Draft_Snap_Parallel.svg) Snap parallel** option from the menu, or from the [3D view](/3D_view "3D view") context menu.
...
9. The point is marked and the ![](/src/assets/images/Draft_Snap_Parallel.svg) icon is displayed near the cursor.
