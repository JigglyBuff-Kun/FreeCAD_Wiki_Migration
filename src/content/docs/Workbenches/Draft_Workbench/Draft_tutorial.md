...
This tutorial is meant to introduce the reader to the basic workflow of the ![](/src/assets/images/Workbench_Draft.svg) [Draft Workbench](/Draft_Workbench "Draft Workbench").
...
![](/src/assets/images/00_Dr01_Draft_Tutorial_final.png)
...
: 1.1. Switch to the [Draft Workbench](/Draft_Workbench "Draft Workbench") from the [workbench selector](/Std_Workbench "Std Workbench"), or the menu **View → Workbench → ![](/src/assets/images/Workbench_Draft.svg) Draft**.
: 1.2. Make sure you understand how to use the [property editor](/Property_editor "Property editor"), particularly the **Data** and **View** tabs to change the properties. When changing properties, you may have to do a ![](/src/assets/images/Std_Refresh.svg) [Std Refresh](/Std_Refresh "Std Refresh") action to see the result in the [3D view](/3D_view "3D view").
: 1.3. Since the Draft objects are planar shapes, they are better viewed from the top. Use ![](/src/assets/images/Std_ViewTop.svg) [View top](/Std_ViewTop "Std ViewTop") to set the [3D view](/3D_view "3D view").
: 1.4. Although it is not used in this tutorial, the Draft grid is helpful to position geometrical elements. Use ![](/src/assets/images/Draft_SelectPlane.svg) [SelectPlane](/Draft_SelectPlane "Draft SelectPlane") to set both the working plane and the grid, and then show and hide the grid with ![](/src/assets/images/Draft_ToggleGrid.svg) [Toggle grid](/Draft_ToggleGrid "Draft ToggleGrid").
...
3. Press ![](/src/assets/images/Draft_SelectPlane.svg) [SelectPlane](/Draft_SelectPlane "Draft SelectPlane"), or go to the menu **Utilities → ![](/src/assets/images/Draft_SelectPlane.svg) [Select plane](/Draft_SelectPlane "Draft SelectPlane")**, to open the working plane [task panel](/Task_panel "Task panel").

: 3.1. Press ![](/src/assets/images/Std_ViewTop.svg) Top (XY).
...
: 4.1. Press ![](/src/assets/images/Draft_Arc.svg) [Arc](/Draft_Arc "Draft Arc").
...
: 5.1. Press ![](/src/assets/images/Draft_Line.svg) [Line](/Draft_Line "Draft Line").
: 5.2. In the [Snap toolbar](/Draft_Snap "Draft Snap") make sure ![](/src/assets/images/Draft_Snap_Lock.svg) [Toggle snap](/Draft_Snap_Lock "Draft Snap Lock") is active, and only ![](/src/assets/images/Draft_Snap_Endpoint.svg) [Endpoint](/Draft_Snap_Endpoint "Draft Snap Endpoint") as well. As you move the pointer onto the arc and close to one of its endpoints, the ![](/src/assets/images/Draft_Snap_Endpoint.svg) [Endpoint](/Draft_Snap_Endpoint "Draft Snap Endpoint") icon should appear. Also, the target point is emphasized with a large white dot. Click to select this point.
...
![](/src/assets/images/01_Dr01_Draft_Arc_profile.png)
...
: 6a.2. With these objects selected, click on ![](/src/assets/images/Draft_Upgrade.svg) [Upgrade](/Draft_Upgrade "Draft Upgrade").
...
: 6b.1. Switch to the ![](/src/assets/images/Workbench_Part.svg) [Part Workbench](/Part_Workbench "Part Workbench").
: 6b.2. With these objects selected, click on ![](/src/assets/images/Part_Compound.svg) [Part Compound](/Part_Compound "Part Compound").

## Rectangles, circles, and polygons

7. We will draw a rectangular frame. (Switch back to the ![](/src/assets/images/Workbench_Draft.svg) [Draft Workbench](/Draft_Workbench "Draft Workbench").)

: 7.1. Press ![](/src/assets/images/Draft_Rectangle.svg) [Rectangle](/Draft_Rectangle "Draft Rectangle").
...
: 8.1. Press ![](/src/assets/images/Draft_Circle.svg) [Circle](/Draft_Circle "Draft Circle").
...
: 9.1. Press ![](/src/assets/images/Draft_Polygon.svg) [Polygon](/Draft_Polygon "Draft Polygon").
...
![](/src/assets/images/02_Dr01_Draft_Rectangle_circle_polygon.png)
...
: 10.1. Select the `Wire` object that was previously created with the ![](/src/assets/images/Draft_Upgrade.svg) [Upgrade](/Draft_Upgrade "Draft Upgrade") tool, or the `Compound` created with the ![](/src/assets/images/Part_Compound.svg) [Part Compound](/Part_Compound "Part Compound") tool.
: 10.2. Press ![](/src/assets/images/Draft_PolarArray.svg) [PolarArray](/Draft_PolarArray "Draft PolarArray").
...
![](/src/assets/images/03_Dr01_Draft_PolarArray.png)
...
: 11.1. Press ![](/src/assets/images/Draft_Dimension.svg) [Dimension](/Draft_Dimension "Draft Dimension").
: 11.2. Pick the first point. In this tutorial the first point will always be the origin `(0, 0, 0)`.
: 11.3. In the [Snap toolbar](/Draft_Snap "Draft Snap") make sure ![](/src/assets/images/Draft_Snap_Lock.svg) [Toggle snap](/Draft_Snap_Lock "Draft Snap Lock") is active, and only ![](/src/assets/images/Draft_Snap_Midpoint.svg) [Midpoint](/Draft_Snap_Midpoint "Draft Snap Midpoint") as well. As you move the pointer to the top edge of the polygon, the ![](/src/assets/images/Draft_Snap_Midpoint.svg) [Midpoint](/Draft_Snap_Midpoint "Draft Snap Midpoint") icon should appear; click to select this point.
...
12. Repeat the process for the two arcs of the closed profile. The first point of the measurement will still be the origin, and the second point will use the ![](/src/assets/images/Draft_Snap_Midpoint.svg) [Midpoint](/Draft_Snap_Midpoint "Draft Snap Midpoint") of the arc.

13. Repeat the process for the circle located in the center. The first point of the measurement will still be the origin. To select the second point make sure ![](/src/assets/images/Draft_Snap_Lock.svg) [Toggle snap](/Draft_Snap_Lock "Draft Snap Lock") is active, and only ![](/src/assets/images/Draft_Snap_Angle.svg) [Angle](/Draft_Snap_Angle "Draft Snap Angle") as well. As you move the pointer to the top of the circle, the ![](/src/assets/images/Draft_Snap_Angle.svg) [Angle](/Draft_Snap_Angle "Draft Snap Angle") icon should appear; click to select this point. Then move the cursor to the right, and click to fix the dimension.

Remember to adjust the View**Font Size**, and other properties to see the dimension correctly.

![](/src/assets/images/04_Dr01_Draft_Dimension.png)
...
: 14.1. Press ![](/src/assets/images/Draft_Text.svg) [Text](/Draft_Text "Draft Text").
: 14.2. Select the reference point in the [3D view](/3D_view "3D view"). In the [Snap toolbar](/Draft_Snap "Draft Snap") make sure ![](/src/assets/images/Draft_Snap_Lock.svg) [Toggle snap](/Draft_Snap_Lock "Draft Snap Lock") is active, and only ![](/src/assets/images/Draft_Snap_Midpoint.svg) [Midpoint](/Draft_Snap_Midpoint "Draft Snap Midpoint") as well. Move the pointer to the top edge of the highest arc, so that the ![](/src/assets/images/Draft_Snap_Midpoint.svg) [Midpoint](/Draft_Snap_Midpoint "Draft Snap Midpoint") icon appears; click to select this point.
...
: 15.1. Press ![](/src/assets/images/Draft_ShapeString.svg) [ShapeString](/Draft_ShapeString "Draft ShapeString").
...
![](/src/assets/images/05_Dr01_Draft_Text_ShapeString.png)
...
Before doing anything, hide the Draft grid by pressing ![](/src/assets/images/Draft_ToggleGrid.svg) [Toggle grid](/Draft_ToggleGrid "Draft ToggleGrid").

16. Switch to the ![](/src/assets/images/Workbench_TechDraw.svg) [TechDraw Workbench](/TechDraw_Workbench "TechDraw Workbench").

: 16.1. Create a standard page by pressing ![](/src/assets/images/TechDraw_PageDefault.svg) [TechDraw PageDefault](/TechDraw_PageDefault "TechDraw PageDefault").
: 16.2. In the [tree view](/Tree_view "Tree view") select all objects created, except for the Page, and then press ![](/src/assets/images/TechDraw_ActiveView.svg) [TechDraw ActiveView](/TechDraw_ActiveView "TechDraw ActiveView"). Press OK with the default options; it may take a few seconds to create the view in the page.
...
: 16.5. Recompute the model by using ![](/src/assets/images/Std_Refresh.svg) [Refresh](/Std_Refresh "Std Refresh") or pressing F5.
: 16.6. Hide the frames of the objects by pressing ![](/src/assets/images/TechDraw_ToggleFrame.svg) [TechDraw ToggleFrame](/TechDraw_ToggleFrame "TechDraw ToggleFrame").
...
Tools like ![](/src/assets/images/TechDraw_ActiveView.svg) [TechDraw ActiveView](/TechDraw_ActiveView "TechDraw ActiveView"), ![](/src/assets/images/TechDraw_DraftView.svg) [TechDraw DraftView](/TechDraw_DraftView "TechDraw DraftView"), and ![](/src/assets/images/TechDraw_ArchView.svg) [TechDraw ArchView](/TechDraw_ArchView "TechDraw ArchView") work by receiving an internal SVG image that is generated by internal Draft functions; therefore, TechDraw doesn't have much control about how these views are displayed. More integration of Draft and TechDraw is a work in progress.
...
- It is possible to transform a Draft object into a [Sketch](/Sketch "Sketch"), and the other way around, using the ![](/src/assets/images/Draft_Draft2Sketch.svg) [Draft Draft2Sketch](/Draft_Draft2Sketch "Draft Draft2Sketch") tool.
