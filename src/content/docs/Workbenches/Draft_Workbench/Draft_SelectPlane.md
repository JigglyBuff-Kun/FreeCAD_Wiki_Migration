...
1. Do one of the following:
   - Select a single object. The following objects are supported:
     - [Draft WorkingPlaneProxies](/Draft_WorkingPlaneProxy "Draft WorkingPlaneProxy"): the View**View Data** (the camera position) and the View**Visibility Map** (the saved visibility of objects) of the working plane proxy are also restored.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_SelectPlane/en&oldid=1513537>"
