---
title: FEM Post Processing based on VTK
---
This page is dedicated to the description of the [Google Summer of Code](/Google_Summer_of_Code "Google Summer of Code") project idea regarding FEM post processing based on the VTK library.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=FEM_Post_Processing_based_on_VTK&oldid=334820>"