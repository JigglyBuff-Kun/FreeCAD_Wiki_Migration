...
2. There are several ways to invoke the command:
   - Press the ![](/src/assets/images/FEM_ConstraintTransform.svg) [Local coordinate system](/FEM_ConstraintTransform "FEM ConstraintTransform") button.
   - Select the **Model → Geometrical analysis features → ![](/src/assets/images/FEM_ConstraintTransform.svg) Local coordinate system** option from the menu.
...
![](/src/assets/images/FEM_transform_rect_displ.PNG)
...
![](/src/assets/images/FEM_transform_cyl_displ.PNG)
...
![](/src/assets/images/FEM_transform_cyl_force.PNG)
