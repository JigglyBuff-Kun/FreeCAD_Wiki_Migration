...
The most basic object that can be created is a [Part Feature](/Part_Feature "Part Feature"), which has a simple Data**Placement** property, and basic properties to define its color and appearance.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_scripting/en&oldid=1268489>"