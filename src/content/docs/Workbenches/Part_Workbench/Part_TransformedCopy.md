...
The ![](/src/assets/images/Part_TransformedCopy.svg) **Part TransformedCopy** command creates non-parametric copies of objects. It is intended for objects nested in containers.
...
2. Select the **Part → Create a copy → ![](/src/assets/images/Part_TransformedCopy.svg) Create transformed copy** option from the menu.
