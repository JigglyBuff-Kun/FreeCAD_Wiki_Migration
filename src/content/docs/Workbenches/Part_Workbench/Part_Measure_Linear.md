...
2. There are several ways to invoke the command:
   - Press the ![](/src/assets/images/Part_Measure_Linear.svg) [Measure Linear](/Part_Measure_Linear "Part Measure Linear") button.
   - Select the **Measure → ![](/src/assets/images/Part_Measure_Linear.svg) Measure Linear** option from the menu.
