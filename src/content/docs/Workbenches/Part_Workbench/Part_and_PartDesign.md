...
(Another thing mentioned often is a Body **_MUST_** be a single contiguous solid. This means all geometry created by a feature in the Body _must_ touch it's predecessor.)
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Part_and_PartDesign/en&oldid=1446925>"
