---
title: Bancada de Trabalho Folha de Cálculo
---
...
[introduced in 0.15](/Release_notes_0.15 "Release notes 0.15")A bancada de trabalho Folha de Cálculo permite criar e editar folhas de cálculo, executar cálculos, e obter informação de um modelo, e exportar informação para outras aplicações de folha de cálculo tais como o LibreOffice ou Microsoft Excel.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Spreadsheet_Workbench/pt&oldid=1506762>"
