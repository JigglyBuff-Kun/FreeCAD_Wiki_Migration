...
- ![](/images/Draft_ToggleDisplayMode.svg) [Toggle normal/wireframe display](/Draft_ToggleDisplayMode "Draft ToggleDisplayMode"): switches the Ver**Display Mode** property of selected objects between `Flat Lines` and `Wireframe`.
...
- [Pattern](/Draft_Pattern "Draft Pattern"): Draft objects with a Dados**Make Face** property can display an SVG pattern instead of a solid face color.
...
- ![](/images/Draft_SelectPlane.svg) [Write camera position](/Draft_WorkingPlaneProxy#Context_menu "Draft WorkingPlaneProxy"): updates the Ver**View Data** property of the working plane proxy with the current [3D view](/3D_view "3D view") camera settings.

- ![](/images/Draft_SelectPlane.svg) [Write objects state](/Draft_WorkingPlaneProxy#Context_menu "Draft WorkingPlaneProxy"): updates the Ver**Visibility Map** property of the working plane proxy with the current visibility state of objects in the document.
...
- [Draft tutorial](/index.php?title=Draft_tutorial/pt&action=edit&redlink=1 "Draft tutorial/pt (page does not exist)")
- [Draft ShapeString tutorial](/Draft_ShapeString_tutorial "Draft ShapeString tutorial")

Retrieved from "<http://wiki.freecad.org/index.php?title=Draft_Workbench/pt&oldid=1547509>"
