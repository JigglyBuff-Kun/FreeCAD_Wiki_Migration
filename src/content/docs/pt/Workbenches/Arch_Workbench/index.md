---
title: Bancada de trabalho "Arch" (Arquitectura)
---
...
- [OBJ](/Arch_OBJ "Arch OBJ") : Obj mesh format

## API

O módulo Arch (Arquitetura) pode ser usado em scripts python e [macros](/Macros/pt "Macros/pt") usando funções [Arch Python API](http://www.freecadweb.org/api/Arch.html).

## Tutoriais

- [Tuturiais de Arquitetura](/Arch_tutorial "Arch tutorial")
- [Tutoriais de Arquitetura no blog do Yorik](http://yorik.uncreated.net/guestblog.php?2012=180)

Retrieved from "<http://wiki.freecad.org/index.php?title=Arch_Workbench/pt&oldid=1433529>"
