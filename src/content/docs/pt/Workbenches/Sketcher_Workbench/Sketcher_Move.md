...
| Sketcher Move |
| Localização do menu |
| Sketch → Ferramentas de esboço (Sketcher) → Move |
...
| 0.18 |
| Veja também |
| [Clonar](/index.php?title=Sketcher_Clone/pt&action=edit&redlink=1 "Sketcher Clone/pt (page does not exist)"), [Copiar](/index.php?title=Sketcher_Copy/pt&action=edit&redlink=1 "Sketcher Copy/pt (page does not exist)") |
|  |
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Sketcher_Move/pt&oldid=1458231>"