---
title: Bancada de trabalho Drawing (Desenho de Folhas)
---
...
**Note**
A ferramenta [Vista Draft](/Draft_Drawing "Draft Drawing") é usada principalmente para colocar os objetos draft (traços) no papel. Tem algumas capacidades extra relativamente ás ferramentas Drawing Standard, e suporta objetos específicos como [Draft dimensions](/Draft_Dimension "Draft Dimension").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Drawing_Workbench/pt&oldid=1462070>"
