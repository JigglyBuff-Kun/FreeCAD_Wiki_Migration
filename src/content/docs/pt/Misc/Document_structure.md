...
Os objectos dentro de um documento FreeCAD pode ser de diferentes tipos. Cada bancada pode criar seus próprios tipos de objectos, por exemplo, o [Mesh Workbench](/Mesh_Workbench "Mesh Workbench") cria objectos de malha, os [Part Workbench](/Part_Workbench "Part Workbench") cria objectos parciais , o [Draft Workbench](/Draft_Workbench "Draft Workbench") também cria objectos parciais, etc.
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Document_structure/pt&oldid=1536775>"