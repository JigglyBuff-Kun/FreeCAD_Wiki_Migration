---
title: Notas de lançamento da versão 0.17
---
"Esta versão do FreeCAD é dedicada ao nosso amigo Roland Frank [que nos deixou em 2017](https://forum.freecadweb.org/viewtopic.php?f=8&t=25673). Ele foi um membro do forum do FreeCAD muito ativo e bem apreciado, e os seus videos e tuturiais nos canais do youtube em [Learn FreeCAD](https://www.youtube.com/watch?v=_HEvhclR4-o&list=PL6fZ68Cq3L8k0JhxnIVjZQN26cn9idJrj) and [BPLFRE](https://www.youtube.com/watch?v=m49z0weonog&list=PLsrwVwvqYb8G4Ri0iz1JIebsOXkgoytAY) ajudaram muita gente a iniciar-se no FreeCAD.

O FreeCAD 0.17 foi lançado a 06 de abril de 2018, obtenha-o na página de [Download](/Download "Download"). Isto é um resumo das alterações mais importantes. A lista completa de alterações pode ser encontrada em [MantisBT bugtracker FC 0.17 changelog](https://www.freecadweb.org/tracker/changelog_page.php?version_id=73).

Versões anteriores das Notas de lançamento do FreeCAD podem ser encontradas em [Por onde começar](/Getting_started/pt "Getting started/pt").
...
Retrieved from "<http://wiki.freecad.org/index.php?title=Release_notes_0.17/pt&oldid=1074024>"