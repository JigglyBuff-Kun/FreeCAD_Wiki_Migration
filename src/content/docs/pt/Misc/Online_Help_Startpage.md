...
Este documento foi criado automaticamente a partir dos conteúdos do wiki da documentação oficial do FreeCAD, que pode ser encontrada online em [[1]](http://www.freecadweb.org/wiki/index.php?title=Main_Page). Dado que o wiki é mantido ativamente a desenvolvido continuamente pela comunidade de programadores e utilizadores do FreeCAD, poderá descobrir que a versão online contém mais e mais recente material do que este documento. Lá irá encontrar traduções em curso desta documentação em várias linguagens. Seja como for, esperamos que encontre aqui toda a informação de que necessita. No caso de ter dúvidas para as quais não encontra resposta aqui, procure no [fórum FreeCAD](http://forum.freecadweb.org/index.php), onde poderá encontrar resposta à sua questão, ou alguém que possa ajudar.
