...
Outro objetivo do projeto FreeCAD é fazer uso das melhores bibliotecas 'open-source' disponíveis na área da [Computação Científica](http://pt.wikipedia.org/wiki/Computação_científica). Entre elas há o [OpenCascade](http://OpenCascade.org), uma biblioteca de CAD poderosa, [Coin3D](http://Coin3D.org), uma implementação do [OpenInventor](http://en.wikipedia.org/wiki/Open_Inventor), [Qt](http://www.qtsoftware.com/), a famosa arquitetura de interface gráfico, e o [Python](http://www.python.org), uma das melhores linguagens de 'scripting' existentes. O FreeCAD também pode ser usado como biblioteca noutros programas.

O FreeCAD é também completamente [multi-plataforma](http://pt.wikipedia.org/wiki/Multiplataforma), e atualmente corre perfeitamente em Windows, Linux/Unix e sistemas Mac OSX, com exatamente a mesma aparência e funcionalidade em todas as plataformas.

Para saber mais acerca das capacidades do FreeCAD, veja a lista de funcionalidades  [lista de funcionalidades](/Feature_list/pt "Feature list/pt"), as  [notas da última versão](/Getting_started/pt#What's_new "Getting started/pt") ou os  [artigos de familiarização](/Getting_started/pt "Getting started/pt"), ou siga diretamente para a  [área de utilizadores](/User_hub/pt "User hub/pt")!

### Sobre o projeto FreeCAD

O Projeto Freecad começou em 2001, como descrito na página  [história](/History/pt "History/pt")

FreeCAD é mantido e desenvolvido por uma comunidade de desenvolvedores entusiastas e utilizadores (veja a página [contribuidores](/Contributors/pt "Contributors/pt")). Eles trabalham no FreeCAD voluntariamente, no seu tempo livre. Eles não podem garantir que FreeCAD contém ou conterá tudo que você deseja, mas eles costumam fazer o seu melhor! A comunidade reúne-se em [Forum FreeCAD](http://forum.freecadweb.org), onde a maioria das ideias e decisões são discutidas. Sinta-se livre para se juntar a nós!
...
Retrieved from "<http://wiki.freecad.org/index.php?title=About_FreeCAD/pt&oldid=1295139>"